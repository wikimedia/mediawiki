	...
	>
		<template #default>
			<cdx-message
				:type="messageType"
				inline
				class="mw-watchstar-WatchstarPopup-message"
			>
				<div v-if="!errorMessage" v-i18n-html="message"></div>
				<!-- eslint-disable vue/no-v-html Error message HTML comes from the API. -->
