...
( function ( mw, $ ) {
	 ...
	 * @param {boolean} [options.autoHide=false] Should the notification automatically hidden after a specific amount of
	 *  seconds?
	 */
	mw.notification.convertmessagebox = function ( options ) {
		...
		autoHide = options.autoHide ? options.autoHide : $msgBox.attr( 'data-mw-autohide' ) === 'true';
		...
		notif = mw.notification.notify( msg, { autoHide: autoHide, type: options.type } );
		if ( !autoHide ) {
