...
( function ( mw, $ ) {
	 ...
	 * session or series of sessions. Its uniqueness should not be depended on unless the browser
	 ...
	 * See: http://en.wikipedia.org/wiki/Birthday_problem#Probability_table
	 *
	...
	generateRandomSessionId: function () {
		...
		if (cryptoObj) {
			...
			window.crypto.getRandomValues(_int32Array);
