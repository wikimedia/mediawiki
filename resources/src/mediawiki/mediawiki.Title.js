...
( function ( mw, $ ) {
	 ...
	 * prefix in `title`. If you do not want this behavior, use #makeTitle.
	 *
	 ...
	 *
	 * Unlike #newFromText or the constructor, this function doesn't allow the given `namespace` to be
	 ...
	 *     mw.Title.makeTitle( NS_TEMPLATE, 'Template:Foo' ).getPrefixedText(); // => 'Template:Template:Foo'
	 *
	 * The single exception to this behavior is when `namespace` is 0, indicating the main namespace.
