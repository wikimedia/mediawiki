( function ( mw, $ ) {
	...
	function Notification( message, options ) {
		...
		// timeouts: Holds appropriate methods to set/clear timeouts
		...
		this.timeouts = {
			set: options.visibleTimeout ? mw.setVisibleTimeout : setTimeout,
			clear: options.visibleTimeout ? mw.clearVisibleTimeout : clearTimeout
		};
	}
