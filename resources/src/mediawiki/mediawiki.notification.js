( function ( mw, $ ) {
	...
	function init() {
		...
		$globalArea
			.attr( 'id', 'mw-notification-area-global' )
	...
	notification = {
		 ...
		 *
		 * - global:
		 *   An optional boolean. If set to true, the notification will appear
		 *   in the wrapper div that is placed outside the content area.
		 */
		defaults: {
			autoHide: true,
			tag: false,
