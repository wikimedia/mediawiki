...
( function ( mw, $ ) {
	 ...
	 * @cfg {mw.Uri|string} [config.bugsLink="//phabricator.wikimedia.org/maniphest/task/create/"] URL where
	 * bugs can be posted
	 * @cfg {mw.Uri|string} [config.bugsListLink="//phabricator.wikimedia.org/maniphest/query/advanced"]
