...
( function ( mw, $, OO ) {
	...
	mw.GallerySlider.prototype.drawCarousel = function () {
		var $carousel, $imgContainer, next, prev, toggle,
			interfaceElements, carouselStack;
	...
	mw.GallerySlider.prototype.toggleThumbnails = function ( show ) {
		...
		this.$gallery
			.find( '.gallerycarousel' )
			.toggleClass( 'mw-gallery-slider-thumbnails-toggled', show );
	};
