( function ( mw, $ ) {
	...
	var util = {
		...
		/**
		 * Direct translation of wfBaseConvert from PHP.  Can't be done with parseInt and
		 * Integer.toString because javascript uses doubles for math, giving only 53 bits
		 * of precision.
		 *
		 * @param {string} input value to change the base of
		 * @param {number} sourceBase Current base of input
		 * @param {number} destBase Base to output
		 * @return {string} The input converted from sourceBase to destBase
		 */
		baseConvert: function ( input, sourceBase, destBase ) {
