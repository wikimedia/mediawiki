	...
	mw = {
		...
		loader: ( function () {
			...
			function getCombinedVersion( modules ) {
				...
				// Trim to 16 characters for consistency with server-side ResourceLoader::makeHash.
				// It also saves precious space in the limited query string. Otherwise modules are
				// more likely to require multiple HTTP requests.
				return sha1( hashes.join( '' ) ).slice( 0, 16 );
			}
