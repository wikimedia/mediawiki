...
( function ( $ ) {
	...
	mw = {
		...
		loader: ( function () {
			...
			/**
			 * Fired on various resource loading errors.
			 *
			 * @event resourceloader.exception
			 * @param {Exception|Mixed} e The error that was thrown. Almost always an exception
			...
			/**
			 * Fired on resource loading error conditions.
			 *
			 * @event resourceloader.assert
			 * @param {string} source Source of the error. Possible values:
