...
( function ( mw, $ ) {
	...
	mw.experiments = {
		 ...
		 * @property {String} experiment.name The name of the experiment
		 * @property {Boolean} experiment.enabled Whether or not the experiment is
		 *  enabled. If the experiment is disabled, then the user is always assigned
		 *  to the control bucket
		 * @property {Object} experiment.buckets A map of bucket name to probability
