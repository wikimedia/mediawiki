...
( function ( mw ) {
	 ...
	 * need more than the 53 bits of precision offered by Number.toString and
	 * parseInt.
	 *
	 * @since 1.25
	 ...
	 */
	mw.baseConvert = function ( input, sourceBase, destBase ) {
