( function ( mw, OO ) {
	 ...
	 *
	 * Note you can provide the targetHost or not - if the first argument is
	...
	function ForeignUpload( targetHost, apiconfig ) {
		...
		if ( document.location.host !== this.targetHost ) {
			api = new mw.ForeignApi(
				document.location.protocol + '//' + this.targetHost + '/w/api.php',
				apiconfig
			);
		} else {
