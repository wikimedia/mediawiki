...
( function ( mw, $ ) {
	...
	$( function () {
		...
		if ( $oouiNodes.length ) {
			// The modules are added to the page client-side and should already be loading, but this
			// module doesn't depend on them, so we have to wait until they're loaded
