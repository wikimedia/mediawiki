...
/**
 * @var {string} cachedAccessKeyPrefix Cached access key prefix for used browser
 */
var cachedAccessKeyPrefix,

/**
 * @var {boolean} useTestPrefix Wether to use 'test-' instead of correct prefix (used for testing)
 */
	useTestPrefix = false;
