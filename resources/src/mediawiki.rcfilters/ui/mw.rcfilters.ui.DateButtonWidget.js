( function ( mw ) {
	...
	mw.rcfilters.ui.DateButtonWidget.prototype.onModelInitialize = function () {
		var datePopupWidget, selectedItem, currentValue;
		...
		if ( this.daysGroupModel ) {
			...
			selectedItem = this.daysGroupModel.getSelectedItems()[ 0 ];
			currentValue = ( selectedItem && selectedItem.getLabel() ) ||
				mw.language.convertNumber( this.daysGroupModel.getDefaultParamValue() );
