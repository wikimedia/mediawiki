( function ( mw ) {
	 ...
	 * @param {string} specialPage Name of the special page
	...
	mw.rcfilters.ui.MainWrapperWidget = function MwRcfiltersUiMainWrapperWidget(
		controller, model, savedQueriesModel, changesListModel, specialPage, config
	) {
		...
		this.setTopSection( specialPage );
		this.initFormWidget();
	};
	...
	mw.rcfilters.ui.MainWrapperWidget.prototype.setTopSection = function ( specialPage ) {
		...
		if ( specialPage === 'Recentchanges' || specialPage === 'Recentchangeslinked' ) {
			...
			this.filtersWidget.setTopSection( rcTopSection.$element );
		}
		...
		if ( specialPage === 'Watchlist' ) {
			...
			this.filtersWidget.setTopSection( wlTopSection.$element );
		}
	};
	...
	mw.rcfilters.ui.MainWrapperWidget.prototype.initFormWidget = function () {
		return new mw.rcfilters.ui.FormWrapperWidget(
			this.model, this.changesListModel, this.controller, $( 'fieldset.cloptions' ) );
	};
}( mediaWiki ) );
