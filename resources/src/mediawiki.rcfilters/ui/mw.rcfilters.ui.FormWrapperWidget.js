( function ( mw ) {
	...
	mw.rcfilters.ui.FormWrapperWidget.prototype.cleanUpFieldset = function () {
		var $namespaceSelect = this.$element.find( '#namespace' ),
			$namespaceChekboxes = this.$element.find( '#nsassociated, #nsinvert' ),
		...
		$namespaceChekboxes.prop( 'disabled', $namespaceSelect.val() === '' );
		$namespaceSelect.on( 'change', function () {
			$namespaceChekboxes.prop( 'disabled', $( this ).val() === '' );
		} );
