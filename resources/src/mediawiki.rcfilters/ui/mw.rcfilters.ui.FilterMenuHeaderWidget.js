( function ( mw, $ ) {
	...
	mw.rcfilters.ui.FilterMenuHeaderWidget = function MwRcfiltersUiFilterMenuHeaderWidget( controller, model, config ) {
		...
		this.invertNamespacesButton = new OO.ui.ToggleButtonWidget( {
			icon: '',
			label: mw.msg( 'invert' ),
			classes: [ 'mw-rcfilters-ui-filterMenuHeaderWidget-inverNamespacesButton' ]
		} );
		...
		this.model.connect( this, {
			...
			nsInvertChange: 'onModelNSinvertChange',
					...
					.append(
						$( '<div>' )
							...
							.append(
								...
								$( '<div>' )
									.addClass( 'mw-rcfilters-ui-cell' )
									.addClass( 'mw-rcfilters-ui-filterMenuHeaderWidget-header-nsinvert' )
	...
	mw.rcfilters.ui.FilterMenuHeaderWidget.prototype.onModelUpdate = function () {
		...
		this.invertNamespacesButton.toggle( view === 'namespaces' );
	};
	 ...
	 * @param {boolean} highlightEnabled Highlight is enabled
	 */
	mw.rcfilters.ui.FilterMenuHeaderWidget.prototype.onModelNSinvertChange = function ( highlightEnabled ) {
		this.invertNamespacesButton.setActive( highlightEnabled );
	};
