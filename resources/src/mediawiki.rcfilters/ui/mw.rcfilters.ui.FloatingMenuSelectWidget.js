( function ( mw ) {
	 ...
	 * @inheritdoc
	 */
	mw.rcfilters.ui.FloatingMenuSelectWidget.prototype.onKeyDown = function ( e ) {
		var nextItem,
			currentItem = this.getHighlightedItem() || this.getSelectedItem();

		// Call parent
		mw.rcfilters.ui.FloatingMenuSelectWidget.parent.prototype.onKeyDown.call( this, e );
