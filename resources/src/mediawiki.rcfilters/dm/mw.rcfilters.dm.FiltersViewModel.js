( function ( mw ) {
	 ...
	 *
	 * @param {boolean} isSelected Item is selected
	 * @param {string[]} names An array of item names
	 */
	mw.rcfilters.dm.FiltersViewModel.prototype.toggleSelectItemsByName = function ( isSelected, names ) {
		this.getItems().forEach( function ( item ) {
			if ( names.indexOf( item.getName() ) > -1 ) {
