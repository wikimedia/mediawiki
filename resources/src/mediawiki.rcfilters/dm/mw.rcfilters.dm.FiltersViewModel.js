( function ( mw, $ ) {
	...
	/**
	 * Apply highlights to items based on given parameters
	 *
	 * @param  {Object} params Highlight parameter definition
	 */
	mw.rcfilters.dm.FiltersViewModel.prototype.applyHighlightFromParams = function ( params ) {
