( function ( mw, $ ) {
	...
	mw.rcfilters.dm.FiltersViewModel.prototype.initializeFilters = function ( filters ) {
		var i, filterItem, excludedFilters,
			...
			addToMap = function ( excludedFilters ) {
				excludedFilters.forEach( function ( filterName ) {
					this.excludedByMap[ filterName ] = this.excludedByMap[ filterName ] || [];
					this.excludedByMap[ filterName ].push( filterItem.getName() );
				} );
			};
		...
		$.each( filters, function ( group, data ) {
			...
			model.groups[ group ].exclusion_type = data.exclusion_type || 'default'; // eslint-disable-line camelcase
