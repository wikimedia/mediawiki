( function ( mw, $ ) {
	...
	mw.rcfilters.dm.FiltersViewModel.prototype.reassessFilterInteractions = function ( item ) {
		...
		// Group A conflicts with option B if and only if
		// all selected items of group A are in conflict with option B
		// this.getSelectedItemsConflictWith( item )
	};
