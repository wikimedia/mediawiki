( function ( mw, $ ) {
	 ...
	 *
	 * Note: This method is assumed to be used once per load. The parameters are given
	 * in full for the system to consider groups and their individual parameter values.
	 * We should not call this method more than once in order to update different
