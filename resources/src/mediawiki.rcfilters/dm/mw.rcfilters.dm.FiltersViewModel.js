( function ( mw, $ ) {
	...
	mw.rcfilters.dm.FiltersViewModel.prototype.switchView = function ( view ) {
		if ( this.views.indexOf( view ) > -1 && this.currentView !== view ) {
	...
	/**
	 * Get the items that match the requested view
	 *
	 * @param {string} view Requested view. If not provided, current view
	 *  is used.
	 * @return {mw.rcfilters.dm.FilterItem} Items
	 */
	mw.rcfilters.dm.FiltersViewModel.prototype.getItemsInView = function ( view ) {
		var result = [];
