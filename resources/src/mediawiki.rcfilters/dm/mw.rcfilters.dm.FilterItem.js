( function ( mw ) {
	 ...
	 * Set filter superset
	 *
	 * @return {string[]} superset Filter superset
	 */
	 ...
	 */
	mw.rcfilters.dm.FilterItem.prototype.hasConflictWith = function ( filterName ) {
		return this.conflicts.indexOf( filterName ) > -1;
	};
	 ...
	 *
	 * @param {boolean} [included] Filter is in conflict state
	 * @fires update
	 */
