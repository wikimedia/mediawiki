( function ( mw ) {
	 ...
	 * @cfg {string} [groupType] The group type
	...
	mw.rcfilters.dm.ItemModel.prototype.getValue = function () {
		return this.coerceValue( this.value );
	};

	/**
	 * Convert value to its appropriate representation based on group type
	 *
	 * @param {*} value
	 * @return {*}
	 */
	mw.rcfilters.dm.ItemModel.prototype.coerceValue = function ( value ) {
		return this.groupType === 'any_value' ? value : !!value;
	};
