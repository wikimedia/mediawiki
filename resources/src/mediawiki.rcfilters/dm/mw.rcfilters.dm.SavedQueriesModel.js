...
debugger;
	...
	mw.rcfilters.dm.SavedQueriesModel.prototype.addNewQuery = function ( label, data, isDefault, id ) {
		...
		// Minimize separately to keep structure
		normalizedData.params = this.filtersModel.getMinimizedParamRepresentation( data.params ),
		normalizedData.highlights = this.filtersModel.getMinimizedParamRepresentation( data.highlights );
