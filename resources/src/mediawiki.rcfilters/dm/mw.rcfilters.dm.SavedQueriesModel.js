( function ( mw, $ ) {
	...
	mw.rcfilters.dm.SavedQueriesModel.prototype.convertToParameters = function ( data ) {
		...
		// Filters
		newData.params = this.filtersModel.getParametersFromFilters( data.filters );

		// Highlights (only change is taking out 'highlight' itself)
		newData.highlights = $.extend( true, {}, data.highlights );
		delete newData.highlights.highlight;

		// Add highlight and invert toggles to params
		newData.params.highlight = String( Number( data.highlights.highlight || 0 ) );
