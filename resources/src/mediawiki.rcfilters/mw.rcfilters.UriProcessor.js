( function ( mw, $ ) {
	...
	mw.rcfilters.UriProcessor.prototype.isNewState = function ( currentUriQuery, updatedUriQuery ) {
		...
		currentParamState = this._buildFullModelParameterState( currentUriQuery );
		updatedParamState = this._buildFullModelParameterState( updatedUriQuery );

		// Merge back into the uri query so we retain unrecognize params
		currentParamState = $.extend( true, {}, currentUriQuery, currentParamState );
		updatedParamState = $.extend( true, {}, updatedUriQuery, updatedParamState );
	 ...
	 */
	mw.rcfilters.UriProcessor.prototype._buildFullModelParameterState = function ( uriQuery ) {
