( function ( mw, $ ) {
	...
	mw.rcfilters.UriProcessor.prototype.isNewState = function ( currentUriQuery, updatedUriQuery ) {
		...
		currentParamState = this.filtersModel.getExpandedParamRepresentation( currentUriQuery );
		updatedParamState = this.filtersModel.getExpandedParamRepresentation( updatedUriQuery );
