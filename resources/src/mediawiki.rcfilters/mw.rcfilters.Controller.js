( function ( mw, $ ) {
	...
	mw.rcfilters.Controller.prototype.saveCurrentQuery = function ( label ) {
		...
		// These are filter sates; highlight is stored as boolean
		...
		this.savedQueriesModel.addNewQuery(
			label || mw.msg( 'rcfilters-savedqueries-defaultlabel' ),
			{
				...
				nsinvert: String( Number( this.areNamespacesInverted() ) )
			}
		);
		...
		return this.savedQueriesModel.findMatchingQuery(
			{
				filters: this.filtersModel.getSelectedState(),
				highlights: highlightedItems,
				nsinvert: String( Number( this.filtersModel.areNamespacesInverted() ) )
			}
		);
	};
