( function ( mw, $ ) {
	...
	mw.rcfilters.Controller.prototype.initialize = function ( filterStructure ) {
		...
		if ( this.uriProcessor.isQueryValidForLoad( uri.query ) ) {
			...
			this.updateModelAndViewFromUrl();
	 ...
	 */
	mw.rcfilters.Controller.prototype.updateModelAndViewFromUrl = function () {
	...
	mw.rcfilters.Controller.prototype._getUpdatedUri = function () {
		...
		// Extend the URI query so we retain parameters unrecognized
		// by the system
		uri.extend( this.uriProcessor.getUriParametersFromModel() );
