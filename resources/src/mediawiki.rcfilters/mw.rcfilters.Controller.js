( function ( mw, $ ) {
	...
	mw.rcfilters.Controller.prototype._getDefaultParams = function () {
		var savedParams = {},
			...
			queryFilters = defaultSavedQueryItem.getFilters(),
			queryHighlights = defaultSavedQueryItem.getHighlights();

		if ( defaultSavedQueryItem ) {
			// Translate filters to group-filters, since they're stored "flat" but
			// getParametersFromFilters requires a group->filters structure
			$.each( queryFilters, function ( filterName, value ) {
...
// TODO: getParametersFromFilters should accept a 'flat' list rather than group->filters list

// Being worked on in a separate commit
			savedParams = this.filtersModel.getParametersFromFilters( defaultSavedQueryItem.getFilters() );
