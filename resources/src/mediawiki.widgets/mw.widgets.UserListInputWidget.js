...
( function ( $, mw ) {
	...
	mw.widgets.UserListInputWidget = function MwWidgetsComplexNamespaceInputWidget( config ) {
		var userinputWidgetItems, checkboxItems;
		...
		this.userinputLabel = new OO.ui.LabelWidget( $.extend( {
			input: this.userinput
		}, config.userinputLabel ) );

		userinputWidgetItems.push( this.userinputLabel, this.userinput );
		...
		if ( config.groupinput !== null ) {
			...
			this.groupinputLabel = new OO.ui.LabelWidget( $.extend({
				input: this.groupinput
			}, config.groupinputLabel ) );
			userinputWidgetItems.push( this.groupinputLabel, this.groupinput );
		}
