...
( function ( $, mw ) {
	 ...
	 * @inheritdoc
	 */
	mw.widgets.TitleWidget.prototype.getSuggestionsPromise = function ( value ) {
		var req,
			widget = this,
		...
		if ( mw.Title.newFromText( value ) ) {
			return this.interwikiPrefixesPromise.then( function () {
				var params, props,
					interwiki = value.substring( 0, value.indexOf( ':' ) );
				if (
					interwiki && interwiki !== '' &&
	 ...
	 * @inheritdoc
	 */
	mw.widgets.TitleWidget.prototype.isValid = function () {
