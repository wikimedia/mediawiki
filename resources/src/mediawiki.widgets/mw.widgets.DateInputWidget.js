...
( function ( $, mw ) {
	 ...
	 *
	 * // TODO We're now mixing in TabIndexedElement twice, one for $input in superclass, this is bad
	 *
	 * @constructor
	...
	OO.mixinClass( mw.widgets.DateInputWidget, OO.ui.mixin.TabIndexedElement );
