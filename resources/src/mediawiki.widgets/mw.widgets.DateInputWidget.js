...
( function ( $, mw ) {
	 ...
	 * @cfg {string} [placeholderLabel=No date selected] Placeholder text shown when the widget is not selected.
	 *	Default text taken from message `mw-widgets-dateinput-no-date`.
	...
	mw.widgets.DateInputWidget = function MWWDateInputWidget( config ) {
		...
		this.textInput = new OO.ui.TextInputWidget( {
			...
			placeholderDateFormat: placeholderDateFormat,
