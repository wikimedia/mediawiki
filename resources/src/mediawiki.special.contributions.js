( function () {
	...
	$( () => {
		...
		startReady = whenBlurred( $( '#mw-date-start .oo-ui-inputWidget-input' ) ).then( () => mw.widgets.DateInputWidget.static.infuse( $( '#mw-date-start' ) ) );
		endReady = whenBlurred( $( '#mw-date-end .oo-ui-inputWidget-input' ) ).then( () => mw.widgets.DateInputWidget.static.infuse( $( '#mw-date-end' ) ) );
