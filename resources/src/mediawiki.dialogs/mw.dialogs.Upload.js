...
( function ( $, mw ) {
	...
	mw.dialogs.Upload = function ( config ) {
		// Parent constructor
		mw.dialogs.Upload.super.call( this, config );
	}
	...
	mw.dialogs.Upload.prototype.initialize = function () {
		mw.dialogs.Upload.super.prototype.initialize.call( this );
	...
	mw.dialogs.Upload.prototype.getSetupProcess = function ( data ) {
		return mw.dialogs.Upload.super.prototype.getSetupProcess.call( this, data )
			.next( function () {
	...
	mw.dialogs.Upload.prototype.getActionProcess = function ( action ) {
		...
		return mw.dialogs.Upload.super.prototype.getActionProcess.call( this, action );
	};
