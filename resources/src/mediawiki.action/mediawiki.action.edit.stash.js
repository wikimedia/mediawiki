...
( function ( mw, $ ) {
	...
	$( function () {
		...
		function onTextFocus() {
			idleTimeout = 3000; // user still has to type summary
		}

		function onTextFocusOut() {
			idleTimeout = 1000; // user will likely submit soon
		}
		...
		$summary.on( { focus: onEditorIdle, keyup: onTextKeyUp } );
		onFormLoaded();
	} );
}( mediaWiki, jQuery ) );
