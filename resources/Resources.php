...
return [
	...
	'mediawiki.rcfilters.filters.ui' => [
		...
		'messages' => [
			...
			'rcfilters-tag-prefix-categories',
			'rcfilters-tag-prefix-categories-inverted',
			'rcfilters-tag-prefix-tags',
			'rcfilters-exclude-button-off',
			'rcfilters-exclude-button-on',
			'rcfilters-view-tags',
			'rcfilters-view-categories',
			'rcfilters-view-categories-included',
			'rcfilters-view-categories-search',
