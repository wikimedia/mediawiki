...
return array(
	...
	'mediawiki.special.apisandbox' => array(
		...
		'messages' => array(
			...
			'apisandbox-helpurls',
			'apisandbox-examples',
			'apisandbox-undocumented-parameters',
			'apisandbox-undocumented-parameters-add-label',
			'apisandbox-undocumented-parameters-add-placeholder',
			'apisandbox-undocumented-error-exists',
