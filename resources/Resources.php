...
return [
	...
	'mediawiki.ForeignStructuredUpload.BookletLayout' => [
		...
		'messages' => [
			...
			'foreign-structured-upload-form-5-type-option-heading',
			'foreign-structured-upload-form-5-type-option-person',
			'foreign-structured-upload-form-5-type-option-place',
			'foreign-structured-upload-form-5-type-option-object',
			'foreign-structured-upload-form-5-type-option-other',
			'foreign-structured-upload-form-5-type-option-person-help',
			'foreign-structured-upload-form-5-type-option-place-help',
			'foreign-structured-upload-form-5-type-option-object-help',
			'foreign-structured-upload-form-5-type-option-other-help',
			'foreign-structured-upload-form-6-educational-content-intro',
			'foreign-structured-upload-form-6-label-ownership',
			'foreign-structured-upload-form-6-label-license',
			'foreign-structured-upload-form-6-label-final-warning',
			'foreign-structured-upload-form-6-label-content-deleted',
			'foreign-structured-upload-form-6-label-content-reviewed',
			'foreign-structured-upload-form-more-options-label',
			'foreign-structured-upload-form-more-options-link',
		],
	],
	'mediawiki.toc' => [
