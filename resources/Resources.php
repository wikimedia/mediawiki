...
return [
	...
	'mediawiki.ForeignStructuredUpload.BookletLayout' => [
		...
		'messages' => [
			...
			'upload-form-label-own-work-message-generic-shared',
			'upload-form-label-not-own-work-message-generic-shared',
			'upload-form-label-not-own-work-local-generic-shared',
		],
	],
	'mediawiki.toc' => [
