...
return array(
	...
	/* es5-shim */
	// WARNING: This is not a full ES5 shim, missing Object.create and some other methods
	'es5-shim' => array(
		'scripts' => array(
			'resources/lib/es5-shim/es5-shim.js',
			'resources/lib/es5-shim/es5-sham.js',
		),
		'skipFunction' => 'resources/lib/es5-shim/es5-skip.js'
	),
