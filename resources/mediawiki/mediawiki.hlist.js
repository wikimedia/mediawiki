...
( function ( mw, $ ) {
    ...
    if ( jQuery.client.profile().versionNumber === 8 ) {
        jQuery( '.hlist' ).find( 'dd:last-child, dt:last-child, li:last-child' )
            .addClass( 'hlist-last-child' );
    }
    /* IE 7 and below: Generate interpuncts and parentheses */
    if ( jQuery.client.profile().versionNumber <= 7 ) {
        var hlists = jQuery( '.hlist' );
