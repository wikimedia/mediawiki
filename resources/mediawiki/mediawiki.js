...
var mw = ( function ( $, undefined ) {
	...
	return {
		...
		loader: ( function () {
			 ...
			 *
			 * Will be appended to an existing ResourceLoader-created `<style>` tag or create
			 * a new one based on whether the given `cssText` is safe for extension.
			 *
			...
			return {
				...
				/**
				 * Batch-request queued dependencies from the server. This will load and execute
				...
				/**
				 * Load an external script or one or more modules for future use.
				 *
				...
				/**
				 * For backwards-compatibility with Squid-cached pages.
