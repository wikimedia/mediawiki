				...
				work: function () {
					...
					if ( mw.loader.store.enabled ) {
						...
						try {
							...
							// First of all let's clear whatever is there.
							mw.loader.store.clear();

							if ( err.name === 'SyntaxError' ) {
								// This most likely means that no code has been executed.
								// Log it, clear the store and continue loading.
								// This might be caused by remnants of bug 57567.
				...
				store: {
					...
					set: function ( module, descriptor ) {
						...
						try {
							...
							if ( args[1].match( /^\s*\(/ ) ) {
								args[1] = args[1].replace( /^\s*\(/, 'function(' );
