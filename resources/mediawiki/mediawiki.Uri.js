...
( function ( mw, $ ) {
	...
	mw.UriRelative = function ( documentLocation ) {
		 ...
		 * @class mw.Uri
		 *
		 * @constructor Construct a new URI object. Throws error if arguments are illegal/impossible, or
		 ...
		 * mw.util.rawurlencode, but we also replace a space with a +.
		 *
		 * @static
		...
		Uri.prototype = {
			...
			/**
			 * Return user and password section of a URI.
			 *
			 * @return {string}
			 */
			...
			/**
			 * Return the userInfo, host and port section of the URI. In most real-world URLs this is
			 * simply the hostname, but the definition of 'authority' section is more general.
			 *
			 * @return {string}
			 */
			...
			/**
			 * Return the query arguments of the URL, encoded into a string. Does not preserve the
			 * original order of arguments passed in the URI. Does handle escaping.
			 *
			 * @return {string}
			 */
			...
			/**
			 * Return everything after the authority section of the URI.
			 *
			 * @return {string}
			 */
			...
			/**
			 * Get the entire URI string. May not be precisely the same as input due to order of query
			 * arguments.
			 *
