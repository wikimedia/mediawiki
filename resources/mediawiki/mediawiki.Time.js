...
( function ( mw, $ ) {
	 ...
	 * @constructor
	 * @param {Date|String|mw.Time} time Time/Date string, or a Date object.
	 * This parameter is optional. If omitted (or set to undefined, null or empty string), then an object will be created
	 * for the current date and time.
	 * @param {Object} options Object with options. Anticipate use in the future, currently no effect.
	 */
	mw.Time = function ( time, options ) {
		 ...
		 * @param {mw.Time} tobj Object to set the time for
		 * @param {String} str string to parse (many possible formats)
		 * @param {Object} options for parsing (passed in from mw.Time's constructor)
