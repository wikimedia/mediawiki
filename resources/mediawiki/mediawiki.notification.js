...
( function ( mw, $ ) {
	...
	function Notification( message, options ) {
		...
		$notification = $( '<div class="mw-notification" />' );
		...
		if ( options.title ) {
			$notificationTitle = $( '<div class="mw-notification-title" />' );
			$notificationTitle.text( options.title );
			$notificationTitle.appendTo( $notification );
		}
		$notificationContent = $( '<div class="mw-notification-content" />' );
			...
			$tagged.each( function () {
				...
				if ( n ) {
					...
					if ( n.$replacementPlaceholder ) {
						...
						delete n.$replacementPlaceholder;
					}
	...
	var notification = {
		 ...
		 */
		init: function () {
			var $area = $( '<div id="mw-notification-area" />' );
			$area
