/**
 * jQuery plugin intended to perform various scroll-related functions
 * Currently includes two related functions:
 * $.fn.scrollIntoView: Scrolls an element's scrollable container such that
 *   the element in question is visible.
 * $.fn.getScrollingParent: Finds the closest scrollable parent container
 *   for an element.
 */
( function ( $ ) {
	/**
