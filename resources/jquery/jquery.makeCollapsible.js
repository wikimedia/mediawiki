...
( function ( $, mw ) {
	...
	function toggleElement( $collapsible, action, $defaultToggle, options ) {
		...
		$collapsible.trigger( 'beforeCollapseExpand.mw-collapse', action );
		$collapsible.trigger( action === 'collapse' ? 'beforeExpand.mw-collapse' : 'beforeCollapse.mw-collapse' );
		hookCallback = function () {
			$collapsible.trigger( 'afterCollapseExpand.mw-collapse', action );
			$collapsible.trigger( action === 'collapse' ? 'afterExpand.mw-collapse' : 'afterCollapse.mw-collapse' );
		};
