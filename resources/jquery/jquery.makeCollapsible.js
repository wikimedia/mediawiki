...
( function ( $, mw ) {
	...
	$.fn.makeCollapsible = function ( options ) {
		...
		return this.each(function () {
			var $collapsible, collapseText, expandText, $toggle, $defaultToggleLink, premadeToggleHandler,
			...
			if ( $customTogglers && $customTogglers.length ) {
				...
				if ( $collapsible.is( 'table' ) ) {
					...
					if ( !$toggle.length ) {
						...
						$toggleLink = $toggle.off( 'click.mw-collapsible' ).on( 'click.mw-collapsible', premadeToggleHandler );
					}
