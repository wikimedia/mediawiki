...
( function ( $ ) {
	...
	$.fn.byteLimit = function ( limit, fn ) {
		...
		return this.each( function ( i, el ) {
			...
			// Eventhough we only trim input after it was changed (never prevent it), we do
			...
			$el.on( eventKeys, function () {
				...
				// which moves the cursor at the end the input, moving it away from whereever it was.
