...
( function ( $ ) {
	 ...
	 * If the event's payload is empty, we've left fullscreen
	 * If the event's payload contains an element, we've entered fullscreen
	...
	function handleFullscreenChange () {
		...
		$( document ).trigger( $.Event( 'jq-fullscreen-change', fullscreenElement ) );
	}
