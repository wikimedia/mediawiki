...
( function ( mw, $ ) {
	$( document ).ready( function () {
		...
		$patrolLinks.on( 'click', function ( event ) {
			...
			// hide the link
			$patrolLinks.hide();
			// Create a new spinner and attach a custom class. This is
			// necessary to be able to remove it cause we might add two
			// instances, and $spinner.remove() will only remove the last one
