...
OO.ui.WindowManager.prototype.openWindow = function ( win, data, lifecycle, compatOpening ) {
	...
	lifecycle.done = function () {
		OO.ui.warnDeprecation(
			'Using the return value of openWindow as a promise is deprecated. ' +
			'Use .openWindow( ... ).opening.done( ... ) instead.'
		);
		return compatOpening.done.apply( this, arguments );
	};
	lifecycle.fail = function () {
		OO.ui.warnDeprecation(
			'Using the return value of openWindow as a promise is deprecated. ' +
			'Use .openWindow( ... ).opening.fail( ... ) instead.'
		);
		return compatOpening.fail.apply( this, arguments );
	};
...
OO.ui.WindowManager.prototype.closeWindow = function ( win, data ) {
	...
	lifecycle.done = function () {
		OO.ui.warnDeprecation(
			'Using the return value of closeWindow as a promise is deprecated. ' +
			'Use .closeWindow( ... ).closing.done( ... ) instead.'
		);
		return compatClosing.done.apply( this, arguments );
	};
	lifecycle.fail = function () {
		OO.ui.warnDeprecation(
			'Using the return value of closeWindow as a promise is deprecated. ' +
			'Use .closeWindow( ... ).closing.fail( ... ) instead.'
		);
		return compatClosing.fail.apply( this, arguments );
	};
