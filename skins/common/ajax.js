( function ( mw ) {
	 ...
	 */
	var sajax_init_object = function() {
	 ...
	 * with id = showFoo
	 */
	var sajax_do_call = function(func_name, args, target) {
		var i, x, n;
		var uri;
		var post_data;
	...
	mw.log.deprecate( window, 'sajax_debug', sajax_debug, deprecationNotice );
	mw.log.deprecate( window, 'sajax_init_object', sajax_init_object, deprecationNotice );
	mw.log.deprecate( window, 'sajax_do_call', sajax_do_call, deprecationNotice );
