...
?>
		...
		<div id="mw-navigation">
			...
			<div id="mw-panel">
				<!-- logo -->
					<div id="p-logo" role="banner"><div id="change-logo-url"><?php $this->msg( 'change-logo-url' )  ?> </div><a style="background-image: url(<?php $this->text( 'logopath' ) ?>);" href="<?php echo htmlspecialchars( $this->data['nav_urls']['mainpage']['href'] ) ?>" <?php echo Xml::expandAttributes( Linker::tooltipAndAccesskeyAttribs( 'p-logo' ) ) ?>></a></div>
				<!-- /logo -->
