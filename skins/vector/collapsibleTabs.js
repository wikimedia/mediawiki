...
( function ( $ ) {
	...
	$.collapsibleTabs = {
		...
		moveToCollapsed: function ( ele ) {
			var outerScopeData, expContainerSettings, target,
				$moving = $( ele );

			outerScopeData = $.collapsibleTabs.getSettings( $moving );
			if ( !outerScopeData ) {
				return;
			}
			expContainerSettings = $.collapsibleTabs.getSettings( $( outerScopeData.expandedContainer ) );
			...
			target = outerScopeData.collapsedContainer;
			$moving.css( 'position', 'relative' )
				...
				.animate( { width: '1px' }, 'normal', function () {
					...
					$( this ).detach().prependTo( target ).data( 'collapsibleTabsSettings', outerScopeData );
