...
ALTER TABLE `user` MODIFY COLUMN user_touched varbinary(14) NOT NULL default '' ;
ALTER TABLE `user` MODIFY COLUMN user_email_authenticated varbinary(14)  ;
ALTER TABLE `user` MODIFY COLUMN user_email_token_expires varbinary(14)  ;
ALTER TABLE `user` MODIFY COLUMN user_registration varbinary(14)  ;
...
ALTER TABLE `ipblocks` MODIFY COLUMN ipb_expiry varbinary(14) NOT NULL default '' ;
...
ALTER TABLE `filearchive` MODIFY COLUMN fa_timestamp varbinary(14) default '' ;
...
ALTER TABLE `recentchanges` MODIFY COLUMN rc_cur_time varbinary(14) NOT NULL default '' ;
...
ALTER TABLE `protected_titles` MODIFY COLUMN pt_expiry varbinary(14) NOT NULL default '' ;
