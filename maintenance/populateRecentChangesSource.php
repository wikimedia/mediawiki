...
class PopulateRecentChangesSource extends LoggedUpdateMaintenance {
	...
	protected function doDBUpdates() {
		...
		$updatedValues = $this->buildUpdateCondition();
	...
	protected function buildUpdateCondition( $dbw ) {
		$rcNew = $dbw->addQuotes( RC_NEW );
		$rcSrcNew = $dbw->addQuotes( RC_SRC_NEW );
		$rcEdit = $dbw->addQuotes( RC_EDIT );
		$rcSrcEdit = $dbw->addQuotes( RC_SRC_EDIT );
		$rcLog = $dbw->addQuotes( RC_LOG );
		$rcSrcLog = $dbw->addQuotes( RC_SRC_LOG );
		$rcExternal = $dbw->addQuotes( RC_EXTERNAL );
		$rcSrcExternal = $dbw->addQuotes( RC_SRC_EXTERNAL );
