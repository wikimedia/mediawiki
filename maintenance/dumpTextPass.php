 ...
 * @ingroup Maintenance
 */
class TextPassDumper extends BackupMaintenance {
...
TEXT;
		...
		$this->addOption( 'checkpointfile', 'Use this string for checkpoint filenames,substituting first' .
			'pageid written for the first %s (required) and the last pageid written for the second %s ' .
			'if it exists.', false, true, false, true ); // This can be specified multiple times
