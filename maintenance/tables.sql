...
CREATE TABLE /*_*/watchlist (
  ...
  -- Timestamp used to send notification e-mails and show "updated
  -- since last visit" markers on history and recent changes / watchlist.
  -- Set to NULL when the user visits latest revision of the page,
  -- which means that they should be sent an e-mail on the next change.
