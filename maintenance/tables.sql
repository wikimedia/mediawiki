...
-- In case a synchronization tool is used (ie Wikibase), the data
-- fields can be obtained from an external source, in which case
-- they should not be modified locally (they are marked with -- obtained from repo).
