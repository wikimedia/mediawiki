...
CREATE TABLE /*_*/slots (
  ...
  -- reference to rev_id
  -- TODO: This may need to be a 32 bit int until rev_id becomes 64 bit too. Benchmark!
...
-- TODO: we may need slot_page to efficiently select a per-slot edit history. Benchmark!
CREATE INDEX /*i*/slot_role_inherited ON /*_*/slots (slot_role, slot_inherited);

-- Index for finding content usage (and thus detecting orphan content rows)
-- XXX: YAGNI?
CREATE INDEX /*i*/slot_content ON /*_*/slots (slot_content);
