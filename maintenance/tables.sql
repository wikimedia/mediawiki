...
CREATE TABLE /*_*/archive (
  ...
  -- Copied from page_id.
  -- Restoration will attempt to use this as page ID if no current page with
  -- the same name exists. Otherwise, the revisions will be restored under the
  -- current page. Can be used for manual undeletion by developers if multiple
  -- pages by the same name were archived.
  --
