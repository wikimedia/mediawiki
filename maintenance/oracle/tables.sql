...
CREATE TABLE &mw_prefix.image_actor_temp (
  imgactor_name VARCHAR2(255) NOT NULL,
  imgactor_actor NUMBER NOT NULL,
  imgactor_timestamp TIMESTAMP(6) WITH TIME ZONE
);
ALTER TABLE &mw_prefix.image_actor_temp ADD CONSTRAINT &mw_prefix.image_actor_temp_pk PRIMARY KEY (imgactor_name, imgactor_actor);
CREATE UNIQUE INDEX &mw_prefix.imgactor_name ON &mw_prefix.image_actor_temp (imgactor_name);
CREATE INDEX &mw_prefix.img_actor_timestamp ON &mw_prefix.image_actor_temp (imgactor_actor, imgactor_timestamp);
