...
CREATE TABLE &mw_prefix.slots (
  slot_revision_id NUMBER unsigned NOT NULL,
  slot_role_id NUMBER unsigned NOT NULL,
  slot_content_id NUMBER unsigned NOT NULL,
  slot_inherited NUMBER unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE &mw_prefix.content (
  content_id NUMBER unsigned NOT NULL PRIMARY KEY,
  content_size NUMBER unsigned NOT NULL,
  content_sha1 VARBINARY(32),
  content_model NUMBER unsigned NOT NULL,
...
CREATE UNIQUE INDEX &mw_prefix.role_name ON &mw_prefix.slot_roles (role_name);

/*$mw$*/
CREATE TRIGGER &mw_prefix.slot_roles_default_role_id BEFORE INSERT ON &mw_prefix.slot_roles
...
CREATE TABLE &mw_prefix.content_models (
  model_id NUMBER NOT NULL PRIMARY KEY,
  model_name VARBINARY(64) NOT NULL
);

CREATE UNIQUE INDEX &mw_prefix.model_name ON &mw_prefix.content_models (model_name);

/*$mw$*/
CREATE TRIGGER &mw_prefix.content_models_default_model_id BEFORE INSERT ON &mw_prefix.content_models
