...
class RefreshFileHeaders extends Maintenance {
	...
	public function execute() {
		...
		$media_type = str_replace( ' ', '_', $this->getOption( 'media_type', '' ) ); // filter by img_media_type
		$major_mime = str_replace( ' ', '_', $this->getOption( 'major_mime', '' ) ); // filter by img_major_mime
		$minor_mime = str_replace( ' ', '_', $this->getOption( 'minor_mime', '' ) ); // filter by img_minor_mime
