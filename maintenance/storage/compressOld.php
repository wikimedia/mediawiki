...
class CompressOld extends Maintenance {
	...
	/**
	 * Opti9on to load revisions in chunks.
	 *
	 */
	const LS_CHUNKED = 1;
	...
	/**
	 * Fetches the text row-by-row to "compressPage" function for compression.
	 *
	 * @param int $start
	 * @param string $extdb
	 */
	...
	/**
	 * Compress the text in chunks after concatenate the revisions.
	 *
	 * @param int $startId
