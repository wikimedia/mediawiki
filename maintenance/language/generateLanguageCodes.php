...
class GenerateLanguageCodes extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->mDescription = "Generate languages/LanguagesCodes.cdb with all ISO 639 language";
	...
	public function execute() {
		...
		$cdb = CdbWriter::open( __DIR__ . '/LanguageCodes.cdb' );
		...
		foreach( $file as $line ) {
			...
			$cdb->set( $index, implode( '|', $codeList['tmp'] ); );
