...
class GenerateLanguageMetaData extends Maintenance {
	...
	public function execute() {
		...
		$comment = '/* This file should be generated by maintenance/language/generateLanguageMetaData.php.
			Do not edit! */';
		$code =  "<?php\n$comment\n\n const LANGUAGE_CONSTANTS = " . var_export( $constants, true) . ";\n";
		file_put_contents( "$IP/languages/metadata.php", $code );
