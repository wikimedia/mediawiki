...
CREATE TABLE /*_*/user (
   ...
   user_newpass_time varchar(14) NULL,
...
CREATE TABLE /*_*/user_groups (
   ug_user  INT     NOT NULL REFERENCES /*_*/user(user_id) ON DELETE CASCADE,
...
CREATE TABLE /*_*/user_former_groups (
  ufg_user INT NOT NULL REFERENCES /*_*/user(user_id) ON DELETE CASCADE,
...
CREATE TABLE /*_*/user_newtalk (
   user_id INT         NOT NULL DEFAULT 0 /*REFERENCES user(user_id)*/,
...
CREATE TABLE /*_*/user_properties (
	up_user INT NOT NULL REFERENCES /*_*/user(user_id) ON DELETE CASCADE,
...
--
CREATE TABLE /*_*/page (
   page_id        INT          NOT NULL  PRIMARY KEY IDENTITY,
...
CREATE TABLE /*_*/revision (
   ...
   rev_len INT,
   rev_parent_id INT DEFAULT NULL /* REFERENCES revision(rev_id) */,
...
CREATE TABLE /*_*/text (
   old_id INT NOT NULL  PRIMARY KEY IDENTITY,
...
CREATE TABLE /*_*/archive (
   ...
   ar_user INT NOT NULL DEFAULT 0 /* REFERENCES user(user_id) */,
...
CREATE TABLE /*_*/templatelinks (
  tl_from int NOT NULL default 0 /* REFERENCES page(page_id) */,
...
CREATE TABLE /*_*/imagelinks (
  ...
  il_from int NOT NULL default 0 /* REFERENCES page(page_id) */,
...
CREATE TABLE /*_*/categorylinks (
  ...
  cl_from int NOT NULL default 0 /* REFERENCES page(page_id) */,
...
CREATE TABLE /*_*/externallinks (
  ...
  el_from int NOT NULL default 0 /* REFERENCES page(page_id) */,
...
CREATE TABLE /*_*/iwlinks (
  -- page_id of the referring page
  iwl_from int NOT NULL default 0 /* REFERENCES page(page_id) */,
...
CREATE TABLE /*_*/ipblocks (
  ...
  ipb_user int NOT NULL default 0 /* REFERENCES user(user_id) */,

  -- User ID who made the block.
  ipb_by int NOT NULL default 0 /* REFERENCES user(user_id) */,
...
CREATE TABLE /*_*/image (
  ...
  img_user int NOT NULL default 0 /* REFERENCES user(user_id) */,
...
CREATE TABLE /*_*/oldimage (
  ...
  oi_name varbinary(255) NOT NULL default 0x /* REFERENCES image(img_name) */,
...
CREATE TABLE /*_*/watchlist (
  -- Key to user.user_id
  wl_user int NOT NULL REFERENCES /*_*/user(user_id) ON DELETE CASCADE,
...
-- Table for caching JSON message nvarchar(max)s for the resource loader
