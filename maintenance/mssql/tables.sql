...
CREATE TABLE /*_*/image (
  ...
  img_description_id bigint unsigned NOT NULL CONSTRAINT DF_img_description_id DEFAULT 0 CONSTRAINT FK_img_description_id FOREIGN KEY REFERENCES /*_*/comment(comment_id),
