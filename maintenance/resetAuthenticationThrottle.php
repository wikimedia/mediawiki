...
class ResetAuthenticationThrottle extends Maintenance {
	...
	public function execute() {
		...
		} elseif ( $username === null && $ip === null ) {
			$this->fatalError( 'At least one of --user and --ip is required!' );
		...
		if ( $forSignup ) {
			$this->clearSignupThrottle( $username, $ip );
		}
	 ...
	 * @param string $ip
	 */
	protected function clearSignupThrottle( $username, $ip ) {
