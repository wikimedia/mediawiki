...
TEXT
		...
		$this->addOption( 'fix', 'Actually clean up invalid titles. If this parameter is ' .
			...
			false, false );
		// We require a log file to write to. The script can output a lot of stuff,
		// and it is unrecoverable if it scrolls off the top of your console or if you
...
TEXT
			...
			case 'categorylinks':
				...
				if ( $table === 'categorylinks' ) {
					$this->output(
						"You are urged to run this script with `-t category` after these jobs\n" .
						"have been processed.\n" );
				}
				break;
		}
