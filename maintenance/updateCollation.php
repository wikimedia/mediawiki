 ...
 * (cl_collation != '$wgCategoryCollation <version>') and repopulate cl_sortkey
...
out-of-date (cl_collation != '\$wgCategoryCollation <version>') and repopulate
cl_sortkey using the page title and cl_sortkey_prefix.  If all collations are
...
TEXT
		...
		$this->addOption( 'previous-collation', 'Set the previous value of ' .
			'$wgCategoryCollation <version> here to speed up this script, especially if your ' .
			...
			'even older collation. Example: --previous-collation="uca-fr 57.1"',
			false, true );
	...
	public function execute() {
		...
		$collationName = $collation->getCollationIdentifier();
