...
TEXT;
		...
		$this->addOption( 'previous-collation', 'Set the previous value of ' .
			'$wgCategoryCollations here to speed up this script, especially if your ' .
			'categorylinks table is large. This will allow the script to use better ' .
			'queries, but it may miss out-of-date rows with a different, ' .
