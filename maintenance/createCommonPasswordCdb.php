 ...
 *
 * Meant to take a file like https://github.com/danielmiessler/SecLists/blob/master/Passwords/10_million_password_list_top_1000000.txt?raw=true as input
...
class GenerateCommonPassword extends Maintenance {
	...
	public function execute() {
		...
		try {
			...
			$skipped = 0;
			for( $i = 0; $i < count( $lines ) && ($i - $skipped) < $limit; $i++ ) {
