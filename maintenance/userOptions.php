...
class UserOptionsScript extends Maintenance {
	function __construct() {
		parent::__construct();
		$this->addDescription(
			'List the available user options, report usage statistics, or change the value of all user options.'
		);
		...
		$this->addOption( 'dry', 'Perform a dry run and do no actually save to the database' );
	}
