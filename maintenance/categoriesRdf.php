...
class CategoriesRDF extends Maintenance {
	 ...
	 */
	protected function getCategoryIterator( IDatabase $dbr ) {
	 ...
	 */
	protected function writeCategoryData( $row ) {
	 ...
	 */
	protected function writeCategoryLinkData( $row, array $pages ) {
	 ...
	 * @param Title $title
	 * @return string
	 * @see \Wikibase\Rdf\SiteLinksRdfBuilder
	 */
	private function titleToUrl( Title $title ) {
		global $wgArticlePath;
		// NOTE: This encoding should be the same as SiteLinksRdfBuilder uses
