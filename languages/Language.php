...
class Language {
	...
	/**
	 * This method is deprecated since 1.31 and kept as alias for truncateWithByteLimit, which
	 ...
	 *
	 * @deprecated since 1.31, use truncateWithByteLimit instead.
	 *
	...
	function truncate( $string, $length, $ellipsis = '...', $adjustLength = true ) {
		return $this->truncateWithByteLimit( $string, $length, $ellipsis, $adjustLength );
	}
	 ...
	 * @return string
	 */
	function truncateWithByteLimit ( $string, $length, $ellipsis = '...', $adjustLength = true ) {
	...
	/**
	 * Truncate a string to a specified number of graphemes, appending an optional
	 * string (e.g. for ellipsis).
	 *
	 * Using grapheme methods provides better precision for measuring length of a string.
	 * This method is suitable for truncation for UI, instead of truncating by byte limit, which
	 * is suitable for DB.
	 *
	 * Note: This method uses grapheme methods for string length measurement. This usually gives
	 * good precision, but can be slightly off for graphemes with grouped and combined characters.
	 *
	 * If $length is negative, the string will be truncated from the beginning.
	 *
	 * @since 1.31
	 *
	 * @param string $string String to truncate
	 * @param int $length Maximum number of graphemes
	 * @param string $ellipsis String to append to the end of truncated text
	 * @param bool $adjustLength Subtract length of ellipsis from $length
	 *
	 * @return string
	 */
	function truncateWithGraphemeLimit ( $string, $length, $ellipsis = '...', $adjustLength = true ) {
		return $this->truncateInternal(
			$string, $length, $ellipsis, $adjustLength, 'grapheme_strlen', 'grapheme_substr'
		);
	}
	 ...
	 *
	 * For usages, see truncateWithByteLimit and truncateWithGraphemeLimit.
	 *
	 * @param string $string String to truncate
