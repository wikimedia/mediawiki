...
class Language {
	 ...
	 * Take a list of strings and build a locale-friendly comma-separated
	 * list, using the local comma-separator message.
	 * @param array $list Array of strings to put in a comma list
	 * @return string
	 */
	 ...
	 * @param array $list Array of strings to put in a semicolon list
	 * @return string
	 */
	 ...
	 * @param array $list Array of strings to put in a pipe list
	 * @return string
	 */
