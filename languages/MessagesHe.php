...
"nocookiesnew"               => "נוצר חשבון המשתמש שלך, אך לא נכנסתם כמשתמשים רשומים למערכת כיוון שניטרלתם את העוגיות, שהאתר משתמש בהן לצורך כניסה למערכת. אנא הפעילו אותן מחדש, ולאחר מכן תוכלו להיכנס למערכת עם שם המשתמש והסיסמה החדשים שלכם.",
"nocookieslogin"             => "לא הצלחתם להיכנס למערכת כמשתמשים רשומים כיוון שניטרלתם את העוגיות, שהאתר משתמש בהן לצורך כניסה למערכת. אנא הפעילו אותן מחדש, ולאחר מכן תוכלו להיכנס למערכת עם שם המשתמש והסיסמה שלכם.",
...
"nogomatch"         => 'אין דף שכותרתו "$1". באפשרותכם [{{fullurl:$1|action=edit}} ליצור את הדף].',
...
"largefileserver"             => "גודל התמונה שהעליתם חורג ממגבלת השרת.",
...
"watchdetails"         => "יש לכם $1 דפים (לא כולל דפי שיחה) ברשימת המעקב. יש באפשרותכם [[{{ns:special}}:Watchlist/edit|להציג ולערוך את רשימת המעקב במלואה]], או [[{{ns:special}}:Watchlist/clear|להסיר ממנה את כל הדפים]].",
...
"wlhideshowbots"       => "$1 עריכות שנעשו על־ידי בוט.",
"wlshow"               => "הצג",
"wlhide"               => "הסתר",
