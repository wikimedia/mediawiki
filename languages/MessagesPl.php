...
"tog-watchcreations" => "Dodaj tworzone przez siebie strony do obserwowanych",
...
"tog-autopatrol" => "Zaznacz swoje edycje jako patrolowane",
"tog-forceeditsummary" => "Informuj o niewypełnieniu pola opisu zmian",
"tog-watchlisthideown" => "Ukryj moje edycje w obserwowanych",
"tog-watchlisthidebots" => "Ukryj boty w obserwowanych",

"underline-always" => "Zawsze",
"underline-never" => "Nigdy",
"underline-default" => "Z przeglądarki",
...
"privacypage" => "{{ns:4}}:Zasady ochrony prywatności",
"errorpagetitle" => "Błąd",
