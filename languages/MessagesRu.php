...
/** Russian (русский язык)
  *
  * Based on Messages.php 13479 (2006-04-04)
  * and ru.wikipedia MediaWiki namespace (2006-04-04)
  *
...
'anoneditwarning' => 'Вы не представились системе. Ваш IP-адрес будет записан в историю изменений этой страницы.',
...
'revdelete-text' => "Улалённые версии будут показываться в истории страницы,
...
'rcnote'                => 'Последние <strong>$1</strong> изменений за <strong>$2</strong> дней.',
...
'sharedupload' => "Этот файл хранитеся на [[Викисклад]]е, хранилище изображений и мультимедиа для использования в изданиях [[Фонд Викимедиа|Фонда Викимедиа]].
...
За исключением них, есть '''$2''' страниц, которые считаются полноценными статьями. Для того, чтобы страница считалась полноценной статьёй, она должна находиться в основном пространстве имён и содержать хотя бы одну внутреннюю ссылку.

Всего с момента установки программного обеспечения было сделано '''$4''' изменений страниц.
Таким образом, в среднем приходится '''$5''' изменений на одну страницу.
...
'uctop'         => ' (наверху)' ,
'newbies'       => 'новички',
'contribs-showhideminor' => '$1 мелких правок',
...
'subcategorycount' => 'В этой категории $1 подкатегорий',
