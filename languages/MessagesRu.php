...
/** Russian (русский язык)
  *
  * Based on Messages.php 1.22
  * and ru.wikipedia MediaWiki namespace (2006-03-06)
  *
...
'mainpagedocfooter' => 'См. [http://www.mediawiki.org/wiki/Help:Configuration_settings список конфигурационных настроек]
и [http://meta.wikipedia.org/wiki/MediaWiki_User%27s_Guide руководство пользователя].',
...
'showhideminor' => '$1 мелкие правки | $2 ботов | $3 представившихся участников | $4 проверенные правки | $5 свои правки',
...
'disambiguations'       => 'Страницы, описывающие термины',
...
'selflinkstext'             => 'Следующие страницы содержат ссылки на самих себя:',
...
'contribslink'  => 'вклад',
'autoblocker'   => 'Вы автоматически заблокированны, потому что у вас такой же IP-адрес, как у [[user:$1|«$1»]]. Причина — «$2».',
