...
'val_add'	=> 'Añadir',
'val_article_lists'	=> 'Lista de artículos validados',
'val_clear_old'	=> 'Despejar mis datos antiguos de validación',
'val_del'	=> 'Borrar',
'val_details_th'	=> '<sub>Usuario</sub> \ <sup>Tema</sup>',
'val_details_th_user'	=> 'Usuario $1',
'val_form_note'	=> '\'\'\'Consejo:\'\'\' El fusionar tus datos implica que para la revisión de artículo que seleccionaste, todas las opciones donde has especificado «sin opinión» se establecerán al valor y comentario de la revisión más reciente para la que has expresado una opinión. Por ejemple, si quieres cambiar una única opción por una revisión más moderna, pero también mantener tus otros ajustes para este artículo en esta revisión, simplemente selecciona qué opción pretendes cambiar, y el proceso de fusionado rellenará las otras opciones con tus ajustes anteriores.',
'val_iamsure'	=> '¡Activa esta caja si estás seguro!',
'val_list_header'	=> '<th>Nº</th><th>Tema</th><th>Rango</th><th>Acción</th>',
'val_max_topics'	=> 'Se ha alcanzado el máximo de $1 temas',
'val_merge_old'	=> 'Usar mis juicios anteriores donde seleccione «Sin opinión»',
'val_my_stats_title'	=> 'La visión de conjunto de mi validación',
'val_no'	=> 'No',
'val_no_anon_validation'	=> 'Tienes que ingresar para validar un artículo.',
'val_noop'	=> 'Sin opinión',
'val_no_topics_defined'	=> 'No hay temas definidos',
'val_no_topics_defined_text'	=> 'No tienes temas definidos que puedan ser calificados. Ve a  [[Special:Validate]], y haz que un administrador ejecute la función de «Gestión» para añadir al menos un tema y el rango de puntuación.',
'val_of'	=> '$1 de $2',
'val_page_validation_statistics'	=> 'Estadísticas de validación de página para $1',
'val_percent'	=> '<b>$1%</b><br />($2 de $3 puntos<br />por $4 usuarios)',
'val_percent_single'	=> '<b>$1%</b><br />($2 de $3 puntos<br />por un usuario)',
'val_rev_for'	=> 'Revisiones para $1',
'val_revision'	=> 'Revisión',
'val_revision_changes_ok'	=> '¡Tus puntuaciones han sido almacenadas!',
'val_revision_number'	=> 'Revisión nº$1',
'val_revision_of'	=> 'Revisión de $1',
'val_revision_stats_link'	=> 'detalles',
'val_rev_stats'	=> 'Ver las estadísticas de validaciones para "$1" <a href="$2">aquí</a>',
'val_show_my_ratings'	=> 'Mostrar mis validaciones',
'val_stat_link_text'	=> 'Estadísticas de validación para este artículos',
'val_tab'	=> 'Validar',
'val_table_header'	=> '<tr><th>Clase</th>$1<th colspan="4">Opinión</th>$1<th>Comentario</th></tr>',
'val_this_is_current_version'	=> 'esta es la última versión',
'val_time'	=> 'Fecha',
'val_topic_desc_page'	=> 'Project:Temas de validación',
'val_total'	=> 'Total',
'val_user_stats_title'	=> 'Visión general de validación del usuario $1',
'val_user_validations'	=> 'Este usuario ha validado $1 páginas.',
'val_validate_article_namespace_only'	=> 'Sólo se pueden validar artículos. Esta página no está en el espacio de nombres de artículos.',
'val_validated'	=> 'Validación realizada.',
'val_validate_version'	=> 'Validar esta versión',
'val_validation_of'	=> 'Validación de "$1"',
'val_version'	=> 'Versión',
'val_version_of'	=> 'Versión de $1',
'val_view_version'	=> 'Ver esta revisión',
'val_votepage_intro'	=> 'Cambiar este texto <a href="{{SERVER}}{{localurl:MediaWiki:Val_votepage_intro}}">aquí</a>',
'val_warning'	=> '<b>¡Nunca, <i>jamás</i>, cambies algo aquí sin el consenso <i>explícito</i> de a comunidad!</b>',
'val_yes'	=> 'Si',
'variantname-zh'	=> 'zh',
