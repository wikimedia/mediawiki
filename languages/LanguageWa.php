...
/* private */ $wgLanguageNamesWa = array(
	...
	"ba" => "Башкорт", /* bashkir */
	"be" => "Беларуски", /* bielorûsse */
	"bg" => "Български", /* bulgåre */
	"bh"	=> "Bihara", # co a fé
	"bi"	=> "Bislama", # co a fé
	"bn" => "বাংলা", /* bengali */
	"bo"	=> "Tibetan", # co a fé
	...
	"ik" => "Iñupiaq", /* inupiak */
	"is" => "Íslenska", /* izlandès */
	"it" => "Italiano", /* itålyin */
	"iu" => "ᐃᓄᒃᑎᑐᑦ", /* inuktitut */
	"ja" => "日本語", /* djaponès */
	"jv" => "Basa Jawa", /* djavanès */
	"ka" => "ქართველი", /* djeyordjyin */
	"kk" => "Қазақ", /* kazaxh */
	...
	"sk" => "Slovenčina", /* eslovake */
	"sl" => "Slovenščina", /* eslovenyin */
	"sm"	=> "Samoan", # co a fé
	"sn"	=> "Shona", # co a fé
	"so" => "Soomaali", # co a fé
	"sq" => "Shqip", /* albanyin */
...
[[$wgMetaNamespace:Pådje protedjeye]] s'&nbsp;i vs plait.
