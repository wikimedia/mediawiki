...
"nodb"			=> "Não foi possível selecionar o bando de dados $1",
...
"summary"		=> "Sumário",
"subject"		=> "Assunto",
"minoredit"		=> "Edição mínima",
"watchthis"		=> "Oservar este artigo",
"savearticle"	=> "Salvar página",
"preview"		=> "Prever",
"showpreview"	=> "Mostrar previssão",
...
"searchresulttext" => "Para mais informações sobre busca na Wikipedia, see $1.",
...
"linkshere"		=> "Os seguintes artivos contém ligações que apontam para cá:",
