...
'tog-showtoc' => 'Tampilkan daftar isi (untuk artikel yang mempunyai lebih dari 3 subbab)',
...
"perfcached" => "Data berikut ini diambil dari <em>cache</em> dan mungkin tidak up-to-date:",
...
'protectedtext' => 'Halaman ini sedang dikunci dari penyuntingan. Lihat [[{{ns:project}}:Perlindungan]] untuk keterangan lebih lanjut.',
...
'prefs-help-email' => '* <strong>Surat-e</strong> (tidak wajib): Memungkinkan orang lain untuk menghubungi Anda melalui situs tanpa perlu memberikan alamat email Anda kepada mereka, dan juga dapat digunakan untuk mengirimkan kata sandi baru jika Anda lupa kata sandi Anda.',
"loginerror" => "Kesalahan masuk log",
"nocookiesnew" => "Akun pengguna telah dibuat, tetapi Anda belum masuk log. {{SITENAME}} menggunakan cookies untuk log pengguna. Cookies pada penjelajah web Anda dimatikan. Silakan aktifkan cookies dan masuk log kembali dengan nama pengguna dan kata sandi Anda.",
"nocookieslogin" => "{{SITENAME}} menggunakan cookies untuk log penggunanya. Cookies pada penjelajah web Anda dimatikan. Silakan aktifkan cookies dan coba lagi.",
...
"searchresulttext" => "Untuk informasi lebih lanjut tentang pencarian di {{SITENAME}}, lihat [[{{ns:project}}:Pencarian|Mencari {{SITENAME}}]].",
...
"showingresults" => "Di bawah ditampilkan sampai <strong>$1</strong> hasil pencarian, dimulai dari #<strong>$2</strong>.",
...
'imagelisttext' => "Di bawah ini adalah daftar berkas <strong>$1</strong> yang telah diurutkan $2.",
...
"userstatstext" => "Ada '''$1''' pengguna terdaftar, dimana '''$2''' (atau '''$4%''') diantaranya adalah pengurus (lihat $3).",
...
"version" => "Versi",
'log' => 'Log',
'alllogstext' => 'Tampilan gabungan log pemuatan, penghapusan, perlindungan, pemblokiran, dan sysop. Anda dapat melakukan pembatasan tampilan dengan memilih jenis log, nama pengguna, atau nama halaman yang terpengaruh.',
...
"emailuser" => "Surat-e pengguna ini",
"emailpage" => "Surat-e pengguna",
"emailpagetext" => "Jika pengguna ini memasukkan alamat surat-e yang sah dalam preferensinya, formulir dibawah ini akan mengirimkan sebuah surat-e. Alamat surat-e yg terdapat pada preferensi Anda akan muncul sebagai alamat \"From\" dalam surat-e tersebut, sehingga penerima dapat membalas surat-e tersebut.",
...
"watchnochange" => "Tak ada halaman pantauan Anda yang telah berubah dalam jangka waktu yang ditampilkan.",
'watchdetails'		=> '* $1 halaman dipantau, tidak termasuk halaman bicara
* [[Special:Watchlist/edit|Lihat dan sunting daftar pantauan]]
* [[Special:Watchlist/clear|Hapus semua halaman dari daftar]]',
...
"removechecked" => "Hapus butir yang diberi tanda cek dari daftar pantauan",
...
"removingchecked" => "Menghapus butir-butir yang diminta dari daftar pantauan Anda...",
"couldntremove" => "Tidak dapat menghapus butir '$1'...",
"iteminvalidname" => "Ada masalah dengan butir '$1' (namanya tidak sah)...",
...
'revertpage'	=> "Suntingan [[Special:Contributions/$2|$2]] ([[User_talk:$2|Talk]]) dikembalikan ke versi terakhir oleh [[User:$1|$1]]",
...
"protectlogtext" => "Di bawah ini adalah daftar log perlindungan/penghilangan perlindungan halaman. Lihat [[{{ns:project}}:Halaman dilindungi]] untuk informasi lebih lanjut.",
...
'protect-text' => 'Anda dapat melihat atau mengganti tingkatan perlindungan untuk halaman <strong>$1</strong> di sini. Yakinkan bahwa Anda telah mengikuti [[{{ns:project}}:Halaman dilindungi|pedoman proyek]].',
...
"undeletedtext" => "Halaman [[:$1|$1]] berhasil dikembalikan. Lihat [[Special:Log/delete|Log penghapusan]] untuk log terkini penghapusan dan pengembalian halaman.",
...
"lastmodifiedby" => "Halaman ini terakhir kali diubah pada $1 oleh $2.",
"and" => "dan",
