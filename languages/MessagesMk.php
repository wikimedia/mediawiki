...
'sysoptext'             => 'Бараното дејство може да го
изврши само корисник со администраторски статус. 
Видете $1.',
...
'noconnect'             => 'Извинете! Викито има некои технички проблеми и неможе да пристапи кон серверот. 
<br /> 
$1',
...
'badarticleerror'       => 'Ова дејство неможе да се спроведе на наведената страница.',
...
'perfdisabled'          => 'Извинете! Оваа можност е привремено исклучена бидејќи ја успорува базата до ниво на кое никој неможе да го користи викито.',
...
Забелешка: Неможете да ја користите опцијата "е-пошта до корисникот" ако немате внесено валидна адреса во вашите [[Special:Прилагодувања|прилагодувања]]. Вашата IP адреса е $3. Ве молиме вклучете ја оваа адреса во сите барања што ќе ги приложите.',
...
што е повеќе од максималните $2 килобајти. Неможе да се зачува.</strong>',
...
'revnotfoundtext'       => 'Старата верзија на оваа страница неможе да се пронајде. 
...
'oldrevisionnavigation' => 'Ревизии од $1; $5<br />($6) $3 | $2 | $4 ($7)',
...
'upload_directory_read_only'=> 'Веб серверот неможе да запишува во папката за подигнување ($1).',
...
следниов начин: <tt><nowiki>[[Слика:$1|мини|Опис]]</nowiki></tt>',
...
\'\'\'$2\'\'\' (или \'\'\'$4%\'\'\') од нив се администратори (види $3).',
...
набљудувани страници. Означете ги полињата на страниците кои сакате да ги остраните од вашата листа и кликнете го копчето \'Отстрани го избраното\' 
...
Кликнете го копчето „назад“ и повторно вчитајте ја страницата 
...
и кликнете на \'\'\'\'\'Врати\'\'\'\'\'. За да извршите селективно враќање, 
селектирајте ги полињата до соодветните ревизии за враќање и кликнете
на \'\'\'\'\'Врати\'\'\'\'\'. Со кликнување на \'\'\'\'\'Ресетирај\'\'\'\'\' ги бришете
...
'cannotundelete'        => 'Враќањето не успеа, некој друг можеби ја вратил стрницата претходно.',
...
'sorbs_create_account_reason'=> 'Вашата IP адреса е наведена како отворено прокси во [http://www.sorbs.net SORBS] DNSBL. Неможете да креирате сметка',
...
'confirmemail_text'     => 'Ова вики бара да ја валидирата вашата е-поштенска адреса 
...
отворете ја врската во вашиот прелистуваш за да потврдите дека вашата е-поштенска 
адреса е валидна.',
'confirmemail_send'     => 'Прати код за потврда',
'confirmemail_sent'     => 'Пораката за потврда е пратена.',
'confirmemail_sendfailed'=> 'Неможам да пратам порака со код за потврда. Проверете дали адресата содржи неважечки знаци.',
