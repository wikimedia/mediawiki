...
class LanguageTt_cyrl extends Language {
	...
	function convertGrammarTt_cyrl( $word, $case ) {
		global $wgGrammarForms;
		if ( isset( $wgGrammarForms['tt-kz'][$case][$word] ) ) {
			return $wgGrammarForms['tt-kz'][$case][$word];
		}
		if ( isset( $wgGrammarForms['tt-cyrl'][$case][$word] ) ) {
			return $wgGrammarForms['tt-cyrl'][$case][$word];
		}
	...
	function convertGrammarTt_latn( $word, $case ) {
		global $wgGrammarForms;
		if ( isset( $wgGrammarForms['tt-tr'][$case][$word] ) ) {
			return $wgGrammarForms['tt-tr'][$case][$word];
		}
		if ( isset( $wgGrammarForms['tt-latn'][$case][$word] ) ) {
			return $wgGrammarForms['tt-latn'][$case][$word];
		}
		// Set up some constants...
		// Vowels in last syllable
	...
	function convertGrammarTt_arab( $word, $case ) {
		global $wgGrammarForms;
		if ( isset( $wgGrammarForms['tt-cn'][$case][$word] ) ) {
			return $wgGrammarForms['tt-cn'][$case][$word];
		}
		if ( isset( $wgGrammarForms['tt-arab'][$case][$word] ) ) {
			return $wgGrammarForms['tt-arab'][$case][$word];
		}
		// Set up some constants...
		// Vowels in last syllable
