		...
		for( $i = $len; $i >= 2; $i-- ) {
			...
			if(
				...
				if(
					...
					return $this->wordsWithFalseTatarSuffixes[$noun2];
				}
			}
			$parts = $saved_parts;
			if(
	...
	function __construct(
		...
		$this->wordsWithFalseTatarSuffixes = array_fill_keys(
			[
				...
				'шигый', 'мөгаен', 'табигый', 'яхшы', 'гаеп', 'нәгыйм', 'гает', 'газыйм', 'бие',
				'тиеш', 'ситдыйк', 'шәфигый', 'гашыйк', 'икътисадый',
				'гуам', 'имам',
				'елмай', 'маэмай', 'гавая', 'парагвай',
				'горилла', 'игълан', 'бәла', 'әхлак', 'һәлак', 'купала', 'мөлаем', 'коала',
				'калигула',
