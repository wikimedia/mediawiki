...
// https://tt.wikipedia.org/wiki/%D0%A4%D0%B0%D0%B9%D0%BB:Tatar_telenen_orfografiase_10.jpg
		...
		*/
		...
		if(
		...
		}elseif(preg_match( '/^көн(чыгыш|батыш)|гөлбакча|ч[иы]наяк/u', $text )){
			...
			|| preg_match( '/багира|тагил|^хими/u', $text )
		){
			...
			// робагый has gone to tatar branch but i do not need to fix it
		){
