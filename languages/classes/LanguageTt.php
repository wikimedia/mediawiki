		...
		*/
		if (
			preg_match(
				'/^('
				// к
				. 'кала[кг]|куллан|калкын|кае[кнш]|курык|каер|кечкенә[йяею]|кагыл|коерык|кө[йяею]'
				. '|ко[йяею]|кы[йяею](?!фәт)|кызы[кг]|кыя[кг]|кояш|кавын|кыз|кар|капка|ки[яею]'
				. '|кабат|комар|канат|кат(?!ок)|ка[йя]|ку[йяею]|кына|куан|кыл|кан(?!дид|әга)|кыса'
				. '|ку(?=$|а|ды|ган|ыр|са|ма|мы|ык|ын|ыл|дыр|ып)'
				. '|кун'
				// у
				. '|урта[кг]|урнаш|у[йяею]|утыр|у[кг]'
				// т
				. '|тука[йяею]|тукран|тая[кг]|тагын|ту[йяею]|тө[йяею]|тапкыр|тырыш|тугры|та[пб]'
				. '|тар[аы]|туглан|ти[яею]?|тарт|тор|тот|та[кг](?!ил)|түбән'
				// б
				. '|бөе[кг]|бое|бае|бул|баш|бар|ба[кг](?!ира)|бу[кг]|быел|бу[йе]'
				// г
				. '|га($|ча)|гүя|гаян|гыйнвар|гырылда|гына'
				// я
				. '|я[кг](?!ъ)|якын|ямь|яш[әиь]|яса|ярдәм|яр|яхшы|яз'
				// а
				. '|а[кг](?!ент)(?!тив)|ал|аер|ассызы[кг]|ака[йяею]|авыл|аза[кг]|аркан|авыр|авыз'
				. '|аек'
				// х
				. '|хоку[кг]|хакан'
				// в
				...
				. '|ышан'
				// с
				. '|сугар|са[кг]|си[яею]|суз|сан|соң|сал'
				// ю
		...
		if (
			preg_match(
				...
				// в
				. '|вәкил|вазыйф|вәкал|вә$|ватан|вакыйг|вилаят|васыят|вакыт'
				// н
				. '|намзәт|нәүбәт|нәстәгъ'
				// м
				. '|мөрәҗ|мәгар|мәкал|мәгълүм|максат|маэмай|мөстәкыйль'
				// г
				...
				// т
				. '|тәэмин|тәвәк|тәшвик|тәрәкк|тәнвин|тәэсир|тасвир'
				// ш
				. '|шөгыл|шигыр'
				// с
				. '|сәлам|сәясәт|сәнагат|сәгат|сәнгат|сәяси'
				// п
				. '|пакь'
				// д
				. '|дөнья|диван'
