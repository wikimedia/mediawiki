...
class TtConverter extends LanguageConverter {
	...
	function convLcTtWordWithoutThickSuffixesCyToLa(
		...
		if (
			...
			return $this->processWordWithArabicStemCyrlToLat(
		...
		*/
		...
		// return $this->processWordWithRussianStemCyrlToLat( $text );
		return $this->processWordWithTurkicStemCyrlToLat( $text, $beforeThickSuffixes );
	...
	*/
	...
	function processWordWithRussianStemCyrlToLat( $text, $beforeThickSuffixes = false ) {
		...
		// октябрь
		$parts = preg_split( '/(?<=т)(?=ябр[ье])(?!ябрьск)/u',
	...
	function processWordWithArabicStemCyrlToLat(
		$text, $beforeThickSuffixes = false, $compoundOtherPart = null
	) {
