		...
		*/
		if (
			...
			preg_match(
				...
				. '|кыйммәт|кади|каф|кари|кадер|кардәш|каһин|кәеф|кыйсса|кыям|камил|куф[иа]'
				// җ
	...
	*/
	...
	function isValidDivision( $parts ){
		if(
			...
			||
			preg_match(
				'/^(духовной|октябрьской|предприятий|раменской|иҗтимаг|ясс|яхш)$/u',
				$parts[0]
			)
