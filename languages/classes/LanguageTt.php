	...
	*/
	...
	function __construct(
		...
		// $this->thickTatarVerbs = array_fill_keys(
			// [
				// 'кун', 'ку', 'кыйл', 'кыл', 'тул', 'ту', 'кал', 'кат', 'кап', 'уз', 'йар',
				// 'ал', 'аш', 'укы', 'ук', 'арт', 'у', 'оч', 'йылмай',
				// 'куш', 'сау', 'ау', 'тайан', 'тай', 'йугал', 'бар', 'бат', 'тул', 'ту', 'кама',
				// 'сал', 'бул', 'сык', 'бас',
				// 'кыр', 'кый', 'башкар', 'коткар',
				// 'как', 'ак', 'сук', 'йык', 'йак', 'курык', 'курк', 'бак', 'йабык', 'так', 'йок',
		...
		$this->russianWordsWithFalseThickTatarSuffixesAfterNoun = array_fill_keys(
			[
				...
				'гуам',
				'гавая', 'парагвай',
				'горилла', 'купала', 'коала',
				'калигула',
				'валдай', 'команда', 'канада', 'кофта', 'казадаев', 'коста',
				'яков',
				// 'калий', 'камбий',
				'вассал', 'капитал',
		...
		$this->arabicWordsWithFalseThickTatarSuffixesAfterNoun = array_fill_keys(
			[
				'вакыйга',
				'иҗтимагый', 'шигый', 'мөгаен', 'табигый', 'гаеп', 'нәгыйм', 'гает', 'газыйм',
				'ситдыйк', 'шәфигый', 'гашыйк', 'икътисадый', 'катгый',
				'имам',
				'маэмай',
		...
		$this->tatarWordsWithFalseThickTatarSuffixesAfterNoun = array_fill_keys(
			[
				'яссы', 'яхшы', 'бие', 'тиеш', 'якты', 'тиен', 'ярты',
				// 'елмай',
			],
			5
		);
