...
// Cyrillic
define( 'CRH_C_UC', 'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ' );
	# Crimean Tatar Cyrillic uppercase
define( 'CRH_C_LC', 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя' );
	# Crimean Tatar Cyrillic lowercase
define( 'CRH_C_CONS_UC', 'БВГДЖЗЙКЛМНПРСТФХЦЧШЩCÑ' );
	# Crimean Tatar Cyrillic + CÑ uppercase consonants
define( 'CRH_C_CONS_LC', 'бвгджзйклмнпрстфхцчшщcñ' );
...
define( 'CRH_C_M_CONS', 'бгкмпшcБГКМПШC' );
