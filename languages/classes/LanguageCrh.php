...
// Cyrillic
const CRH_C_UC = 'АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ'; # Crimean Tatar Cyrillic uppercase
const CRH_C_LC = 'абвгдеёжзийклмнопрстуфхцчшщъыьэюя'; # Crimean Tatar Cyrillic lowercase
const CRH_C_CONS_UC = 'БВГДЖЗЙКЛМНПРСТФХЦЧШЩCÑ'; # Crimean Tatar Cyrillic + CÑ uppercase consonants
const CRH_C_CONS_LC = 'бвгджзйклмнпрстфхцчшщcñ'; # Crimean Tatar Cyrillic + CÑ lowercase consonants
const CRH_C_CONS = 'бвгджзйклмнпрстфхцчшщcñБВГДЖЗЙКЛМНПРСТФХЦЧШЩCÑ'; # Crimean Tatar Cyrillic + CÑ consonants
const CRH_C_M_CONS = 'бгкмпшcБГКМПШC'; # Crimean Tatar Cyrillic M-type consonants

// Latin
const CRH_L_UC = 'AÂBCÇDEFGĞHIİJKLMNÑOÖPQRSŞTUÜVXYZ'; # Crimean Tatar Latin uppercase
const CRH_L_LC = 'aâbcçdefgğhıijklmnñoöpqrsştuüvxyz'; # Crimean Tatar Latin lowercase
const CRH_L_N_CONS_UC = 'ÇNRSTZ'; # Crimean Tatar Latin N-type upper case consonants
const CRH_L_N_CONS_LC = 'çnrstz'; # Crimean Tatar Latin N-type lower case consonants
const CRH_L_N_CONS = 'çnrstzÇNRSTZ'; # Crimean Tatar Latin N-type consonants
const CRH_L_M_CONS = 'bcgkmpşBCGKMPŞ'; # Crimean Tatar Latin M-type consonants
const CRH_L_CONS_UC = 'BCÇDFGHJKLMNÑPRSŞTVZ'; # Crimean Tatar Latin uppercase consonants
const CRH_L_CONS_LC = 'bcçdfghjklmnñprsştvz'; # Crimean Tatar Latin lowercase consonants
const CRH_L_CONS = 'bcçdfghjklmnñprsştvzBCÇDFGHJKLMNÑPRSŞTVZ'; # Crimean Tatar Latin consonants
const CRH_L_VOW_UC = 'AÂEIİOÖUÜ'; # Crimean Tatar Latin uppercase vowels
const CRH_L_VOW = 'aâeıioöuüAÂEIİOÖUÜ'; # Crimean Tatar Latin vowels
const CRH_L_F_UC = 'EİÖÜ'; # Crimean Tatar Latin uppercase front vowels
const CRH_L_F = 'eiöüEİÖÜ'; # Crimean Tatar Latin front vowels
...
class CrhConverter extends LanguageConverter {
	...
	function loadExceptions() {
		...
		list( $this->mExceptions, $this->mCyrl2LatnPatterns, $this->mLatn2CyrlPatterns,
			$this->mCyrlCleanUpRegexes ) = $crhExceptions->loadExceptions( CRH_L_LC . CRH_C_LC,
			CRH_L_UC . CRH_C_UC );
	}
