...
"tagline"                     => "Dari {{ns:project}}, ensiklopedia bebas", # "From {{ns:project}}, the free encyclopedia",
...
"{{ns:project}}page"         => "Lihat halaman meta", #"View meta page",
...
"administrators"        => "{{ns:-1}}:Listadministrators", #"Special:Listadministrators",
"sysoptitle"          => "Capaian penyelia diperlukan", #"Sysop access required",
"sysoptext"           => "Perbuatan anda itu hanya boleh dilakukan oleh seorang <a href=\"{{localurle:{{ns:-1}}:Listadministrators}}\">penyelia</a>.", #"Only the <a href=\"{{localurle:Special:Listadministrators}}\">administrators</a>can do that.",
...
"nbytes"              => "$1 bait",
"ok"                  => "OK",
"sitetitle"           => "{{ns:project}}",
"sitesubtitle"                => "Ensiklopedia Bebas",
...
"nosuchactiontext"      => "Tindakan yang ditetapkan oleh URL tidak dikenalpasti oleh perisian {{ns:project}}.", #"The action specified by the URL is not recognized by the {{ns:project}} software",
"nosuchspecialpage"     => "Tiada halaman istimewa tersebut", #"No such special page",
"nospecialpagetext"     => "Anda memintai halaman istimewa yang tidak dikenalpasti oleh perisian {{ns:project}}.", #"You have requested a special page that is not recognized by the {{ns:project}} software.",
...
"newusersonly"          => "(Pengguna baru sahaja)", #"(new users only)",
...
"loginsuccess"          => "Anda berjaya log masuk ke {{ns:project}} sebagai \"$1\".", #"You are now logged in to {{ns:project}} as \"$1\".",
...
"passwordremindertitle" => "Peringatan kata laluan daripada {{ns:project}}", #"Password reminder from {{ns:project}}",
"passwordremindertext"  => "Anda dari alamat IP $1 mungkin telah memohon kata laluan {{ns:project}} yang baru. Kata laluan terkini untuk pengguna \"$2\" ialah \"$3\". Anda disarankan log masuk dengan segera untuk menukarkan kata laluan anda.", #"Someone (probably you, from IP address $1) requested that we send you a new {{ns:project}} login password. The password for user \"$2\" is now \"$3\". You should log in and change your password now.",
...
"whitelistedittext"     => "Anda harus [[{{ns:-1}}:Userlogin|log masuk]] untuk dapat menyunting rencana.",
"whitelistreadtitle"    => "Pendaftaran masuk diperlukan untuk membaca",
"whitelistreadtext"     => "Anda harus [[{{ns:-1}}:Userlogin|log masuk]] untuk dapat membaca rencana.",
"whitelistacctitle"     => "Anda tidak dibenarkan membuka akaun",
"whitelistacctext"      => "Untuk dibenarkan membuka akaun dalam Wiki ini, anda harus [[{{ns:-1}}:Userlogin|log masuk]] dan mempunyai kebenaran yang wajar.",
"loginreqtitle"         => "Pendaftaran masuk diperlukan",
"loginreqtext"          => "Anda harus [[{{ns:-1}}:Userlogin|log masuk]] untuk dapat melihat halaman yang lain.",
...
"prefsnologintext"      => "Anda mesti [[{{ns:-1}}:Userlogin|log masuk]] untuk menetapkan butir-butir kecenderungan anda dalam [[{{ns:-1}}:Preferences|Tatarajah]].",
...
Sila lihat halaman-halaman ini: [[{{ns:project}}:FAQ|{{ns:project}} FAQ]],
[[{{ns:project}}:Polisi dan garis panduan|Dasar {{ns:project}}]]
...
Jika anda ingin melihat {{ns:project}} berjaya, adalah amat penting bahawa anda
...
"rcliu"                       => "; $1 suntingan daripada pengguna yang log masuk", 
"diff"                        => "perbezaan", #"diff",
"hist"                        => "sejarah", #"hist",
"hide"                        => "sorok", #"hide",
"show"                        => "papar", #"show",
...
"uploadnologintext" => "Anda mesti [[{{ns:-1}}:Userlogin|log masuk]] untuk memuat naik fail.",
"uploaderror"     => "Ralat muat naik", #"Upload error",
"uploadtext"      => "Borang di bawah adalah untuk memuat naik fail yang baru. Ia juga boleh digunakan untuk mecapai [[{{ns:-1}}:Imagelist|senarai imej]]. Setiap pemuatan naik dan pemadaman di halaman ini juga dicatat dalam [[{{ns:-1}}:Log|log]]. <p>Anda juga dikehendaki menandakan kotak untuk mengesahkan bahawa anda tidak melanggarkan sebarang hak cipta dengan pemuatan naik fail ini. Tekan butang \"Muat naik\" untuk menyelesaikan pemuatan naik. <p>Untuk memasukkan imej yang anda baru muat naik ke dalam halaman rencana, gunakan pautan dalam bentuk '''[[{{ns:6}}:fail.jpg]]''', '''[[{{ns:6}}:fail.png|teks alt]]''' atau '''[[{{ns:-2}}:fail.ogg]]''' untuk mengaitkan fail imej secara langsung.",
...
"copyrightpagename" => "Hak cipta {{ns:project}}",
...
"largefile"       => "Saiz fail ini $1 bait. Saiz imej yang tidak melebihi 100k disarankan.",
...
"missinglanguagelinks"  => "Pautan-pautan bahasa yang terhilang", #"Missing Language Links",
"missinglanguagelinksbutton" => "Cari pautan bahasa yang terhilang untuk"
...
"booksourcetext"          => "Di bawah ini adalah senarai pautan ke laman lain yang menjual buku,baik buku baru ataupun buku terpakai, dan mungkin mempunyai maklumat lanjut tentang buku yang anda sedang mencari. {{ns:project}} tidak bergabung dengan mana-mana perniagaan di atas, dan senarai ini bukan merupakan penyokongan.",
"isbn"                          => "ISBN",
...
"mailnologintext"         => "Anda harus [[{{ns:-1}}:Userlogin|log masuk]] dan mempunyai alamat emel yang sah di dalam [[{{ns:-1}}:Preferences|Tatarajah]] anda untuk mengirimkan emel kepada pengguna lain.",  #"You must be <a href=\"{{localurle:{{ns:-1}}:Userlogin}}\">logged in</a> and have a valid e-mail address in your <#a href=\"{{localurle:{{ns:-1}}:Preferences}}\">preferences</a> to send e-mail to other users.",
...
"watchnologintext"      => "Anda mesti [[{{ns:-1}}:Userlogin|log masuk]] untuk mengubahkan senarai pantau.",
"addedwatch"            => "Telah ditambah ke senarai pantau",
"addedwatchtext"          => "Halaman \"$1\" telah ditambah ke <a href=\"{{localurle:{{ns:-1}}:Senarai_pantau}}\">Senarai Pantau</a>. Semua perubahan pada masa hadapan di halaman tersebut dan halaman perbualannya akan disenaraikan di sini. Tajuk halaman tersebut juga akan <b>dicetak tebal</b> dalam <a href=\"{{localurle:{{ns:-1}}:Recentchanges}}\">senarai perubahan terkini</a> supaya lebih mudah dilihat. <p>Jika anda ingin memadamkan halaman dari senarai pantau, klik \"Nyahpantau\" pada palang di atas.",
...
* [[{{ns:-1}}:Watchlist/edit|Paparkan senarai pantauan yang lengkap]].",
...
"undeletedtext"     => "Pemulihan [[$1]] berjaya. Sila lihat [[{{ns:project}}:Log pemadaman]] untuk rekod pemadaman dan pemulihan terkini.",
...
"blockiptext"     => "Gunakan borang di bawah untuk menyekatkan capaian tulis dari alamat IP atau pengguna tertentu. Ini hanya dilakukan untuk mencegah laku musnah selaras dengan [[{{ns:project}}:Polisi dan garis panduan|Dasar {{ns:project}}]]. Masukkan alasan tertentu di bawah (umpamannya, sebutkan halaman yang telah dilaku musnahkan).",
...
"blockipsuccesstext" => "Alamat IP atau nama pengguna \"$1\" telah disekat. <br />Sila lihat [[{{ns:-1}}:Ipblocklist|Senarai Sekatan]] untuk meninjau penyekatan semula.", 
...
"blocklogtext"      => "Ini adalah log tindakan sekat dan nyahsekat. Penyekatan secara automatik tidak tersenarai. Sila lihat [[{{ns:-1}}:Ipblocklist|Senarai Sekatan IP]] untuk penyekatan terkini.",
...
"lockdbsuccesstext" => "Pangkalan data {{ns:project}} telah dikunci.<br />Pastikan anda membukanya semula selepas penyelenggaraan telah selesai.", 
"unlockdbsuccesstext" => "Pangkalan data {{ns:project}} telah dibuka semula.", #"The {{ns:project}} database has been unlocked.",
...
"movenologintext" => "Anda harus [[{{ns:-1}}:Userlogin|log masuk]] untuk mengalihkan halaman.",
