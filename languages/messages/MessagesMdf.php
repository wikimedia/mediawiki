...
'nonefound'             => "'''Шарфтк мяльсот''': Улема, вешендемась аф лисеви сидеста васьфневи валда, кепотьксоньди \"лама\" эли \"мезе\". Стапт валхт аф индексияфневихть. Улема, тонь вешендемаса фкя валда лама (мувихть аньцек лопатне конань потмосост улихть сембе тяштьф валхне).",
'powersearch'           => 'Вешендемс',
'powersearchtext'       => 'Вешендемс:<br />$1<br />$2 лепнень йотксост Няфтемс йотафтф лопат<br />Вешендемс $3 $9',
'searchdisabled'        => '{{SITENAME}}-са тяни вешендемась аш. Ули кода вешендемс Google эли иля вешендемань интернет програпнень вельде. Шарфтк мяльсот синь {{SITENAME}}-нь потмонц верзиец, улема, сирелгодсь.',
