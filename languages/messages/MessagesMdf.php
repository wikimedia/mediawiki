...
'formerror'            => 'Эльбятькс: Формсь аф сёрматфтови',
...
'perfcached'           => 'Вешф програмонь информациесь сёрматфоль инголе ванфтови файлхнень эса ди, улема, сирелгодсь.',
'perfcachedts'         => 'Тя програмонь информациесь сёрматфоль инголе ванфтови файлхнень эса ди мекольцеда одонзаф $1.',
...
'titleprotected'       => '[[Тии:$1|$1]] кардазь тя лемсь мархта лопа тиемать. Туфталсь <i>$2</i>.',
...
'loginpagetitle'     => 'Тиить сувама',
'yourname'           => 'Тиить лемоц:',
'yourpassword'       => 'Сувама вал:',
'yourpasswordagain'  => 'Сёрматк сувама вал омбоцекс:',
'remembermypassword' => 'Мяляфтомс монь тиинь лемоц тя содама машинаса',
'yourdomainname'     => 'Тонь доменце:',
'externaldberror'    => 'Лиссь эльбятькс ушень датабазонь вельде кемокстакшнембачк эли тондейть аф мярьгови полафнемс тонь ушень лувомать.',
'loginproblem'       => '<b>Тиись аф содаф.</b><br />',
'login'              => 'Сувама',
'loginprompt'        => '{{SITENAME}} лопас сувамда инголе тондейть эряви нолдамс тевс cookies.',
'userlogin'          => 'Сувама / сёрматфтомс сувамас',
'logout'             => 'Лисема',
'userlogout'         => 'Лисеть',
'notloggedin'        => 'Апак сувак',
'nologin'            => 'Аш сувама лемце? $1.',
'nologinlink'        => 'Тиемс сувамась',
'createaccount'      => 'Тиемс тиинь од лопа',
