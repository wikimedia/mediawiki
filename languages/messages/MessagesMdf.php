...
'overlogpagetext' => 'Ватт ала ащи сяда мекольце нардаматнень эди пякстаматнень лувомасна, сембе ся потмосна кяшфоль системонь вийкснень эзда. Ватт тяниень кардафкснень эди пякстаматнень лувкссна [[Special:IPBlockList|IP пякстамонь лувомаса]].',
...
'recentchangescount'       => 'Мъзяра петнемат няфтемс мекольце полафнемаса, история ди сувама лувома лопаса:',
...
'uploadlogpagetext'           => 'Ватт ала сяда мекольце файлонь тонгома лувомась.
