...
'throttled-mailpassword'     => 'Сувама валсь кучфоль ни ётай $1 ойста (часста). Кучсеви аньцек фкя сувама валсь $1 ойс кальдяв тиемада аралама туфталонкса.',
...
'revdelete-logaction'         => '$1-нь {{PLURAL:$1|верзиец ётафтовсь|верзиенза ётафтовсть}} $2-с',
...
'powersearchtext'       => 'Вешендемс:<br />$1<br />$2 лепнень ётксост Няфтемс ётафтф лопат<br />Вешендемс $3 $9',
...
'rcnote'                            => "Ала {{PLURAL:$1|Мекольце '''1''' полафнема|Мекольце '''$1''' полафнемат}} '''$2''' ётай  {{PLURAL:$2|шис|шис}}, $3ста.",
...
'recentchangeslinked-summary'  => "Тя башка лопас сувафнезь мекольце полафнемат сюлмаф лопава. Тонь мельгеваномастот лопатне '''тяштезь эчкста'''.",
...
'userstatstext'          => "Тяса {{PLURAL:$1|'''1''' сёрматфтф [[Special:ListUsers|тиись]]| '''$1''' сёрматфтф [[Special:ListUsers|тиихне]]}}, '''$2'''-нь (эли '''$4%''') {{PLURAL:$2|ули|улихть}} $5-нь видексонза.
Тяса {{PLURAL:$6|ули|улихть}} тяни '''$6''' эряй сёрматф тиинь {{PLURAL:$6|сёрматфтомац|сёрматфтомасна}}.",
...
'doubleredirects'     => 'Кафонзаф шафтфксне',
'doubleredirectstext' => 'Тя лопань лувомаса няфтевихть шашфтфксне сюлмафт иля шашфтфкснень мархта. Эрь луфксса (строкаса) улихть васенце ди омбоце шашфтфкснень сюлмафкссна, тяса тага ули омбоце шашфтксонь васенце киксонцты сюлмафкссь, тоса ули няфтемась лопань лемонц лангс конань мархта эряволь васенце шашфтфксоть сюлмафтомс.',

'brokenredirects'        => 'Синтьф шашфтфксне',
'brokenredirectstext'    => 'Ся шашфтфксне сюлмафт лопат мархта конат ашет:',
...
'ucnote'        => 'Ала тя тиить мекольце <b>$1</b> полафнеманза мекольце <b>$2</b> шис.',
'uclinks'       => 'Ваномс мекольце $1 полафнемат; ваномс мекольце $2 шит.',
'uctop'         => '(прянь)',
...
# Move page
'movepage'                => 'Ётафтомс лопа иля вастс',
'movepagetext'            => "Форм ала тевс нолдамста тон лопать одс лемдесак, сембе сонь историяц ули шашфтф мархтонза од лем лопас.
Сире лемоц арай од лем лопас шашфтфксокс.
Лемть мархта шашфтфксне улихть кода эслек одонзамс. Улефтяряй мяльце синь эслек одонзальхть, эряви нама варжамс[[Special:DoubleRedirects|кафонзаф]] эли [[Special:BrokenRedirects|синтьф шашфтфксне]].
Тондейть сави лацкаста варжамс сюлмафксне илядсть арафнефокс виде ёну.

Шарфтк мяльце улендярясь ни тя од лемса иля сёрматфсь, лопась '''аф''' ётафтови мъзярс од вастсь арай шавакс эли шашфтфксокс эди тоса аш ётай петнематнень историяц. Сякокс тондейть ули кода шашфтомс лопать меки коса сон инголе ульсь, эди тондейть аш кода тага весть тиемс лопать кона ули ни.
...
'talkpagemoved'           => 'Сотф мархтонза корхнема лопать ста ина ётафтфоль.',
'talkpagenotmoved'        => 'Сонь корхнема лопац <strong>афоль</strong> ётафтф.',
...
'subcategorycount'       => '{{PLURAL:$1|фкя субкатегорие|$1 субкатегориет}} тя категориеса.',
...
'confirmemail_body'       => 'Кивок, улема тон, IP адресста $1 ушедсь од сёрматфтомась "$2" {{SITENAME}}са тя электрононь адрессь мархта.

Улендяряй тя сёрматфтомась афкукс тоннеть тондейть тянь кемокстаманди эди электрононь адрессь {{SITENAME}}са тевс нолдаманди панжик тя сюлмафкссь тонь интернет поладксонь вальмасот:

$3

Улендяряй тя аф тонннель, тят панжи тя сюлмафкссь.
Кемокстама кодсь сирелгоды $4.',
...
'lag-warn-high'   => 'Серверонь вельф стака яксеманкса $1 фавда од полафнематне аш кода няфтемс тя лувомаса.',
