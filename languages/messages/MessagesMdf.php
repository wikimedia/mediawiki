...
'tog-externaleditor'          => 'Нолдамс тевс уша-ширень петнить мъзярс илякс изь мярьгов',
'tog-externaldiff'            => 'Нолдамс тевс уша-ширень diff мъзярс илякс изь мярьгов',
...
'editinginterface'     => "'''Ворьхть!:''' Тон петнесак лопать конань эса ащи лопать ванфонц програмонь текстоц. Петнематне полафтсазь сонь ванфоц кода сон няеви иля тиихненди. Йотафтома тиеманкса эняльттяма ваномс [http://translatewiki.net/wiki/Translating:Intro Betawiki] МедиаВикить локализациеть проектть.",
...
'externaldberror'            => 'Лиссь эльбятькс уша-ширень датабазонь вельде кемокстакшнембачк эли тондейть аф мярьгови полафнемс тонь уша-ширень сёрматфтомацень.',
