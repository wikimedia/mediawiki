...
Kò ṣe é múpamọ́.",
'semiprotectedpagewarning'         => "'''Àkíyèsí:''' Ojúewé yìí ti jẹ́ títìpa àyàfi àwọn oníṣe fífilórúkọsílẹ̀ níkan ni wọ́n le ṣàtúnṣe rẹ̀.",
...
'revdelete-log'               => 'Ìdíẹ̀:',
'revdelete-submit'            => 'Ṣe é sí àtúnyẹ̀wò ṣíṣàyàn',
...
'prefs-watchlist-edits-max' => '(nọ́mbà púpọ̀jùlọ: 1000)',
...
# User rights
'userrights'                  => 'Ìmójútó àwọn ẹ̀tọ́ oníṣe', # Not used as normal message but as header for the special page itself
...
'editcomment'  => "Àkótán àtúnṣe náà jẹ́: \"''\$1''\".", # only shown if there is an edit comment
...
'exif-orientation-1' => 'Déédé', # 0th row: top; 0th column: left
...
# Special:Version
'version'                  => 'Àtẹ̀jáde', # Not used as normal message but as header for the special page itself
