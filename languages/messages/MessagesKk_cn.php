...
'page-rss-feed'           => '«$1» دەگەن RSS ارناسى',
'page-atom-feed'          => '«$1» دەگەن Atom ارناسى',
...
'prefs-help-email-required'  => 'ە-پوشتا جايى قاجەت.',
...
'cantcreateaccount-text' => "مىنا IP جايدان (<b>$1</b>) تٸركەلگٸ جاساۋىن [[{{ns:user}}:$3|$3]] بۇعاتتاعان.
...
'page_last'           => 'سوڭعىسىنا',
'histlegend'          => 'ايىرماسىن بٶلەكتەۋ: سالىستىرامىن دەگەن نۇسقالاردى تاڭداپ, نە <Enter> پەرنەسٸن, نە تٶمەندەگٸ تٷيمەنٸ باسىڭىز.<br />
...
# Diffs
'history-title'             => '«$1» دەگەننٸڭ نۇسقالار تاريحى',
...
'undeletedrevisions'           => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}} قايتاردى',
'undeletedrevisions-files'     => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}} جٵنە {{PLURAL:$2|1 فايل|$2 فايل}} قايتاردى',
