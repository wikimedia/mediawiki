...
'mainpage'          => 'باستى بەت',
'mainpagetext'      => "<big>'''MediaWiki باعدارلاماسى سٴاتتٴى ورناتىلدى.'''</big>",
...
* [http://www.mediawiki.org/wiki/Help:FAQ MediaWiki جسج]
* [http://mail.wikimedia.org/mailman/listinfo/mediawiki-announce MediaWiki حات تاراتۋ تٴىزٴىمٴى]',
...
'autoredircomment'  => '[[$1]] بەتٴىنە ايدادى',
...
'userinvalidcssjstitle'     => "'''نازار سالىڭىز:''' مىندا «$1» اتاۋلى بەزەندٴىرۋ مٴانەرٴى جوق. پايدالانۋشىنىڭ .css جٴانە .js فايل اتاۋى كٴىشٴى ٴارٴىپپپەن جازىلاتىنىن ۇمىتپاڭىز, مىسالى, {{ns:user}}:Foo/monobook.css اتاۋىن {{ns:user}}:Foo/Monobook.css اتاۋىمەن سالىستىرعاندا.",
'updated'                   => '(جاڭارتىلعان)',
...
'old-revision-navigation'     => '$1 كەزٴىندەگٴى نۇسقاسى; $5<br />($6) $3 | $2 | $4 ($7)',
...
سوڭعى ٴوڭدەۋدٴى [[{{ns:user}}:$3|$3]] ([[{{ns:user_talk}}:$3|تالقىلاۋى]]) جاساعان.',
...
'linkshere'     => "مىناعان '''[[:$1]]''' كەلەسٴى بەتتەر سٴىلتەيدٴى:",
'nolinkshere'   => "مىناعان '''[[:$1]]''' ەش بەت سٴىلتەمەيدٴى.",
...
'sorbs'                       => 'SORBS DNSBL قارا تٴىزٴىمٴى',
'sorbsreason'                 => 'سٴىزدٴىڭ IP جايىڭىز [http://www.sorbs.net SORBS] DNSBL اشىق پروكسي سەرۆەرلەر قارا تٴىزٴىمٴىندە بار.',
'sorbs_create_account_reason' => 'سٴىزدٴىڭ IP جايىڭىز [http://www.sorbs.net SORBS] DNSBL اشىق پروكسي سەرۆەرلەر قارا تٴىزٴىمٴىندە بار. تٴىركەلگٴى جاساي المايسىز.',
...
'notacceptable'     => 'وسى ۋيكي سەرۆەرٴى سٴىزدٴىڭ «user client» وقي الاتىن پٴىشٴىمٴى بار دەرەكتەردٴى جٴىبەرە المايدى.',
...
'showbigimage' => 'جوعارى ايقىندى ($1×$2, $3 كب) نۇسقاسىن جٴۇكتەۋ',
