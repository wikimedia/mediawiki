...
'undelete_short'    => '{{PLURAL:$1|بٸر تٷزەتۋ|$1 تٷزەتۋ}} جويۋىن بولدىرماۋ',
'protect'           => 'قورعاۋ',
...
'viewcount'         => 'بۇل بەت {{PLURAL:$1|بٸر رەت|$1 رەت}} قاتىنالعان.',
...
'currentevents-url' => 'اعىمداعى وقيعالار',
...
'restorelink'             => '{{PLURAL:$1|جويىلعان بٸر تٷزەتۋ|جويىلعان $1 تٷزەتۋ}}',
'feedlinks'               => 'ارنا:',
...
'userpage-userdoesnotexist' => '«$1» قاتىسۋشى تٸركەلگٸسٸ جاسالماعان. بۇل بەتتٸ باستاۋ/ٶڭدەۋ تالابىڭىزدى تەكسەرٸپ شىعىڭىز.',
...
'undo-summary' => '[[{{ns:special}}:Contributions/$2|$2]] ([[{{ns:user_talk}}:$2|تالقىلاۋى]]) ٸستەگەن $1 نۇسقاسىن جوققا شىعاردى',
...
'revdelete-selected'          => "'''$1:''' دەگەننٸڭ {{PLURAL:$2|بٶلەكتەنگەن نۇسقاسى|بٶلەكتەنگەن نۇسقالارى}}:",
'logdelete-selected'          => "'''$1:''' دەگەننٸڭ {{PLURAL:$2|بٶلەكتەنگەن جۋرنال وقيعاسى|بٶلەكتەنگەن جۋرنال وقيعالارى}}:",
...
'revdelete-logaction'         => '{{PLURAL:$1|1 نۇسقانى|$1 نۇسقانى}} $2 كٷيٸنە قويدى',
'logdelete-logaction'         => '[[$3]] دەگەنگە {{PLURAL:$1|1 وقيعانى|$1 وقيعانى}} $2 كٷيٸنە قويدى',
...
'selectnewerversionfordiff' => 'سالىستىرۋ ٷشٸن جاڭالاۋ نۇسقاسىن بٶلەكتەڭٸز',
'selectolderversionfordiff' => 'سالىستىرۋ ٷشٸن ەسكٸلەۋ نۇسقاسىن بٶلەكتەڭٸز',
...
'prefsnologintext'         => 'باپتاۋلارىڭىزدى قويۋ ٷشٸن [[{{ns:special}}:Userlogin|كٸرۋٸڭٸز]] تيٸستٸ.',
...
'newpageletter'                     => 'ج',
'boteditletter'                     => 'ب',
'number_of_watching_users_pageview' => '[باقىلاعان {{PLURAL:$1|1 قاتىسۋشى|$1 قاتىسۋشى}}]',
...
'imagelisttext'             => "تٶمەندە ''$2'' سۇرىپتالعان {{PLURAL:$1|'''1''' فايل|'''$1'''فايل}} تٸزٸمٸ.",
...
'filerevert-intro'          => '<span class="plainlinks">\'\'\'[[{{ns:media}}:$1|$1]]\'\'\' دەگەندٸ [$3, $2 كەزٸندەگٸ $4 نۇسقاسىنا] قايتارۋداسىز.</span>',
'filerevert-comment'        => 'مٵندەمەسٸ:',
'filerevert-defaultcomment' => '$2, $1 كەزٸندەگٸ نۇسقاسىنا قايتارىلدى',
'filerevert-submit'         => 'قايتار',
'filerevert-success'        => '<span class="plainlinks">\'\'\'[[{{ns:media}}:$1|$1]]\'\'\' دەگەن [$3, $2 كەزٸندەگٸ $4 نۇسقاسىنا] قايتارىلدى.</span>',
...
'alreadyrolled'               => '[[:$1]] بەتٸنٸڭ [[{{ns:user}}:$2|$2]] ([[{{ns:user_talk}}:$2|تالقىلاۋى]])
سوڭعى تٷزەتۋٸ كەرٸ قايتارىلمادى; باسقا بٸرەۋ بەتتٸ الداقاشان ٶڭدەگەن نە قايتارعان.

سوڭعى ٶڭدەۋدٸ [[{{ns:user}}:$3|$3]] ([[{{ns:user_talk}}:$3|تالقىلاۋى]]) ٸستەگەن.',
...
'undeleterevisions'            => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}} مۇراعاتتالدى',
...
'undeletedrevisions'           => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}} قالپىنا كەلتٸرٸلدٸ',
'undeletedrevisions-files'     => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}} جٵنە {{PLURAL:$2|1 فايل|$2 فايل}} قالپىنا كەلتٸرٸلدٸ',
'undeletedfiles'               => '{{PLURAL:$1|1 فايل|$1 فايل}} قالپىنا كەلتٸرٸلدٸ',
...
'undelete-missing-filearchive' => 'مۇراعاتتالعان فايل (نٶمٸرٸ $1) قالپىنا كەلتٸرٸلمەدٸ, سەبەبٸ ول دەرەكقوردا جوق.
بۇنىڭ جويۋدى بولدىرماۋى الداقاشان بولعانى مٷمكٸن.',
...
'contribslink'                => 'ٷلەسٸ',
'autoblocker'                 => 'IP جايىڭىزدى جۋىقتا «[[{{ns:user}}:1|$1]]» پايدالانعان, سوندىقتان ٶزدٸكتٸك بۇعاتتالعان. $1 بۇعاتتاۋى ٷشٸن كەلتٸرٸلگەن سەبەبٸ: «$2».',
...
'import-logentry-upload-detail'    => '{{PLURAL:$1|1 نۇسقا|$1 نۇسقا}}',
'import-logentry-interwiki'        => 'ۋيكي-تاسىمالدانعان $1',
'import-logentry-interwiki-detail' => '$2 دەگەننەن {{PLURAL:$1|1 نۇسقا|$1 نۇسقا}}',
...
'mw_math_simple' => 'كٵدٸمگٸ بولسا HTML پٸشٸمٸمەن, ٵيتپەسە PNG تٷرٸمەن',
'mw_math_html'   => 'ىقتيمال بولسا HTML پٸشٸمٸمەن, ٵيتپەسە PNG تٷرٸمەن',
'mw_math_source' => 'TeX پٸشٸمٸندە قالدىرۋ (مٵتٸندٸك شولعىشتارى ٷشٸنا)',
...
جارامدىلىعىن راستاۋىڭىز كەرەك. ٶزٸڭٸزدٸڭ جايىڭىزعا راستاۋ حاتىن جٸبەرۋ ٷشٸن تٶمەندەگٸ تٷيمەنٸ نۇقىڭىز.
...
'watchlistedit-raw-removed'    => '{{PLURAL:$1|1 اتاۋ|$1 اتاۋ}} الاستالدى:',
