...
'tog-minordefault'            => 'Σημαίνειν ὡς ἥττονας ὅλας τὰς μεταγραφὰς προκαθωρισμένως',
...
'tog-enotifwatchlistpages'    => 'Ἄγγειλον μοι ὅτε δέλτος τις ἐν τῇ ἐφοροδιαλογῇ μου μεταβάλλεται',
...
Οὐ δύνασαι χρῆσθαι τὴν δυνατότητα «αποστολῆς ἠλεκτρονικῆς ἐπιστολῆς τῷδε χρήστη» εἰ οὐχ ὁρίσεις ἔγκυρόν τινα ἠλεκτρονικὴν διεύθυνσιν ἐν ταῖς [[Special:Preferences|προκρίσεσί]] σου. 
...
'contextchars'             => 'Συναφὲς κείμενον ἄνα σειράν:',
...
'rcnote'                            => "Κατωτέρω {{PLURAL:$1|ἐστὶ '''1''' ἀλλαγὴ|εἰσὶν αἱ τελευταίαι '''$1''' ἀλλαγαὶ}} ἐν {{PLURAL:$2|τῇ τελευταίᾳ ἡμέρᾳ|ταῖς τελευταίαις '''$2''' ἡμέραις}}, ὡς καὶ $5, $4.",
...
# Special:ImageList
'imagelist-summary'     => 'Ἡδε εἰδικὴ δέλτος δεικνύει ὅλα τὰ ἐπιπεφορτισμένα αρχεῖα.
...
'exif-orientation-2' => 'Ἀντιστραφεῖσα ὁριζοντίως', # 0th row: top; 0th column: right
'exif-orientation-3' => 'Περιεστραμμένον κατὰ 180°', # 0th row: bottom; 0th column: right
'exif-orientation-4' => 'Ἀντιστραφεῖσα καθέτως', # 0th row: bottom; 0th column: left
