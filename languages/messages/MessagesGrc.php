...
'tog-editsectiononrightclick' => 'Καθιστᾶν δυνατὸν τὸ μεταγράφειν τμήματα διὰ τοῦ ἐπὶ τῶν ἐπιγραφῶν τῶν τμημάτων θλίβειν δεξιῶς (ἀπαιτεῖται JavaScript)',
...
'vector-action-undelete'     => 'Ἀποκαθιστᾶν',
...
'usercssyoucanpreview'             => "'''Βουλή:''' Χρῆσον τὸ κομβίον 'Δεικνύναι προθεώρησιν' ἵνα δοκιμάσῃς τὴν νέαν σου CSS πρό τοῦ καταγράφειν.",
'userjsyoucanpreview'              => "'''Βουλή:''' Χρῆσον τὸ κομβίον 'Δεικνύναι προθεώρησιν' ἵνα δοκιμάσῃς τὴν νέαν σου JS πρό τοῦ καταγράφειν.",
...
'timezoneuseserverdefault'      => 'Χρῆσθαι ἐξυπηρετικὴν μηχανὴν προκαθωρισμένως',
...
'linksearch-text' => 'Ἔξεστί σοι χρῆσθαι ὑποκαταστάσιμας φράσεις ὅπως "*.wikipedia.org".<br />
...
'emailpagetext'    => 'Χρώμενος τὸ κάτωθι πρότυπον, ἀπόστειλον μήνυμά τι, ἐφὄσον δεδήλωκας ἔγκυρον ἠλ-διεύθυνσιν τινὰ εἰς τὰς [[Special:Preferences|προτιμήσεις χρωμένου]]. Ἥδε ἡ διεύθυνσις πεφασμένη ἔσεται ὡς διεύθυνσις ἀποστολέως τοῦ μηνύματος, οὕτως ὥστε ὁ παραλήπτης δύνηται ἀποκριθῆναι.',
...
'allmessages-prefix'            => 'Διηθητήριον κατά πρόθεμα:',
...
Ὁ πρῶτος σύνδεσμος ἐν πάσῃ γραμμῇ ὀφείλει εἶναι σύνδεσμος πρὸς κακὸν ἀρχεῖον τι.
...
Ἔξεστί σοι [[Special:UserLogin|συνδεῖσθαι]] καὶ χρῆσθαι τὸ βίκι.',
...
'tags-intro'              => 'Ἥδε ἡ δέλτος προσαρτήματα συγκαταλέγει (οἷσπερ ἔξεστι τῷ λογισμικῷ χρῆσθαι διὰ τὸ διακρίνειν μεταγραφὴν τινά) καὶ τὴν νοηματικὴν σήμανσιν σφῶν.',
