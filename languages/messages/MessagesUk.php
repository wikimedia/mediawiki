...
'protectedpagemovewarning'     => "'''Попередження:''' Ця сторінка була захищена таким чином, що тільки користувачі з правами адміністратора можуть її перейменовувати. Останні записи журналу наведені нижче для довідки:",
'semiprotectedpagemovewarning' => "'''Зауваження:''' Ця сторінка була захищена таким чином, що тільки зареєстровані користувачі можуть її перейменовувати. Останні записи журналу наведені нижче для довідки:",
