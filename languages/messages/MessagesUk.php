...
'ajax-remove-category'          => 'Вилучити категорію',
'ajax-edit-category'            => 'Змінити категорію',
'ajax-add-category-submit'      => 'Додати',
'ajax-confirm-ok'               => 'Готово',
'ajax-confirm-title'            => 'Підтвердити дію',
'ajax-confirm-save'             => 'Зберегти',
'ajax-confirm-save-all'         => 'Зберегти всі зміни',
'ajax-cancel'                   => 'Скасувати правку',
'ajax-cancel-all'               => 'Скасувати всі зміни',
'ajax-add-category-summary'     => 'Додати категорію „$1“',
'ajax-edit-category-summary'    => 'Змінити категорію "$1" на "$2"',
'ajax-remove-category-summary'  => 'Вилучити категорію „$1“',
'ajax-category-question'        => 'Чому ви хочете зробити наступні зміни:',
...
'ajax-edit-category-error'      => 'Не вдалося змінити категорію "$1".
Це зазвичай відбувається, коли категорію було додано до сторінки за допомогою шаблона.',
'ajax-category-already-present' => 'Ця сторінка вже належить до категорії "$1"',
'ajax-category-hook-error'      => 'Локальної функція перешкодила застосуванню змін.',
'ajax-api-error'                => 'API повернув помилку: $1: $2 .',
'ajax-api-unknown-error'        => 'API сповістив про невідому помилку.',
