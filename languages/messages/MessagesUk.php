...
'previewnote'                       => '<strong>Зверніть увагу, - це тільки попередній перегляд, текст ще не збережено!</strong>',
...
Ви також зобов'язуєтесь, що написане вами тут належить вам чи взято з джерела, що є суспільним надбанням чи подібним вільним джерелом.
...
'nonefound'                 => '<strong>Зауваження:</strong> До невдалого пошуку часто може призводити спроба знайти загальні слова, які не підлягають індексації, наприклад - «також» чи «що», або використання більше, ніж одного ключового слова для пошуку. Показуються тільки сторінки, що містять усі вказані для пошуку слова.',
...
'fileexists'                  => 'Файл з такою назвою вже існує. Перевірте, будь-ласка, <strong><tt>$1</tt></strong> якщо ви не впевнені чи хочете змінювати його.',
...
'mailnologintext' => 'Щоб мати можливість відправляти електронну пошту іншим користувачам ви повинні [[Special:Userlogin|ввійти в систему]] й мати адресу електронної пошти в ваших [[Special:Preferences|налаштуваннях]], щоб мати можливість надсилати електронну пошту іншим користувачам.',
...
'watchnologintext'     => 'Щоб змінювати список спостереження, ви повинні [[Special:Userlogin|ввійти в систему]].',
