...
$magicWords = array(
	...
	'tag'                   => array( '0', 'тег', 'мітка', 'тэг', 'метка', 'tag' ),
...
'protectedpagewarning'             => "'''Попередження: Ця сторінка була захищена від змін таким чином, що тільки користувачі з правами адміністратора можуть її редагувати.'''
Останній запис журналу наведений нижче для довідки:",
'semiprotectedpagewarning'         => "'''Зауваження:''' Ця сторінка була захищена таким чином, що тільки зареєстровані користувачі можуть її редагувати.
Останній запис журналу наведений нижче для довідки:",
...
'titleprotectedwarning'            => "'''Попередження. Ця сторінка була захищена таким чином, що для її створення потрібні [[Special:ListGroupRights|особливі права]].'''
Останній запис журналу наведений нижче для довідки:",
...
'protectedpagemovewarning'     => "'''Попередження:''' Ця сторінка була захищена таким чином, що тільки користувачі з правами адміністратора можуть її перейменовувати.
Останній запис журналу наведений нижче для довідки:",
'semiprotectedpagemovewarning' => "'''Зауваження:''' Ця сторінка була захищена таким чином, що тільки зареєстровані користувачі можуть її перейменувати.
Останній запис журналу наведений нижче для довідки:",
