...
'linkprefix'        => '/^(.*?)(„|«)$/sD',
'mainpagetext'      => '<span style="font-size:larger">Програмне забезпечення «MediaWiki» успішно встановлене.</span>',
...
'nospecialpagetext' => "<span style="font-size:larger">'''Така спеціальна сторінка не існує.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Ваш обліковий запис або IP-адреса заблоковані.'''</span>
...
'revertpage-nouser' => "Відкинуто редагування (ім'я користувача вилучене) до зробленого [[Користувач:$1|$1]]",
...
'undeletedpage'                => "<span style="font-size:larger">'''Сторінка «$1» відновлена'''</span>
...
'movepage-moved'               => "<span style="font-size:larger">'''Сторінка «$1» перейменована на «$2»'''</span>",
