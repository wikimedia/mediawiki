...
'password-login-forbidden'   => 'Використання цього імені користувача і пароля заборонені.',
...
'sitecsspreview'                   => "' ' Пам'ятатйте, що це тільки попередній перегляд цього CSS-файлу. ' '
' ' Його ще не збереженено! ' '",
...
'uploadstash-badtoken' => 'Не вдалося виконати вказані дії. Можливо, вичерпаний термін дії вашого жетону безпеки. Спробуйте ще раз.',
...
'disableaccount-mustconfirm' => 'Ви повинні підтвердити, що ви хочете, щоб відключити цей обліковий запис.',
'disableaccount-nosuchuser'  => 'Облікового запису користувача "$1" не існує.',
'disableaccount-success'     => 'Обліковий запис користувача "$ 1" був відключений назавжди.',
