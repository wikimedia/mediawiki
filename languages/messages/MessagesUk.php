...
'logdelete-logaction'         => '$1 {{PLURAL:$1|подія|події|подій}} сторінки [[$3]] {{plural:$1|переведена|переведені|переведені}} у режим $2',
...
'userrights-available-add'         => 'Ви можете додавати користувачів до {{PLURAL:$2|групи $1|груп: $1}}.',
'userrights-available-remove'      => 'Ви можете вилучати користувачів з {{PLURAL:$2|групи $1|груп: $1}}.',
...
'recentchangeslinked-summary'  => "На цій спеціальній сторінці представлений список останніх змін на пов'язаних сторінках. Сторінки з вашого списку спостереження '''виділені'''.",
...
'undeleterevdel'               => 'Відновлення не буде здійснене, якщо воно призведе до часткового вилучення останньої версії. У подібному випадку вам слід не позначати або розкрити останні вилучені версії. Версії файлів, на перегляд яких у вас нема прав, не будуть відновлені.',
