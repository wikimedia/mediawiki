...
$specialPageAliases = [
	...
	'ApiSandbox'                => [ 'Майданчик_для_тестування_API', 'Пісочниця_API' ],
	'AutoblockList'             => [ 'Список_автоблокувань' ],
	...
	'DeletePage'                => [ 'Вилучити_сторінку' ],
	'Diff'                      => [ 'Відмінності' ],
	'DoubleRedirects'           => [ 'Подвійні_перенаправлення', 'Двойные_перенаправления' ],
	'EditPage'                  => [ 'Редагувати_сторінку' ],
	'EditRecovery'              => [ 'Відновлення_редагувань' ],
	...
	'NamespaceInfo'             => [ 'Інформація_про_простір_назв' ],
	'Newimages'                 => [ 'Нові_файли', 'Новые_файлы' ],
	'Newpages'                  => [ 'Нові_сторінки', 'Новые_страницы' ],
	'NewSection'                => [ 'Новий_розділ' ],
	'PageHistory'               => [ 'Історія_змін_сторінки' ],
	'PageInfo'                  => [ 'Інформація_про_сторінку' ],
	'PagesWithProp'             => [ 'Сторінки_з_властивостями' ],
	'PasswordPolicies'          => [ 'Політика_щодо_паролів' ],
	...
	'ProtectPage'               => [ 'Захист_сторінки' ],
	'Purge'                     => [ 'Очистити_кеш' ],
	'RandomInCategory'          => [ 'Випадкова_сторінка_у_категорії' ],
	...
	'Randomrootpage'            => [ 'Випадкова_коренева_сторінка' ],
	...
	'RemoveCredentials'         => [ 'Вилучити_облікові_дані' ],
	'Renameuser'                => [ 'Перейменувати_користувача', 'Переименовать_участника' ],
	'ResetTokens'               => [ 'Скидання_токенів' ],
	...
	'Tags'                      => [ 'Мітки', 'Метки' ],
	'TrackingCategories'        => [ 'Категорії_спостереження' ],
...
$magicWords = [
	...
	'defaultsort'               => [ '1', 'СТАНДАРТНЕ_СОРТУВАННЯ', 'КЛЮЧ_СОРТУВАННЯ', 'СОРТИРОВКА_ПО_УМОЛЧАНИЮ', 'КЛЮЧ_СОРТИРОВКИ', 'DEFAULTSORT:', 'DEFAULTSORTKEY:', 'DEFAULTCATEGORYSORT:' ],
