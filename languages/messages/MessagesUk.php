...
'statistics-articles'      => 'Тематичних сторінок',
...
'alllogstext'          => "Комбінований показ журналів {{grammar:genitive | {{SITENAME}} }}. Ви можете відфільтрувати результати за типом журналу, іменем користувача (враховується регістр) або пов'язаної сторінки (враховується регістр).",
...
Ймовірно, це сталось через те, що вона містить посилання на зовнішній сайт присутній у чорному списку.',
...
#Вони будуть співвіднесені з URL зовнішніх зображень.
#Підхожі будуть показані як зображення, решта будуть показані як посилання на зображення
