...
'createacct-emailrequired'  => 'Label in new create account form for email field when it is required.',
'createacct-emailoptional' => 'Label in new create account form for email field when it is optional.',
'createacct-email-ph'  => 'Placeholder in new create account form for email field.',
'createaccountmail' => 'Button text for creating a new account and sending the new password to the specified e-mail address directly, as used on [[Special:UserLogin/signup]] if creating accounts by e-mail is allowed.',
'createaccountreason' => '{{Identical|Reason}}',
'createacct-reason' => 'In new create account form, label for field to enter reason to create an account when already logged-in.',
'createacct-benefit-heading' => 'In new create account form, the heading for the section describing the benefits of creating an account.',
'createacct-benefit-icon1' => 'In new create account form, the CSS style for the div next to the first benefit. If you replace this you will need probably need to adjust CSS.',
'createacct-benefit-head1' => 'In new create account form, the text in the heading for the first benefit. Do not edit the magic word; if you replace it you will probably need to adjust CSS.',
'createacct-benefit-body1' => 'In new create account form, the text for the first benefit.',
'createacct-benefit-icon2' => 'In new create account form, the CSS style for the div next to the second benefit. If you replace this you will need probably need to adjust CSS.',
'createacct-benefit-head2' => 'In new create account form, the text in the heading for the second benefit. Do not edit the magic word; if you replace it you will probably need to adjust CSS.',
'createacct-benefit-body2' => 'In new create account form, the text for the second benefit.',
'createacct-benefit-icon3' => 'In new create account form, the CSS style for the div next to the third benefit. If you replace this you will need probably need to adjust CSS.',
'createacct-benefit-head3' => 'In new create account form, the text in the heading for the third benefit. Do not edit the magic word; if you replace it you will probably need to adjust CSS.',
'createacct-benefit-body3' => 'In new create account form, the text for the third benefit.',
