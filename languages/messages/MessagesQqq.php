...
'filemetadata-notfile' => 'Shown by the <code><nowiki>{{#filemetadata:</nowiki></code> parser function if the parser function is used with a page that is not a file. $1 is the name of the file that the parser function was used with.',
'filemetadata-unsupported' => 'Shown when using <nowiki>{{#filemetadata:..}}</nowiki> parser function on a file that does not support metadata. This could be if we do not support extracting metadata from this type of file, or if there was some sort of error when attempting to extract the metadata (It is not shown if the file simply has no metadata). $1 is the full page name of the file in question',
'filemetadata-noprop' => "Shown by <code><nowiki>{{#filemetadata:...}}</nowiki></code> if the metadata property being requested in not present in the file. See also {{mw-msg|filemetadata-noprop}}. $1 is the full page name of the file. $2 is the name of the property.",
'filemetadata-nosubprop' => "Similar to {{msg-mw|filemetadata-noprop}} but shown by <code><nowiki>{{#filemetadata:...}}</nowiki></code> if the base property exists (The part before the "/" in the property name), but not the specific sub property. $1 is the full page name of the file in question. $2 is the full property name including the sub-property (example ImageDescription/en). $3 is only the base property name (example ImageDescription).",
