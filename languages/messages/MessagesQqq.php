...
# Edit pages
'summary' => 'The Summary text beside the edit summary field, with a parameter that is filled with a message for the remaining number of characters in the edit summary.

{{Identical|Summary}}',
'minoredit' => 'Text above Save page button in editor',
'characters-remaining' => 'Message for number of characters that can still be entered in the edit summary. Takes the initial remaining number as a parameter.',
