...
'invalidtitle-knownnamespace' => 'Displayed when an invalid title was encountred (generally in a list), but the namespace number is known to exist.
...
'invalidtitle-unknownnamespace' => 'Displayed when an invalid title was encountred (generally in a list) and the namespace number is unknown.
* $1 is the namespace number
