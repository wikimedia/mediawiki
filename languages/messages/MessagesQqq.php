...
'noimage'                   => 'In image description page when there is no file by that name.  The variable $1 comes from {{msg-mw|noimage-linktext}}, which is only substituted in this message.',
'noimage-linktext'          => 'This message is used as a variable in {{msg-mw|noimage}}, and will not be used anywhere else.',
...
CCW is an abbreviation for counter-clockwise', # 0th row: left; 0th column: top
'exif-orientation-6' => '0th row: right; 0th column: top

CW is an abbreviation for clockwise', # 0th row: right; 0th column: top
'exif-orientation-7' => '0th row: right; 0th column: bottom

CW is an abbreviation for clockwise', # 0th row: right; 0th column: bottom
'exif-orientation-8' => '0th row: left; 0th column: bottom

CCW is an abbreviation for counter-clockwise.', # 0th row: left; 0th column: bottom
