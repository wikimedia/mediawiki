...
'accountcreated' => 'Title of page when a logged-in user creates an account.',
'accountcreatedtext' => 'Text shown when a logged-in user creates an account. $1 is the new username.',
