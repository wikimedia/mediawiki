...
The message appears after the "newmessageslink"; it is followed by the "newmessagesdifflink". Used in message {{msg-mw|youhavenewmessagesfromusers}} (as parameter $3).',
...
ten users have edited the user talk page since the user last viewed it. Used in message {{msg-mw|youhavenewmessagesfromusers}} (as parameter $3).',
