...
+{{Identical|Developer}}',
'developerpage' => 'It is page that explains how to contribute to mediawiki. Used at the bottom of every page on the wiki. Example: [[{{MediaWiki:Developerpage}}|{{MediaWiki:Developer}}]]',
