...
$magicWords = array(
	...
	'img_thumbnail'             => array( '1', 'мини', 'жима', 'жимо', 'миниатюра', 'thumb', 'thumbnail' ),
	'img_manualthumb'           => array( '1', 'жима=$1', 'жимо=$1', 'мини=$1', 'миниатюра=$1', 'thumbnail=$1', 'thumb=$1' ),
	'img_right'                 => array( '1', 'справа', 'бакъхьа', 'right' ),
	'img_left'                  => array( '1', 'слева', 'харцхьа', 'left' ),
	'img_none'                  => array( '1', 'йоцуш', 'без', 'none' ),
	'img_width'                 => array( '1', '$1пкс', '$1px' ),
	'img_center'                => array( '1', 'центр', 'юккъ', 'center', 'centre' ),
	'img_framed'                => array( '1', 'гурабе', 'обрамить', 'frame', 'framed', 'enframed' ),
	'img_frameless'             => array( '1', 'безрамки', 'гурабоцаш', 'frameless' ),
