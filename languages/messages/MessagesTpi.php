...
'hidden-category-category' => 'Ol grup hait', # Name of the category where hidden categories will be listed
...
# Revision feed
'history-feed-item-nocomment' => '$1 long $2', # user at time
...
'shared-repo-from'    => 'long $1', # $1 is the repository name
...
'brokenredirects-edit'   => '(senisim)',
'brokenredirects-delete' => '(rausim)',
...
'ipaddress'          => 'IP adres:',
'ipboptions'         => '2 awa:2 hours,1 de:1 day,3 de:3 days,1 wik:1 week,2 wik:2 weeks,1 mun:1 month,3 mun:3 months,6 mun:6 months,1 yia:1 year,oltaim:infinite', # display1:time1,display2:time2,...
...
'movepage-moved'   => '\'\'\'"$1" i surikim pinis long "$2"\'\'\'', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
