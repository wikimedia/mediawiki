...
$specialPageAliases = [
	...
	'Log'                           => [ 'Rejestr', 'Logi' ],
	'Lonelypages'                   => [ 'Osierocone_strony', 'Porzucone_strony' ],
	...
	'WatchlistLabels'               => [ 'Etykiety_obserwowanych' ],
...
$magicWords = [
	...
	'ns'                        => [ '0', 'PN:', 'NS:' ],
	'numberingroup'             => [ '1', 'CZŁONKÓWGRUPY', 'NUMBERINGROUP', 'NUMINGROUP' ],
	...
	'pagesincategory_all'       => [ '0', 'wszystkie', 'all' ],
	'pagesincategory_files'     => [ '0', 'pliki', 'files' ],
	'pagesincategory_pages'     => [ '0', 'strony', 'pages' ],
	'pagesincategory_subcats'   => [ '0', 'podkategorie', 'subcats' ],
	'pagesinnamespace'          => [ '1', 'STRONWPRZESTRZENI', 'PAGESINNAMESPACE:', 'PAGESINNS:' ],
	'pagesize'                  => [ '1', 'ROZMIARSTRONY', 'PAGESIZE' ],
	'plural'                    => [ '0', 'MNOGA:', 'PLURAL:' ],
	'protectionexpiry'          => [ '1', 'OKRESZABEZPIECZENIA', 'ZABEZPIECZENIEWYGASA', 'PROTECTIONEXPIRY' ],
	'protectionlevel'           => [ '1', '__POZIOMZABEZPIECZEŃ__', 'PROTECTIONLEVEL' ],
	'rawsuffix'                 => [ '1', 'SUROWA', 'R' ],
	'redirect'                  => [ '0', '#PATRZ', '#PRZEKIERUJ', '#TAM', '#REDIRECT' ],
	'revisionid'                => [ '1', 'IDWERSJI', 'REVISIONID' ],
	'revisionsize'              => [ '1', 'ROZMIARWERSJI', 'REVISIONSIZE' ],
	'revisionuser'              => [ '1', 'AUTORWERSJI', 'REVISIONUSER' ],
	...
	'userlanguage'              => [ '1', 'JĘZYKUŻYTKOWNIKA', 'USERLANGUAGE' ],
];
