...
'mainpagetext'      => "<span style="font-size:larger">'''ویكیمیدیا به‌سه‌ركه‌وتووی دامه‌زرا.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''پەڕەیەکی تایبەت دەخوازیت کە بوونی نیە.'''</span>
...
'blockedtext'                      => '<span style="font-size:larger">\'\'\'ناوی بەکارهێنەری یان ئای‌پی ئەدرەسی تۆ بەربەست‌ کراوە.\'\'\'</span><br /><br />
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 هێنراوەتەوە'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" گوازراوەتەوە بۆ "$2"\'\'\'</span>',
