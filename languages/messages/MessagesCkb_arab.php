...
'category-subcat-count'          => '{{PLURAL:$2|ئەم پۆلە تەنھا ژێرپۆلی خوارەوەی تێدایە.| ئەم پۆلە ئەم {{PLURAL:$1|ژێرپۆلەی|$1 ژێرپۆلانەی}} تێدایە، لە کۆی $2 دا.}}',
...
'nonefound'                        => "'''تێبینی''': لە حاڵەتی بنچینەیی تەنھا ھەندێک لە بۆشایی‌ناوەکاندا دەگێڕدرێن.
پێشگری ''all:'' بەکاربێنە بۆ گەڕان لە نێو ھەموو بابەتەکان (لەوانە پەڕەکانی لێدوان، داڕێژەکان و هتد)، یان بۆشایی‌ناوێکی دڵخواز وەک پێشگر بەکار بێنە.",
...
بۆ بینینی و گەڕان لەو پەڕگانە پێشتر بار کراون بڕۆ بۆ [[Special:FileList|لیستی پەڕگە بارکراوەکان]]، ھەروەھا [[Special:Log/upload|ڕەشنووسی بارکردنەکان]] و [[Special:Log/delete|رەشنووسی سڕینەوەکان]].
...
* '''<tt><nowiki>[[</nowiki>{{ns:file}}<nowiki>:File.png|200px|thumb|left|alt text]]</nowiki></tt>''' بۆ بەکارهێنانی بە پانتایی ٢٠٠ پیکسەل لە چوارچێوەیەک لە  پەراوێزی چەپ بە 'alt text' وەک شرۆڤە
* '''<tt><nowiki>[[</nowiki>{{ns:media}}<nowiki>:File.ogg]]</nowiki></tt>''' بۆ بەستەرپێدان بە پەڕگەیەک بێ نیشان‌دانی خودی پەڕگەکە",
...
'filehist-help'             => 'کلیک بکە لەسەر ڕێکەوت/کات بۆ بینینی پەڕگە بەو شێوە کە لەو کاتەدا بووە.',
...
# Unused templates
'unusedtemplates'     => 'قاڵبە بەکارنەھێنراوەکان',
...
'uncategorizedpages'      => 'پەڕە پۆلێننەکراوەکان',
'uncategorizedcategories' => 'پۆلە پۆلێننەکراوەکان',
'uncategorizedimages'     => 'پەڕگە پۆلێننەکراوەکان',
'uncategorizedtemplates'  => 'قاڵبە پۆلێننەکراوەکان',
...
گۆڕانکارییەکانی داھاتووی ئەم پەڕە و پەڕەی لێدوانەکەی، لەوێدا بە ڕیزدەکرێ و پەڕەکە لە [[Special:RecentChanges|لیستی دوایین گۆڕانکارییەکان]]دا  ئەستوورکراو دەردەکەوێت بۆ ئەوەی ئاسانتر دەستکەوێت.',
...
'movepagetalktext'             => "پەڕەی لێدوانی پەیوەندیدار بە شێوە خۆکار لەگەڵیدا دەگوازرێتەوە '''مەگەر:'''
*پەڕەیەکی لێدوانی ناواڵا پێشتر ھەیە لە ژێر ناوە نوێکەدا، یان
*ئەم بۆکسەی خوارەوەت لێنەداوە
...
'talkexists'                   => "'''خودی پەڕەکە گوازرایەوە بەڵام پەڕەی لێدوانەکەی ناگوازرێتەوە چونکو بە پێشتر بە سەردێرە نوێکەوە یەکێک ھەیە.
...
'movesubpage'                  => '{{PLURAL:$1|ژێرپەڕە|ژێرپەڕەکان}}',
...
'tooltip-n-mainpage-description'  => 'سەردانی پەڕەی دەستپێک',
...
'watchlisttools-view' => 'گۆڕانکارییە پەیوەندیدارەکان نیشانبدە',
