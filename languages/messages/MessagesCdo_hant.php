<?php
/** Mindong (Traditional Han script) (閩東語（傳統漢字）)
 *
 * @file
 * @ingroup Languages
 */

$fallback = 'cdo, cdo-latn, nan-hant, zh-hant, zh, zh-hans';
...
$specialPageAliases = [
	...
	'Withoutinterwiki'          => [ '無跨語言', '無跨wiki', '無跨維基' ],
];
