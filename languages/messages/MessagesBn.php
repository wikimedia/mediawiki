...
'mypage'         => 'আমার পাতা',
'mytalk'         => 'আমার আলাপ',
'anontalk'       => 'এই বেনামী ব্যবহারকারীর আলাপের পৃষ্ঠা',
'navigation'     => 'পরিভ্রমন',
...
'edithelppage'      => '{{ns:project}}:কিভাবে একটি পৃষ্ঠা সম্পাদনা করবেন',
...
'newarticle'           => '(নতুন)',
'newarticletext'       => 'এই নিবন্ধটি এখনো {{SITENAME}} এ সংযুক্ত হয়নি। আপনি চাইলে নীচের বক্সে বিষয়টি নিয়ে কিছু লিখে ও রক্ষা করে এই নিবন্ধটি শুরু করতে পারেন । যদি ভুলবশত এখানে এসে থাকেন তাহলে ব্রাউজারের ব্যাক বোতামে ক্লিক করে আগের পৃষ্ঠায় ফিরে যান।',
