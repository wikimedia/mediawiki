...
'mainpagetext'      => "<span style="font-size:larger">'''মিডিয়াউইকি সফলভাবে ইন্সটল করা হয়েছে।'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''আপনি একটি অবৈধ বিশেষ পাতা অনুরোধ করেছেন।'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 পুনরুদ্ধার করা হয়েছে'''</span>
...
'movepage-moved'          => '<span style="font-size:larger">\'\'\'"$1"-কে "$2" শিরোনামে স্থানান্তর করা হয়েছে\'\'\'</span>',
