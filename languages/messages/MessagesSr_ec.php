...
'confirmemail_pending'     => '<div class="error">Код за потврду је већ био послат на адресу Ваше е-поште;
ако сте скоро направили налог, можда би требало да ишчекате неколико минута да би вам стигао, пре него што затражите нови код.</div>',
