...
$magicWords = [
	...
	'defaultsort'               => [ '1', 'ПОДРАЗУМЕВАНОСОРТИРАЊЕ:', 'ПОДРАЗУМИЈЕВАНОСОРТИРАЊЕ:', 'ПОДРАЗУМЕВАНИКЉУЧЗАСОРТИРАЊЕ:', 'ПОДРАЗУМИЈЕВАНИКЉУЧЗАСОРТИРАЊЕ:', 'ПОДРАЗУМЕВАНОСОРТИРАЊЕКАТЕГОРИЈЕ:', 'ПОДРАЗУМИЈЕВАНОСОРТИРАЊЕКАТЕГОРИЈЕ:', 'ПОДРАЗМЕВАНОСОРТИРАЊЕКАТЕГОРИЈЕ:', 'ПОДРАЗМИЈЕВАНОСОРТИРАЊЕКАТЕГОРИЈЕ:', 'DEFAULTSORT:' ],
