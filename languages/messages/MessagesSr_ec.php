...
'group-user-member'          => '{{GENDER:|корисник|корисница|корисник}}',
'group-autoconfirmed-member' => '{{GENDER:|аутоматски потврђен корисник|аутоматски потврђена корисница|аутоматски потврђен корисник}}',
'group-bot-member'           => 'бот',
'group-sysop-member'         => '{{GENDER:|администратор|администраторка|администратор}}',
'group-bureaucrat-member'    => '{{GENDER:|бирократа|бирократкиња|бирократа}}',
'group-suppress-member'      => '{{GENDER:|ревизор|ревизорка|ревизор}}',
...
'usercreated'             => 'Направљено дана $1 у $2',
