...
Пошто сте администратор, можете је видети. Детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} историји брисања].",
...
'newuserlog-create-entry'     => '{{GENDER:|је отворио|је отворила|је отворио}} налог',
