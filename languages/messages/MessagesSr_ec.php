...
'editundo'                 => 'поништи',
'diff-multi'               => '({{PLURAL:$1|Није приказана једна међуизмена|Нису приказане $1 међуизмене|Није приказано $1 међуизмена}} {{PLURAL:$2|једног|$2|$2}} корисника)',
...
'right-purge'                 => 'чишћење привремене меморије странице без потврде',
