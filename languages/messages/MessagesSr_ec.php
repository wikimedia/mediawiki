...
'tog-usenewrc'                => 'Проширени списак скорашњих измена (захтева јаваскрипту)',
...
'tog-previewontop'            => 'Претпреглед пре оквира за уређивање',
'tog-previewonfirst'          => 'Претпреглед на првој измени',
...
'tog-enotifminoredits'        => 'Пошаљи ми е-поруку за мале измене страница које надгледам',
...
'tog-uselivepreview'          => 'Живи претпреглед (захтева јаваскрипту – експериментално)',
...
'tog-ccmeonemails'            => 'Пошаљи ми примерке е-порука које шаљем другим корисницима',
...
'vector-simplesearch-preference' => 'Проширени предлози за претрагу (само за Vector тему)',
...
'nospecialpagetext' => '<strong>Тражена посебна страница не постоји.</strong>
...
'nocookieslogin'             => 'Ова викија користи колачиће за пријављивање чланова.
...
'yourdiff'                         => 'Разлике',
'copyrightwarning'                 => "Обратите пажњу да се сваки прилог на {{SITENAME}} сматра да је објављен под $2 лиценцом (погледајте $1 за детаље). Ако не желите да се ваш рад мења и расподељује без ограничења, онда га не шаљите овде.<br />
...
'nocreate-loggedin'                => 'Немате дозволу за прављење нових страница.',
...
'language-converter-depth-warning'        => 'Ограничење дубине синтаксе је прекорачено ($1)',
...
Детаље можете видети у [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} извештају].
Као администратор, још увек можете да [$1 видите ову измену].",
'rev-suppressed-text-unhide'  => "Измена ове странице је '''потиснута'''.
Детаље можете видети у [{{fullurl:{{#Special:Log}}/suppress|page={{FULLPAGENAMEE}}}} извештају].
Као администратор, још увек можете да [$1 видите ову измену].",
'rev-deleted-text-view'       => "Измена ове странице је '''обрисана'''.
Пошто сте администратор, можете је видети. Детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} извештају].",
'rev-suppressed-text-view'    => "Измена ове странице је '''потиснута'''.
Пошто сте администратор, можете је видети; детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/suppress|page={{FULLPAGENAMEE}}}} извештају].",
...
'rev-deleted-unhide-diff'     => "Једна од измена овог дифа је '''обрисана'''.
Детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} извештају].
Пошто сте администратор, можете [$1 видети овај диф].",
'rev-suppressed-unhide-diff'  => "Једна од измена овог дифа је '''потиснута'''.
Детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/suppress|page={{FULLPAGENAMEE}}}} извештају].
Пошто сте администратор, [$1 можете видети овај диф].",
'rev-deleted-diff-view'       => "Једна од измена овог дифа је '''обрисана'''.
Пошто сте администратор, можете видети овај диф; детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} извештају].",
'rev-suppressed-diff-view'    => "Једна од измена овог дифа је '''потиснута'''.
Пошто сте администратор, можете видети овај диф; детаље можете пронаћи у [{{fullurl:{{#Special:Log}}/suppress|page={{FULLPAGENAMEE}}}} извештају].",
...
'revdelete-confirm'           => 'Потврдите да желите ово да урадите, да разумете последице и да сте прочитали нашу [[{{MediaWiki:Policy-url}}|политику]].',
...
'right-purge'                 => 'чишћење оставе страница без потврде',
...
'right-suppressionlog'        => 'прегледање личних извештаја',
