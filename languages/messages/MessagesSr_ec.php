...
'showingresultstotal'       => "Приказ испод {{PLURAL:$3|резултат '''$1''' од '''$3'''|резултате '''$1 - $2''' од '''$3'''}}",
...
Један код за потврду је већ био послат на ваш имејл;
Ако сте скоро направили Ваш налог, препоручује Вам се да причекате неколико минута како би Вам тај мејл пристигао, пре него што затражите други код.</div>',
...
'filepath-summary' => 'Ова специјална страна даје целу адресу наведеног фајла.
Слике се приказују у пуној резолуцији, а дриги типови података се помоћу њима придруженог програма приказују или изводе директно.

Унесите име фајла без префикса "{{ns:image}}:".',

# Special:FileDuplicateSearch
'fileduplicatesearch'          => 'Претражите дупликате фајлова',
'fileduplicatesearch-summary'  => 'Претрага за дуплираним фајловима према хеш вредностима.

Унесите назив фајла без префикса "{{ns:image}}:".',
