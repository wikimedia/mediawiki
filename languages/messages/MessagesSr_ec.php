...
'lastmodifiedat'    => 'Ова страница је последњи пут измењена $1 у $2', # $1 date, $2 time
...
'deleted-notice'                   => 'Ова страница је обрисана.
Историја брисања ове странице је приложена испод, као додатна информација.',
...
'revdelete-toomanytargets-title' => 'Превише циљаних страница',
'revdelete-toomanytargets-text'  => 'Задали сте превише типова циљаних страница на којима треба спровести ову акцију.',
...
'sharedupload'              => 'Ова датотека је из $1 и може се користити на другим пројектима.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
...
'movepage-moved'               => "'''Страница „$1“ је преименована у „$2“!'''", # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
...
'lastmodifiedatby' => 'Ову страницу {{GENDER:$4|је последњи пут променио|је последњи пут променила|последњи пут промени}} $3, $1 у $2.', # $1 date, $2 time, $3 user
...
# Special:Version
'version'                          => 'Издање', # Not used as normal message but as header for the special page itself
