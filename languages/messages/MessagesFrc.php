...
'mainpagetext'      => "<span style="font-size:larger">'''Vous avez bien installé MediaWiki.'''</span>",
...
'blockedtext'                => "<span style="font-size:larger">'''Votre compte d'useur (ou votre adresse IP) est bloqué.'''</span>
