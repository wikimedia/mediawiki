...
'copyrightpagename'    => '{{SITENAME}} проектының авторлыҡ хоҡуҡтары',
...
$1',
'nodb'                 => '$1 мәғлүмәттәр базаһын һайлап булмай',
'cachederror'          => 'Түбәндә һоралған биттең кэшта һаҡланған өлгөһө күрһәтелгән, уның иҫкергән булыуы мөмкин.',
...
'cannotdelete'         => 'Билдәләнгән битте йәки файлды юйып булмай.
Уның башҡа ҡатнашыусы тарафынан юйылған булыуы мөмкин.',
...
'passwordtooshort'           => 'Һеҙҙең паролегеҙ дөрөҫ түгел йәки бигерәк ҡыҫҡа.
Пароль кәмендә $1 {{PLURAL:$1|хәрефтән}} торорға һәм һеҙҙең исемегеҙ менән тап килмәҫкә тейеш.',
...
'resetpass_bad_temporary'   => 'Хаталы ваҡытлыса пароль.
Һеҙ, бәлки, паролегеҙҙе уңышлы алмаштырғанһығыҙ инде йәки яңы ваҡытлыса пароль һоратҡанһығыҙ.',
...
'resetpass-log'             => 'Пароль үҙгәртеү яҙмалары журналы',
'resetpass-logtext'         => 'Түбәндә хәкимдәр тарафынан ҡатнашыусыларҙың паролен үҙгәртеү яҙмалары журналы килтерелгән.',
'resetpass-logentry'        => '$1 ҡатнашыусыһының паролен үҙгәрткән',
'resetpass-comment'         => 'Паролде үҙгәртеү сәбәбе:',
...
'confirmedittitle'                 => 'Үҙгәртеү өсөн электрон адрес почтаһын раҫлау кәрәк',
...
'usercssjsyoucanpreview'           => "'''Кәңәш:''' Яңы CSS-файлды йәки JS-файлды һаҡларҙан алда тикшерер өсөн \"Ҡарап сығырға\" төймәһенә баҫығыҙ.",
...
'protectedpagewarning'             => "'''Иҫкәрмә: Был бит хәким хоҡуҡтары булған ҡатнашыусылар ғына үҙгәртерлек итеп бикләнгән.'''",
'semiprotectedpagewarning'         => "'''Иҫкәрмә:''' Был бит теркәлгән ҡатнашыусылар ғына үҙгәртерлек итеп бикләнгән.",
...
'titleprotectedwarning'            => "'''Иҫкәрмә: Был бит [[Special:ListGroupRights|махсус хоҡуҡтары]] булған ҡатнашыусылар ғына булдыра алырлыҡ итеп бикләнгән.'''",
'templatesused'                    => 'Был биттә ҡулланылған ҡалыптар:',
'templatesusedpreview'             => 'Был ҡарап сығыу битендә ҡулланылған ҡалыптар:',
'templatesusedsection'             => 'Был бүлектә ҡулланылған ҡалыптар:',
...
'recreate-deleted-warn'            => "'''Иғтибар: Һеҙ, элек юйылған битте яңынан яһарға йыйынаһығыҙ.'''

Был битте яңынан яһау кәрәклеген яңынан тикшерегеҙ.
Түбәндә уңайлылыҡ өсөн биттең юйыу яҙмалары килтерелә:",
'deleted-notice'                   => 'Был бит юйылған.
Белешмә өсөн түбәндә битте юйыу яҙмалары килтерелә.',
'deletelog-fulllog'                => 'Бар яҙмаларҙы ҡарарға',
...
'revision-info'          => 'Версия: $1; $2', # Additionally available: $3: revision id
...
[{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} Юйыу яҙмалары журналында] аңлатмалар булыуы мөмкин.",
'rev-deleted-text-view'          => "Биттең был өлгөһө '''юйылған'''.
Һеҙ хәким булғанлыҡтан уны ҡарай алаһығыҙ. [{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} Юйыу яҙмалары журналында] аңлатмалар булыуы мөмкин.",
'rev-deleted-no-diff'            => "Һеҙ өлгөләр араһындағы айырманы ҡарай алмайһығыҙ, сөнки бит өлгөләренең береһе '''юйылған'''.
[{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} Юйыу яҙмаларында] аңлатмалар булыуы мөмкин.",
'rev-deleted-unhide-diff'        => "Һеҙ өлгөләр араһындағы айырманы ҡарай алмайһығыҙ, сөнки бит өлгөләренең береһе '''юйылған'''.
[{{fullurl:{{#Special:Log}}/delete|page={{FULLPAGENAMEE}}}} Юйыу яҙмалары журналында] аңлатмалар булыуы мөмкин.
Һеҙ хәким булғанлыҡтан, әгәр дауам итергә теләһәгеҙ, [$1 был өлгөнө] ҡарай алаһығыҙ.",
...
'revdelete-toomanytargets-title' => 'Бигерәк күп кәрәкле биттәр',
'revdelete-toomanytargets-text'  => 'Һеҙ был ғәмәлде башҡарыу өсөн бигерәк күп төрлө маҡсаттар билдәләгәнһегеҙ.',
...
'revdelete-text'                 => "'''Юйылған өлгөләр һәм ваҡиғалар һаман да биттең тарихында һәм яҙмалар журналдарында күрһәтеләсәк, әммә уларҙың эстәлеген дөйөм ҡарау мөмкин булмаясаҡ.'''
{{SITENAME}} проектының башҡа хәкимдәре, әгәр өҫтәмә сикләүҙәр билдәләнмәһә, һаман да йәшерелгән эстәлекте ҡарай һәм уны ошо уҡ интерфейс аша яңынан тергеҙә аласаҡ.

Зинһар, дауам итергә теләүегеҙҙе, бының эҙемтәләрен аңлауығыҙҙы һәм һеҙ быны [[{{MediaWiki:Policy-url}}|ҡағиҙәләргә]] ярашлы эшләүегеҙҙе раҫлағыҙ.",
...
'revdelete-log'                  => 'Сәбәп:',
'revdelete-submit'               => 'Һайланған өлгөләр өсөн ҡулланырға',
...
'visualcomparison'        => 'Күрһәтмәле сағыштырыу',
'wikicodecomparison'      => 'Вики-текстты сағыштырыу',
'editundo'                => 'кире алыу',
'diff-movedto'            => '$1 өлгөһөнә күсерелгән',
'diff-styleadded'         => '$1 стиле өҫтәлгән',
'diff-added'              => '$1 өҫтәлгән',
'diff-changedto'          => '$1 тип үҙгәртелгән',
'diff-movedoutof'         => '$1 өлгөһөнән сығарылған',
'diff-styleremoved'       => '$1 стиле юйылған',
'diff-removed'            => '$1 юйылған',
'diff-changedfrom'        => '$1 тигәндән үҙгәртелгән',
'diff-src'                => 'сығанаҡ',
'diff-withdestination'    => '$1 маҡсаты менән',
'diff-with'               => '&#32;$1 $2 менән',
'diff-with-final'         => '&#32;һәм $1 $2',
'diff-width'              => 'киңлек',
'diff-height'             => 'бейеклек',
'diff-p'                  => "'''абзац'''",
'diff-blockquote'         => "'''өҙөмтә'''",
'diff-h1'                 => "'''1-се быуын исеме'''",
'diff-h2'                 => "'''2-се быуын исеме'''",
'diff-h3'                 => "'''3-сө быуын исеме'''",
'diff-h4'                 => "'''4-се быуын исеме'''",
'diff-h5'                 => "'''5-се быуын исеме'''",
'diff-pre'                => "'''билдәләнгән форматлы бүлек'''",
'diff-div'                => "'''бүлек'''",
'diff-ul'                 => "'''тәртипкә килтерелмәгән исемлек'''",
'diff-ol'                 => "'''тәртипкә килтерелгән исемлек'''",
'diff-li'                 => "'''исемлектең есеме'''",
'diff-table'              => "'''таблица'''",
'diff-tbody'              => "'''таблицаның эстәлеге'''",
'diff-tr'                 => "'''юл'''",
'diff-td'                 => "'''күҙәнәк'''",
'diff-th'                 => "'''башлыҡ'''",
'diff-br'                 => "'''өҙөү'''",
'diff-hr'                 => "'''горизонталь һыҙыҡ'''",
'diff-code'               => "'''компьютер коды бүлеге'''",
'diff-dl'                 => "'''билдәләмәләр исемлеге'''",
'diff-dt'                 => "'''билдәләнә торған һүҙ'''",
'diff-dd'                 => "'''билдәләмә'''",
'diff-input'              => "'''керетеү'''",
'diff-form'               => "'''форма'''",
'diff-img'                => "'''рәсем'''",
...
'diff-i'                  => "'''ҡыя яҙыу'''",
'diff-b'                  => "'''ҡалын яҙыу'''",
'diff-strong'             => "'''ҡалын яҙыу(strong)'''",
'diff-em'                 => "'''ҡыя яҙыу(emphasis)'''",
'diff-font'               => "'''шрифт'''",
'diff-big'                => "'''эре'''",
'diff-del'                => "'''юйылған'''",
'diff-tt'                 => "'''үҙгәрмәүсән киңлек'''",
'diff-sub'                => "'''юлдан аҫта'''",
'diff-sup'                => "'''юлдан өҫтә'''",
'diff-strike'             => "'''һыҙылған'''",
...
'noexactmatch'                     => "'''\"\$1\" исемле бит юҡ.'''
Һеҙ [[:\$1|бындай исемле битте булдыра]] алаһығыҙ.",
'noexactmatch-nocreate'            => "'''\"\$1\" исемле бит юҡ.'''",
...
'searchprofile-articles-and-proj'  => 'Эстәлек һәм проект биттәре',
'searchprofile-project'            => 'Проект биттәре',
'searchprofile-images'             => 'Файлдар',
...
'prefs-search-nsdefault'           => 'Ғәҙәттәге көйләүҙәрҙе ҡулланып эҙләү:',
'prefs-search-nscustom'            => 'Күрһәтелгән исем арауыҡтарында эҙләү:',
...
'showingresultstotal'              => "Түбәндә {{PLURAL:$4|'''$3''' һөҙөмтәнән '''$1''' күрһәтелгән |'''$3''' һөҙөмтәнән '''$1 - $2''' эсендәгеһе}} күрһәтелгән",
...
'prefsreset'                => 'Ғәҙәттәге көйләүҙәр тергеҙелгән.',
...
'math'                      => 'Формулалар',
'dateformat'                => 'Ваҡыт форматы',
'datedefault'               => 'Ғәҙәттәге',
'datetime'                  => 'Көн һәм ваҡыт',
...
'recentchangescount'        => 'Һуңғы үҙгәртеүҙәрҙә, биттәрҙең тарихында, яҙмалар журналдарында һ.б. ғәҙәттә күренгән үҙгәртеүҙәр һаны:',
'savedprefs'                => 'Һеҙҙең көйләүҙәрегеҙ һаҡланды.',
'timezonelegend'            => 'Ваҡыт бүлкәте:',
'timezonetext'              => 'Һеҙҙең урындағы ваҡыттың сервер ваҡытынан (UTC) айырмаын керетегеҙ (сәғәттәрҙә).',
'localtime'                 => 'Урындағы ваҡыт:',
'timezoneselect'            => 'Ваҡыт бүлкәте:',
...
'defaultns'                 => 'Ғәҙәттә ошо исемдәр арауыҡтарында эҙләргә:',
'default'                   => 'ғәҙәттәге',
'files'                     => 'Файлдар',
...
Зинһар, башҡа исем һайлағыҙ.",
'fileexists-thumb'            => "<center>'''Булған файл'''</center>",
...
'uploadcorrupt'               => 'Файл боҙолған йәки киңәйтеүе дөрөҫ түгел.
Зинһар, файлды тикшерегеҙ һәм яңынан тейәп ҡарағыҙ.',
...
'shareduploadwiki'          => 'Өҫтәмә мәғлүмәт өсөн $1 битен ҡарағыҙ.',
'shareduploadwiki-desc'     => 'Түбәндә $1 битенән тасуирлама килтерелгән.',
'shareduploadwiki-linktext' => 'файл тасуирламаһы',
'noimage'                   => 'Бындай исемле файл юҡ, әммә уны $1 мөмкин.',
'noimage-linktext'          => 'тейәргә',
'uploadnewversion-linktext' => 'Был файлдың яңы версияһын тейәргә',
'shared-repo-from'          => '$1 базаһынан', # $1 is the repository name
'shared-repo'               => 'дөйөм һаҡлағыс', # used when shared-repo-NAME does not exist
...
'randompage-nopages' => '"$1" исемдәр арауығында биттәр юҡ.',
...
'brokenredirects-edit'   => '(үҙгәртергә)',
...
'categoriespagetext'            => 'Түбәндәге категорияларҙа биттәр йәки файлдар бар.
...
'historywarning'         => "'''Иҫкәрмә:''' Һеҙ юйырға йыйынған биттең тарихы бар:",
...
'editcomment'      => "Үҙгәртеүҙең тасуирламаһы \"''\$1''\" ине.", # only shown if there is an edit comment
'revertpage'       => '[[Special:Contributions/$2|$2]] ([[User talk:$2|фекер алышыу]]) уҙгәртеүҙәре [[User:$1|$1]] өлгөһөнә ҡайтарылды', # Additionally available: $3: revid of the revision reverted to, $4: timestamp of the revision reverted to, $5: revid of the revision reverted from, $6: timestamp of the revision reverted from
...
'protect-unchain'             => 'Биттең исемен үҙгәртеүҙең биген алырға',
...
'nocontribs'          => 'Күрһәтелгән шарттарға яуап биргән үҙгәртеүҙәр табылманы.', # Optional parameter: $1 is the user name
'uctop'               => '(аҙаҡҡы)',
...
'blocklog-fulllog'                => 'Бөтә бикләүҙәр яҙмалары журналы',
...
'allmessagesfilter'         => 'Хәбәрҙең исеме буйынса һайлау:',
'allmessagesmodified'       => 'Үҙгәртелгәндәрҙе генә күрһәтергә',
...
'lastmodifiedatby' => 'Был бит һуңғы тапҡыр $1 $2 $3 тарафынан үҙгәртелгән.', # $1 date, $2 time, $3 user
...
'markedaspatrolledtext'               => 'Һайланған өлгө тикшерелгән тип билдәләнгән.',
...
# Visual comparison
'visual-comparison' => 'Күрһәтмәле сағыштырыу',

# Media information
'imagemaxsize'         => 'Файлдың тасуирламаһы битендә рәсемдең ҙурлығын ошо кимәлгә тиклем сикләргә:',
...
'exif-orientation-1' => 'Ғәҙәти', # 0th row: top; 0th column: left
'exif-orientation-2' => 'X күсәре буйынса сағылдырылған', # 0th row: top; 0th column: right
'exif-orientation-3' => '180° әйләндерелгән', # 0th row: bottom; 0th column: right
'exif-orientation-4' => 'Y күсәре буйынса сағылдырылған', # 0th row: bottom; 0th column: left
'exif-orientation-5' => 'Сәғәт телдәренә ҡаршы 90° әйләндерелгән һәм Y күсәре буйынса сағылдырылған', # 0th row: left; 0th column: top
'exif-orientation-6' => 'Сәғәт телдәре буйынса 90° әйләндерелгән', # 0th row: right; 0th column: top
'exif-orientation-7' => 'Сәғәт телдәре буйынса 90° әйләндерелгән һәм Y күсәре буйынса сағылдырылған', # 0th row: right; 0th column: bottom
'exif-orientation-8' => 'Сәғәт телдәренә ҡаршы 90° әйләндерелгән', # 0th row: left; 0th column: bottom
...
# Special:Version
'version'                          => 'MediaWiki өлгөһө', # Not used as normal message but as header for the special page itself
