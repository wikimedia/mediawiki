...
'userrights-available-add'      => '倷可以把用戶加到{{PLURAL:$2|箇隻組|箇隻組}}：$1。',
'userrights-available-remove'   => '倷可以搦用戶從{{PLURAL:$2|箇隻組|箇集組}}開除：$1。',
...
'undeleterevdel'               => '要係最晏嗰修改拕刪卟，噉就扤得反刪除進行伓正。要係咁嗰話，倷就要反選到或反弆到最晏刪卟嗰修改。對於倷冇權限望嗰修改係恢復伓正嗰。',
