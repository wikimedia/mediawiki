...
'mainpagetext'      => "<span style="font-size:larger">'''MediaWiki мувафакъиетнен къурулды.'''</span>",
...
'nospecialpagetext' => "'''<span style="font-size:larger">Тапылмагъан бир махсус саифеге кирдинъиз.</span>'''
...
'blockedtext'                      => "<span style="font-size:larger">'''Эсабынъыз я да IP адресинъиз блок этильди.'''</span>
...
'timezoneuseoffset'             => 'Башкъа (фракъны бельгиленъиз)',
...
'fileexists-thumbnail-yes'    => "Бельки де бу файл бир кучюльген копиядыр (thumbnail). [[$1|thumb]]
...
'protect-expiry-options'      => '2 саат:2 hours,1 кунь:1 day,3 кунь:3 days,1 афта:1 week,2 афта:2 weeks,1 ай:1 month,3 ай:3 months,6 ай:6 months,1 йыл:1 year,муддетсиз:infinite',
...
'movepage-moved'          => "<span style="font-size:larger">'''«$1» саифесининъ ады «$2» оларакъ денъиштирильди'''</span>",
