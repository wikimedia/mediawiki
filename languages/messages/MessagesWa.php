...
'mainpagetext' => "<span style="font-size:larger">'''Li programe Wiki a stî astalé a l' idêye.'''</span>",
...
'undeletedpage'                => "<span style="font-size:larger">'''Li pådje $1 a stî rapexheye.'''
