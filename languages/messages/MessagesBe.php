...
'acct_creation_throttle_hit' => 'Вы ўжо маеце {{PLURAL:$1|1 рахунак|$1 рахункаў}}. Большая колькасць не дазваляецца.',
...
'statistics-users-active-desc' => 'Удзельнікі, якія хоць нешта зрабілі за месяц',
