...
'category-article-count'   => "{{PLURAL:$2|Nyns eus dhe'n class-ma saw an folen a-sew.|Yma'n {{PLURAL:$1|folen|$1 folennow}} a-sew y'n class-ma; yma $2 class yn sum.}}",
...
'remembermypassword'      => "Gwra remembra ow ger-tremena war'n amontyer-ma (rag ughboynt a $1 {{PLURAL:$1|dedh|dedh}})",
...
Why a ell [[Special:Search/{{PAGENAME}}|whila titel an folen-ma]] yn folennow erel,
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} whila y\'n covnotennow kelmys],
...
'searchresulttext'               => 'Rag derivadow pella war whilas yn {{SITENAME}}, gwra gweles [[{{MediaWiki:Helppage}}|{{int:help}}]].',
...
'searchall'                      => 'oll',
'nonefound'                      => "'''Noten''': Nyns yw saw rann a'n spasys-hanow whilys yn sqwir.
Gwra assaya dhe rag-gorra dha wovyn hen ''all:'' rag whila yn pub le (a-barth an folennow kescows, scantlyns, etc), po gwra usya an spas-hanow whensys avel rag-gorrans.",
...
Yth yw folennow eus war dha [[Special:Watchlist|rol golyas]] yn '''tew'''.",
...
'filehist-thumbtext'        => 'Skeusennik rag an versyon dhort $1',
...
'allpagesfrom'   => 'Disqwedhes an folennow ujy ow talleth orth:',
'allpagesto'     => 'Disqwedhes an folennow ujy ow tiwedha orth:',
...
'tooltip-rollback'                => 'Yma "restorya" ow trebuchya chanjyow gwres dhe\'n folen-ma gans an kens devnydhyor yn onen clyck',
