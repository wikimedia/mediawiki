...
'mainpagetext'      => "<span style="font-size:larger">'''Sztalowańy MediaWiki śe udoło.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Uoprogramowańy ńy rozpoznowo takij špecyjalnyj zajty.'''</span>
...
'blockedtext'                      => '<span style="font-size:larger">\'\'\'Twoje kůnto abo adres IP sům zawarte.\'\'\'</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''Wćepano nazod zajta $1.'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" přećiśńjynto ku "$2"\'\'\'</span>',
