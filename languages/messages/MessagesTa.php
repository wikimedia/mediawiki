...
'lastmodifiedat'    => 'இப்பக்கம் கடைசியாக $1, $2 மணிக்குத் திருத்தப்பட்டது.', # $1 date, $2 time
...
'deleted-notice'                   => 'இது ஒரு நீக்கப்பட்ட பக்கமாகும்.

தங்களின் வசதிக்காக இப்பக்கத்தின் நீக்கல் குறிப்புகள் கொடுக்கப்பட்டுள்ளது.',
...
'diff-height'             => 'உயரம்',
'diff-p'                  => "ஒரு '''பத்தி'''",
'diff-h1'                 => "ஒரு '''தலைப்பு (நிலை 1)'''",
'diff-h2'                 => "ஒரு '''தலைப்பு (நிலை 2)'''",
'diff-h3'                 => "ஒரு '''தலைப்பு (நிலை 3)'''",
'diff-h4'                 => "ஒரு '''தலைப்பு (நிலை 4)'''",
'diff-h5'                 => "ஒரு '''தலைப்பு (நிலை 5)'''",
'diff-tr'                 => "ஒரு '''கிடைவரி'''",
'diff-td'                 => "ஒரு '''சிறுபகுதி'''",
'diff-th'                 => "ஒரு '''தலைப்பு'''",
'diff-i'                  => "'''சாய்வெழுத்து'''",
'diff-big'                => "'''பெரியது'''",
...
'sharedupload'              => 'இக்கோப்பு $1 இல் இருநது, இதனை ஏனைய திட்டங்களிலும் பயன்படுத்தப்படலாம்.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
'shareduploadwiki'          => 'மேலதிகத் தகவல்களுக்கு $1 பக்கத்தைப் பார்க்கவும்.',
'shareduploadwiki-desc'     => '$1-ன் விவரங்கள் கீழே கொடுக்கப்பட்டிருக்கிறது.',
...
'shared-repo-from'          => '$1-ல் இருந்து', # $1 is the repository name
'shared-repo'               => 'பகிர்ந்து பயன்கொள் வைப்பகம்', # used when shared-repo-NAME does not exist
...
'editcomment'      => "தொகுப்பிற்கான சிறுகுறிப்புக்கள் இவை:\"''\$1''\".", # only shown if there is an edit comment
...
'protect-expiry-options'      => '1 மணி:1 hour,1 நாள்:1 day,1 வாரம்:1 week,2 வாரங்கள்:2 weeks,1 மாதம்:1 month,3 மாதங்கள்:3 months,6 மாதங்கள்:6 months,1 ஆண்டு:1 year,முடிவிலி:infinite', # display1:time1,display2:time2,...
...
'lastmodifiedatby' => 'இப்பக்கம் கடைசியாக $2, $1 அன்று $3 என்ற பயனரால் தொகுக்கப்பட்டது.', # $1 date, $2 time, $3 user
