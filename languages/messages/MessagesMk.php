...
'newmessagesdifflink'     => '{{PLURAL:$1|една промена|$1 промени}}',
...
'yourdiff'                         => 'Разлики',
'copyrightwarning'                 => "Имајте предвид дека сите придонеси кон {{SITENAME}} се смета дека се издадени под $2 (видете $1 за детали). 
