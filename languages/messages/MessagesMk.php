...
'badaccess-groups' => 'Акцијата што ја баравте е ограничена само на корисници во една од групите $1.',
...
'badsiglength'               => 'Потписот е премногу долг; мора да содржи помалку од $1 знаци.',
'email'                      => 'Е-пошта',
...
'emailauthenticated'         => 'Вашата е-поштенска адреса беше автентицирана на $1.',
...
# Oversight log
'oversightlog' => 'Дневник на надгледувања',
...
За преглед или пребарување на претходно подигнати податотеки погледнете ја [[Special:Imagelist|листата на подигнати податотеки]], подигнувања и бришења се ажурираат во [[Special:Log/upload|дневникот на подигнувања]]

За да вклучите податотека во страница, користете врска во форма
'''<nowiki>[[</nowiki>{{ns:image}}<nowiki>:File.jpg]]</nowiki>''',
'''<nowiki>[[</nowiki>{{ns:image}}<nowiki>:File.png|alt text]]</nowiki>''' или
'''<nowiki>[[</nowiki>{{ns:media}}<nowiki>:File.ogg]]</nowiki>''' за директна врска до податотека.",
...
'userstatstext'          => "Има вкупно {{PLURAL:$1|'''1''' регистриран [[Special:Listusers|корисник]]|'''$1''' регистрирани [[Special:Listusers|корисници]]}}, од кои '''$2''' (или '''$4%''') {{PLURAL:$2|има|имаат}} „$5“ кориснички права.",
...
'category-media-count'   => 'Има {{PLURAL:$1|една податотека|$1 податотеки}} во оваа категорија.',
