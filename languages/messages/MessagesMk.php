...
Последното барање од базата беше за:
<blockquote><tt>"$1"</tt></blockquote>
од функцијата "<tt>$2</tt>".
MySQL ја пријави следната грешка "<tt>$3: $4</tt>".',
'dberrortextcl'        => 'Грешка во пребарувањето на базата. 
Последното барање од базата беше за: 
"$1" 
од функцијата "$2". 
MySQL ја пријави следната грешка "$3: $4".',
...
'directorycreateerror' => 'Не можеше да се создаде директориумот „$1“.',
...
'titleprotected'       => "Овој наслов е заштитен од создавање од страна на [[User:$1|$1]].
Даденото образложение гласи ''$2''.",
...
'rev-deleted-text-permission' => "Оваа промена на страницата била '''избришана'''.
...
'rev-deleted-text-view'       => "Оваа промена на страницата била '''избришана'''.
...
'undeleteinvert'             => 'Обратно избирање',
...
'movepage-moved-noredirect'    => 'Создавањето на пренасочувања е исклучено.',
...
'confirmemail_pending'     => 'Веќе ви е испратен потврден кон по е-пошта;
доколку сметката сте создале скоро, пред да побарате нов код, треба да почекате неколку минути за да пристигне оваа порака.',
