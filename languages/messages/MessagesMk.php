...
'searchmenu-new'                   => "Креирај ја страницата ''[[:$1]]'' на ова вики!'''",
...
Соодветно пренасочување беше креирано.', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
'movepage-moved-noredirect'    => '<big>\'\'\'"$1" беше преместена во "$2"\'\'\'</big>

Креирањето на пренасочување е исклучено.', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
