...
'nosuchsectiontitle'               => 'Нема такво заглавие',
'nosuchsectiontext'                => 'Се обидовте да уредите заглавие која не постои. Бидејќи не постои заглавие $1, нема каде да се зачуваат вашите уредувања.',
...
'prefs-help-watchlist-token'    => 'Со внесување на тајниот клуч во полево ќе се создаде RSS емитување за вашата листа на набљудувања.
