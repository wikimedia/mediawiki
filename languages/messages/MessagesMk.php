...
'loginpagetitle'             => 'Најава на корисник',
...
'diff-src'                => 'извор',
'diff-withdestination'    => 'со одредницата $1',
'diff-with'               => '&#32;со $1 $2',
...
'diff-code'               => "'''блок од сметачки код'''",
...
'movepage-moved'               => "'''„$1“ е преместена под името „$2“'''", # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
...
'exif-orientation-2' => 'Пресликано по хоризонтала', # 0th row: top; 0th column: right
'exif-orientation-3' => 'Свртено за 180°', # 0th row: bottom; 0th column: right
'exif-orientation-4' => 'Пресликано по вертикала', # 0th row: bottom; 0th column: left
'exif-orientation-5' => 'Свртено за 90° влево и пресликано по вертикала', # 0th row: left; 0th column: top
'exif-orientation-6' => 'Свртено за 90° вдесно', # 0th row: right; 0th column: top
'exif-orientation-7' => 'Свртено за 90° вдесно и преликано по вертикала', # 0th row: right; 0th column: bottom
'exif-orientation-8' => 'Свртено за 90° влево', # 0th row: left; 0th column: bottom
