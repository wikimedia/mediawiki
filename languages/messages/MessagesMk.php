...
Администраторот што го заклучи го понуди следново образложение: „$3“.',
...
Исто така потврдувате дека текстот сте го напишале сами, или сте го копирале од јавен домен или сличен слободен извор (видетe $1 за подробности).<br />
