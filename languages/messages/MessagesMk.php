...
'mainpagetext'      => "<span style="font-size:larger">'''Успешно инсталирање на MediaWiki.'''</span>",
...
'blockedtext'                      => "<span style="font-size:larger">'''Вашето корисничко име или IP адреса се блокирани.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 беше обновена'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" беше преместена во "$2"\'\'\'</span>',
