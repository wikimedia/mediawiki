...
'rev-deleted-text-permission'    => "Ревизија на оваа страница е '''избришана од јавните архиви'''.
Можеби има детали во [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} дневникот на бришења].",
'rev-deleted-text-view'          => "Ревизија на оваа страница беше '''избришана од јавните архиви'''.
...
'rev-deleted-unhide-diff'        => "Една од ревизиите на оваа разлика била '''тргната од јавните архиви'''.
Можеби има детали во [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} дневникот на бришења].
Како администратор вие можете [$1 да ја видите оваа разлика] ако сакате да продолжите.",
...
'sp-contributions-userrights'    => 'Управување со кориснички права',
...
'metadata-help'     => 'Оваа датотека содржи дополнителни информации, најверојатно додадени од дигитална камера или скенер користени за нејзино создавање или дигитализација. Ако при тоа датотеката претрпела промени, некои детали може да не соодветствуваат во целост после промената на датотеката.',
