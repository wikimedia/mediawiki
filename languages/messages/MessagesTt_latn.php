...
'hidden-category-category'       => 'Yäşeren törkemnär', # Name of the category where hidden categories will be listed
...
'lastmodifiedat'    => 'Bu bitne soñğı üzgärtü: $2, $1.', # $1 date, $2 time
...
# User rights
'userrights'                     => 'Qullanuçı xoquqları belän idarä itü', # Not used as normal message but as header for the special page itself
...
'sharedupload'              => "Bu fayl $1'dan häm başqa proyektlarda qullanırğa mömkin.", # $1 is the repo name, $2 is shareduploadwiki(-desc)
'uploadnewversion-linktext' => 'Bu faylnıñ yaña yuramasın yökläw',
'shared-repo-from'          => '$1 dän', # $1 is the repository name
...
'editcomment'    => "Üzgärtü öçen taswir: \"''\$1''\".", # only shown if there is an edit comment
'revertpage'     => '[[Special:Contributions/$2|$2]] üzgärtüläre ([[User talk:$2|bäxäs]])  [[User:$1|$1]] yuramasına kire qaytarıldı', # Additionally available: $3: revid of the revision reverted to, $4: timestamp of the revision reverted to, $5: revid of the revision reverted from, $6: timestamp of the revision reverted from
...
'protect-expiry-options'      => '1 säğät:1 hour,1 kön:1 day,1 atna:1 week,2 atna:2 weeks,1 ay:1 month,3 ay:3 months,6 ay:6 months,1 yıl:1 year,waqıtsız:infinite', # display1:time1,display2:time2,...
...
'ipboptions'                 => '2 säğät:2 hours,1 kön:1 day,3 kön:3 days,1 atna:1 week,2 atna:2 weeks,1 ay:1 month,3ay:3 months,6 ay:6 months,1 yıl:1 year,çiklänmägän:infinite', # display1:time1,display2:time2,...
...
'movepage-moved'            => "'''«$1» bite «$2» bitenä küçerelde'''", # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
