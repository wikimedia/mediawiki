...
$magicWords = array(
	'redirect'              => array( '0', '#تحويل', '#تحويل', '#تحويل', '#REDIRECT' ),
	'notoc'                 => array( '0', '__لافهرس__', '__لافهرس__', '__لافهرس__', '__NOTOC__' ),
	'nogallery'             => array( '0', '__لامعرض__', '__لامعرض__', '__لامعرض__', '__NOGALLERY__' ),
	'forcetoc'              => array( '0', '__لصق_فهرس__', '__لصق_فهرس__', '__لصق_فهرس__', '__FORCETOC__' ),
	'toc'                   => array( '0', '__فهرس__', '__فهرس__', '__فهرس__', '__TOC__' ),
	'noeditsection'         => array( '0', '__لاتحريرقسم__', '__لاتحريرقسم__', '__لاتحريرقسم__', '__NOEDITSECTION__' ),
	'noheader'              => array( '0', '__لاعنوان__', '__لاعنوان__', '__لاعنوان__', '__NOHEADER__' ),
	'currentmonth'          => array( '1', 'شهر_حالى', 'شهر', 'شهر_حالي', 'شهر', 'شهر_حالي', 'شهر', 'CURRENTMONTH' ),
	'currentmonthname'      => array( '1', 'اسم_الشهر_الحالى', 'اسم_شهر_حالى', 'اسم_شهر', 'اسم_الشهر_الحالي', 'اسم_شهر_حالي', 'اسم_شهر', 'اسم_الشهر_الحالي', 'اسم_شهر_حالي', 'اسم_شهر', 'CURRENTMONTHNAME' ),
	'currentmonthnamegen'   => array( '1', 'اسم_الشهر_الحالى_المولد', 'اسم_شهر_حالى_مولد', 'اسم_الشهر_الحالي_المولد', 'اسم_شهر_حالي_مولد', 'اسم_الشهر_الحالي_المولد', 'اسم_شهر_حالي_مولد', 'CURRENTMONTHNAMEGEN' ),
	'currentmonthabbrev'    => array( '1', 'اختصار_الشهر_الحالى', 'اختصار_شهر_حالى', 'اختصار_الشهر_الحالي', 'اختصار_شهر_حالي', 'اختصار_الشهر_الحالي', 'اختصار_شهر_حالي', 'CURRENTMONTHABBREV' ),
	'currentday'            => array( '1', 'يوم_حالى', 'يوم', 'يوم_حالي', 'يوم', 'يوم_حالي', 'يوم', 'CURRENTDAY' ),
	'currentday2'           => array( '1', 'يوم_حالى2', 'يوم2', 'يوم_حالي2', 'يوم2', 'يوم_حالي2', 'يوم2', 'CURRENTDAY2' ),
	'currentdayname'        => array( '1', 'اسم_اليوم_الحالى', 'اسم_يوم_حالى', 'اسم_يوم', 'اسم_اليوم_الحالي', 'اسم_يوم_حالي', 'اسم_يوم', 'اسم_اليوم_الحالي', 'اسم_يوم_حالي', 'اسم_يوم', 'CURRENTDAYNAME' ),
	'currentyear'           => array( '1', 'عام_حالى', 'عام', 'عام_حالي', 'عام', 'عام_حالي', 'عام', 'CURRENTYEAR' ),
	'currenttime'           => array( '1', 'وقت_حالى', 'وقت', 'وقت_حالي', 'وقت', 'وقت_حالي', 'وقت', 'CURRENTTIME' ),
	'currenthour'           => array( '1', 'ساعة_حالية', 'ساعة', 'ساعة_حالية', 'ساعة', 'ساعة_حالية', 'ساعة', 'CURRENTHOUR' ),
	'localmonth'            => array( '1', 'شهر_محلى', 'شهر_محلي', 'شهر_محلي', 'LOCALMONTH' ),
	'localmonthname'        => array( '1', 'اسم_الشهر_المحلى', 'اسم_شهر_محلى', 'اسم_الشهر_المحلي', 'اسم_شهر_محلي', 'اسم_الشهر_المحلي', 'اسم_شهر_محلي', 'LOCALMONTHNAME' ),
	'localmonthnamegen'     => array( '1', 'اسم_الشهر_المحلى_المولد', 'اسم_شهر_محلى_مولد', 'اسم_الشهر_المحلي_المولد', 'اسم_شهر_محلي_مولد', 'اسم_الشهر_المحلي_المولد', 'اسم_شهر_محلي_مولد', 'LOCALMONTHNAMEGEN' ),
	'localmonthabbrev'      => array( '1', 'اختصار_الشهر_المحلى', 'اختصار_شهر_محلى', 'اختصار_الشهر_المحلي', 'اختصار_شهر_محلي', 'اختصار_الشهر_المحلي', 'اختصار_شهر_محلي', 'LOCALMONTHABBREV' ),
	'localday'              => array( '1', 'يوم_محلى', 'يوم_محلي', 'يوم_محلي', 'LOCALDAY' ),
	'localday2'             => array( '1', 'يوم_محلى2', 'يوم_محلي2', 'يوم_محلي2', 'LOCALDAY2' ),
	'localdayname'          => array( '1', 'اسم_اليوم_المحلى', 'اسم_يوم_محلى', 'اسم_اليوم_المحلي', 'اسم_يوم_محلي', 'اسم_اليوم_المحلي', 'اسم_يوم_محلي', 'LOCALDAYNAME' ),
	'localyear'             => array( '1', 'عام_محلى', 'عام_محلي', 'عام_محلي', 'LOCALYEAR' ),
	'localtime'             => array( '1', 'وقت_محلى', 'وقت_محلي', 'وقت_محلي', 'LOCALTIME' ),
	'localhour'             => array( '1', 'ساعة_محلية', 'ساعة_محلية', 'ساعة_محلية', 'LOCALHOUR' ),
	'numberofpages'         => array( '1', 'عدد_الصفحات', 'عدد_صفحات', 'عدد_الصفحات', 'عدد_صفحات', 'عدد_الصفحات', 'عدد_صفحات', 'NUMBEROFPAGES' ),
	'numberofarticles'      => array( '1', 'عدد_المقالات', 'عدد_مقالات', 'عدد_المقالات', 'عدد_مقالات', 'عدد_المقالات', 'عدد_مقالات', 'NUMBEROFARTICLES' ),
	'numberoffiles'         => array( '1', 'عدد_الملفات', 'عدد_ملفات', 'عدد_الملفات', 'عدد_ملفات', 'عدد_الملفات', 'عدد_ملفات', 'NUMBEROFFILES' ),
	'numberofusers'         => array( '1', 'عدد_المستخدمين', 'عدد_مستخدمين', 'عدد_المستخدمين', 'عدد_مستخدمين', 'عدد_المستخدمين', 'عدد_مستخدمين', 'NUMBEROFUSERS' ),
	'numberofactiveusers'   => array( '1', 'مستخدمون_نشطون', 'عدد_المستخدمين_النشطين', 'عدد_مستخدمين_نشطين', 'NUMBEROFACTIVEUSERS' ),
	'numberofedits'         => array( '1', 'عدد_التعديلات', 'عدد_تعديلات', 'عدد_التعديلات', 'عدد_تعديلات', 'عدد_التعديلات', 'عدد_تعديلات', 'NUMBEROFEDITS' ),
	'numberofviews'         => array( '1', 'عدد_المشاهدات', 'عدد_مشاهدات', 'عدد_المشاهدات', 'عدد_مشاهدات', 'عدد_المشاهدات', 'عدد_مشاهدات', 'NUMBEROFVIEWS' ),
	'pagename'              => array( '1', 'اسم_الصفحة', 'اسم_صفحة', 'اسم_الصفحة', 'اسم_صفحة', 'اسم_الصفحة', 'اسم_صفحة', 'PAGENAME' ),
	'pagenamee'             => array( '1', 'عنوان_الصفحة', 'عنوان_صفحة', 'عنوان_الصفحة', 'عنوان_صفحة', 'عنوان_الصفحة', 'عنوان_صفحة', 'PAGENAMEE' ),
	'namespace'             => array( '1', 'نطاق', 'نطاق', 'نطاق', 'NAMESPACE' ),
	'namespacee'            => array( '1', 'عنوان_نطاق', 'عنوان_نطاق', 'عنوان_نطاق', 'NAMESPACEE' ),
	'talkspace'             => array( '1', 'نطاق_النقاش', 'نطاق_نقاش', 'نطاق_النقاش', 'نطاق_نقاش', 'نطاق_النقاش', 'نطاق_نقاش', 'TALKSPACE' ),
	'talkspacee'            => array( '1', 'عنوان_النقاش', 'عنوان_نقاش', 'عنوان_النقاش', 'عنوان_نقاش', 'عنوان_النقاش', 'عنوان_نقاش', 'TALKSPACEE' ),
	'subjectspace'          => array( '1', 'نطاق_الموضوع', 'نطاق_المقالة', 'نطاق_الموضوع', 'نطاق_المقالة', 'نطاق_الموضوع', 'نطاق_المقالة', 'SUBJECTSPACE', 'ARTICLESPACE' ),
	'subjectspacee'         => array( '1', 'عنوان_نطاق_الموضوع', 'عنوان_نطاق_المقالة', 'عنوان_نطاق_الموضوع', 'عنوان_نطاق_المقالة', 'عنوان_نطاق_الموضوع', 'عنوان_نطاق_المقالة', 'SUBJECTSPACEE', 'ARTICLESPACEE' ),
	'fullpagename'          => array( '1', 'اسم_الصفحة_الكامل', 'اسم_صفحة_كامل', 'اسم_كامل', 'اسم_الصفحة_الكامل', 'اسم_صفحة_كامل', 'اسم_كامل', 'اسم_الصفحة_الكامل', 'اسم_صفحة_كامل', 'اسم_كامل', 'FULLPAGENAME' ),
	'fullpagenamee'         => array( '1', 'عنوان_الصفحة_الكامل', 'عنوان_صفحة_كامل', 'عنوان_كامل', 'عنوان_الصفحة_الكامل', 'عنوان_صفحة_كامل', 'عنوان_كامل', 'عنوان_الصفحة_الكامل', 'عنوان_صفحة_كامل', 'عنوان_كامل', 'FULLPAGENAMEE' ),
	'subpagename'           => array( '1', 'اسم_الصفحة_الفرعي', 'اسم_صفحة_فرعي', 'اسم_الصفحة_الفرعي', 'اسم_صفحة_فرعي', 'اسم_الصفحة_الفرعي', 'اسم_صفحة_فرعي', 'SUBPAGENAME' ),
	'subpagenamee'          => array( '1', 'عنوان_الصفحة_الفرعى', 'عنوان_صفحة_فرعى', 'عنوان_الصفحة_الفرعي', 'عنوان_صفحة_فرعي', 'عنوان_الصفحة_الفرعي', 'عنوان_صفحة_فرعي', 'SUBPAGENAMEE' ),
	'basepagename'          => array( '1', 'اسم_الصفحة_الأساسى', 'اسم_صفحة_أساسى', 'اسم_الصفحة_الأساسي', 'اسم_صفحة_أساسي', 'اسم_الصفحة_الأساسي', 'اسم_صفحة_أساسي', 'BASEPAGENAME' ),
	'basepagenamee'         => array( '1', 'عنوان_الصفحة_الأساسى', 'عنوان_صفحة_أساسى', 'عنوان_الصفحة_الأساسي', 'عنوان_صفحة_أساسي', 'عنوان_الصفحة_الأساسي', 'عنوان_صفحة_أساسي', 'BASEPAGENAMEE' ),
	'talkpagename'          => array( '1', 'اسم_صفحة_النقاش', 'اسم_صفحة_نقاش', 'اسم_صفحة_النقاش', 'اسم_صفحة_نقاش', 'اسم_صفحة_النقاش', 'اسم_صفحة_نقاش', 'TALKPAGENAME' ),
	'talkpagenamee'         => array( '1', 'عنوان_صفحة_النقاش', 'عنوان_صفحة_نقاش', 'عنوان_صفحة_النقاش', 'عنوان_صفحة_نقاش', 'عنوان_صفحة_النقاش', 'عنوان_صفحة_نقاش', 'TALKPAGENAMEE' ),
	'subjectpagename'       => array( '1', 'اسم_صفحة_الموضوع', 'اسم_صفحة_المقالة', 'اسم_صفحة_الموضوع', 'اسم_صفحة_المقالة', 'اسم_صفحة_الموضوع', 'اسم_صفحة_المقالة', 'SUBJECTPAGENAME', 'ARTICLEPAGENAME' ),
	'subjectpagenamee'      => array( '1', 'عنوان_صفحة_الموضوع', 'عنوان_صفحة_المقالة', 'عنوان_صفحة_الموضوع', 'عنوان_صفحة_المقالة', 'عنوان_صفحة_الموضوع', 'عنوان_صفحة_المقالة', 'SUBJECTPAGENAMEE', 'ARTICLEPAGENAMEE' ),
	'msg'                   => array( '0', 'رسالة:', 'رسالة:', 'رسالة:', 'MSG:' ),
	'subst'                 => array( '0', 'نسخ:', 'إحلال:', 'نسخ:', 'إحلال:', 'نسخ:', 'إحلال:', 'SUBST:' ),
	'msgnw'                 => array( '0', 'مصدر:', 'مصدر_قالب:', 'مصدر:', 'مصدر_قالب:', 'مصدر:', 'مصدر_قالب:', 'MSGNW:' ),
	'img_thumbnail'         => array( '1', 'تصغير', 'تصغير', 'تصغير', 'thumbnail', 'thumb' ),
	'img_manualthumb'       => array( '1', 'تصغير=$1', 'تصغير=$1', 'تصغير=$1', 'thumbnail=$1', 'thumb=$1' ),
	'img_right'             => array( '1', 'يمين', 'يمين', 'يمين', 'right' ),
	'img_left'              => array( '1', 'يسار', 'يسار', 'يسار', 'left' ),
	'img_none'              => array( '1', 'بدون', 'بلا', 'بدون', 'بلا', 'بدون', 'بلا', 'none' ),
	'img_width'             => array( '1', '$1بك', '$1بك', '$1عن', '$1بك', '$1عن', '$1px' ),
	'img_center'            => array( '1', 'مركز', 'مركز', 'مركز', 'center', 'centre' ),
	'img_framed'            => array( '1', 'إطار', 'إطار', 'إطار', 'framed', 'enframed', 'frame' ),
	'img_frameless'         => array( '1', 'لاإطار', 'لاإطار', 'لاإطار', 'frameless' ),
	'img_page'              => array( '1', 'صفحة=$1', 'صفحة $1', 'صفحة=$1', 'صفحة $1', 'صفحة=$1', 'صفحة $1', 'page=$1', 'page $1' ),
	'img_upright'           => array( '1', 'معدول', 'معدول=$1', 'معدول $1', 'معدول', 'معدول=$1', 'معدول $1', 'معدول', 'معدول=$1', 'معدول $1', 'upright', 'upright=$1', 'upright $1' ),
	'img_border'            => array( '1', 'حد', 'حدود', 'حد', 'حدود', 'حد', 'حدود', 'border' ),
	'img_baseline'          => array( '1', 'خط_أساسى', 'خط_أساسي', 'خط_أساسي', 'baseline' ),
	'img_sub'               => array( '1', 'فرعى', 'فرعي', 'فرعي', 'sub' ),
	'img_super'             => array( '1', 'سوبر', 'سب', 'سوبر', 'سب', 'سوبر', 'سب', 'super', 'sup' ),
	'img_top'               => array( '1', 'أعلى', 'أعلى', 'أعلى', 'top' ),
	'img_text_top'          => array( '1', 'نص_أعلى', 'نص_أعلى', 'نص_أعلى', 'text-top' ),
	'img_middle'            => array( '1', 'وسط', 'وسط', 'وسط', 'middle' ),
	'img_bottom'            => array( '1', 'أسفل', 'أسفل', 'أسفل', 'bottom' ),
	'img_text_bottom'       => array( '1', 'نص_أسفل', 'نص_أسفل', 'نص_أسفل', 'text-bottom' ),
	'img_link'              => array( '1', 'وصلة=$1', 'رابط=$1', 'وصلة=$1', 'رابط=$1', 'وصلة=$1', 'رابط=$1', 'link=$1' ),
	'img_alt'               => array( '1', 'بديل=$1', 'بديل=$1', 'بديل=$1', 'alt=$1' ),
	'int'                   => array( '0', 'محتوى:', 'محتوى:', 'محتوى:', 'INT:' ),
	'sitename'              => array( '1', 'اسم_الموقع', 'اسم_موقع', 'اسم_الموقع', 'اسم_موقع', 'اسم_الموقع', 'اسم_موقع', 'SITENAME' ),
	'ns'                    => array( '0', 'نط:', 'نط:', 'نط:', 'NS:' ),
	'localurl'              => array( '0', 'مسار_محلى:', 'مسار_محلي:', 'مسار_محلي:', 'LOCALURL:' ),
	'localurle'             => array( '0', 'عنوان_المسار_المحلى:', 'عنوان_مسار_محلى:', 'عنوان_المسار_المحلي:', 'عنوان_مسار_محلي:', 'عنوان_المسار_المحلي:', 'عنوان_مسار_محلي:', 'LOCALURLE:' ),
	'server'                => array( '0', 'خادم', 'خادم', 'خادم', 'SERVER' ),
	'servername'            => array( '0', 'اسم_الخادم', 'اسم_خادم', 'اسم_الخادم', 'اسم_خادم', 'اسم_الخادم', 'اسم_خادم', 'SERVERNAME' ),
	'scriptpath'            => array( '0', 'مسار_السكريبت', 'مسار_سكريبت', 'مسار_السكريبت', 'مسار_سكريبت', 'مسار_السكريبت', 'مسار_سكريبت', 'SCRIPTPATH' ),
	'grammar'               => array( '0', 'قواعد_اللغة:', 'قواعد_لغة:', 'قواعد_اللغة:', 'قواعد_لغة:', 'قواعد_اللغة:', 'قواعد_لغة:', 'GRAMMAR:' ),
	'notitleconvert'        => array( '0', '__لاتحويل_عنوان__', '__لاتع__', '__لاتحويل_عنوان__', '__لاتع__', '__لاتحويل_عنوان__', '__لاتع__', '__NOTITLECONVERT__', '__NOTC__' ),
	'nocontentconvert'      => array( '0', '__لاتحويل_محتوى__', '__لاتم__', '__لاتحويل_محتوى__', '__لاتم__', '__لاتحويل_محتوى__', '__لاتم__', '__NOCONTENTCONVERT__', '__NOCC__' ),
	'currentweek'           => array( '1', 'أسبوع_حالى', 'أسبوع', 'أسبوع_حالي', 'أسبوع', 'أسبوع_حالي', 'أسبوع', 'CURRENTWEEK' ),
	'currentdow'            => array( '1', 'يوم_حالى_مأ', 'يوم_حالي_مأ', 'يوم_حالي_مأ', 'CURRENTDOW' ),
	'localweek'             => array( '1', 'أسبوع_محلى', 'أسبوع_محلي', 'أسبوع_محلي', 'LOCALWEEK' ),
	'localdow'              => array( '1', 'يوم_محلى_مأ', 'يوم_محلي_مأ', 'يوم_محلي_مأ', 'LOCALDOW' ),
	'revisionid'            => array( '1', 'رقم_النسخة', 'رقم_نسخة', 'رقم_النسخة', 'رقم_نسخة', 'رقم_النسخة', 'رقم_نسخة', 'REVISIONID' ),
	'revisionday'           => array( '1', 'يوم_النسخة', 'يوم_نسخة', 'يوم_النسخة', 'يوم_نسخة', 'يوم_النسخة', 'يوم_نسخة', 'REVISIONDAY' ),
	'revisionday2'          => array( '1', 'يوم_النسخة2', 'يوم_نسخة2', 'يوم_النسخة2', 'يوم_نسخة2', 'يوم_النسخة2', 'يوم_نسخة2', 'REVISIONDAY2' ),
	'revisionmonth'         => array( '1', 'شهر_النسخة', 'شهر_نسخة', 'شهر_النسخة', 'شهر_نسخة', 'شهر_النسخة', 'شهر_نسخة', 'REVISIONMONTH' ),
	'revisionyear'          => array( '1', 'عام_النسخة', 'عام_نسخة', 'عام_النسخة', 'عام_نسخة', 'عام_النسخة', 'عام_نسخة', 'REVISIONYEAR' ),
	'revisiontimestamp'     => array( '1', 'طابع_وقت_النسخة', 'طابع_وقت_نسخة', 'طابع_وقت_النسخة', 'طابع_وقت_نسخة', 'طابع_وقت_النسخة', 'طابع_وقت_نسخة', 'REVISIONTIMESTAMP' ),
	'plural'                => array( '0', 'جمع:', 'جمع:', 'جمع:', 'PLURAL:' ),
	'fullurl'               => array( '0', 'عنوان_كامل:', 'عنوان_كامل:', 'عنوان_كامل:', 'FULLURL:' ),
	'fullurle'              => array( '0', 'مسار_كامل:', 'مسار_كامل:', 'مسار_كامل:', 'FULLURLE:' ),
	'lcfirst'               => array( '0', 'عنوان_كبير:', 'عنوان_كبير:', 'عنوان_كبير:', 'LCFIRST:' ),
	'ucfirst'               => array( '0', 'عنوان_صغير:', 'عنوان_صغير:', 'عنوان_صغير:', 'UCFIRST:' ),
	'lc'                    => array( '0', 'صغير:', 'صغير:', 'صغير:', 'LC:' ),
	'uc'                    => array( '0', 'كبير:', 'كبير:', 'كبير:', 'UC:' ),
	'raw'                   => array( '0', 'خام:', 'خام:', 'خام:', 'RAW:' ),
	'displaytitle'          => array( '1', 'عرض_العنوان', 'عرض_عنوان', 'عرض_العنوان', 'عرض_عنوان', 'عرض_العنوان', 'عرض_عنوان', 'DISPLAYTITLE' ),
	'rawsuffix'             => array( '1', 'أر', 'آر', 'أر', 'آر', 'أر', 'آر', 'R' ),
	'newsectionlink'        => array( '1', '__وصلة_قسم_جديد__', '__وصلة_قسم_جديد__', '__وصلة_قسم_جديد__', '__NEWSECTIONLINK__' ),
	'currentversion'        => array( '1', 'نسخة_حالية', 'نسخة_حالية', 'نسخة_حالية', 'CURRENTVERSION' ),
	'urlencode'             => array( '0', 'كود_المسار:', 'كود_مسار:', 'كود_المسار:', 'كود_مسار:', 'كود_المسار:', 'كود_مسار:', 'URLENCODE:' ),
	'anchorencode'          => array( '0', 'كود_الأنكور', 'كود_أنكور', 'كود_الأنكور', 'كود_أنكور', 'كود_الأنكور', 'كود_أنكور', 'ANCHORENCODE' ),
	'currenttimestamp'      => array( '1', 'طابع_الوقت_الحالي', 'طابع_وقت_حالي', 'طابع_الوقت_الحالي', 'طابع_وقت_حالي', 'طابع_الوقت_الحالي', 'طابع_وقت_حالي', 'CURRENTTIMESTAMP' ),
	'localtimestamp'        => array( '1', 'طابع_الوقت_المحلى', 'طابع_وقت_محلى', 'طابع_الوقت_المحلي', 'طابع_وقت_محلي', 'طابع_الوقت_المحلي', 'طابع_وقت_محلي', 'LOCALTIMESTAMP' ),
	'directionmark'         => array( '1', 'علامة_الاتجاه', 'علامة_اتجاه', 'علامة_الاتجاه', 'علامة_اتجاه', 'علامة_الاتجاه', 'علامة_اتجاه', 'DIRECTIONMARK', 'DIRMARK' ),
	'language'              => array( '0', '#لغة:', '#لغة:', '#لغة:', '#LANGUAGE:' ),
	'contentlanguage'       => array( '1', 'لغة_المحتوى', 'لغة_محتوى', 'لغة_المحتوى', 'لغة_محتوى', 'لغة_المحتوى', 'لغة_محتوى', 'CONTENTLANGUAGE', 'CONTENTLANG' ),
	'pagesinnamespace'      => array( '1', 'صفحات_فى_نطاق:', 'صفحات_فى_نط:', 'صفحات_في_نطاق:', 'صفحات_في_نط:', 'صفحات_في_نطاق:', 'صفحات_في_نط:', 'PAGESINNAMESPACE:', 'PAGESINNS:' ),
	'numberofadmins'        => array( '1', 'عدد_الإداريين', 'عدد_إداريين', 'عدد_الإداريين', 'عدد_إداريين', 'عدد_الإداريين', 'عدد_إداريين', 'NUMBEROFADMINS' ),
	'formatnum'             => array( '0', 'صيغة_رقم', 'صيغة_رقم', 'صيغة_رقم', 'FORMATNUM' ),
	'padleft'               => array( '0', 'باد_يسار', 'باد_يسار', 'باد_يسار', 'PADLEFT' ),
	'padright'              => array( '0', 'باد_يمين', 'باد_يمين', 'باد_يمين', 'PADRIGHT' ),
	'special'               => array( '0', 'خاص', 'خاص', 'خاص', 'special' ),
	'defaultsort'           => array( '1', 'ترتيب_قياسى:', 'ترتيب_افتراضى:', 'مفتاح_ترتيب_قياسى:', 'مفتاح_ترتيب_افتراضى:', 'ترتيب_تصنيف_قياسى:', 'ترتيب_تصنيف_افتراضى:', 'ترتيب_قياسي:', 'ترتيب_افتراضي:', 'مفتاح_ترتيب_قياسي:', 'مفتاح_ترتيب_افتراضي:', 'ترتيب_تصنيف_قياسي:', 'ترتيب_تصنيف_افتراضي:', 'ترتيب_قياسي:', 'ترتيب_افتراضي:', 'مفتاح_ترتيب_قياسي:', 'مفتاح_ترتيب_افتراضي:', 'ترتيب_تصنيف_قياسي:', 'ترتيب_تصنيف_افتراضي:', 'DEFAULTSORT:', 'DEFAULTSORTKEY:', 'DEFAULTCATEGORYSORT:' ),
	'filepath'              => array( '0', 'مسار_الملف:', 'مسار_ملف:', 'مسار_الملف:', 'مسار_ملف:', 'مسار_الملف:', 'مسار_ملف:', 'FILEPATH:' ),
	'tag'                   => array( '0', 'وسم', 'وسم', 'وسم', 'tag' ),
	'hiddencat'             => array( '1', '__تصنيف_مخفى__', '__تصنيف_مخفي__', '__تصنيف_مخفي__', '__HIDDENCAT__' ),
	'pagesincategory'       => array( '1', 'صفحات_فى_التصنيف', 'صفحات في التصنيف', 'صفحات في التصنيف', 'PAGESINCATEGORY', 'PAGESINCAT' ),
	'pagesize'              => array( '1', 'حجم_الصفحة', 'حجم_صفحة', 'حجم_الصفحة', 'حجم_صفحة', 'حجم_الصفحة', 'حجم_صفحة', 'PAGESIZE' ),
	'index'                 => array( '1', '__فهرسة__', '__فهرسة__', '__فهرسة__', '__INDEX__' ),
	'noindex'               => array( '1', '__لافهرسة__', '__لافهرسة__', '__لافهرسة__', '__NOINDEX__' ),
	'numberingroup'         => array( '1', 'عدد_فى_المجموعة', 'عدد_فى_مجموعة', 'عدد_في_المجموعة', 'عدد_في_مجموعة', 'عدد_في_المجموعة', 'عدد_في_مجموعة', 'NUMBERINGROUP', 'NUMINGROUP' ),
	'staticredirect'        => array( '1', '__تحويلة_إستاتيكية__', '__تحويلة_ساكنة__', '__تحويلة_إستاتيكية__', '__تحويلة_ساكنة__', '__تحويلة_إستاتيكية__', '__تحويلة_ساكنة__', '__STATICREDIRECT__' ),
	'protectionlevel'       => array( '1', 'مستوى_الحماية', 'مستوى_حماية', 'مستوى_الحماية', 'مستوى_حماية', 'PROTECTIONLEVEL' ),
);
...
'sp-contributions-userrights'    => 'إدارة الحقوق بتاعة اليوزر',
