...
'category-subcat-count'          => '{{PLURAL:$2| التصنيف دا فيه  التصنيف الفرعى الجاى بس.|التصنيف دا فيه {{PLURAL:$1|تصنيف فرعي|$1 تصنيف فرعي}}، من إجمالى $2.}}',
...
'category-article-count-limited' => 'تحت {{PLURAL:$1|صفحة|$1 صفحة}} فى التصنيف الحالي.',
'category-file-count'            => '{{PLURAL:$2| التصنيف دا  فيه الملف الجاى دا بس.|تحت {{PLURAL:$1|ملف|$1 ملف}} فى  التصنيف دا، من إجمالى $2.}}',
'category-file-count-limited'    => 'تحت {{PLURAL:$1|ملف|$1 ملف}} فى التصنيف الحالي.',
...
* [http://www.mediawiki.org/wiki/Manual:FAQ أسئلة بتكرر حوالين الويكى ميديا]
* [http://lists.wikimedia.org/mailman/listinfo/mediawiki-announce لستة الايميلات بتاعة اعلانات الويكى ميديا]',
...
'noconnect'            => 'متأسفين،الويكى  عندها شوية مشاكل فنية و مش قادرة توصل ب سيرفر الداتابيز. <br />
$1',
