...
$magicWords = array(
	...
	'numberingroup'         => array( '1', 'عدد_فى_المجموعة', 'عدد_فى_مجموعة', 'NUMBERINGROUP', 'NUMINGROUP' ),
...
'tog-watchlisthideliu'        => 'خبي التعديلات بتاعة اليوزرز المتسجل دخولهم دلوقتى من لستة المراقبة',
...
'filedelete-success-old'      => "نسخة الـ'''[[Media:$1|$1]]''' اللي بتاريخ $3، $2 اتمسحت.",
...
'allpagesto'        => 'اعرض الصفحات اللي بتنتهي عند:',
...
'tooltip-rollback'                => '"رول باك" بترجع التعديل (التعديلات)  في  الصفحة دي للمساهم الأخير بدوسة واحدة.',
'tooltip-undo'                    => '"رجوع" بترجع  التعديل دا وبتفتح استمارة التعديل في شكل البروفة. بتسمح بإضافة سبب في الملخص.',
