...
'revertpage'       => '已恢复[[Special:Contributions/$2|$2]]（[[User talk:$2|讨论]]）的编辑至[[User:$1|$1]]的最后一个修订版本', # Additionally available: $3: revid of the revision reverted to, $4: timestamp of the revision reverted to, $5: revid of the revision reverted from, $6: timestamp of the revision reverted from
...
'movepagebtn'                  => '移动页面',
'pagemovedsub'                 => '移动成功',
'movepage-moved'               => "'''“$1”已移动到“$2”'''", # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
