...
# Suppression log
'suppressionlog'     => '废止日志',
'suppressionlogtext' => '以下是最近删除以及由操作员牵涉到内容封锁的列表。参看[[Special:Ipblocklist|IP封锁名单]]去参看现时进行中的禁止以及封锁之名单。',
