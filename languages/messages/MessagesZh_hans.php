...
$specialPageAliases = array(
	...
	'FileDuplicateSearch'       => array( '选择重覆文件' ),
...
'tog-usenewrc'                => '使用增强最近更改 (JavaScript)',
...
'move-talk-subpages'           => '移动子对话页面（上至$1页）',
...
'imagemaxsize'         => "图像大小限制:<br />''（用在文件描述页面中）''",
'thumbsize'            => '缩略图大小:',
