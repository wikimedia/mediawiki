...
$magicWords = array(
	...
	'img_thumbnail'             => array( '1', 'miniatur', 'Miniatur', 'mini', 'thumb', 'thumbnail' ),
	'img_right'                 => array( '1', 'riets', 'rechts', 'right' ),
	'img_left'                  => array( '1', 'lénks', 'links', 'left' ),
	'img_none'                  => array( '1', 'ohne', 'ouni', 'none' ),
	'img_center'                => array( '1', 'zentréiert', 'zentriert', 'center', 'centre' ),
	'img_framed'                => array( '1', 'gerummt', 'gerahmt', 'frame', 'framed', 'enframed' ),
	'img_frameless'             => array( '1', 'rahmenlos', 'net_gerummt', 'frameless' ),
	'img_page'                  => array( '1', 'Säit=$1', 'Säit_$1', 'seite=$1', 'seite $1', 'page=$1', 'page $1' ),
	'img_border'                => array( '1', 'rand', 'bord', 'border' ),
