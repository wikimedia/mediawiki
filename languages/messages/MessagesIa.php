...
'bugreports'        => 'Reportos de defectos',
'bugreportspage'    => 'Project:Reportos de defectos',
...
'badsiglength'               => 'Signatura troppo longe; debe haber minus de $1 characteres.',
'email'                      => 'E-mail',
...
'revdelete-nooldid-text'      => 'Tu non ha specificate alcun revision(es) visate pro executar iste function.',
...
'revdelete-logaction'         => '$1 {{PLURAL:$1|revision|revisiones}} cambiate al modo $2',
'logdelete-logaction'         => '$1 {{PLURAL:$1|evento|eventos}} a [[$3]] cambiate al modo $2',
...
'userrights-groupsremovable'       => 'Gruppos eliminabile:',
'userrights-groupsavailable'       => 'Gruppos disponibile:',
'userrights-groupshelp'            => 'Selige le gruppos al quales tu vole adder o del quales tu vole eliminar le usator. Le gruppos non marcate non se cambiara. Tu pote dismarcar un gruppo con CTRL + clic-a-sinistra',
'userrights-reason'                => 'Motivo pro le cambio:',
'userrights-available-none'        => 'Tu non pote alterar le membrato del gruppo.',
'userrights-available-add'         => 'Tu pote adder qualcunque usator a iste {{PLURAL:$2|gruppo|gruppos}}: $1.',
'userrights-available-remove'      => 'Tu pote eliminar qualcunque usator de iste {{PLURAL:$2|gruppo|gruppos}}: $1.',
'userrights-available-add-self'    => 'Tu pote adder te al sequente {{PLURAL:$2|gruppo|gruppos}}: $1.',
'userrights-available-remove-self' => 'Tu pote eliminar te del sequente {{PLURAL:$2|gruppo|gruppos}}: $1.',
...
'recentchangeslinked-summary'  => "Iste pagina special detalia le modificationes recente in paginas que es ligate. Le paginas presente in tu observatorio se monstra in litteras '''grasse.'''",
...
'filepageexists'              => 'Le pagina de description pro iste file ha ja essite create a <strong><tt>$1</tt></strong>, ma nulle file con iste nomine existe al momento.
Le summario que tu entra non apparera in le pagina de description.
Pro inserer tu summario ibi, tu debera modificar lo manualmente',
...
'withoutinterwiki-header'  => 'Le sequente paginas non ha ligamines a versiones in altere linguas:',
...
'protectsub'                  => '(Ora se defini le nivello de protection pro "$1")',
'confirmprotect'              => 'Confirmar protection',
...
'unprotectsub'                => '(Ora se disprotege "$1")',
...
'undeleterevdel'               => 'Le restauration non essera executate si illo resultara in le deletion partial del revision le plus recente del pagina. In tal casos, tu debe dismarcar o revelar le revisiones delite le plus recente. Le revisiones de files que tu non ha le permission de vider non essera restaurate.',
...
'subcategorycount'       => 'Il ha {{PLURAL:$1|un subcategoria|$1 subcategorias}} de iste categoria.',
'categoryarticlecount'   => 'Il ha {{PLURAL:$1|un pagina|$1 paginas}} in iste categoria.',
