...
'perfdisabledsub' => '這裏是自$1的複製版本：', # obsolete?
...
'loginerror'                 => '登錄錯誤',
'prefs-help-email'           => '*<strong>點子郵件</strong>（可選）：讓他人通過網站在不知道您的電子郵件地址的情況下通過電子郵件與您聯絡，以及通過電子郵件取得遺忘的密碼。',
...
'whitelistacctext'     => '在本維基中建立帳號您必須先[[Special:Userlogin|登錄]]並擁有相關權限。',
'accmailtitle'         => '密碼寄出',
...
'anontalkpagetext'     => "---- ''這是一個還未建立帳號的匿名用戶的對話頁。我們因此只能用[[網址]]來與他／她聯絡。該網址可能由幾名用戶共享。如果您是一名匿名用戶並認為本頁上的評語與您無關，請[[Special:Userlogin|創建新帳號或登錄]]以避免在未來於其他匿名用戶混淆。''",
...
才能更改您的監視列表',
'addedwatch'         => '加入到監視列表',
'addedwatchtext'     => '<p>本頁（“$1”）已經被加入到您的<a href="{{localurle:Special:Watchlist}}">監視列表</a>中。
...
<br />參看[[Special:Ipblocklist|被封網址列表]]以復審查封。',
'unblockip'          => '解除禁封網址',
