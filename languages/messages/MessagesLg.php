...
'hidden-category-category'       => 'Amatuluba agakisidwa', # Name of the category where hidden categories will be listed
...
'movepage-moved'   => '\'\'\'"$1" kati luyitibwa "$2"\'\'\'', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
...
'lastmodifiedatby' => 'Olupapula luno lwasemba okukyusibwamu $3 ku saawa $2, nga $1', # $1 date, $2 time, $3 user
