...
'resetpass_bad_temporary'   => 'არასწორი დროებითი პაროლი.
შეიძლება თქვენ უკვე შეცვალეთ თქვენი პაროლი, ან სცადეთ დროებითი პაროლის კიდევ ერთხელ მოთხოვნა .',
...
'resetpass-log'             => 'პაროლების აღდგენის ჟურნალი',
'resetpass-logtext'         => 'ქვევით ჟურნალში წარმოდგენილია მომხმარებელთა სია, რომელთათვისაც ადმინისტრატორებმა აღადგინეს პაროლი.',
...
'deleted-notice'                   => 'ეს გვერდი წაიშალა
...
განმარტება შესაძლოა მოცემული იყოს [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} წაშლათა ჟურნალში].",
...
'rev-deleted-no-diff'            => "თქვენ არ შეგიძლიათ ამ განსხვავების ნახვა, ვინაიდან ერთ-ერთი ცვლილება '''წაიშალა'''.
დეტალები შესაძლოა მოცემული იყოს [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} წაშლათა ჟურნალში].",
'rev-deleted-unhide-diff'        => "ამ განსხვავების ერთ-ერთი ვერსია '''წაიშალა'''.
დეტალები შესაძლოა მოცემული იყოს [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} წაშლათა ჟურნალში].
როგორც ადმინისტრატორს, სურვილისამებრ, თქვენ მაინც შეგიძლიათ [$1 იხილოთ ეს განსხვავება].",
...
'revdelete-toomanytargets-text'  => 'მითითებული მოქმედების შესასრულებლად თქვენ მიუთითეთ ძალიან ბევრი მიზნის ტიპი.',
...
'revdelete-submit'               => 'გამოიყენეთ არჩეული ვერსია',
...
'searchprofile-articles'           => 'გვერდის შინაარსი',
'searchprofile-articles-and-proj'  => 'შინაარსი და პროექტის გვერდები',
...
'prefs-search-nsdefault'           => 'ძებნა ნაგულისხმევის გამოყენებით:',
...
'shareduploadwiki-desc'     => 'მისი $1 აღწერილობა ნაჩვენებია ქვევით.',
