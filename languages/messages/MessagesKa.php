...
'linkprefix'        => '/^(.*?)(„|«)$/sD',
'mainpagetext'      => "<span style="font-size:larger">'''მედიავიკი წარმატებით ჩაიტვირთა.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''თქვენ არასწორი სპეციალური გვერდი მოითხოვეთ.'''</span>
...
'blockedtext'                      => '<span style="font-size:larger">\'\'\'თქვენი მომხმარებლის სახელი ან IP მისამართი დაბლოკილ იქნა.\'\'\'</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 აღდგენილია'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" გადატანილ იქნა "$2"-ზე\'\'\'</span>',
