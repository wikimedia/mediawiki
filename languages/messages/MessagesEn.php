...
'userlogin-yourname-help'    => 'Enter your username',
'usercreate-helpusername-url' => '{{ns:Project}}:Username_policy',
'usercreate-helpusername-link' => '[[{{MediaWiki:usercreate-helpusername-url}}|(help me choose)]]',
'yourpassword'               => 'Password:',
'userlogin-yourpassword'     => 'Password',
'userlogin-yourpassword-help' => 'Enter your password',
'usercreate-yourpassword-help' => 'Enter a password',
'yourpasswordagain'          => 'Retype password:',
'usercreate-yourpasswordagain' => 'Confirm password',
'usercreate-yourpasswordagain-help' => 'Enter password again',
...
'createaccount-heading'      => 'Create account',
'gotaccount'                 => 'Already have an account? $1.',
'gotaccountlink'             => 'Log in',
'userlogin-resetlink'        => 'Forgotten your login details?',
'helplogin-url'              => 'Help:Logging in',
'userlogin-helplink'         => '[[{{MediaWiki:helplogin-url}}|Help with logging in]]',
'createaccount-join'         => 'Enter your information below.',
'usercreate-email'           => 'Email address',
'usercreate-email-help'      => 'Enter your email address (optional)',
'usercreate-emailrequired-help' => 'Enter your email address',
'createaccountmail'          => 'Use a temporary random password and send it to the email address specified below',
'createaccountreason'        => 'Reason:',
'usercreate-reason'          => 'Reason',
'createacct-benefit-heading' => '{{SITENAME}} is made by people like you.',
'createacct-benefit-icon1'   => 'icon-edits',
'createacct-benefit-head1'   => '<div class="number">{{NUMBEROFEDITS}}</div>',
'createacct-benefit-body1'   => '<div class="number-text">edits</div>',
'createacct-benefit-icon2'   => 'icon-pages',
'createacct-benefit-head2'   => '<div class="number">{{NUMBEROFARTICLES}}</div>',
'createacct-benefit-body2'   => '<span class="number-text">pages</span>',
'createacct-benefit-icon3'   => 'icon-contributors',
#'createacct-benefit-head3'   => '<span class="number">{{NUMBEROFUSERS}}</span>',
#'createacct-benefit-body3'   => 'contributors this month',
'createacct-benefit-head3'   => 'Create articles',
'createacct-benefit-body3'   => "After signing up, you'll be able to help Wikipedia grow by starting new encyclopedia articles.",
