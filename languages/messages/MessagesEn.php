...
'sharedupload'              => 'This file is from $1 and may be used by other projects.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
...
'movepage-moved'               => '\'\'\'"$1" has been moved to "$2"\'\'\'', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
