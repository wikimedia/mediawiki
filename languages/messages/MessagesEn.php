...
$specialPageAliases = array(
	...
	'Log'                       => array( 'Log', 'Logs' ),
	'Blockip'                   => array( 'BlockUser', 'BlockIP' ),
...
'clearyourcache'                   => "'''<span style=\"color:blue;\">Note - After saving, you may have to bypass your browser's cache to see the changes.</span>''' '''<span style=\"color:blue;\">Mozilla / Firefox / Safari:</span>''' hold ''<span style=\"color:blue;\">Shift</span>'' while clicking ''<span style=\"color:blue;\">Reload</span>,'' or press either ''<span style=\"color:blue;\">Ctrl-F5</span>'' or ''<span style=\"color:blue;\">Ctrl-R</span>'' (''<span style=\"color:blue;\">Command-R</span>'' on a Macintosh); '''<span style=\"color:blue;\">Konqueror:</span> '''click ''<span style=\"color:blue;\">Reload</span>'' or press ''<span style=\"color:blue;\">F5</span>;'' '''<span style=\"color:blue;\">Opera:</span>''' clear the cache in ''<span style=\"color:blue;\">Tools → Preferences</span>;'' '''<span style=\"color:blue;\">Internet Explorer:</span>''' hold ''<span style=\"color:blue;\">Ctrl</span>'' while clicking ''<span style=\"color:blue;\">Refresh</span>,'' or press ''<span style=\"color:blue;\">Ctrl-F5</span>.''",
