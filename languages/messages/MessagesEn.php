...
'nomorelinkshere'          => "$1 You may wish to return to the [[:Special:Whatlinkshere/$2&from=$3&back=$3|previous page of listings]].",
'nomorelinkshere-ns'       => "No more pages link to '''[[:$1]]''' in the chosen namespace. You may wish to return to the [[:Special:Whatlinkshere/$1&from=$2&back=$2|previous page of listings]].",
'nomorelinkshere-lost'     => "No more pages link to '''[[:$1]]'''. You may wish to return to the [[:Special:Whatlinkshere/$1|first page of listings]] to start again.",
'nomorelinkshere-ns-lost'  => "No more pages link to '''[[:$1]]''' in the chosen namespace. You may wish to return to the [[:Special:Whatlinkshere/$1|first page of listings]] to start again.",
