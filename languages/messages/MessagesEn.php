...
'searchsubtitle'                   => 'You searched for <strong>[[:$1]]</strong> ([[Special:Prefixindex/$1|all pages starting with "$1"]]{{int:pipe-separator}}[[Special:WhatLinksHere/$1|all pages that link to "$1"]])',
'searchsubtitleinvalid'            => "You searched for <strong>$1</strong>",
...
'searchmenu-exists'                => "<strong>There is a page named \"[[:\$1]]\" on this wiki.</strong>",
'searchmenu-new'                   => "<strong>Create the page \"[[:\$1]]\" on this wiki!</strong>",
...
'nonefound'                        => "<strong>Note:</strong> Only some namespaces are searched by default.
Try prefixing your query with <em>all:</em> to search all content (including talk pages, templates, etc.), or use the desired namespace as prefix.",
...
'rcnote'                            => "Below {{PLURAL:$1|is <strong>1</strong> change|are the last <strong>$1</strong> changes}} in the last {{PLURAL:$2|day|<strong>$2</strong> days}}, as of $5, $4.",
...
'talkexists'                   => "<strong>The page itself was moved successfully, but the talk page could not be moved because one already exists at the new title.
Please merge them manually.</strong>",
'movedto'                      => 'moved to',
