...
$specialPageAliases = [
	...
	'ApiFeatureUsage'           => [ 'Využití_funkcí_API', 'Vyuziti_funkci_API' ],
	'ApiSandbox'                => [ 'API_pískoviště', 'API_piskoviste' ],
	...
	'CentralAuth'               => [ 'Informace_o_globálním_účtu', 'Informace_o_globalnim_uctu' ],
	'ChangeContentModel'        => [ 'Změna_modelu_obsahu_stránky', 'Zmena_modelu_obsahu_stranky' ],
	...
	'ContentTranslation'        => [ 'Přeložit_stránku', 'Prelozit_stranku' ],
	...
	'DisambiguationPages'       => [ 'Rozcestníky', 'Rozcestniky' ],
	'DisambiguationPageLinks'   => [ 'Stránky_odkazující_na_rozcestníky', 'Stranky_odkazujici_na_rozcestniky' ],
	...
	'GlobalBlockList'           => [ 'Seznam_globálně_zablokovaných_IP_adres', 'Seznam_globalne_zablokovanych_IP_adres' ],
	'GlobalBlockWhitelist'      => [ 'Místní_stav_globálních_bloků', 'Mistni_stav_globalnich_bloku' ],
	'GlobalGroupPermissions'    => [ 'Správa_globálních_skupin', 'Sprava_globalnich_skupin' ],
	'GlobalRenameProgress'      => [ 'Průběh_globálního_přejmenování', 'Prubeh_globalniho_prejmenovani' ],
	'GlobalRenameRequest'       => [ 'Žádost_o_přejmenování_globálního_účtu', 'Zadost_o_prejmenovani_globalniho_uctu' ],
	'GlobalUsage'               => [ 'Globální_využití_souboru', 'Globalni_vyuziti_souboru' ],
	'GlobalUsers'               => [ 'Seznam_globálních_uživatelů', 'Seznam_globalnich_uzivatelu' ],
	'GraphSandbox'              => [ 'Pískoviště_pro_grafy', 'Piskoviste_pro_grafy' ],
	...
	'ListDuplicatedFiles'       => [ 'Seznam_souborů_s_duplikáty', 'Seznam_souboru_s_duplikaty' ],
	'Listfiles'                 => [ 'Seznam_souborů', 'Seznam_souboru' ],
	'ListGrants'                => [ 'Svolení', 'Svoleni' ],
	...
	'MediaStatistics'           => [ 'Statistika_souborů', 'Statistika_souboru' ],
	'MassMessage'               => [ 'Poslat_hromadnou_zprávu', 'Poslat_hromadnou_zpravu' ],
	'MergeAccount'              => [ 'Stav_sjednocení_přihlašovacích_účtů', 'Stav_sjednoceni_prihlasovacich_uctu' ],
	...
	'Nuke'                      => [ 'Hromadné_mazání', 'Hromadne_mazani' ],
	'OAuthListConsumers'        => [ 'Seznam_aplikací_OAuth', 'Seznam_aplikaci_OAuth' ],
	'OAuthManageMyGrants'       => [ 'Správa_připojených_aplikací', 'Sprava_pripojenych_aplikaci' ],
	'PagesWithProp'             => [ 'Stránky s vlastností', 'Stranky_s_vlastnosti' ],
	'Preferences'               => [ 'Nastavení', 'Nastaveni' ],
	'PrefixIndex'               => [ 'Seznam_všech_stránek_podle_začátku_názvu', 'Seznam_vsech_stranek_podle_zacatku_nazvu' ],
	...
	'ResetTokens'               => [ 'Reinicializace_klíčů', 'Reinicializace_klicu' ],
	'Revisiondelete'            => [ 'Smazat_revizi' ],
	'Search'                    => [ 'Hledání', 'Hledani' ],
	'Shortpages'                => [ 'Nejkratší_stránky', 'Nejkratsi_stranky' ],
	'SiteMatrix'                => [ 'Seznam_všech_wiki_nadace_Wikimedia', 'Seznam_vsech_wiki_nadace_Wikimedia' ],
	'Specialpages'              => [ 'Speciální_stránky', 'Specialni_stranky' ],
	'Statistics'                => [ 'Statistika', 'Statistiky' ],
	'Tags'                      => [ 'Značky', 'Znacky' ],
	'TemplateSandbox'           => [ 'Šablonové_pískoviště', 'Sablonove_piskoviste' ],
	...
	'UsersWhoWillBeRenamed'     => [ 'Uživatelé,_kteří_budou_přejmenováni', 'Uzivatele,_kteri_budou_prejmenovani' ],
	'Version'                   => [ 'Verze' ],
