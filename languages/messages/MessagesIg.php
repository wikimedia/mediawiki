...
'copyrightpagename'    => '{{SITENAME}} kechịrịnàíwú',
...
'nodb'                 => 'Énwéghịkị nwèré $1 njídé-ụmá orunotu',
...
'resetpass-comment'         => 'Mgbághapụtà méré ka okwúngáfè gbànwere:',
...
'confirmedittitle'                 => 'Ha gi si e-mailu gi di ézíbóté mgbe Í gi rü',
...
'semiprotectedpagewarning'         => "'''Lè kwá:''' Ihüá è cẹdolu màkà nání ndi banyéré wiki gí nweríkí rü nà ya.",
'templatesused'                    => 'Àtụ hé jịrị na ihüá:',
'templatesusedpreview'             => 'Àtụ hé jị nà nlétú nkèá:',
...
'deleted-notice'                   => 'Ihü á à gbakashiala.
Ndétu-ncheta maka mgbakashia ihü á di na àlà màkà ádiàmámá.',
'deletelog-fulllog'                => 'Zìchá ndétu ncheta',
...
'revision-info'          => 'Orübà na nke $1 shí $2', # Additionally available: $3: revision id
...
'history-feed-item-nocomment' => '$1 ngbe $2', # user at time
...
'editundo'                => 'emekwàlà',
'diff-movedto'            => 'páfùrù gá $1',
'diff-styleadded'         => 'àgwà $1 tìnyèrè',
'diff-added'              => 'tinyèrè $1',
'diff-changedto'          => 'gabwèrè gá $1',
'diff-movedoutof'         => 'páfùrù shí $1',
'diff-styleremoved'       => '$1 ágwa wéfùrù',
'diff-removed'            => '$1 wéfùrù',
'diff-changedfrom'        => 'gabwèrè shí $1',
'diff-src'                => 'mkpọlógwù',
'diff-withdestination'    => 'na ébé ọ nà gá $1',
'diff-with'               => '&#32;ji $1 $2',
'diff-with-final'         => '&#32;na $1 $2',
'diff-width'              => 'àsáa',
'diff-height'             => 'ógólógó',
'diff-p'                  => "'''nkeji edemede'''",
'diff-blockquote'         => "'''ndépùta'''",
'diff-h1'                 => "'''íshí édé (ọtú nke 1)'''",
'diff-h2'                 => "'''íshí édé (ọtú nke 2)'''",
'diff-h3'                 => "'''íshí édé (ọtú nke 3)'''",
'diff-h4'                 => "'''íshí édé (ọtú nke 4)'''",
'diff-h5'                 => "'''íshí édé (ọtú nke 5)'''",
'diff-div'                => "'''nkèjị'''",
'diff-ol'                 => "'''ndétu di nà ùsòlò'''",
'diff-li'                 => "'''ndétu ihe'''",
'diff-table'              => "'''ogō'''",
'diff-tbody'              => "'''Ihe nọr na ímé agada'''",
'diff-tr'                 => "'''ǹdịlị'''",
'diff-td'                 => "'''ọtú'''",
'diff-th'                 => "'''íshí n'íshí'''",
'diff-br'                 => "'''gbàjí'''",
...
'diff-strong'             => "'''íke'''",
'diff-em'                 => "'''di mkpà'''",
'diff-font'               => "'''ọdịdị mkpụrụ edemede'''",
'diff-big'                => "'''bù ibù'''",
'diff-del'                => "'''gbakashịrị'''",
'diff-tt'                 => "'''àsáa nke gbado'''",
'diff-sub'                => "'''édé-n-ímé'''",
'diff-sup'                => "'''édé-ukwu'''",
'diff-strike'             => "'''kwá àhìrì'''",
...
'searchprofile-articles-and-proj' => 'Ihü orürü & ihe dị',
'searchprofile-project'           => 'Ihü orürü',
'searchprofile-images'            => 'Ákwúkwó orunotu',
...
'recentchangesdays-max'     => '(ùbe ya bu {{PLURAL:$1|chi|chi}} $1)',
'timezonelegend'            => 'Nkeji ogẹ:',
'localtime'                 => 'Ogẹ ebeanọr:',
'timezoneselect'            => 'Nkeji ogẹ:',
...
'sharedupload'              => 'Ákwúkwó runotu nke shì $1 na ó nwèríkí di na orürü nke ndi ozor.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
'uploadnewversion-linktext' => 'Tinyé akwúkó orunotu di òhúrù na élú nke',
'shared-repo-from'          => 'shí $1', # $1 is the repository name
...
'protect-expiry-options'      => 'àmànì 1:1 hour,chi 1:1 day,izù 1:1 week,izù 2:2 weeks,önwa1:1 month,önwa 3:3 months,önwa 6:6 months,afọr 1:1 year,ógè énwéghị ùbe:infinite', # display1:time1,display2:time2,...
...
'ipbother'                 => 'Ógẹ ozor',
'ipboptions'               => 'àmànì 2:2 hours,chi 1:1 day,chi 3:3 days,izù 1:1 week,izù 2:2 weeks,önwa1:1 month,önwa 3:3 months,önwa 6:6 months,afọr 1:1 year,ógè énwéghị ùbe:infinite', # display1:time1,display2:time2,...
...
'movepage-moved'          => '\'\'\'"$1" páfùrù Í gá "$2"\'\'\'', # The two titles are passed in plain text as $3 and $4 to allow additional goodies in the message.
...
* onúf
* nkówá íjè ISO
* ógólógó focal', # Do not translate list items
...
'exif-orientation-1' => 'Ñkịtị', # 0th row: top; 0th column: left
...
# Special:Version
'version'                   => 'Ùdị', # Not used as normal message but as header for the special page itself
