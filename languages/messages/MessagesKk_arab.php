...
'tog-externaleditor'          => 'شەتتىك وڭدەۋىشتى ادەپكىدەن قولدان',
...
'bugreportspage'       => '{{ns:project}}:قاتەلىك باياناتتارى',
...
'undo-summary' => '[[{{#special:Contributions}}/$2|$2]] ([[{{ns:user_talk}}:$2|تالقىلاۋى]]) ىستەگەن ٴنومىر $1 تۇزەتۋىن جوققا شىعاردى',

# Account creation failure
'cantcreateaccounttitle' => 'جاڭا تىركەلگى جاسالمادى',
'cantcreateaccount-text' => "بۇل IP مەكەنجايدان ('''$1''') جاڭا تىركەلگى جاساۋىن [[{{ns:user}}:$3|$3]] بۇعاتتاعان.
...
'prefsnologintext'         => 'پايدالانۋشىلىق باپتالىمدارىڭىزدى قويۋ ٴۇشىن [[{{#special:Userlogin}}|كىرۋىڭىز]] ٴجون.',
...
'right-suppressredirect'     => 'ٴتىيىستى اتاۋعا بەتتى جىلجىتقاندا ايداتۋدى جاساماۋ',
...
'uploadnologintext'           => 'فايلداردى قوتارىپ بەرۋ ٴۇشىن [[{{#special:Userlogin}}|كىرۋىڭىز]] ٴجون.',
'upload_directory_read_only'  => 'قوتارىپ بەرىلەتىن قالتاسىنا ($1) جازۋعا ۆەب-سەرۆەرگە رۇقسات بەرىلمەگەن.',
...
'redirectstofile'                => 'بۇل فايلعا كەلەسى فايلدار ايدايدى:',
'duplicatesoffile'               => 'كەلەسى فايلدار بۇل فايلدىڭ تەلنۇسقالارى:',
...
بۇعان «تالقىلاۋ» بەتتەرى, {{SITENAME}} جوباسى تۋرالى بەتتەر, تىم قىسقا «بىتەمە» بەتتەرى, ايداتۋلار, تاعى دا باسقا ماعلۇمات دەپ تانىلمايتىن بەتتەر كىرىستىرلەدى.
...
[http://meta.wikimedia.org/wiki/Help:Job_queue تاپسىرىمالار كەزەگىنىڭ] ۇزىندىعى: '''$7'''.",
...
'mailnologintext' => 'باسقا قاتىسۋشىعا حات جونەلتۋ ٴۇشىن [[{{#special:Userlogin}}|كىرۋىڭىز]] ٴجون, جانە [[{{#special:Preferences}}|باپتالىمدارىڭىزدا]] جارامدى ە-پوشتا مەكەنجايى بولۋى ٴجون.',
...
'revertpage'                  => '[[{{#special:Contributions}}/$2|$2]] ([[{{ns:user_talk}}:$2|تالقىلاۋى]]) وڭدەمەلەرىنەن قايتارعان;
...
اڭعارتپا: ەگەر وسى ارادا الداقاشان جاڭا تاقىرىپ اتى بار بەت بولسا, بۇل بوس نە ايداتۋ بولعانشا دەيىن, جانە سوڭىندا تۇزەتۋ تارىيحى جوق بولسا, بەت '''جىلجىتىلمايدى'''. وسىنىڭ ماعىناسى: ەگەر بەتتى قاتەلىكپەن قايتا اتاساڭىز, بۇرىنعى اتاۋىنا قايتا اتاۋعا بولادى, جانە بار بەتتىڭ ۇستىنە جازۋىڭىزعا بولمايدى.
...
'movepage-max-pages'      => '$1 بەتتىڭ ەڭ كوبى جىلجىتىلدى جانە مىننان كوبى وزدىكتىك جىلجىلتىلمايدى.',
'1movedto2'               => '[[$1]] دەگەندى [[$2]] دەگەنگە جىلجىتتى',
'1movedto2_redir'         => '[[$1]] دەگەندى [[$2]] دەگەن ايداتۋ ۇستىنە جىلجىتتى',
...
'specialpages-group-maintenance' => 'باپتاۋ باياناتتار',
...
'specialpages-group-pages'       => 'بەت تىزمدەرى',
'specialpages-group-pagetools'   => 'بەت قۇرالدارى',
