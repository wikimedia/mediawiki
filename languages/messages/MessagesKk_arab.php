...
'ipb_modifying_block'         => 'بولعان بۇعاتتاۋدى وزگەرتۋ:',
'ipb_tweak_block'             => 'قۇلاقتاندىرۋ: بۇل قاتىسۋشى ($1) الداقاشان بۇعاتتالعان.
بۇعاتتاۋ باپتالىمدارىن قويۋ ٴۇشىن بۇل ٴپىشىندى قولدانا الاسىز.',
