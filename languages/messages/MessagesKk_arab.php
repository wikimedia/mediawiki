...
'mainpagetext'      => "<span style="font-size:larger">'''مەدىياۋىيكىي بۋماسى ٴساتتى ورناتىلدى.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''جارامسىز ارنايى بەتتى سۇرادىڭىز.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''قاتىسۋشى اتىڭىز نە IP مەكەنجايىڭىز بۇعاتتالعان.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 قالپىنا كەلتىرىلدى'''</span>
