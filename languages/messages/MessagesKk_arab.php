...
'editinginterface'     => "'''قۇلاقتاندىرۋ:''' باعدارلاما جاساقتامانىڭ تىلدەسۋ ٴماتىنىن جەتىستىرەتىن بەتىن وڭدەپ جاتىرسىز.
...
{{SITENAME}} باپتاۋ وزگەرتۋىن ۇمىتپاڭىز.',
...
'noarticletext'                     => 'بۇل بەتتە اعىمدا ەش ٴماتىن جوق, دەگەنمەن باسقا بەتتەردەن [[{{#special:Search}}/{{PAGENAME}}|بۇل بەت اتاۋىن ىزدەي]] نە [{{fullurl:{{FULLPAGENAME}}|action=edit}} بۇل بەتتى وڭدەي] الاسىز.',
...
'session_fail_preview'              => '<strong>عافۋ ەتىڭىز! سەسسىييا دەرەكتەرى ىسىراپ قالعاندىقتان وڭدەمەڭىزدى جۇرگىزە المايمىز.
قايتا بايقاپ كورىڭىز. ەگەر بۇل ٴالى ىستەمەسە, شىعۋدى جانە قايتا كىرۋدى بايقاپ كورىڭىز.</strong>',
'session_fail_preview_html'         => "<strong>عافۋ ەتىڭىز! سەسسىييا دەرەكتەرى ىسىراپ قالعاندىقتان وڭدەمەڭىزدى جۇرگىزە المايمىز.</strong>
...
'token_suffix_mismatch'             => '<strong>وڭدەمەڭىز تايدىرىلدى, سەبەبى تاپسىرىسكەرىڭىز وڭدەمە دەرەكتەر بۋماسىنداعى تىنىس بەلگىلەرىن ٴبۇلدىرتتى.
...
جۇمىس ىستەۋگە ىقتىيمالدىق بەرۋ ٴۇشىن, تومەنگى وڭدەۋ اۋماعىندا ASCII ەمەس ارىپتەر ونالتىلىق سان بەلگىلەمەسىمەن كورسەتىلەدى</strong>.',
...
'undo-failure' => 'بۇل وڭدەمە جوققا شىعارىلمايدى, سەبەبى تارتىستى ارالىق وڭدەمەلەر بار.',
...
'cantcreateaccount-text' => "بۇل IP جايدان ('''$1''') جاڭا تىركەلگى جاساۋىن [[{{ns:user}}:$3|$3]] بۇعاتتاعان.

$3 كەلتىرىلگەن سەبەبى: ''$2''",

# History pages
'viewpagelogs'        => 'بۇل بەتىڭ جۋرنالدارىن قاراۋ',
'nohistory'           => 'مىندا بۇل بەتتىنىڭ تۇزەتۋ تارىيحى جوق.',
'revnotfound'         => 'تۇزەتۋ تابىلمادى',
'revnotfoundtext'     => 'بۇل بەتتىڭ سۇرالعان ەسكى تۇزەتۋى تابىلعان جوق. وسى بەتتى اشۋعا پايدالانعان URL جايىن قايتا تەكسەرىپ شىعىڭىز.',
'currentrev'          => 'اعىمدىق تۇزەتۋ',
'revisionasof'        => '$1 كەزىندەگى تۇزەتۋ',
'revision-info'       => '$1 كەزىندەگى $2 شستەگەن تۇزەتۋ',
...
'revdelete-unsuppress'        => 'قالپىنا كەلتىرىلگەن تۇزەتۋلەر تىيىمدارىن الاستاۋ',
...
'mergehistory-header'              => 'بۇل بەت ارقىلى ٴبىر قاينار بەتتىڭ تۇزەتۋلەر تارىيحىن جاڭا بەتكە بىرىكتىرۋگە مۇمكىندىك بەرەدى.
...
# Diffs
'history-title'           => '«$1» دەگەننىڭ تۇزەتۋ تارىيحى',
...
'searchall'                 => 'بارلىق',
'showingresults'            => "تومەندە ٴنومىر '''$2''' ورنىنان باستاپ '''$1''' ناتىيجەگە دەيىن جەتكەنشە كورسەتىلەدى.",
...
'nonefound'                 => "'''اڭعارتپا''': باستاپقىدان ىزدەۋ تەك كەيبىر ەسىم ايالاردا بولادى. بارلىق ماعلۇماتتى (سونىڭ ىشىندە تالقىلاۋ بەتتەردى, ۇلگىلەردى ت.ب.) ىزدەۋ ٴۇشىن سۇرانىمىڭىزدى ''بارلىق:'' دەپ باستاڭىز, نەمەسە قالاعان ەسىم اياسىن باستاۋىش ەسەبىندە قولدانىڭىز.",
'powersearch'               => 'كەڭەيتىلگەن ىزدەۋ',
'powersearch-legend'        => 'كەڭەيتىلگەن ىزدەۋ',
'powersearchtext'           => 'مىنا ەسىم ايالاردا ىزدەۋ:<br />$1<br />$2 ايداتۋلاردى تىزىمدەۋ<br />ىزدەۋ سۇرانىمى: $3 $9',
...
* كەلتىرىلگەن * توپتى ٴبىر ۇستەگەنىنەن الاستاي المايتىندىعىن, نە قاراما-قارسىسىن كورسەتەدى.',
...
'right-markbotedits'         => 'قايتارىلعان وڭدەمەلەرردى بوتتار جاساعان دەپ بەلگىلەۋ',
'right-import'               => 'باسقا ۋىيكىيلەردەن بەتتەردى سىرتتان الۋ',
'right-importupload'         => 'فايل قوتارۋىمەن بەتتەردى سىرتتان الۋ',
'right-patrol'               => 'وڭدەمەلەردى كۇزەتتە دەپ بەلگىلەۋ',
'right-autopatrol'           => 'وڭدەمەلەردى كۇزەتتە دەپ وزدىكتىك بەلگىلەۋ',
...
'right-userrights-interwiki' => 'باسقا ۇىيكىي توراپتارىنداعى قاتىسۋشىلاردىڭ قۇقىقتارىن وڭدەۋ',
...
'rcshowhidepatr'                    => 'كۇزەتتەگى وڭدەمەلەردى $1',
...
'rollback'                    => 'وڭدەمەلەردى كەرى قايتارۋ',
'rollback_short'              => 'كەرى قايتارۋ',
'rollbacklink'                => 'كەرى قايتارۋ',
'rollbackfailed'              => 'كەرى قايتارۋ ٴساتسىز ٴبىتتى',
'cantrollback'                => 'وڭدەمە قايتارىلمايدى;
بۇل بەتتىڭ اۋتورى تەك سوڭعى ۇلەسكەر بولعان.',
'alreadyrolled'               => '[[:$1]] بەتىنىڭ [[{{ns:user}}:$2|$2]] ([[{{ns:user_talk}}:$2|تالقىلاۋى]]) سوڭعى وڭدەمەسى كەرى قايتارىلمادى;
...
بولەكتەۋمەن قالپىنا كەلتىرۋ ورىنداۋ ٴۇشىن, كەلتىرەمىن دەگەن تۇزەتۋلەرىنە سايكەس قاباشاقتارىن بەلگىلەڭىز دە, جانە '''''قالپىنا كەلتىر!''''' تۇيمەسىن نۇقىڭىز. '''''قايتا قوي''''' تۇيمەسىن نۇقىعاندا ماندەمە اۋماعى تازارتادى جانە بارلىق شارشىلاردى قۇسبەلگىلەردەن بوساتادى.",
...
وسىنداي جاعدايلاردا, ەڭ جاڭا جويىلعان تۇزەتۋ بەلگىلەۋىن نەمەسە جاسىرۋىن بولدىرماڭىز.',
...
'undelete-filename-mismatch'   => '$1 كەزىندەگى فايل تۇزەتۋىنىڭ جويۋى بولدىرمادى: فايل اتى سايكەسسىز',
...
'imagenocrossnamespace'   => "سۋرەت فايل ەمەس باسقا ەسىم اياسىنا جىلجىتىلمايدى",
...
بەتتەردى سىرتقا بەرۋ ٴۇشىن, اتاۋلارىن تومەندەگى ٴماتىن اۋماعىنا ەنگىزىڭىز (ٴبىر جولدا ٴبىر اتاۋ), جانە دە بولەكتەڭىز: نە اعىمدىق نۇسقاسىن, بارلىق ەسكى نۇسقالارى مەن جانە تارىيحى جولدارى مەن بىرگە, نەمەسە ٴدال اعىمدىق نۇسقاسىن, سوڭعى وڭدەمەۋ تۋرالى اقپاراتى مەن بىرگە.
...
بارلىق ۋىيكىي اراسىنداعى سىرتتان الۋ ارەكەتتەر [[{{#special:Log}}/import|سىرتتان الۋ جۋرنالىنا]] جازىلىپ الىنادى.',
...
'importhistoryconflict'      => 'تۇزەتۋ تارىحىنىڭ تارتىسى بار (بۇل بەتتى الدىندا سىرتتان الىنعان سىيياقتى)',
...
'importlogpagetext'                => 'باسقا ۋىيكىيلەردەن تۇزەتۋ تارىيحىمەن بىرگە بەتتەردى اكىمشىلىك رەتىندە سىرتتان الۋ.',
'import-logentry-upload'           => 'فايل قوتارۋىمەن سىرتتان «[[$1]]» بەتى الىندى',
'import-logentry-upload-detail'    => '$1 تۇزەتۋ',
'import-logentry-interwiki'        => 'ۋىيكىي اراسىنان الىنعان $1',
'import-logentry-interwiki-detail' => '$2 دەگەننەن $1 تۇزەتۋ',

# Tooltip help for the actions
'tooltip-pt-userpage'             => 'جەكە بەتىم',
'tooltip-pt-anonuserpage'         => 'بۇل IP جايدىڭ جەكە بەتى',
'tooltip-pt-mytalk'               => 'تالقىلاۋ بەتىم',
'tooltip-pt-anontalk'             => 'بۇل IP جاي وڭدەمەلەرىن تالقىلاۋ',
...
'spam_blanking'       => '$1 دەگەنگە سىلتەمەسى بار بارلىق تۇزەتۋلەر تازارتىلدى',
...
'markaspatrolledtext'                 => 'بۇل بەتتى كۇزەتۋدە دەپ بەلگىلەۋ',
'markedaspatrolled'                   => 'كۇزەتتە دەپ بەلگىلەندى',
'markedaspatrolledtext'               => 'بولەكتەنگەن تۇزەتۋ كۇزەتتە دەپ بەلگىلەندى.',
...
'markedaspatrollederrortext'          => 'كۇزەتتە دەپ بەلگىلەۋ ٴۇشىن تۇزەتۋدى كەلتىرىڭىز.',
'markedaspatrollederror-noautopatrol' => 'ٴوز وزگەرىستەرىڭىزدى كۇزەتتە دەپ بەلگىلەي المايسىز.',
...
'edit-externally'      => 'بۇل فايلدى سىرتقى قوندىرما ارقىلى وڭدەۋ',
...
# Watchlist editor
'watchlistedit-numitems'       => 'باقىلاۋ تىزىمىڭىزدە, تالقىلاۋ بەتتەرسىز, $1 اتاۋ بار.',
...
'watchlistedit-normal-done'    => 'باقىلاۋ تىزىمىڭىزدەن $1 اتاۋ الاستالدى:',
...
'watchlistedit-raw-added'      => '$1 اتاۋ ۇستەلدى:',
'watchlistedit-raw-removed'    => '$1 اتاۋ الاستالدى:',
