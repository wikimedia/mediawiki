...
'blockedtext'                      => "<span style="font-size:larger">'''Ihr Benutzername oder Ihre IP-Adresse wurde gesperrt.'''</span>
...
'copyrightwarning'                 => "'''Bitte <span style="font-size:larger">kopieren Sie keine Webseiten</span>, die nicht Ihre eigenen sind, benutzen Sie <span style="font-size:larger">keine urheberrechtlich geschützten Werke</span> ohne Erlaubnis des Copyright-Inhabers!'''<br />
