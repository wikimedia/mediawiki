...
'missingarticle'       => 'Hindi natagpuan ng kalipunan ng dato ang teksto ng isang pahinang dapat na natagpuan nito, may pangalan "$1".

Kalimitang sanhi ito ng sumusunod na mga wala sa panahong kawing ng pagkakaiba o kasaysayan patungo sa isang pahinang nabura na.

Kung hindi ito ang kaso, maaaring nakatuklas ka ng isang depekto sa loob ng sopwer.
Pakiulat ito sa isang tagapangasiwa, na tinatandaan at tinutukoy ang URL.',
...
'throttled-mailpassword'     => 'Naipadala na ang isang pampaalala ng hudyat, sa loob ng huling $1 mga oras.  Para maiwasan ang pangaabuso, isang pampaalala ng hudyat lamang ang ipadadala sa bawat $1 mga oras.',
'mailerror'                  => 'Kamalian sa pagpapadala ng liham: $1',
'acct_creation_throttle_hit' => 'Paumanhin, nakalikha ka na ng $1 mga kuwenta/akawnt.  Hindi ka na maaaring gumawa ng mas higit pa rito.',
...
'resetpass'               => 'Muling itakda ang hudyat ng kuwenta/akawnt',
...
'subject-preview'           => 'Paunang tingin sa paksa/ulo ng balita',
...
'whitelistreadtitle'        => 'Kailangan ang paglagda para mabasa',
'whitelistreadtext'         => 'Kailangan mong [[Special:Userlogin|lumagda]] para makapagbasa ng mga pahina.',
'whitelistacctitle'         => 'Walang kang pahintulot para lumikha ng kuwenta/akawnt',
'whitelistacctext'          => 'Para mapahintulutang makapaglikha ng mga kuwenta/akawnt sa {{SITENAME}} kailangan mong  [[Special:Userlogin|lumagda]] at magkaroon ng mga naaangkop na mga kapahintulutan.',
...
Hindi ito masasagip.'''",
'readonlywarning'           => '<strong>BABALA: Ikinandado ang kalipunan ng dato para sa pagpapanatili, kaya hindi mo masasagip ang iyong mga pagbabgo sa ngayon.  Maaaring ibigin mong gupitin at idikit ang teksto sa isang talaksang pangteksto at sagipin ito mamaya-maya.</strong>',
...
'loadhist'            => 'Ikinakarga ang kasaysayan ng pahina',
...
'revdelete-hide-restricted'   => "Ipatupad ang mga pagbabawal na ito sa mga ''Sysop'' at ikandado ang ugnayang-panghangganang ito",
...
'revdelete-logaction'         => 'Itinakda ang $1 {{PLURAL:$1|pagbabago|mga pagbabago}} sa modalidad na $2',
'logdelete-logaction'         => 'Itinakda ang $1 {{PLURAL:$1|kaganapan|mga kaganapan}} na pang-[[$3]] sa modalidad na $2',
...
# Oversight log
'oversightlog'    => 'Talaan ng pagiingat-tago',
'overlogpagetext' => "Nasa ibaba ang isang talaan ng mga pinakakamakailan lamang na mga pagbubura at paghadlang/pagharang na kinasasangkutan ng mga nilalamang nakatago sa mga ''sysop''.  Tingnan ang [[Special:Ipblocklist|talaan ng mga hinadlangang IP]] para sa talaan ng mga pangkasalukuyang umiiral na mga pagbabawal at paghadlang/pagharang.",

# History merging
'mergehistory'                     => 'Pagsanibin mga pahina ng kasaysayan',
'mergehistory-header'              => 'Nagbibigay sa iyo ng pahintulot ang pahinang ito para mapagsanib ang mga pagbabago sa kasaysayan ng isang pinagmulang pahina patungo sa isang mas bagong pahina.
Pakitiyak na ang pagbabagong ito ay makapagpapanatili sa pagpapatuloy ng pahinang pangkasaysayan.',
...
'powersearchtext'       => 'Maghanap sa espasyo ng mga pangalan:<br />$1<br />$2 Itala ang mga panuto/panturo<br />Hanapin ang $3 $9',
...
'timezonetext'             => 'Ang bilang ng oras na ipinagkakaiba ng iyong katutubong oras mula sa oras ng serbidor (UTC).',
...
'userrights-groupsremovable'       => 'Mga pangkat na maaaring tanggalin:',
'userrights-groupsavailable'       => 'Mga pangkat na makukuha:',
'userrights-groupshelp'            => "Piliin ang mga pangkat na ibig mong pagtanggalan o pagdagdagan ng tagagamit.  Hindi mababago ang hindi napiling mga pangkat.  Maaaring mong tanggalin ang pagkakapili sa isang pangkat sa pamamagitan ng ''CTRL + Left Click'' (CTRL + \"Kaliwang pindutan\")",
'userrights-reason'                => 'Dahilan ng pagbabago:',
'userrights-available-none'        => 'Hindi mo maaaring baguhin ang kasapiang pampangkat.',
'userrights-available-add'         => 'Maaari mong idagdag ang alinmang tagagamit sa {{PLURAL:$2|pangkat na ito|mga pangkat na ito}}: $1.',
'userrights-available-remove'      => 'Maaari mong tanggalin ang alinmang tagagamit mula sa {{PLURAL:$2|pangkat na ito|mga pangkat na ito}}: $1.',
...
'rcnote'                            => "Nasa ibaba {{PLURAL:$1|ang '''1''' pagbabago|ang pinakahuling '''$1''' mga pagbabago}} sa loob ng huling {{PLURAL:$2|araw|'''$2''' mga araw}}, mula pa noong $3.",
...
'recentchangeslinked-summary'  => "Itinatala ng natatanging pahinang ito ang huling mga pagbabago sa magkakakawing na mga pahina.  Ang mga pahina sa iyong talaan ng mga binabantayan ay may '''makakapal na mga panitik'''.",
...
Para matingnan o makapaghanap ng mga dati nang naikargang mga talaksan pumunta sa [[Special:Imagelist|talaan ng ikinargang mga talaksan]], nakatala rin sa [[Special:Log/upload|talaan ng pagkarga]] ang mga pagkakarga at pagbubura.

Para makapagsama ng isang talaksan sa loob ng isang pahina, gumamit ng isang kawing na nasa loob ng pormularyo
'''<nowiki>[[</nowiki>{{ns:image}}<nowiki>:File.jpg]]</nowiki>''',
'''<nowiki>[[</nowiki>{{ns:image}}<nowiki>:File.png|tekstong pamalit]]</nowiki>''' (''alt text'') o
'''<nowiki>[[</nowiki>{{ns:media}}<nowiki>:File.ogg]]</nowiki>''' para tuwirang makakawing sa talaksan.",
...
'uploadlogpagetext'           => 'Nasa ibaba ang isang talaan ng pinakakamakailan lamang na mga pagkakarga ng mga talaksan.',
...
'filetype-unwanted-type'      => "Ang '''\".\$1\"''' ay isang hindi ninanais na uri ng talaksan.  Ang ninanais na mga uri ng talaksan ay mga \$2.",
'filetype-banned-type'        => "Ang '''\".\$1\"''' ay isang hindi pinapahintulutang uri ng talaksan.  Ang mga pinapahintulutang mga uri ng talaksan ay mga \$2.",
...
'filepageexists'              => 'Nilikha na sa <strong><tt>$1</tt></strong> ang pahina ng paglalarawan para sa talaksang ito, subalit walang talaksang umiiral na may ganitong pangalan sa kasalukuyan.
Hindi lilitaw sa pahina ng paglalarawan ang buod na ipapasok mo.
Para mapalitaw ang buod mo doon, kakailanganin mong baguhin ito sa pamamagitan ng paraang kinakamay (kaparaanang manwal)',
...
'fileexists-forbidden'        => 'Mayroon nang isang talaksang may ganitong pangalan;
pakibalikan po at ikarga ang talaksang ito sa ilalim ng isang bagong pangalan. [[Image:$1|thumb|center|$1]]',
'fileexists-shared-forbidden' => 'Mayroon nang isang talaksang may ganitong pangalan sa loob ng pinagsasaluhang repositoryo ng talaksan; pakibalikan po at ikarga ang talaksang ito sa isang bagong pangalan. [[Image:$1|thumb|center|$1]]',
...
'getimagelist'              => 'kinukuha ang talaan ng talaksan',
'ilsubmit'                  => 'Hanapin',
'showlast'                  => 'Ipakita ang huling $1 mga talaksang inayos bilang $2.',
'byname'                    => 'ayon sa pangalan',
'bydate'                    => 'ayon sa petsa',
'bysize'                    => 'ayon sa sukat',
'imgdelete'                 => 'bur',
'imgdesc'                   => 'pagl',
'imgfile'                   => 'talaksan',
...
'linkstoimage'              => 'Kumakawing ang sumusunod na mga pahina sa talaksang ito:',
...
'userstatstext'          => "Mayroong {{PLURAL:$1|'''1''' nakatalang [[Special:Listusers|tagagamit]]|mga '''$1''' nakatalang [[Special:Listusers|mga tagagamit]]}}, na ang '''$2''' (o '''$4%''') dito ay {{PLURAL:$2|may|may mga}} $5 mga karapatan.",
...
'withoutinterwiki-header'  => 'Hindi kumakawing sa ibang mga bersyon ng wika ang sumusunod na mga pahina:',
...
'intl'                    => 'Mga kawing na pang-ugnayangwika',
'move'                    => 'Ilipat',
...
'groups'             => 'Mga pangkat ng tagagamit',
...
** Bandalismo',
'delete-toobig'               => 'May isang malaking kasaysayan ng pagbabago ang pahinang ito, mahigit sa $1 mga pagbabago. Ipinagbabawal ang pagbura ng ganyang mga pahina upang maiwasan ang hindi sinasadyang pagkaantala ng {{SITENAME}}.',
'delete-warning-toobig'       => 'Mayroong isang malaking kasaysayan ng pagbabago ang pahinang ito, mahigit sa $1 mga pagbabago.  Ang pagbubura rito ay maaaring makaantala sa mga gawaing pangkalipunan ng dato ng {{SITENAME}}; magpatuloy na may pagiingat.',
...
'protectsub'                  => '(Itinatakda ang antas ng panananggalang para sa "$1")',
'confirmprotect'              => 'Tiyakin ang pagsasanggalang',
...
'unprotectsub'                => '(Tinatanggal mula sa panananggalang ang "$1")',
...
'undeletepagetext'             => 'Binura ang sumusunod na mga pahina subalit nananatili pa ring nasa loob ng sinupan (arkibo) at maaari pang maibalik.  Maaaring palagiang linisin (tanggalan ng laman) ang sinupan.',
...
'undeleterevdel'               => 'Hindi isasagawa ang pagpapabalik mula sa pagkakabura kung magreresulta ito sa bahaging pagkakabura ng pagbabagong nasa pangitaas na pahina.  Sa ganitong mga pagkakataon, dapat mong tanggalin ang tsek o alisin mula sa pagkakatago ang pinakabagong mga pagbabagong nabura.
Hindi ibabalik ang mga pagbabago ng talaksang wala kang pahintulot na tingnan.',
...
'undelete-revision'            => 'Naburang mga pagbabago sa $1 (mula pa noong $2) ni $3:',
...
'ucnote'        => 'Nasa ibaba ang pinakahuling <b>$1</b> mga pagbabago ng tagagamit na ito na nasa loob ng huling <b>$2</b> mga araw.',
'uclinks'       => 'Tingnan ang huling $1 mga pagbabago, tingnan ang huling $2 mga araw.',
'uctop'         => ' (itaas)',
...
'categoryarticlecount'   => 'Mayroong {{PLURAL:$1|isang pahina|$1 mga pahina}} sa loob ng kauriang ito.',
...
'confirmemail_body'       => 'May isa, maaaring ikaw, mula sa adres ng IP na $1, ang nagpatala ng akawnt/kuwentang "$2" na may ganitong adres ng e-liham sa {{SITENAME}}.

Para patotohanang talagang ikaw ang may-ari ng kuwentang ito at paganahin ang mga kasangkapang-katangian ng e-liham na nasa {{SITENAME}}, buksan ang kawing na ito sa iyong pantingin-tingin (\'\'browser\'\'):

$3

Kung *hindi* ikaw ito, huwag sundan ang kawing.
Magwawakas ang pagiging mabisa ng kodigong ito sa $4.',
...
'imgmultigo'       => 'Punta!',
'imgmultigotopre'  => 'Puntahan ang pahina',
...
'lag-warn-high'   => 'Dahil sa malaking kaiwanan/kabagalan ng serbidor ng kalipunan ng dato, maaaring hindi naipapakita sa talaang ito ang mga pagbabagong mas bago kaysa $1 mga segundo.',
...
'filepath-summary' => 'Ibinabalik ng natatanging pahinang ito ang buong daanan para sa isang talaksan.
Ipinapakita ang mga larawan sa pinakabuong resolusyon/pinakamainam na kalinawan, ang ibang uri ng mga talaksan ay tuwirang pinasimulan sa pamamagitan ng mga kaugnay nilang programa.

Ipasok ang pangalan ng talaksan na hindi kasama ang unlapi/paunang "{{ns:image}}:".',
