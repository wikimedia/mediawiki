...
$magicWords = array(
	'redirect'              => array( '0', '#PUSAPUNA', '#REDIRECCIÓN', '#REDIRECCIÓN', '#REDIRECT' ),
	'notoc'                 => array( '0', '__YUYARINANNAQ__', '__NOTDC__', '__NOTDC__', '__NOTOC__' ),
	'nogallery'             => array( '0', '__RIKCHASUYUNNAQ__', '__NOGALERÍA__', '__NOGALERÍA__', '__NOGALLERY__' ),
	'forcetoc'              => array( '0', '__YUYARINATAATIPACHIY__', '__FORZARTDC__', '__FORZARTOC__', '__FORZARTDC__', '__FORZARTOC__', '__FORCETOC__' ),
	'toc'                   => array( '0', '__YUYARINA__', '__TDC__', '__TDC__', '__TOC__' ),
	'noeditsection'         => array( '0', '__AMARAKITAHUKCHAYCHU__', '__NOEDITARSECCIÓN__', '__NOEDITARSECCIÓN__', '__NOEDITSECTION__' ),
	'noheader'              => array( '0', '__UMANNAQ__', '__NOTÍTULO__', '__NOTÍTULO__', '__NOHEADER__' ),
	'currentmonth'          => array( '1', 'KUNANKILLA', 'MESACTUAL', 'MES ACTUAL', 'MESACTUAL', 'MES ACTUAL', 'CURRENTMONTH', 'CURRENTMONTH2' ),
	'currentmonthname'      => array( '1', 'KUNANKILLASUTI', 'NOMBREMESACTUAL', 'NOMBRE MES ACTUAL', 'NOMBREMESACTUAL', 'NOMBRE MES ACTUAL', 'CURRENTMONTHNAME' ),
	...
	'currentday'            => array( '1', 'KUNANPUNCHAW', 'DÍAACTUAL', 'DIAACTUAL', 'DÍA ACTUAL', 'DIA ACTUAL', 'DÍAACTUAL', 'DIAACTUAL', 'DÍA ACTUAL', 'DIA ACTUAL', 'CURRENTDAY' ),
	'currentday2'           => array( '1', 'KUNANPUNCHAW2', 'DÍAACTUAL2', 'DIAACTUAL2', 'DÍA ACTUAL2', 'DIA ACTUAL2', 'DÍAACTUAL2', 'DIAACTUAL2', 'DÍA ACTUAL2', 'DIA ACTUAL2', 'CURRENTDAY2' ),
	'currentdayname'        => array( '1', 'KUNANPUNCHAWSUTI', 'NOMBREDÍAACTUAL', 'NOMBREDIAACTUAL', 'NOMBREDÍAACTUAL', 'NOMBREDIAACTUAL', 'CURRENTDAYNAME' ),
	'currentyear'           => array( '1', 'KUNANWATA', 'AÑOACTUAL', 'AÑO ACTUAL', 'AÑOACTUAL', 'AÑO ACTUAL', 'CURRENTYEAR' ),
	'currenttime'           => array( '1', 'KUNANPACHA', 'CURRENTTIME' ),
	'currenthour'           => array( '1', 'KUNANURA', 'HORA ACTUAL', 'HORAACTUAL', 'HORA ACTUAL', 'HORAACTUAL', 'CURRENTHOUR' ),
	...
	'numberofpages'         => array( '1', 'HAYKAPANQA', 'NUMBEROFPAGES' ),
	'numberofarticles'      => array( '1', 'HAYKAQILLQA', 'NUMBEROFARTICLES' ),
	'numberoffiles'         => array( '1', 'HAYKAWILLANIQI', 'NUMBEROFFILES' ),
	'numberofusers'         => array( '1', 'HAYKARURAQ', 'NUMBEROFUSERS' ),
	'numberofactiveusers'   => array( '1', 'HAYKARURACHKAQ', 'NUMBEROFACTIVEUSERS' ),
	'numberofedits'         => array( '1', 'HAYKALLAMKAPUSQA', 'NUMBEROFEDITS' ),
	...
	'img_right'             => array( '1', 'paña', 'alliq', 'derecha', 'dcha', 'derecha', 'dcha', 'der', 'right' ),
	'img_left'              => array( '1', 'lluqi', 'ichuq', 'izquierda', 'izda', 'izquierda', 'izda', 'izq', 'left' ),
	'img_none'              => array( '1', 'manaima', 'mana', 'ninguna', 'nada', 'no', 'ninguno', 'ninguna', 'nada', 'no', 'ninguno', 'none' ),
	'img_center'            => array( '1', 'chawpi', 'centro', 'centrado', 'centrada', 'centrar', 'centro', 'centrado', 'centrada', 'centrar', 'center', 'centre' ),
	'img_framed'            => array( '1', 'inchuyuq', 'inchu', 'marco', 'enmarcado', 'enmarcada', 'marco', 'enmarcado', 'enmarcada', 'framed', 'enframed', 'frame' ),
	'img_frameless'         => array( '1', 'inchunnaq', 'sinmarco', 'sin embarcar', 'sinenmarcar', 'sinmarco', 'sin embarcar', 'sinenmarcar', 'frameless' ),
	'img_page'              => array( '1', 'panqa=$1', 'page=$1', 'page $1' ),
	'img_upright'           => array( '1', 'sayaq', 'sayaq=$1', 'upright', 'upright=$1', 'upright $1' ),
	'img_border'            => array( '1', 'saywa', 'borde', 'borde', 'border' ),
	...
	'server'                => array( '0', 'SIRWIQ', 'SERVIDOR', 'SERVIDOR', 'SERVER' ),
	'servername'            => array( '0', 'SIRWIQSUTI', 'NOMBRESERVIDOR', 'NOMBRESERVIDOR', 'SERVERNAME' ),
	'scriptpath'            => array( '0', 'QILLQAÑAN', 'QILLQANAN', 'RUTASCRIPT', 'RUTASCRIPT', 'SCRIPTPATH' ),
	'grammar'               => array( '0', 'SIMIKAMACHIY:', 'GRAMMAR:' ),
	'gender'                => array( '0', 'QHARIWARMI:', 'QARIWARMI:', 'GENDER:' ),
	...
	'displaytitle'          => array( '1', 'SUTITARIKUCHIY', 'MOSTRARTÍTULO', 'MOSTRARTITULO', 'MOSTRARTÍTULO', 'MOSTRARTITULO', 'DISPLAYTITLE' ),
	'currentversion'        => array( '1', 'KUNANMUSUQCHASQA', 'REVISIÓNACTUAL', 'REVISIÓNACTUAL', 'CURRENTVERSION' ),
	'urlencode'             => array( '0', 'URLLLAWICHAY', 'URL-LLAWICHAY', 'CODIFICAR', 'CODIFICAR', 'URLENCODE:' ),
	...
	'numberofadmins'        => array( '1', 'HAYKAKAMACHIQ', 'NÚMEROADMINISITRADORES', 'NÚMEROADMINS', 'NÚMEROADMINISITRADORES', 'NÚMEROADMINS', 'NUMBEROFADMINS' ),
	'formatnum'             => array( '0', 'YUPAYRIKCHAKUY', 'FORMATONÚMERO', 'FORMATONÚMERO', 'FORMATNUM' ),
	'padleft'               => array( '0', 'PADLLUQI', 'PADICHUQ', 'PADLEFT' ),
	'padright'              => array( '0', 'PADPAÑA', 'PADALLIQ', 'PADRIGHT' ),
	'special'               => array( '0', 'sapaq', 'special' ),
	'defaultsort'           => array( '1', 'ALLINCHAY', 'SIQINCHAY', 'ORDENAR', 'ORDENAR', 'DEFAULTSORT:', 'DEFAULTSORTKEY:', 'DEFAULTCATEGORYSORT:' ),
	'filepath'              => array( '0', 'WILLAÑIQIÑAN', 'WILLANIQINAN', 'RUTAARCHIVO', 'RUTARCHIVO', 'RUTAARCHIVO', 'RUTARCHIVO', 'FILEPATH:' ),
	'tag'                   => array( '0', 'unanchacha', 'UNANCHACHA', 'etiqueta', 'ETIQUETA', 'etiqueta', 'ETIQUETA', 'tag' ),
	'hiddencat'             => array( '1', '__PAKASQAKATIGURIYA__', '__CATEGORÍAOCULTA__', '__CATEGORÍAOCULTA__', '__HIDDENCAT__' ),
	'pagesincategory'       => array( '1', 'KATIGURIYAPIPANQAKUNA', 'PÁGINASENCATEGORÍA', 'PÁGINASENCAT', 'PAGSENCAT', 'PÁGINASENCATEGORÍA', 'PÁGINASENCAT', 'PAGSENCAT', 'PAGESINCATEGORY', 'PAGESINCAT' ),
	'pagesize'              => array( '1', 'PANQACHHIKAN', 'PANQACHIKAN', '', 'PANQACHIKA', 'TAMAÑOPÁGINA', 'TAMAÑOPÁGINA', 'PAGESIZE' ),
	'index'                 => array( '1', '__UNANCHAY__', '__INDEX__' ),
	'noindex'               => array( '1', '__AMAUNANCHAYCHU__', '__NOINDEX__' ),
	...
	'protectionlevel'       => array( '1', 'HAYKAAMACHAY', 'IMASINCHIAMACHAY', 'PROTECTIONLEVEL' ),
);
