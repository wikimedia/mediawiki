...
'emailpagetext'   => 'ניתן להשתמש בטופס שלהלן לצורך שליחת הודעת דואר־אלקטרוני למשתמש זה.
...
'watchlist-show-own'       => 'הצגת העריכות שלי',
...
'cant-move-to-user-page'    => 'אין לך הרשאות להעביר עמוד אל עמוד משתמש (מלבד אל תת־עמוד משתמש).',
'newtitle'                  => 'לשם החדש:',
...
'immobile-source-namespace' => 'לא ניתן להעביר עמודים בתוך מתחם השם "$1"',
'immobile-target-namespace' => 'לא ניתן להעביר עמודים אל מתחם השם "$1"',
'immobile-source-page'      => 'עמוד זה אינו ניתן להעברה.',
