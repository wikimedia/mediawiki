...
$specialPageAliases = array(
	'DoubleRedirects'           => array( 'הפניות כפולות' ),
	'BrokenRedirects'           => array( 'הפניות לא תקינות', 'הפניות שבורות' ),
	'Disambiguations'           => array( 'פירושונים', 'דפי פירושונים' ),
	'Userlogin'                 => array( 'כניסה לחשבון', 'כניסה', 'כניסה / הרשמה לחשבון' ),
	'Userlogout'                => array( 'יציאה מהחשבון', 'יציאה' ),
	'Preferences'               => array( 'העדפות', 'ההעדפות שלי' ),
	'Watchlist'                 => array( 'רשימת המעקב', 'רשימת מעקב', 'רשימת המעקב שלי' ),
	'Recentchanges'             => array( 'שינויים אחרונים' ),
	'Upload'                    => array( 'העלאה', 'העלאת קובץ לשרת' ),
	'Imagelist'                 => array( 'רשימת תמונות', 'תמונות' ),
	'Newimages'                 => array( 'תמונות חדשות', 'גלריית תמונות חדשות' ),
	'Listusers'                 => array( 'רשימת משתמשים', 'משתמשים' ),
	'Statistics'                => array( 'סטטיסטיקות' ),
	'Randompage'                => array( 'אקראי', 'דף אקראי' ),
	'Lonelypages'               => array( 'דפים יתומים' ),
	'Uncategorizedpages'        => array( 'דפים חסרי קטגוריה' ),
	'Uncategorizedcategories'   => array( 'קטגוריות חסרות קטגוריה' ),
	'Uncategorizedimages'       => array( 'תמונות חסרות קטגוריה' ),
	'Uncategorizedtemplates'    => array( 'תבניות חסרות קטגוריות' ),
	'Unusedcategories'          => array( 'קטגוריות שאינן בשימוש' ),
	'Unusedimages'              => array( 'תמונות שאינן בשימוש' ),
	'Wantedpages'               => array( 'דפים מבוקשים' ),
	'Wantedcategories'          => array( 'קטגוריות מבוקשות' ),
	'Mostlinked'                => array( 'הדפים המקושרים ביותר' ),
	'Mostlinkedcategories'      => array( 'הקטגוריות המקושרות ביותר' ),
	'Mostlinkedtemplates'       => array( 'התבניות המקושרות ביותר' ),
	'Mostcategories'            => array( 'הקטגוריות הרבות ביותר', 'הדפים מרובי-הקטגוריות ביותר' ),
	'Mostimages'                => array( 'התמונות המקושרות ביותר' ),
	'Mostrevisions'             => array( 'הגרסאות הרבות ביותר', 'הדפים בעלי מספר העריכות הגבוה ביותר' ),
	'Fewestrevisions'           => array( 'הגרסאות המעטות ביותר', 'הדפים בעלי מספר העריכות הנמוך ביותר' ),
	'Shortpages'                => array( 'דפים קצרים' ),
	'Longpages'                 => array( 'דפים ארוכים' ),
	'Newpages'                  => array( 'דפים חדשים' ),
	'Ancientpages'              => array( 'דפים מוזנחים' ),
	'Deadendpages'              => array( 'דפים ללא קישורים' ),
	'Protectedpages'            => array( 'דפים מוגנים' ),
	'Allpages'                  => array( 'כל הדפים' ),
	'Prefixindex'               => array( 'דפים המתחילים ב' ) ,
	'Ipblocklist'               => array( 'רשימת חסומים', 'רשימת משתמשים חסומים', 'משתמשים חסומים' ),
	'Specialpages'              => array( 'דפים מיוחדים' ),
	'Contributions'             => array( 'תרומות', 'תרומות המשתמש' ),
	'Emailuser'                 => array( 'שליחת דואר למשתמש' ),
	'Whatlinkshere'             => array( 'דפים המקושרים לכאן' ),
	'Recentchangeslinked'       => array( 'שינויים בדפים המקושרים' ),
	'Movepage'                  => array( 'העברת דף', 'העברה' ),
	'Blockme'                   => array( 'חסום אותי' ),
	'Booksources'               => array( 'משאבי ספרות', 'משאבי ספרות חיצוניים' ),
	'Categories'                => array( 'קטגוריות', 'רשימת קטגוריות' ),
	'Export'                    => array( 'ייצוא', 'ייצוא דפים' ),
	'Version'                   => array( 'גרסה', 'גרסת התוכנה' ),
	'Allmessages'               => array( 'הודעות המערכת' ),
	'Log'                       => array( 'יומנים' ),
	'Blockip'                   => array( 'חסימת משתמש', 'חסימה' ),
	'Undelete'                  => array( 'צפיה בדפים מחוקים' ),
	'Import'                    => array( 'ייבוא', 'ייבוא דפים' ),
	'Lockdb'                    => array( 'נעילת בסיס הנתונים' ),
	'Unlockdb'                  => array( 'שחרור בסיס הנתונים מנעילה' ),
	'Userrights'                => array( 'ניהול הרשאות משתמש' ),
	'MIMEsearch'                => array( 'חיפוש MIME' ),
	'Unwatchedpages'            => array( 'דפים שאינם במעקב' ),
	'Listredirects'             => array( 'רשימת הפניות', 'הפניות' ),
	'Revisiondelete'            => array( 'מחיקת ושחזור גרסאות' ),
	'Unusedtemplates'           => array( 'תבניות שאינן בשימוש' ),
	'Randomredirect'            => array( 'הפניה אקראית' ),
	'Mypage'                    => array( 'הדף שלי', 'דף המשתמש שלי' ),
	'Mytalk'                    => array( 'דף השיחה שלי' ),
	'Mycontributions'           => array( 'התרומות שלי' ),
	'Listadmins'                => array( 'רשימת מפעילים' ),
	'Popularpages'              => array( 'דפים פופולריים' ),
	'Search'                    => array( 'חיפוש' ),
	'Resetpass'                 => array( 'איפוס סיסמה' ),
	'Withoutinterwiki'          => array( 'דפים ללא קישורי שפה' ),
);
