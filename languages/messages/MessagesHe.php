...
'right-noratelimit'          => 'ביטול הגבלת קצב העריכות',
...
'ipb_modifying_block'         => 'שינוי חסימה קיימת:',
'ipb_tweak_block'             => 'זהירות: משתמש זה ($1) כבר נחסם.
באפשרותכם להשתמש בטופס זה כדי לשנות את הגדרות החסימה.',
