...
אנא בדקו ביומנים.',
'revdelete-only-restricted' => 'שגיאה בהסתרת הפריט מתאריך $2, $1: אין באפשרותך להסתיר פריטים ממפעילי המערכת מבלי לבחור גם באחת מאפשרויות ההסתרה האחרות.',
...
'showingresultsinrange' => '{{PLURAL:$1|מוצגת תוצאה <strong>אחת</strong>|מוצגות עד <strong>$1</strong> תוצאות}} בין המספרים <strong>$2</strong> ו‏‏֫־<strong>$3</strong>:',
...
'right-editmyusercss' => 'עריכת גיליונות CSS של המשתמש עצמו',
'right-editmyuserjs' => 'עריכת קבצי JavaScript של המשתמש עצמו',
'right-viewmywatchlist' => 'צפייה ברשימת המעקב של המשתמש עצמו',
'right-editmywatchlist' => 'עריכת רשימת המעקב של המשתמש עצמו. מספר פעולות עדיין יוסיפו דפים גם ללא הרשאה זו.',
