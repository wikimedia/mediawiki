...
'tog-uselivepreview'          => 'שימוש בתצוגה מקדימה חיה (JavaScript) (ניסיוני)',
...
'edithelppage'      => 'Project:איך לערוך דף',
'faq'               => 'שאלות ותשובות',
'faqpage'           => 'Project:שאלות ותשובות',
'helppage'          => 'Project:עזרה',
'mainpage'          => 'עמוד ראשי',
...
'undeletehistory'              => 'אם תשחזרו את הדף, כל הגרסאות תשוחזרנה להיסטוריית השינויים שלו. אם כבר יש דף חדש באותו השם, הגרסאות והשינויים יופיעו רק בדף ההיסטוריה שלו. בנוס, הגבלות המוטלות על גרסאות קבצים נמחקות במהלך השחזור.',
