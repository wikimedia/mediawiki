...
'login'                      => 'כניסה לחשבון',
'nav-login-createaccount'    => 'כניסה / הרשמה לחשבון',
...
'showingresultstotal'       => "הצגת תוצאות '''$1 - $2''' מתוך '''$3'''",
...
סימון * מסמן שלא תוכלו להסיר משתמש מהקבוצה מרגע שהוספתם אותו אליה, או להיפך.',
...
'group'                => 'קבוצה:',
'group-user'           => 'משתמשים',
'group-emailconfirmed' => 'משתמשים בעלי כתובת דוא"ל מאומתת',
...
'group-emailconfirmed-member' => 'משתמש בעל כתובת דוא"ל מאומתת',
...
'grouppage-emailconfirmed' => '{{ns:project}}:משתמש בעל כתובת דוא"ל מאומתת',
...
'right-hiderevision'     => 'בדיקה ושחזור של גרסאות מחוקות',
...
'right-deleterevision'   => 'הסתרת גרסאות מסוימות של דפים',
'right-proxyunbannable'  => 'עקיפת חסימות פרוקסי',
'right-browsearchive'    => 'חיפוש דפים מחוקים',
'right-trackback'        => 'שליחת טראקבק',
'right-siteadmin'        => 'נעילת וביטול נעילת מסד הנתונים',
...
'right-rollback'         => 'שחזור מהיר של המשתמש האחרון שערך דף מסוים',
'right-userrights'       => 'עריכת כל הרשאות המשתמש',
'right-suppressredirect' => 'מחיקת הפניה בעת העברת דף',
'right-createaccount'    => 'יצירת חשבונות משתמשים',
'right-editinterface'    => 'עריכת ממשק המשתמש',
'right-upload'           => 'העלאת קבצים',
'right-hideuser'         => 'הסתרת שם משתמש מהציבור',
'right-purge'            => 'רענון זכרון המטמון של האתר לדף מסוים ללא הודעת אישור',
'right-upload_by_url'    => 'העלאת קובץ מכתובת URL',
'right-undelete'         => 'שחזור דף מחוק',
'right-suppress'         => 'צפייה ביומנים פרטיים',
'right-autopatrol'       => 'סימון עריכות של המשתמש כבדוקות אוטומטית',
'right-import'           => 'ייבוא דפים מאתרי ויקי אחרים',
'right-deletedhistory'   => 'צפייה בגרסאות מחוקות, ללא הטקסט ששייך להן',
'right-patrol'           => 'סימון עריכות כבדוקות',
