...
'wantedfiletext-cat'      => 'הקבצים האלה בשימוש, אבל אינם קיימים. קבצים ממאגרים חיצוניים יכולים להיות רשומים למרות קיומם. שגיאות כאלה יהיו <del>מחוקות</del>. בנוסף, דפים שמטמיעים קבצים שאינם קיימים רשומים בדף [[:$1]].',
'wantedfiletext-nocat'    => 'הקבצים האלה בשימוש, אבל אינם קיימים. קבצים ממאגרים חיצוניים יכולים להיות רשומים למרות קיומם. שגיאות כאלה יהיו <del>מחוקות</del>.',
