...
'right-patrolmarks'          => '最近更新したページのパトロールマークを表示',
'right-unwatchedpages'       => 'ウォッチされていないページのリストを表示',
...
'uploadlogpagetext'           => '以下はファイルアップロードの最近の記録です。画像付きで見るには[[Special:NewFiles|新規画像ギャラリー]]をご覧ください。',
'filename'                    => 'ファイル名',
'filedesc'                    => 'ファイルの概要',
