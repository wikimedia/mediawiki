...
'hidden-category-category'       => 'নিহিত শ্ৰেণী সমূহ', # Name of the category where hidden categories will be listed
...
'noconnect'            => 'ক্ষ্মমা কৰিব! এই ৱিকিয়ে বৰ্তমান কাৰিকৰি অসুবিধাৰ কাৰণে তথ্যকোষ চাৰ্ভাৰৰ লগত সম্পৰ্ক স্থাপন কৰাত অপৰাগ।<br />
$1',
'nodb'                 => 'তথ্যকোষ $1 বাচনী কৰিব পৰা নগল',
'cachederror'          => 'এয়া আগতে জমা কৰি থোৱা(cached) প্ৰতিলিপী, আৰু এয়া সাম্প্ৰতিক নহব পাৰে।',
...
'templatesused'                    => 'এই পৃষ্ঠাত ব্যৱহৃত ঠাঁচ সমূহ',
'templatesusedpreview'             => 'ব্যৱহৃত ঠাঁচ সমূহ',
...
'recreate-deleted-warn'            => "'''সাৱধান: আপুনি আগতে বিলোপিত কৰা পৃষ্ঠা এটা পূণঃনিৰ্মান কৰি আছে। '''

এই পৄষ্ঠাটো সম্পাদনা কৰা উচিত হব নে নাই আপুনি বিবেচনা কৰি চাওক।
এই পৃষ্ঠাটো বিলোপ কৰাৰ অভিলেখ আপোনাৰ সুবিধাৰ্থে ইয়াত দিয়া হৈছে।",
...
'diff-movedto'            => "$1-লৈ স্থানান্তৰ কৰা হ'ল",
'diff-added'              => "$1 যোগ কৰা হ'ল",
'diff-changedto'          => "$1-লৈ সলনি কৰা হ'ল",
'diff-movedoutof'         => "$1-ৰ পৰা স্থানান্তৰ কৰা হ'ল",
'diff-changedfrom'        => "$1-ৰ পৰা সলনি কৰা হ'ল",
'diff-src'                => 'উৎস',
'diff-width'              => 'পথালি',
'diff-height'             => 'উচ্চতা',
'diff-p'                  => "এটা '''দফা'''",
'diff-blockquote'         => "এটা '''উক্তি'''",
'diff-i'                  => "'''ইটালিক'''",
'diff-b'                  => "'''বোল্ড'''",
...
'prefsnologintext'          => 'আপোনাৰ পচন্দ সলনী কৰিবলৈ হলে [[Special:UserLogin|প্ৰৱেশ]] কৰাতো আৱশ্যক।',
'prefsreset'                => 'পচন্দ সমূহ পুৰ্ববত কৰা হৈছে।',
...
'prefs-watchlist-days-max'  => '(অধিকতম ৭ দিন)',
'prefs-watchlist-edits'     => 'বৰ্ধিত লক্ষ্যসুচীত দেখুৱাব লগা সৰ্বোচ্চ সাল-সলনী:',
'prefs-watchlist-edits-max' => '(অধিকতম সংখ্যা: ১০০০)',
'prefs-misc'                => 'অন্যান্য',
...
'recentchangesdays-max'     => '(অধিকতম $1 {{PLURAL:$1|দিন|দিন}})',
...
'timezonetext'              => '¹চাৰ্ভাৰৰ সময় (UTC) আৰু আপোনাৰ স্থানীয় সময়ৰ মাজত পাৰ্থক্য (ঘণ্টাত)।',
...
'defaultns'                 => 'এই নামস্থান সমূহত সদায়ে অনুসন্ধান কৰিব:',
'default'                   => 'অবিচল',
'files'                     => 'ফাইলসমূহ',
...
'protect-expiry-options'      => '‌১ ঘণ্টা:1 hour,১ দিন:1 day,১ সপ্তাহ:1 week,২ সপ্তাহ:2 weeks,১ মাহ:1 month,৩ মাহ:3 months,৬ মাহ:6 months,১ বছৰ:1 year,অনিৰ্দিস্ট কাল:infinite', # display1:time1,display2:time2,...
...
'ipboptions'               => '২ ঘ্ণ্টা:2 hours,১ দিন:1 day,৩ দিন:3 days,১ সপ্তাহ:1 week,২ সপ্তাহ:2 weeks,১ মাহ:1 month,৩ মাহ:3 months,৬ মাহ:6 months,১ বছৰ:1 year,অনিৰ্দিস্ট কাল:infinite', # display1:time1,display2:time2,...
