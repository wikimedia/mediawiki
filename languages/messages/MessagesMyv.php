...
'loadhist'            => 'Лопанть юронзо-путовксонзо ловновить',
...
'spheading'               => 'Весе теицятнень туртов башка тевень лопат',
'restrictedpheading'      => 'Аволь весе теицятнень туртов башка тевень лопат',
'newpages'                => 'Од лопат',
'newpages-username'       => 'Теицянь лем:',
'ancientpages'            => 'Весемеде умонь лопат',
'intl'                    => 'Кельде кельс сюлмавома пенеть',
'move'                    => 'Печтевтть',
