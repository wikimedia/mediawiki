...
'mainpagetext' => "<span style="font-size:larger">'''МедияВикинь тевс аравтомазо парсте лиссь.'''</span>",
...
'blockedtext'                      => "<span style="font-size:larger">'''Тонть теицянь леметь эли IP-тешкстэть совавтозь саймас.'''</span>
...
'movepage-moved'            => "<span style="font-size:larger">'''«$1»-сь печтевтезь «$2»-с'''</span>",
