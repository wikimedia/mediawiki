...
'noarticletext'                    => 'ھەنووکە ھیچ دەقێک لەم پەڕەدا نیە.
دەتوانی بۆ ئەم ناوە لە [[Special:Search/{{PAGENAME}}|پەڕەکانی تردا بگەڕێی]]، <span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{FULLPAGENAMEE}}}} لە لۆگەکاندا بگەڕی ]، یان [{{fullurl:{{FULLPAGENAME}}|action=edit}} ئەم پەڕە دەستکاری بکەیت]</span>.',
...
'searchsubtitle'                   => "گەڕایت بۆ '''[[:$1]]''' ([[Special:Prefixindex/$1|هەموو ئەو پەڕانەی بە «$1»ەوە دەستپێدەکەن]]{{int:pipe-separator}}[[Special:WhatLinksHere/$1|هەموو ئەو پەڕانەی بەستەریان ھەیە بۆ «$1»]])",
...
'watchlisttools-edit' => 'لیستی چاودێری ببینە و دەستکاریبکە',
'watchlisttools-raw'  => 'لیستی خاوی چاودێری دەستکاریبکە',
