...
'blockedtext'                      => "<span style="font-size:larger">'''თქვან მახვარებუშ ჯოხო ვარა IP მიოწურაფუქ ბლოკირქ იჸუ. '''</span> 
...
'movepage-moved'   => '<span style="font-size:larger">\'\'\'"$1" გინოღალულ რე "$2"\'\'\'</span>',
