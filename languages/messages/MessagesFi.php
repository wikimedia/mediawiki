...
'usercsspreview'                   => "'''Tämä on vain CSS:n esikatselu. Mitään muutoksia ei ole vielä tallennettu.'''",
...
'statistics-header-views'  => 'Näyttämistilastot',
'statistics-header-users'  => 'Käyttäjätilastot',
'statistics-articles'      => 'Sisältösivuja',
'statistics-pages'         => 'Sivuja <small>(tämä sisältää keskustelusivut, {{GRAMMAR:genitive|{{SITENAME}}}} projektisivut, hyvin lyhyet sivut, ohjaukset, ja muut)</small>',
'statistics-files'         => 'Tallennettuja tiedostoja',
'statistics-edits'         => 'Sivuja muokattu {{GRAMMAR:genitive|{{SITENAME}}}} perustamisesta lähtien',
