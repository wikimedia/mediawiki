...
'blockedtext'                      => "<span style="font-size:larger">'''Machomma' i na'an-mu muna'sesetbi pat IP-mu.'''</span>
...
'movepage-moved'   => '<span style="font-size:larger">\'\'\'Makånya "$1" para "$2"\'\'\'</span>',
