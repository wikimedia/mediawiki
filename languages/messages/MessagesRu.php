...
'action-edit'                 => 'править эту страницу',
'action-createpage'           => 'создавать страницы',
'action-createtalk'           => 'создавать страницы обсуждений',
'action-createaccount'        => 'создавать эту учётную запись участника',
'action-minoredit'            => 'отмечать эту правку как малую',
'action-move'                 => 'переименовывать эту страницу',
'action-move-subpages'        => 'переименовывать эту страницу со всеми её подстраницами',
'action-upload'               => 'загружать этот файл',
'action-reupload'             => 'перезаписывать существующий файл',
'action-reupload-shared'      => 'перекрывать файл из общего хранилища',
'action-upload_by_url'        => 'загружать этот файл с адреса URL',
...
'action-deletedhistory'       => 'просматривать журнал удалений этой страницы',
'action-browsearchive'        => 'искать удалённые страницы',
'action-undelete'             => 'восстанавливать эту страницу',
'action-suppressrevision'     => 'просматривать и восстанавливать эту скрытую версию страницы',
'action-suppressionlog'       => 'просматривать этот частный журнал',
'action-block'                => 'блокировать участника, запрещать ему делать правки',
'action-protect'              => 'изменять уровень защиты этой страницы',
'action-import'               => 'импортировать эту страницу в другую вики',
'action-importupload'         => 'импортировать эту страницу из загруженного файла',
'action-patrol'               => 'отмечать чужие правки как отпатрулированные',
'action-autopatrol'           => 'отмечать свои правки как отпатрулированные',
'action-unwatchedpages'       => 'просматривать список страниц, за которыми никто не наблюдает',
'action-trackback'            => 'отправлять trackback',
...
'action-siteadmin'            => 'блокировать и разблокировать базу данных',
...
'dismissnotice'         => 'Скрыть сообщение сайта',
'dismissnotice-nologin' => 'Вы должны [[Special:UserLogin|представиться системе]], чтобы скрыть сообщение сайта.',
