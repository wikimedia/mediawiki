...
'nonefound'                 => "'''Замечание.''' По умолчанию поиск производится не во всех пространствах имён. Используйте приставку ''all:'', чтобы искать по всей Википедии (включая обсуждения участников, шаблоны и пр.), или укажите требуемое пространство имён.",
