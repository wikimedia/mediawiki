...
/** Russian (русский язык)
  ...
  * and ru.wikipedia MediaWiki namespace (2007-05-22)
  *
...
Ваш индентификатор блокировки — #$5. Пожалуйста, указывайте его в своих запросах.',
...
'watcheditlist'        => 'Ниже представлен упорядоченный по алфавиту список наблюдаемых вами страниц. Отметьте страницы, которые вы хотите удалить из вашего списка наблюдения, и нажмите на кнопку «Удалить выбранные элементы» внизу страницы.',
...
'block-log-flags-noautoblock'   => 'автоблокировка запрещена',
...
'lag-warn-high' => 'Из-за большого отставания в синхронизации серверов баз данных, изменения, сделанные раньше чем $1 секунд назад,
могут быть не показаны в этом списке.',
