...
'mainpagetext'      => "<span style="font-size:larger">'''Вики-движок «MediaWiki» успешно установлен.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Запрошенной вами служебной страницы не существует.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Ваша учётная запись или IP-адрес заблокированы.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''Страница «$1» была восстановлена.'''</span>
...
'movepage-moved'               => "<span style="font-size:larger">'''Страница «$1» переименована в «$2»'''</span>",
