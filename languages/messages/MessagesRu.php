...
'usercssyoucanpreview'             => "'''Подсказка.''' Нажмите кнопку «Предварительный просмотр», чтобы проверить ваш новый CSS- или JS-файл перед сохранением.",
'userjsyoucanpreview'              => "'''Подсказка.''' Нажмите кнопку «Предварительный просмотр», чтобы проверить ваш новый CSS- или JS-файл перед сохранением.",
...
'prefs-watchlist-token'         => 'Токен списка набюлдения',
...
Вы можете использовать случайно сгенерированное значение: $1',
