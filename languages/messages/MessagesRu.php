...
'protectedpagewarning' => '<strong>ПРЕДУПРЕЖДЕНИЕ: эта страница защищена от изменений, и только [[Project:Администраторы|администраторы]] могут редактировать её. См. [[Project:Правила защиты страниц|правила защиты страниц]].</strong>',
...
'undo-summary' => 'Отмена версии $1 участника [[{{ns:special}}:Contributions/$2]] ([[{{ns:user_talk}}:$2]])',
