...
'categoriespagetext'            => 'Нижние категории содержат {{PLURAL:$1|страниццы|страницы}} или медиа-файлы.
...
'blockipsuccesssub'               => 'ГСБ вас выебал',
...
'anononlyblock'                   => 'только педерастов',
...
'block-log-flags-anononly'        => 'только педерасты',
