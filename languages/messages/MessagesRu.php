...
'aboutsite' => 'Лоацам {{grammar:genitive|{{SITENAME}}}}',
'aboutpage' => 'Project:Лоацам',
'copyright' => 'Содержимое доступно в соответствии с $1.',
'copyrightpage' => '{{ns:project}}:Авторские права',
'currentevents' => 'Х|анзара хоамаш',
'currentevents-url' => 'Project:Х|анзара хоамаш',
'disclaimers' => 'Бехктокхамах валар/ялар',
'disclaimerpage' => 'Project:Бехктокхамах валар/ялар',
'edithelp' => 'Справка по редактированию',
'edithelppage' => 'Help:Г|алатнийсдар',
'helppage' => 'Help:Чулоацам',
'mainpage' => 'Кертера оаг|ув',
'mainpage-description' => 'Кертера оаг|ув',
'policy-url' => 'Project:Бокъо',
'portal' => 'Гулламков',
'portal-url' => 'Project:Гулламков',
'privacy' => 'Тешакъайлен паччал',
'privacypage' => 'Project:Тешакъайлен паччал',
...
'editsectionhint' => 'декъам «$1» г|алатнийсде',
'toc' => 'Содержание',
'showtoc' => 'показать',
'hidetoc' => 'убрать',
...
'revdelete-show-file-submit' => 'Х|аа',
...
'search-result-size' => '$1 ({{PLURAL:$2|$2 дош|$2 дешаш|$2 дешаш}})',
...
'action-edit' => 'укх оаг|он г|алатнийсдар',
...
'tooltip-search' => 'Укхаз лахар {{grammar:genitive|{{SITENAME}}}}',
...
'tooltip-t-specialpages' => 'Г|улакхен оаг|он дагарлe',
