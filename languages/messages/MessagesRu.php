...
/** Russian (русский язык)
  *
  * Based on MessagesEn.php revision 20872 (2007-04-01)
  * and ru.wikipedia MediaWiki namespace (2007-04-01)
  *
...
'protect'           => 'Защитить',
'protect_change'    => 'Изменить защиту',
...
'revdelete-hide-name'         => 'Скрыть дейсвие и его объект',
...
Имя существующегшо файла: <strong><tt>$2</tt></strong><br />
...
Если у вас есть даное изображение в полном размере, пожалуйста, загрузите его, иначе измените имя файла.',
...
'withoutinterwiki-header' => 'Слежующие страницы не имеют ссылок на иноязыные версии:',
...
'my-watchlist'            => 'Список наблюдения',
...
'whatlinkshere-prev' => 'предыдущие $1',
'whatlinkshere-next' => 'следующие $1',
