...
Вы можете [[Special:EmailUser/$4|отправить письмо {{GENDER:$4|участнику|участнице}} $4]] или любому другому [[{{MediaWiki:Grouppage-sysop}}|администратору]], чтобы обсудить блокировку.
...
Обратите внимание, что Вы не сможете отправить письмо администратору, если Вы не зарегистрированы в проекте или не подтвердили свой адрес электронной почты в [[Special:Preferences|личных настройках]], а также если Вам было запрещено отправлять письма при блокировке.
...
'accmailtext'                      => "Пароль для {{GENDER:$1|участника|участницы}} [[User talk:$1|$1]], созданный из случайных символов, выслан на адрес $2.

После входа в систему Вы сможете ''[[Special:ChangePassword|изменить пароль]]''.",
'newarticle'                       => '(Новая)',
...
'prefs-changeemail'             => 'изменить адрес эл. почты',
...
'backend-fail-batchsize'     => 'Бэкэнд получил блок из $1 {{PLURAL:$1|файловой операции|файловых операций|файловых операций}}, ограничение составляет $2 {{PLURAL:$1|файловая операция|файловых операций|файловых операций}}.',
...
# Unwatched pages
'unwatchedpages' => 'Страницы, за которыми не следят',
...
'usercreated'             => '{{GENDER:$3|зарегистрирован|зарегистрирована}} $1 в $2',
...
'emailuserfooter'      => 'Это письмо было отправлено {{GENDER:$2|участнику|участнице}} $2 от {{GENDER:$1|участника|участницы}} $1 с помощью функции «Отправить письмо» проекта {{SITENAME}}.',
...
Последующие изменения этой страницы и {{#ifeq:{{SUBJECTPAGENAME}}|$1|[[{{TALKPAGENAME}}|связанной с ней страницы обсуждения]]|[[:{{SUBJECTPAGENAME}}|связанной с ней основной страницы]]}} будут отмечаться в этом списке, а также будут выделены '''жирным''' шрифтом на странице со [[Special:RecentChanges|списком свежих изменений]], чтобы их было легче заметить.",
...
'watchnochange'        => 'Ни одна страница из списка наблюдения не изменялась в указанный период.',
...
кто-то другой уже отредактировал или откатил правки на этой странице.
...
'sp-contributions-deleted'             => 'удалённый вклад {{GENDER:$1|участника|участницы}}',
...
'ipb-needreblock'                 => '{{GENDER:$1|Участник $1 уже заблокирован|Участница $1 уже заблокирована}}. Желаете ли Вы изменить параметры блокировки?',
...
Страница с именем «[[:$1]]» уже существует. Вы хотите её удалить, чтобы сделать возможным переименование?',
...
'confirmemail_noemail'      => 'Вы не задали действительного адреса электронной почты в своих [[Special:Preferences|настройках]].',
...
# Watchlist editor
'watchlistedit-numitems'       => 'Ваш список наблюдения содержит $1 {{PLURAL:$1|запись|записи|записей}}, исключая страницы обсуждений.',
...
'watchlistedit-normal-done'    => '$1 {{PLURAL:$1|запись была удалена|записи были удалены|записей были удалены}} из Вашего списка наблюдения:',
'watchlistedit-raw-title'      => 'Правка списка наблюдения как текст',
'watchlistedit-raw-legend'     => 'Править список наблюдения как текст',
...
'watchlistedit-raw-added'      => '$1 {{PLURAL:$1|запись была добавлена|записи были добавлены|записей были добавлены}}:',
'watchlistedit-raw-removed'    => '$1 {{PLURAL:$1|запись была удалена|записи были удалены|записей были удалены}}:',
