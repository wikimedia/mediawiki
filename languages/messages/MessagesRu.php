...
'mergehistory-header'              => "Эта страница позволяет вам объединить историю двух различных страниц.
...
'mergehistory-merge'               => 'Следующие версии [[:$1]] могут быть объединины в [[:$2]]. Используйте переключатели для того, чтобы объединить только диапазон правокю Учтите, что при использовании навигационных ссылок данные будут потерянны.',
'mergehistory-go'                  => 'Показать объединяемые правки',
'mergehistory-submit'              => 'Объединить страницы',
'mergehistory-empty'               => 'Не найдены правки для объединения',
'mergehistory-success'             => '$3 {{PLURAL:$3|версия|версии}} из [[:$1]] успешно объединино в [[:$2]].',
