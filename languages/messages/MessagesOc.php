...
'javascripttest-disabled' => 'Aquesta foncion es pas estada activada sus aqueste wiki.',
...
'logentry-delete-event' => "$1 a modificat la visibilitat {{PLURAL:$5|d'un eveniment del jornal|de $5 eveniments del jornal}} sus $3: $4",
'logentry-delete-revision' => '$1 a modificat la visibilitat {{PLURAL:$5|d’una revision|de $5 revisions}} sus la pagina $3&nbsp;: $4',
'logentry-delete-event-legacy' => '$1 a modificat la visibilitat dels eveniments del jornal sus $3',
'logentry-delete-revision-legacy' => '$1 a modificat la visibilitat de las revisions sus la pagina $3',
'logentry-suppress-delete' => '$1 a suprimit la pagina $3',
