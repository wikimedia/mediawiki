...
$magicWords = array(
	'redirect'              => array( '0', '#ווייטערפירן', '#הפניה', '#הפניה', '#הפניה', '#הפניה', '#REDIRECT' ),
	'nogallery'             => array( '0', '__קיין_גאלעריע', '__ללא_גלריה__', '__ללא_גלריה__', '__ללא_גלריה__', '__NOGALLERY__' ),
	'toc'                   => array( '0', '__אינהאלט__', '__תוכן__', '__תוכן_עניינים__', '__תוכן_עניינים__', '__תוכן__', '__תוכן_עניינים__', '__תוכן__', '__TOC__' ),
	'pagename'              => array( '1', 'בלאטנאמען', 'שם הדף', 'שם הדף', 'PAGENAME' ),
	'namespace'             => array( '1', 'נאמענטייל', 'מרחב השם', 'מרחב השם', 'מרחב השם', 'NAMESPACE' ),
	'fullpagename'          => array( '1', 'פולבלאטנאמען', 'שם הדף המלא', 'שם הדף המלא', 'שם הדף המלא', 'FULLPAGENAME' ),
	'subpagename'           => array( '1', 'אונטערבלאטנאמען', 'שם דף המשנה', 'שם דף המשנה', 'שם דף המשנה', 'SUBPAGENAME' ),
	'subst'                 => array( '0', 'ס:', 'ס:', 'ס:', 'ס:', 'SUBST:' ),
	...
	'img_left'              => array( '1', 'לינקס', 'שמאל', 'שמאל', 'שמאל', 'left' ),
	'img_none'              => array( '1', 'אן', 'ללא', 'ללא', 'none' ),
	'img_center'            => array( '1', 'צענטער', 'מרכז', 'מרכז', 'center', 'centre' ),
	'img_sub'               => array( '1', 'אונטער', 'תחתי', 'תחתי', 'sub' ),
	'plural'                => array( '0', 'מערצאל:', 'רבים:', 'רבים:', 'PLURAL:' ),
	'fullurl'               => array( '0', 'פֿולער נאמען:', 'כתובת מלאה:', 'כתובת מלאה:', 'FULLURL:' ),
	'raw'                   => array( '0', 'רוי:', 'ללא עיבוד:', 'ללא עיבוד:', 'RAW:' ),
	...
	'defaultsort'           => array( '1', 'גרונטסארטיר:', 'מיון רגיל:', 'מיון רגיל:', 'מיון רגיל:', 'DEFAULTSORT:', 'DEFAULTSORTKEY:', 'DEFAULTCATEGORYSORT:' ),
	'pagesize'              => array( '1', 'בלאטגרייס', 'גודל דף', 'גודל דף', 'PAGESIZE' ),
);
