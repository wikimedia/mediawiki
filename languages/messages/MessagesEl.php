...
'sharedupload-desc-there'   => 'Αυτό το αρχείο είναι από $ 1 και μπορεί να χρησιμοποιηθεί από άλλα εγχειρήματα.
Παρακαλούμε δείτε τη [$2 σελίδα περιγραφής αρχείου] για περισσότερες πληροφορίες.',
