...
'action-deleterevision'       => 'διαγράψετε αυτή την έκδοση',
...
'action-patrol'               => 'σημάνετε τις επεξεργασίες άλλων ως ελεγμένες',
'action-mergehistory'         => 'συγχωνεύσετε το ιστορικό αυτής της σελίδας',
'action-userrights'           => 'επεξεργαστείτε όλα τα δικαιώματα χρηστών',
'action-userrights-interwiki' => 'επεξεργαστείτε τα δικαιώματα χρηστών σε άλλα βίκι',
'action-siteadmin'            => 'κλειδώσετε ή ξεκλειδώσετε τη βάσης δεδομένων',
...
'protect-level-autoconfirmed' => 'Φραγή μη εγγεγραμμένων χρηστών',
