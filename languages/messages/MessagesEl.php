...
'createaccountmail' => 'Χρησιμοποιήστε τον τυχαίο προσωρινό κωδικό πρόσβασης και στείλτε τον στην διεύθυνση ηλεκτρονικού ταχυδρομείου που υποδεικνύεται παρακάτω',
...
Μπορείτε αν θέλετε να αποθηκεύσετε το κείμενο σε αρχείο κειμένου (με αποκοπή-και-επικόλληση) και να το φυλάξετε γι' αργότερα.
...
'protect-fallback' => 'Επιτρέπεται μόνο σε χρήστες με δικαιώματα "$1"',
'protect-level-autoconfirmed' => 'Επιτρέπονται μόνο αυτοεπιβεβαιωμένοι χρήστες',
'protect-level-sysop' => 'Επιτρέπεται μόνο στους διαχειριστές',
