...
'showingresultstotal'       => "Παρακάτω {{PLURAL:$3|προβάλλεται το αποτέλεσμα '''$1''' από '''$3'''|προβάλλονται τα αποτελέσματα '''$1 - $2''' από '''$3'''}}",
...
'fileduplicatesearch-summary'  => 'Αναζήτηση για διπλά αρχεία με βάση την αξία hash του αρχείου.

Εισάγετε το όνομα του αρχείου χωρίς το πρόθεμα "{{ns:image}}:".',
