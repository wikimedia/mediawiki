...
'ajax-remove-category'          => 'Αφαίρεση κατηγορίας',
'ajax-edit-category'            => 'Επεξεργασία κατηγορίας',
'ajax-add-category-submit'      => 'Προσθήκη',
'ajax-confirm-ok'               => 'Εντάξει',
'ajax-confirm-title'            => 'Επιβεβαίωση ενέργειας',
'ajax-confirm-save'             => 'Αποθήκευση',
'ajax-confirm-save-all'         => 'Αποθήκευση όλων των αλλαγών',
'ajax-cancel'                   => 'Ακύρωση επεξεργασίας',
'ajax-cancel-all'               => 'Ακύρωση όλων των αλλαγών',
'ajax-add-category-summary'     => 'Προσθήκη κατηγορίας "$1"',
'ajax-edit-category-summary'    => 'Αλλαγή κατηγορίας από "$1" σε "$2"',
'ajax-remove-category-summary'  => 'Αφαίρεση κατηγορίας "$1"',
'ajax-category-question'        => 'Γιατί θέλετε να κάνετε τις ακόλουθες αλλαγές:',
'ajax-error-title'              => 'Σφάλμα',
'ajax-remove-category-error'    => 'Δεν ήταν δυνατή η αφαίρεση να αφαιρεθεί η κατηγορία "$1".
Αυτό συνήθως συμβαίνει όταν η κατηγορία έχει προστεθεί στη σελίδα από ένα πρότυπο.',
'ajax-edit-category-error'      => 'Δεν ήταν δυνατή η επεξεργασία της κατηγορίας "$1".
Αυτό συμβαίνει συνήθως όταν η κατηγορία έχει προστεθεί στη σελίδα σε ένα πρότυπο.',
'ajax-category-already-present' => 'Η σελίδα αυτή ανήκει ήδη στην κατηγορία "$1"',
'ajax-category-hook-error'      => 'Μια τοπική λειτουργία απέτρεψε την αποθήκευση των αλλαγών.',
'ajax-api-error'                => 'Το API επέστρεψε ένα σφάλμα:  $1: $2.',
'ajax-api-unknown-error'        => 'Το API επέστρεψε ένα άγνωστο σφάλμα.',
