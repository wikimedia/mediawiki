...
'prefs-reset-intro'         => 'Μπορείτε να χρησιμοποιήσετε αυτήν την σελίδα για να επαναρυθμίσετε τις προτιμήσεις σας στις προεπιλογές περιοχών. Αυτό δεν μπορεί να ανατρεφθεί.',
