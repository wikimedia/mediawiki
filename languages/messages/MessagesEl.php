...
'mainpagetext'      => "<span style="font-size:larger">'''To λογισμικό MediaWiki εγκαταστάθηκε με επιτυχία.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Ζητήσατε μια άκυρη σελίδα λειτουργιών.'''</span>
...
'userlogin'                  => 'Δημιουργία Λογαριασμού',
'logout'                     => 'Έξοδος',
...
'blockedtext'                      => "<span style="font-size:larger">'''Το όνομα χρήστη σας ή η διεύθυνση IP σας έχει υποστεί φραγή.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''Η $1 έχει επαναφερθεί'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" μεταφέρθηκε στο "$2"\'\'\'</span>',
