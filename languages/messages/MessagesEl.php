...
'rev-deleted-text-permission'    => "Αυτή η έκδοση της σελίδας '''έχει αφαιρεθεί από τα δημόσια αρχεία'''.
Μπορεί να υπάρχουν λεπτομέρειες στο [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} αρχείο καταγραφής διαγραφών].",
'rev-deleted-text-view'          => 'Αυτή η έκδοση της σελίδας έχει αφαιρεθεί από τα δημόσια αρχεία. 
...
'rev-deleted-unhide-diff'        => "Μια από τις εκδόσεις αυτή τη διαφοράς '''έχει αφαιρεθεί από τα δημόσια αρχεία'''. 
Μπορεί να υπάρχουν λεπτομέρειες στο [{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} αρχείο διαγραφών].
