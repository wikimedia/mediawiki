...
'searchprofile-everything-tooltip' => 'Αναζήτηση σε όλο το περιεχόμενο (συμπεριλαμβανομένου τις σελίδες συζήτησης)',
...
'powersearch-ns'                   => 'Αναζήτηση στις περιοχές:',
...
'recentchangesdays-max'     => '(το μέγιστον $1 {{PLURAL:$1|ημέρα|ημέρες}})',
...
'right-suppressredirect' => 'Μην δημιουργείτε ανακατεύθυνση από το παλιό όνομα κατά τη μετακίνηση μιας σελίδας',
...
'right-bot'              => 'Να σας συμπεριφέρονται σαν μια αυτόματη διεργασία',
...
'right-suppressionlog'   => 'Δείτε τις προσωπικές καταγραφές',
'right-block'            => 'Φραγή των άλλων χρηστών από την επεξεργασία',
'right-blockemail'       => 'Φραφή ενός χρήστη από την αποστολή ηλεκτρονικών μηνυμάτων',
'right-hideuser'         => 'Φραγή ενός ονόματος χρήστη, αποκρύβοντάς το από το κοινό',
'right-protect'          => 'Αλλαγή των επιπέδων προστασίας και επεξεργασία προστατευόμενων σελίδων',
'right-editprotected'    => 'Επεξεργασία προστατευμένων σελίδων (χωρίς διαδοχική προστασία)',
'right-editinterface'    => 'Επεξεργασία του περιβάλλοντος χρήστη',
'right-editusercssjs'    => 'Μεταγραφή των αρχείων CSS και JS άλλων χρηστών',
'right-markbotedits'     => 'Σημείωση των επαναφερόμενων επεξεργασιών ως επεξεργασίες μποτ',
...
'action-deleterevision'       => 'διαγραφή αυτής της έκδοσης',
...
'action-patrol'               => 'σημείωση των επεξεργασιών των άλλων ως υπό επιτήρηση',
'action-mergehistory'         => 'μετακίνηση του ιστορικού αυτής της σελίδας',
'action-userrights'           => 'επεξεργασία όλων των δικαιωμάτων χρηστών',
'action-userrights-interwiki' => 'επεξεργασία των δικαιωμάτων των χρηστών σε άλλα βίκι',
'action-siteadmin'            => 'κλείδωμα ή ξεκλείδωμα της βάσης δεδομένων',
...
'double-redirect-fixer'      => 'Ρυθμιστής ανακατευθύνσεων',
...
'email-legend'    => 'Στείλε ένα ηλεκτρονικό μήνυμα σε ένα άλλον χρήστη της {{SITENAME}}',
'emailfrom'       => 'Από:',
'emailto'         => 'Προς:',
'emailsubject'    => 'Θέμα:',
'emailmessage'    => 'Μήνυμα:',
...
'block-log-flags-nousertalk'      => 'δεν μπορείς να επεξεργαστείς τη σελίδα συζήτησής σου',
