...
'formerror'            => 'Σφάλμα: Δεν ολοκληρώθηκε η υποβολή της φόρμας!',
...
'missingsummary'            => "'''Υπενθύμιση:''' Δεν έχετε συμπληρώσει τη σύνοψη επεξεργασίας. Αν κάνετε κλικ στο κουμπί Αποθήκευση πάλι, η επεξεργασία σας θα αποθηκευτεί χωρίς μια σύνοψη.",
...
Το μέγεθος της [http://meta.wikimedia.org/wiki/Help:Job_queue ουράς εργασιών] είναι '''\$7'''.",
...
'ipbhidename'                 => 'Απόκρυψη ονόματος χρήστη/διεύθυνσης IP από το αρχείο καταγραφής φραγών, την ενεργή λίστα φραγών και τη λίστα χρηστών.',
