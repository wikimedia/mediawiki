...
# Feedback
'feedback-note' => 'Коментарът ви ще бъде публично достъпен на страницата "[$2 $1]", заедно с вашето потребителско име, версията на браузъра ви и операционната ви система.',
