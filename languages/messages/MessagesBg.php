...
'mainpagetext'      => "<span style="font-size:larger">'''Уикито беше успешно инсталирано.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Отправихте заявка за невалидна специална страница.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Вашето потребителско име (или IP-адрес) беше блокирано.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''Страницата „$1“ беше възстановена.'''</span>
...
'movepage-moved'               => "<span style="font-size:larger">'''Страницата „$1“ беше преместена под името „$2“.'''</span>",
