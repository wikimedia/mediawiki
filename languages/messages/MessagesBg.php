...
'ajax-add-category-question'    => 'Защо желаете да добавите категория "$1"?',
'ajax-edit-category-question'   => 'Защо желаете да промените категория "$1" на "$2"?',
'ajax-remove-category-question' => 'Защо желаете да премахнете категория "$1"?',
