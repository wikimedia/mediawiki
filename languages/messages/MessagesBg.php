...
'userstatstext'          => "Има {{PLURAL:$1|'''1''' [[Special:ListUsers|регистриран потребител]]|'''$1''' [[Special:ListUsers|регистрирани потребители]]}} и '''$2''' {{PLURAL:$2|потребител|потребители}} (или '''$4%''') с права на $5. Понастоящем {{PLURAL:$6|активна е|активни са}} около '''$6''' {{PLURAL:$6|регистрирана потребителска сметка|регистрирани потребителски сметки}}.",
