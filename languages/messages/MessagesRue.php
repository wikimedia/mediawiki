...
'tog-uselivepreview'          => 'Хосновати фрышный нагляд (JavaScript, експеріментално)',
...
'badtitletext'         => 'Пожадована назжа сторінкы неправилна, порожня, або неправилно одказована як міджі-язычного ці міджі-вікі назва.
...
'showlivepreview'                  => 'Фрышный перегляд',
