...
'post-expand-template-inclusion-warning' => 'Позірь: розмір шаблон про включіня є барз великый.
...
'illegalfilename' => 'Назва файлу "$1" обсягує буквы, котры не суть поволены в назвах сторінок. Просиме, переменуйте файл і спробуйте го заладовати зясь.',
...
'api-error-internal-error' => 'Внутрїшня хыба: дішло ку хыбі під час спрацованя вашого заладованого файлу.',
