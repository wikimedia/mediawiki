...
Таке ся трафляtx звычайно тогды, qk катеґорія была додана до сторінкы через шаблону.',
'ajax-category-already-present' => 'Тота сторінка уж належыть до катеґорії $1',
'ajax-category-hook-error'      => 'Локална функція заборонила уложіню змін',
'ajax-api-error'                => 'API вернуло хыбу: $1: $2',
'ajax-api-unknown-error'        => 'API вернуло незнаму хыбу.',
