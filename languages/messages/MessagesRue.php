...
'copyright' => 'Обсяг є доступный під $1, кідь не є вказане інше.',
...
'emailauthenticated' => 'Адреса вашой ел. пошты была потверджнена $2 о $3.',
'emailnotauthenticated' => 'Адреса вашой ел. пошты дотеперь не была потверждена. У наступных функцій не будуть посыланы жадны мейлы.',
...
'resetpass_announce' => 'Жебы сьте завершыли приголошіня, мусите собі наставити нове гесло.',
...
'revdelete-radio-set' => 'Схованый',
'revdelete-radio-unset' => 'Видимый',
...
'show-big-image' => 'Оріґіналный файл',
