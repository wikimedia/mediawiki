...
'group-emailconfirmed' => 'Хатпен құпталған қатысушылар',
...
'group-emailconfirmed-member' => 'хатпен құпталған қатысушы',
...
'grouppage-emailconfirmed' => '{{ns:project}}:Хатпен құпталған қатысушылар',
...
'right-reupload-shared'      => 'Ортақтастырылған сурет қоймасындағы файлдарды жергіліктілермен асыру',
