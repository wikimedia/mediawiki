...
'noarticletext'                     => 'Бұл бетте ағымда еш мәтін жоқ, дегенмен басқа беттерден [[{{#special:Search}}/{{PAGENAME}}|бұл бет атауын іздей]] не [{{fullurl:{{FULLPAGENAME}}|action=edit}} бұл бетті өңдей] аласыз.',
...
'session_fail_preview'              => '<strong>Ғафу етіңіз! Сессия деректері ысырап қалғандықтан өңдемеңізді жүргізе алмаймыз.
Қайта байқап көріңіз. Егер бұл әлі істемесе, шығуды және қайта кіруді байқап көріңіз.</strong>',
'session_fail_preview_html'         => "<strong>Ғафу етіңіз! Сессия деректері ысырап қалғандықтан өңдемеңізді жүргізе алмаймыз.</strong>
...
'token_suffix_mismatch'             => '<strong>Өңдемеңіз тайдырылды, себебі тапсырыскеріңіз өңдеме деректер бумасындағы тыныс белгілерін бүлдіртті.
...
Жұмыс істеуге ықтималдық беру үшін, төменгі өңдеу аумағында ASCII емес әріптер оналтылық сан белгілемесімен көрсетіледі</strong>.',
...
'undo-failure' => 'Бұл өңдеме жоққа шығарылмайды, себебі тартысты аралық өңдемелер бар.',
...
'revision-info'       => '$1 кезіндегі $2 шстеген түзету',
...
'revdelete-unsuppress'        => 'Қалпына келтірілген түзетулер тиымдарын аластау',
...
'mergehistory-header'              => 'Бұл бет арқылы бір қайнар беттің түзетулер тарихын жаңа бетке біріктіруге мүмкіндік береді.
...
# Diffs
'history-title'           => '«$1» дегеннің түзету тарихы',
...
'searchall'                 => 'барлық',
'showingresults'            => "Төменде нөмір '''$2''' орнынан бастап '''$1''' нәтижеге дейін жеткенше көрсетіледі.",
...
'nonefound'                 => "'''Аңғартпа''': Бастапқыдан іздеу тек кейбір есім аяларда болады. Барлық мағлұматты (соның ішінде талқылау беттерді, үлгілерді т.б.) іздеу үшін сұранымыңызды ''барлық:'' деп бастаңыз, немесе қалаған есім аясын бастауыш есебінде қолданыңыз.",
'powersearch'               => 'Кеңейтілген іздеу',
'powersearch-legend'        => 'Кеңейтілген іздеу',
'powersearchtext'           => 'Мына есім аяларда іздеу:<br />$1<br />$2 Айдатуларды тізімдеу<br />Іздеу сұранымы: $3 $9',
...
* Келтірілген * топты бір үстегенінен аластай алмайтындығын, не қарама-қарсысын көрсетеді.',
...
'right-markbotedits'         => 'Қайтарылған өңдемелеррді боттар жасаған деп белгілеу',
'right-import'               => 'Басқа уикилерден беттерді сырттан алу',
'right-importupload'         => 'Файл қотаруымен беттерді сырттан алу',
'right-patrol'               => 'Өңдемелерді күзетте деп белгілеу',
'right-autopatrol'           => 'Өңдемелерді күзетте деп өздіктік белгілеу',
...
'right-userrights-interwiki' => 'Басқа үики тораптарындағы қатысушылардың құқықтарын өңдеу',
...
'rcshowhidepatr'                    => 'Күзеттегі өңдемелерді $1',
...
Бағанның бас жолын нұқығанда сұрыптау реті өзгертіледі.',
...
'rollback'                    => 'Өңдемелерді кері қайтару',
'rollback_short'              => 'Кері қайтару',
'rollbacklink'                => 'кері қайтару',
'rollbackfailed'              => 'Кері қайтару сәтсіз бітті',
'cantrollback'                => 'Өңдеме қайтарылмайды;
бұл беттің ауторы тек соңғы үлескер болған.',
'alreadyrolled'               => '[[:$1]] бетінің [[{{ns:user}}:$2|$2]] ([[{{ns:user_talk}}:$2|талқылауы]]) соңғы өңдемесі кері қайтарылмады;
...
Бөлектеумен қалпына келтіру орындау үшін, келтіремін деген түзетулеріне сәйкес қабашақтарын белгілеңіз де, және '''''Қалпына келтір!''''' түймесін нұқыңыз. '''''Қайта қой''''' түймесін нұқығанда мәндеме аумағы тазартады және барлық шаршыларды құсбелгілерден босатады.",
...
Осындай жағдайларда, ең жаңа жойылған түзету белгілеуін немесе жасыруын болдырмаңыз.',
...
'undelete-filename-mismatch'   => '$1 кезіндегі файл түзетуінің жоюы болдырмады: файл аты сәйкессіз',
...
'imagenocrossnamespace'   => "Сурет файл емес басқа есім аясына жылжытылмайды",
...
Беттерді сыртқа беру үшін, атауларын төмендегі мәтін аумағына енгізіңіз (бір жолда бір атау), және де бөлектеңіз: не ағымдық нұсқасын, барлық ескі нұсқалары мен және тарихы жолдары мен бірге, немесе дәл ағымдық нұсқасын, соңғы өңдемеу туралы ақпараты мен бірге.
...
Барлық уики арасындағы сырттан алу әрекеттер [[{{#special:Log}}/import|сырттан алу журналына]] жазылып алынады.',
...
'importhistoryconflict'      => 'Түзету тарыхының тартысы бар (бұл бетті алдында сырттан алынған сияқты)',
...
'importlogpagetext'                => 'Басқа уикилерден түзету тарихымен бірге беттерді әкімшілік ретінде сырттан алу.',
'import-logentry-upload'           => 'файл қотаруымен сырттан «[[$1]]» беті алынды',
'import-logentry-upload-detail'    => '$1 түзету',
'import-logentry-interwiki'        => 'уики арасынан алынған $1',
...
'spam_blanking'       => '$1 дегенге сілтемесі бар барлық түзетулер тазартылды',
...
'markaspatrolledtext'                 => 'Бұл бетті күзетуде деп белгілеу',
'markedaspatrolled'                   => 'Күзетте деп белгіленді',
'markedaspatrolledtext'               => 'Бөлектенген түзету күзетте деп белгіленді.',
...
'markedaspatrollederrortext'          => 'Күзетте деп белгілеу үшін түзетуді келтіріңіз.',
'markedaspatrollederror-noautopatrol' => 'Өз өзгерістеріңізді күзетте деп белгілей алмайсыз.',
...
'edit-externally'      => 'Бұл файлды сыртқы қондырма арқылы өңдеу',
...
# Watchlist editor
'watchlistedit-numitems'       => 'Бақылау тізіміңізде, талқылау беттерсіз, $1 атау бар.',
...
'watchlistedit-normal-done'    => 'Бақылау тізіміңізден $1 атау аласталды:',
...
'watchlistedit-raw-added'      => '$1 атау үстелді:',
'watchlistedit-raw-removed'    => '$1 атау аласталды:',
