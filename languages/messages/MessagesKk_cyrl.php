...
'expensive-parserfunction-warning'  => 'Құлақтандыру: Бұл бетте тым көп шығыс алатын құрылым талдатқыштың функциялары шақырымы бар.

Бұның шамасы $2 санынан кем болуы керек, Мында қазір $1 саны.',
'expensive-parserfunction-category' => 'Тым көп шығыс алатын құрылым талдатқыштың функциялары шақырымы бар беттер',
...
'noexactmatch'              => "'''Мында «$1» деп аталған бет жоқ.'''
Бұл бетті өзіңіз [[:$1|бастай аласыз]].",
'noexactmatch-nocreate'     => "'''Мында «$1» деп аталған бет жоқ.'''",
...
'search-external'           => 'Сыртқы іздестіргіш',
...
'group-autoconfirmed'  => 'Өздіктік құпталған қатысушылар',
'group-bot'            => 'Боттар',
...
'group-autoconfirmed-member'  => 'өздіктік құпталған қатысушы',
...
'grouppage-autoconfirmed'  => '{{ns:project}}:Өздіктік құпталған қатысушылар',
...
'listgrouprights-summary'  => 'Келесі тізімде бұл уикиде белгіленген қатысушы құқықтары (байланысты қатынау құқықтарымен бірге) көрсетіледі.',
...
'specialpages-group-maintenance' => 'Қызмет көрсету туралы баянаттар',
'specialpages-group-other'       => 'Басқа арнайы беттер',
'specialpages-group-login'       => 'Кіру / тіркелу',
'specialpages-group-changes'     => 'Жуықтағы өзгерістер мен журналдар',
'specialpages-group-media'       => 'Таспалар туралы баянаттар және файл қотару',
'specialpages-group-users'       => 'Қатысушылар және олардың құқықтары',
'specialpages-group-needy'       => 'Өңдеуі тиісті беттер',
