...
Бұнда ең кемінде $1 таңба болуы және де қатысушы атыңыздан өзгеше болуы жөн.',
...
'revdelete-suppress'          => 'Деректерді басқаларға ұқсас әкімшілерден де шеттету',
...
'sourcefilename'              => 'Қайнардағы файл атауы:',
...
'log-title-wildcard'   => 'Мына мәтіннең басталытын тақырып аттарынан іздеу',
...
Осындай жағдайларда, ең жаңа жойылған түзетуін алып тастаңыз немесе жасыруын болдырмаңыз.',
...
'immobile_namespace'      => 'Қайнар не нысана тақырып аты арнайы түріне жатады;
...
'import-interwiki-text'      => 'Сырттан алатын уики жобасын және бет тақырып атын бөлектеңіз.
