...
'movepage-max-pages'      => '$1 беттің ең көбі жылжытылды және мыннан көбі өздіктік жылжылтылмайды.',
'1movedto2'               => '[[$1]] дегенді [[$2]] дегенге жылжытты',
'1movedto2_redir'         => '[[$1]] дегенді [[$2]] деген айдату үстіне жылжытты',
...
'confirmemail_oncreate'    => 'Құптау белгілемесі е-пошта мекенжайыңызға жөнелтілді.
...
'specialpages-group-maintenance' => 'Баптау баянаттар',
