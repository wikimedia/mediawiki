...
Жүйеге кірместен {{SITENAME}} жобасын пайдалануын жалғастыра аласыз, немесе дәл сол не өзгеше қатысушы боп қайта круіңіз мүмкін.
...
Егер бұны жетістіруді іріктесеңіз, бұл түзетуіңіздің ауторлығын анықтау үшін қолданылады.',
...
Ең кемінде $1 әріп және қатысушы атыңыздан өзгеше болуы керек.',
...
'previewconflict'                   => 'Бұл қарап шығу беті жоғарыдағы өңдеу аумағындағы мәтінді қамтиды да және сақталғандағы өңді көрсетпек.',
...
'revdelete-suppress'          => 'Деректерді басқаларға ұқсас әкімшілерден де бүркемелеу',
...
# Suppression log
'suppressionlog'     => 'Бүркемелеу журналы',
...
'toomanymatches'            => 'Тым көп сәйкес қайтарылды, өзгеше сұранымды байқап көріңіз',
...
'right-reupload-own'         => 'Өзі қотарған бар файл үстіне жазу',
...
'right-purge'                => 'Бетті торап аралық қалтасынан құптаусыз тазарту',
...
'right-patrol'               => 'Басқарардың өңдемелерін күзетте деп белгілеу',
'right-autopatrol'           => 'Өз өңдемелерін күзетте деп өздіктік белгілеу',
...
Файлыңызға сипаттылау атауды іріктеңіз.',
...
'suppressedarticle'           => '«[[$1]]» дегенді бүркемеледі',
...
'nolinkshere-ns'           => "Іріктелген есім аясында '''[[:$1]]''' дегенге ешқандай бет сілтемейді.",
...
'articleexists'           => 'Осылай аталған бет алдақашан бар, не іріктеген атауыңыз жарамды емес.
Өзгеше атауды іріктеңіз',
...
'importinterwiki'            => 'Уики арадан тасымалдап сырттан алу',
...
Уики арадан тасымалдап сырттан алу барлық әрекеттер [[{{#special:Log}}/import|сырттан алу журналына]] жазылып алынады.',
...
'importnosources'            => 'Ешқандай уики арадан тасымалдап сырттан алу қайнары белгіленмеген, және тарихын тікелей қотаруы өшірілген.',
...
'import-logentry-interwiki'        => 'уики арадан тасымалдап алынған $1',
