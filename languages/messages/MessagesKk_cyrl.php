...
'tog-nocache'                 => 'Аралық қалтада бет сақтауын өшір',
...
'cachederror'          => 'Төменде сұратылған беттің аралық қалтадағы көшірмесі, осы бет жаңартылмаған болуы мүмкін.',
...
'missingarticle-rev'   => '(нұсқа н-і: $1)',
...
'perfcached'           => 'Келесі дерек аралық қалтасынан алынған, сондықтан толықтай жаңаланмаған болуы мүмкін.',
'perfcachedts'         => 'Келесі дерек аралық қалтасынан алынған, соңғы жаңаланлған кезі: $1.',
...
Аудару үшін, MediaWiki бағдарламасын жерсіндіру [http://translatewiki.net/wiki/Main_Page?setlang=kk Betawiki жобасын] пайдалануы жан-жағын қарап көріңіз.",
...
'titleprotected'       => "Бұл атауды бастаудан [[{{ns:user}}:$1|$1]] қорғады.
...
Аңғартпа: Кейбір беттер шолғыштың аралық қалтасын босатқанша дейін әлі де жүйеге кіргеніңіздей көрінуі мүмкін.',
...
'externaldberror'            => 'Осы арада не сыртқы растау дерекқорында қате болды, немесе сыртқы тіркелгіңізді жаңалау рұқсаты жоқ.',
...
'email'                      => 'Е-поштаңыз',
'prefs-help-realname'        => 'Шын атыңыз міндетті емес
Егер бұны жетістірсеңіз, шығармаңызға өзіңіздің таңдатыруды беру үшін қолданылады.',
...
'passwordsent'               => 'Жаңа құпия сөз «$1» үшін тіркелген е-пошта жайына жөнелтілді.
Қабылдағаннан кейін кіргенде соны енгізіңіз.',
'blocked-mailpassword'       => 'IP жайыңыздан өңдеу бұғатталған, сондықтан қиянатты қақпайлау үшін құпия сөзді қалпына келтіру жетесін қолдануына рұқсат етілмейді.',
'eauthentsent'               => 'Құптау хаты аталмыш е-пошта жайына жөнелтілді.
Басқа е-пошта хатын жөнелту алдынан, тіркелгі шынынан сіздікі екенін құптау үшін хаттағы нұсқауларға еріуңіз жөн.',
'throttled-mailpassword'     => 'Соңғы $1 сағатта құпия сөз ескерту хаты алдақашан жөнелтілді.
Қиянатты қақпайлау үшін, $1 сағат сайын тек бір ғана құпия сөз ескерту хаты жөнелтіледі.',
...
'createaccount-text'         => 'Кейбіреу е-пошта жайыңызды пайдаланып {{SITENAME}} жобасында ($4) «$2» атауымен, «$3» құпия сөзімен тіркелгі жасаған.
...
'expensive-parserfunction-warning'  => 'Құлақтандыру: Бұл бетте тым көп шығыс алатын құрылым талдатқыш жетелерінің шақырымы бар.

Бұның шамасы $2 санынан кем болуы керек, Мында қазір $1 саны.',
'expensive-parserfunction-category' => 'Тым көп шығыс алатын құрылым талдатқыш жетелерінің шақырымы бар беттер',
...
'revdelete-nooldid-text'      => 'Бұл жетені орындау үшін ақырғы нұсқасын не нұсқаларын енгізбепсіз,
...
# Diffs
'history-title'           => '«$1» дегеннің нұсқа тарихы',
...
'noexactmatch'              => "'''Осы арада «$1» деп аталған бет жоқ.'''
[[:$1|Бұл бетті бастай]] аласыз.",
'noexactmatch-nocreate'     => "'''Осы арада «$1» деп аталған бет жоқ.'''",
...
'nonefound'                 => "'''Аңғартпа''': Табу сәтсіз бітуі жиі «болған» және «деген» сияқты тізімделмейтін жалпы сөздермен іздеуден болуы мүмкін, немесе бірден артық іздеу шарт сөздерін егізгеннен (нәтижелерде тек барлық шарт сөздер кедессе көрсетіледі) болуы мүмкін.",
...
'search-external'           => 'Сыртқы іздегіш',
...
'prefs-watchlist-edits'    => 'Кеңейтілген бақылау тізімінде көрсететін ең көп түзетулері:',
'prefs-misc'               => 'Қосымша',
'saveprefs'                => 'Сақта',
...
* нышаны топты бір үстегенінен аластай алмайтындығын көрсетеді, не қарама-қарсы.',
...
'right-minoredit'            => 'Түзетулерді шағын деп белгілеу',
'right-move'                 => 'Беттерді жылжыту',
'right-suppressredirect'     => 'Тиісті атауға бетті жылжытқанда айдатуды жою',
'right-upload'               => 'Файлдарды қотарып беру',
'right-reupload'             => 'Бар файл үстіне жазу',
'right-reupload-own'         => 'Қатысушының өзі қотарған бар файл үстіне жазу',
'right-reupload-shared'      => 'Таспа ортақ қоймасындағы файлдарды жергіліктілермен асыру',
'right-upload_by_url'        => 'Файлды URL жайымен қотарып беру',
'right-purge'                => 'Тораптағы құптау беті жоқ бет үшін аралық қалтасын тазарту',
'right-autoconfirmed'        => 'Жартылай қорғалған беттерді өңдеу',
'right-bot'                  => 'Өздіктік үдіріс деп есептелу',
'right-nominornewtalk'       => 'Талқылау беттердегі шағын түзетулерді жаңа хабар деп есептемеу',
'right-apihighlimits'        => 'API жоғары шектелімдерін пайдалану',
'right-delete'               => 'Беттерді жою',
'right-bigdelete'            => 'Ұзақ тарихы бар беттерді жою',
'right-deleterevision'       => 'Беттердің өзіндік нұсқаларын жою не жоюын болдырмау',
...
'right-hiderevision'         => 'Әкімшілерден жасырылған нұсқаларды шолу және қалпына келтіру',
...
'right-rollback'             => 'Белгілі бетті өңдеген соңғы қатысушының түзетулерінен жылдам қайтару',
'right-markbotedits'         => 'Қайтарылған түзетулерді боттар жасаған деп белгілеу',
'right-import'               => 'Басқа сыртқы уикилерден беттерді алу',
'right-importupload'         => 'Файл қотаруымен сырттан беттерді алу',
'right-patrol'               => 'Түзетулерді күзетте деп белгілеу',
'right-autopatrol'           => 'Түзетулерді күзетте деп өздіктік белгілеу',
'right-patrolmarks'          => 'Жуықтағы өзгерістердегі күзет белгілерін көру',
...
'right-userrights'           => 'Қатысушылардың барлық құқықтарын өзгерту',
'right-userrights-interwiki' => 'Басқа үики тораптарындағы қатысушылардың құқықтарын өзгерту',
'right-siteadmin'            => 'Дерекқорды құлыптау және құлыптамау',
...
'recentchangeslinked-summary'  => "Бұл тізімде көрсетілген беттен сілтелген беттердегі (не көрсетілген санат мүшелеріндегі) жуықтағы жасалған өзгерістер беріледі.
[[{{#special:Watchlist}}|Бақылау тізіміңіздегі]] беттер '''жуан''' болып белгіленеді.",
'recentchangeslinked-page'     => 'Бет атауы:',
'recentchangeslinked-to'       => 'Орнына келтірілген бетке сілтелген беттердегі өзгерістерді көрсету',
...
'upload-permitted'            => 'Рұқсат берілген файл түрлері: $1.',
...
'uploadlogpagetext'           => 'Төменде ең соңғы қотарылған файл тізімі.',
'filename'                    => 'Файл аты',
...
'sharedupload'                   => 'Бұл файл ортақ қоймаға қотарылған сондықтан басқа жобаларда қолдануы мүмкін.',
...
'shareduploadduplicate-linktext' => 'басқа файл',
'shareduploadconflict'           => 'Бұл файл аты ортақ қоймадағы $1 файлымен дәл келеді',
'shareduploadconflict-linktext'  => 'басқа файл',
...
'protectedtitlestext'     => 'Келесі атаулардың бастауына рұқсат берілмеген',
...
Өңдеуші түйіндемесі: $PAGESUMMARY $PAGEMINOREDIT
...
'undeletepagetitle'            => "'''Келесі тізім [[:$1|$1]] дегеннің жойылған нұсқаларынан тұрады'''.",
...
'whatlinkshere-hideredirs' => 'айдатуларды $1',
'whatlinkshere-hidetrans'  => 'ендірілгендерді $1',
...
'ipbenableautoblock'          => 'Бұл қатысушы соңғы қолданған IP жайын, және кейін өңдеуге байқап көрген әр IP жайларын өзбұғаттауы',
...
'ipbhidename'                 => 'Бұғаттау журналыннан, белсенді бұғаттау тізімінен, қатысушы тізімінен қатысушы атын жасыру',
...
'contribslink'                => 'үлесі',
'autoblocker'                 => 'IP жайыңызды жуықта «[[{{ns:user}}:1|$1]]» пайдаланған, сондықтан өзбұғатталған.
...
Басқа атау тандаңыз',
'cantmove-titleprotected' => 'Бетті мына орынға жылжыта алмайсыз, себебі осы жаңа атау бастауы қорғалған',
...
'fileduplicatesearch-result-n' => '«$1» файлына {{PLURAL:$2|1 тең телнұсқасы|$2 тең телнұсқасы}} бар.',

# Special:SpecialPages
'specialpages-group-maintenance' => 'Қызметтік баянаттар',
...
'specialpages-group-media'       => 'Таспалар баянаттары және файл қотару',
