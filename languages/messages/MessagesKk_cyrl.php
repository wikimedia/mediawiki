...
'mainpagetext'      => "<span style="font-size:larger">'''МедиаУики бумасы сәтті орнатылды.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Жарамсыз арнайы бетті сұрадыңыз.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Қатысушы атыңыз не IP мекенжайыңыз бұғатталған.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 қалпына келтірілді'''</span>
...
'movepage-moved'          => '<span style="font-size:larger">\'\'\'"$1" беті "$2" бетіне жылжытылды\'\'\'</span>',
