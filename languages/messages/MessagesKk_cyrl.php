...
'undelete_short'    => '$1 түзету жоюын болдырмау',
'protect'           => 'Қорғау',
...
'revdelete-log-message'       => '$2 нұсқа үшін $1',
...
'diff-multi'              => '(Арадағы $1 нұсқа көрсетілмеген.)',
...
{{SITENAME}} орнатылғаннан бері беттер {{PLURAL:$3|'''1'''|жалпы '''$3'''}} рет қаралған, және беттер '''$4''' рет түзетілген.
...
'undeleterevisions'            => '$1 нұсқа мұрағатталды',
...
'undeletedrevisions'           => '$1 нұсқа қалпына келтірілді',
'undeletedrevisions-files'     => '$1 нұсқа және $2 файл қалпына келтірілді',
