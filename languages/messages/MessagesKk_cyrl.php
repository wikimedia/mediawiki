...
'ipb_modifying_block'         => 'Болған бұғаттауды өзгерту:',
'ipb_tweak_block'             => 'Құлақтандыру: Бұл қатысушы ($1) алдақашан бұғатталған.
Бұғаттау бапталымдарын қою үшін бұл пішінді қолдана аласыз.',
