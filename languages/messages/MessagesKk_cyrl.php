...
'tog-externaleditor'          => 'Шеттік өңдеуішті әдепкіден қолдан',
...
'readonlytext'         => 'Бұл дерекқор жаңа жазба және тағы басқа өзгерістер жасаудан ағымда құлыпталынған. Бұл дерекқорды жөндету бағдарламаларын орындау үшін болуы мүмкін, бұны бітіргеннен соң қалыпты іске қайтарылады.
...
'editinginterface'     => "'''Құлақтандыру:''' Бағдарлама жасақтаманың тілдесу мәтінін жетістіретін бетін өңдеп жатырсыз.
...
{{SITENAME}} баптау өзгертуін ұмытпаңыз.',
...
Тіркелуді бітіру үшін, мында жаңа құпия сөзіңізді енгізуіңіз жөн:',
...
'autoblockedtext'           => "$1 деген бұрын өзге қатысушы пайдаланған болғасын осы IP жайыңыз өздіктік бұғатталған.
Келтірілген себебі:
...
'confirmedittext'           => 'Беттерді өңдеу үшін алдын ала Е-пошта жайыңызды құптауыңыз жөн.
...
# History pages
'viewpagelogs'        => 'Бұл бетің журналдарын қарау',
'nohistory'           => 'Мында бұл беттінің түзету тарихы жоқ.',
'revnotfound'         => 'Түзету табылмады',
'revnotfoundtext'     => 'Бұл беттің сұралған ескі түзетуі табылған жоқ. Осы бетті ашуға пайдаланған URL жайын қайта тексеріп шығыңыз.',
...
'showingresultstotal'       => "Төменде '''$3''' нәтиже арасынан '''$1 — $2''' ауқымы көрсетіледі",
...
'prefsnologintext'         => 'Баптауыңызды қою үшін [[{{#special:Userlogin}}|кіруіңіз]] жөн.',
...
'right-suppressredirect'     => 'Тиісті атауға бетті жылжытқанда айдатуды жасамау',
...
'right-upload_by_url'        => 'Файлды URL жайынан қотарып беру',
...
'recentchangeslinked-to'       => 'Бұның орнына келтірілген бетке сілтелген беттердегі өзгерістерді көрсет',
...
'upload_directory_read_only'  => 'Қотарып берілетін қалтасына ($1) жазуға веб-серверге рұқсат берілмеген.',
...
'uploadscripted'              => 'Бұл файлда веб шолғышты қателікпен талдатқызатын HTML не әмір белгілемелері бар.',
...
'redirectstofile'                => 'Бұл файлға келесі файлдар айдайды:',
'duplicatesoffile'               => 'Келесі файлдар бұл файлдың телнұсқалары:',
...
Бұған «талқылау» беттері, {{SITENAME}} жобасы туралы беттер, тым қысқа «бітеме» беттері, айдатулар, тағы да басқа мағлұмат деп танылмайтын беттер кірістірледі.
...
[http://meta.wikimedia.org/wiki/Help:Job_queue Тапсырымалар кезегінің] ұзындығы: '''$7'''.",
...
'mailnologintext' => 'Басқа қатысушыға хат жөнелту үшін [[{{#special:Userlogin}}|кіруіңіз]] жөн, және [[{{#special:Preferences}}|баптауыңызда]] жарамды е-пошта жайы болуы жөн.',
...
'noemailtext'     => 'Бұл қатысушы жарамды Е-пошта жайын келтірмеген, не басқалардан хат қабылдауын өшірген.',
'emailfrom'       => 'Кімнен',
'emailto'         => 'Кімге',
...
'revertpage'                  => '[[{{#special:Contributions}}/$2|$2]] ([[{{ns:user_talk}}:$2|талқылауы]]) өңдемелерінен қайтарған;
...
'blockiptext'                 => 'Төмендегі пішін қатысушының жазу рұқсатын белгілі IP жайымен не атымен бұғаттау үшін қолданылады.
...
Аңғартпа: Егер осы арада алдақашан жаңа тақырып аты бар бет болса, бұл бос не айдату болғанша дейін, және соңында түзету тарихы жоқ болса, бет '''жылжытылмайды'''. Осының мағынасы: егер бетті қателікпен қайта атасаңыз, бұрынғы атауына қайта атауға болады, және бар беттің үстіне жазуыңызға болмайды.
...
'tooltip-pt-anonuserpage'         => 'Бұл IP жайдың жеке беті',
'tooltip-pt-mytalk'               => 'Талқылау бетім',
'tooltip-pt-anontalk'             => 'Бұл IP жай өңдемелерін талқылау',
...
Хаттың ішінде белгілеме бар сілтеме кірістірледі; 
...
Жарамсыз таңбалар үшін жайды тексеріп шығыңыз.
