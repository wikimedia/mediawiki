...
'acct_creation_throttle_hit' => 'Эн номнуо $1 ааты оҥорбуккун. 
...
'diff-styleadded'         => 'истиил эбиллибит',
'diff-added'              => 'эбиллибит',
'diff-changedto'          => 'манныкка уларытыллыбыт',
'diff-movedoutof'         => 'мантан ылыллыбыт $1',
'diff-styleremoved'       => 'истиил сотуллубут/сотулунна',
'diff-removed'            => 'сотулунна',
'diff-changedfrom'        => 'мантан уларыйда',
'diff-src'                => 'ылыллыбыт сирэ',
'diff-withdestination'    => 'анааһыннаах',
'diff-width'              => 'кэтитэ',
'diff-height'             => 'үрдүгэ',
'diff-p'                  => "'''апсаас'''",
