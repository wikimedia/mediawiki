...
'mainpagetext'      => "<span style="font-size:larger">'''«MediaWiki» сөпкө туруорулунна.'''</span>",
...
'blockedtext'                      => "<span style="font-size:larger">'''Эн аатыҥ эбэтэр IP-аадырыһыҥ бобулуннулар.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 төннөрүлүннэ (төннөрүллүбүт)'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" сирэй аата маннык буолла "$2"\'\'\'</span>',
...
'protectedpagemovewarning'     => "'''Сэрэтии:''' бу сирэй уларытыыттан көмүскэммит, аатын дьаһабыллар эрэ уларытар кыахтаахтар.",
