...
Эн манна бэлиэтэнниҥ. {{SITENAME}}-ҕа [[Special:Preferences|бэйэҥ туруорууларгын]] уларытаргын умнума.',
...
'loginproblem'               => 'Эн аатыҥ ылыныллыбата. Өссө суруйан көр!',
'login'                      => 'Киир',
...
Эн бу кыттааччыга: $1 эбэтэр атын [[{{MediaWiki:grouppage-sysop}}|администраторга]] суруйан быһаарсыаххын сөп. Болҕой, өскө регистрацияламматах буоллаххына, эбэтэр эл. аадырыскын [[Special:Preferences|манна]] бигэргэппэтэх буоллаххына, эбэтэр сурук суруйарыҥ бобуллубут буоллаҕына администраторга суруйар кыаҕыҥ суох.
...
'anontalkpagetext'          => "----''Бу аатын эппэтэх кыттааччы ырытар сирэйэ. IP-аадырыһа эрэ көстөр. Биир IP-аадырыс хас да киһиэхэ бэриллиэн сөп. Өскө атын киһиэхэ суруллубут суругу алҕас туппут буоллаххына, бэйэҥ [[Special:Userlogin|ааккын билиһиннэр]], оччоҕо кэлин да булкуур тахсыа суоҕа.''",
...
'nocreatetext'              => 'Манна саҥа сирэйдэри оҥорор хааччахтанар. Баар сирэйи уларытыаххын сөп, эбэтэр [[Special:Userlogin|манна киирэн ааккын билиһиннэриэххин эбэтэр саҥа аатынан киириэххин сөп]].',
...
'undo-summary' => '[[Special:Contributions/$2|$2]] кыттааччы ([[{{ns:user_talk}}:$2|ырытыы]]) $1 нүөмэрдээх уларытыытын сотон оннугар туһэрэргэ.',
...
'addedwatchtext'       => '«[[:$1]]» сирэй [[Special:Watchlist|кэтэбилгэ]] киирдэ. Сирэй уларытыылара бүгүҥҥүттэн манна көстөр буолуохтара, эбиитин [[Special:Recentchanges|саҥа уларытыылар испииһэктэригэр]] модьу бичигинэн бэлиэтэнэн көстүөхтэрэ.
...
'revertpage'                  => '([[User_talk:$2|обсуждение]]) көннөрүүлэрэ: [[Special:Contributions/$2|$2]] бу торумҥа: [[{{ns:user}}:$1|$1]] төннөрүлүннүлэр',
...
<br />[[Special:Ipblocklist|Бобуллубут IP-лар испииһэктэрин]] көр.',
