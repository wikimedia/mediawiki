...
'sp-contributions-deleted'       => 'Сотуллубут көннөрүү',
...
'move-talk-subpages'           => 'Сатанар буоллаҕына ырытыы анныкы сирэйдэрин (подстраницы) ааттарын уларыт ($1 дылы)',
...
'external_image_whitelist' => ' #Бу строкааны хайдах баарынан хааллар<pre>
...
#Размещайте фрагменты регулярных выражений над этой строчкой. Бу строкааны хайдах баарынан хааллар.</pre>',
...
'dberr-header'      => 'Бу биики туга эрэ сатамат',
