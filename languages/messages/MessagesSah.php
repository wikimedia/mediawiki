...
'logentry-suppress-delete'            => '$3 сирэйи $1 {{GENDER:$2|баттаабыт}}',
...
'logentry-move-move_redir-noredirect' => '$1 $3 сирэй аатын утаарыы үрдүнэн маннык $4 {{GENDER:$2|уларыппыт}}, утаарыы-сирэй оҥорботох',
'logentry-patrol-patrol'              => '$1 $3 сирэй $4 барылын ботуруулламмыт курдук {{GENDER:$2|бэлиэтээбит}}',
'logentry-patrol-patrol-auto'         => '$1 $3 сирэй $4 барылын аптамаатынан ботуруулламмыт курдук {{GENDER:$2|бэлиэтээбит}}',
