...
'mainpagetext'      => "<span style="font-size:larger">'''මාධ්‍යවිකි සාර්ථක ලෙස ස්ථාපනය කරන ලදි.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''ඔබ අයැද ඇත්තේ අනීතික විශේෂ පිටුවකි.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">ඔබගේ පරිශීලක නාමය හෝ අන්තර්ජාල ලිපිනය හෝ වාරණය කොට ඇත.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 ප්‍රතිෂ්ඨාපනය කෙරී ඇත'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1" යන පිටුව  "$2"\'\'\' වෙත ගෙන යන ලදි</span>',
