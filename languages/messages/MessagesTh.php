...
'diff-big'                => "'''ใหญ่'''",
'diff-del'                => "'''ถูกลบ'''",
'diff-tt'                 => "'''จำกัดความกว้าง'''",
'diff-sub'                => "'''เอียงลงล่าง'''",
'diff-sup'                => "'''เอียงขึ้นบน'''",
...
'tooltip-rollback'                => '"ย้อนกลับ" ใช้ย้อนการแก้ไขของหน้านี้ไปยังรุ่นโดยผู้ใช้ก่อนหน้าในคลิกเดียว',
'tooltip-undo'                    => '"ย้อน" ใช้ย้อนการแก้ไขของหน้านี้และเปิดฟอร์มให้แก้ไข สามารถเพิ่มคำอธิบายในตอนท้าย',
...
'spamprotectiontext'  => 'หน้าที่คุณต้องการบันทึกถูกบล็อกจากตัวกรองสแปม ซึ่งอาจเกิดจากมีลิงก์สแปมในส่วนแหล่งข้อมูลอื่น',
...
'mw_math_modern' => 'แนะนำสำหรับเว็บเบราว์เซอร์แบบใหม่',
