...
'passwordtooshort'           => 'รหัสผ่านสั้นเกินไปต้องมีความยาวอย่างน้อย {{PLURAL:$1|1 ตัวอักษร|$1 ตัวอักษร}}',
...
'anontalkpagetext'                 => "----''หน้านี้เป็นหน้าพูดคุยสำหรับผู้ใช้ที่ไม่ประสงค์ออกนาม ซึ่งยังไม่ได้สร้างบัญชีผู้ใช้
โดยทางเราจำเป็นต้องระบุตัวตนผ่านทางหมายเลขไอพี
ซึ่งหมายเลขไอพีนี้อาจถูกใช้ร่วมกันโดยผู้ใช้หลายคน
ถ้าคุณเป็นผู้ไม่ประสงค์ออกนาม และรู้สึกว่าความเห็นที่คุณได้รับไม่เกี่ยวข้องกับคุณแต่อย่างใด กรุณา[[Special:UserLogin/signup|สร้างบัญชีผู้ใช้]]หรือ[[Special:UserLogin|ล็อกอิน]] เพื่อป้องกันการสับสนกับผู้ใช้ที่ไม่ประสงค์ออกนามรายอื่น''",
...
'revdelete-failure'           => "'''ไม่สามารถตั้งค่าการซ่อนหรือแสดงรุ่นการแก้ไขได้:'''
$1",
