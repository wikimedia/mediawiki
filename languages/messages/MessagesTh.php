...
'category_header'       => 'ส่วนเนื้อหาในหมวดหมู่ "$1"',
...
'aboutpage'         => '{{ns:project}}โครงการ:เกี่ยวกับ',
...
'nlinks'                  => '$1 ลิงก์',
'nmembers'                => '$1 สมาชิก',
'nrevisions'              => '$1 การปรับปรุง',
'nviews'                  => '$1 ครั้ง (เข้าดู)',
...
'protectedpagesempty'     => 'ไม่มีหน้าใดที่ถูกล็อกตามค่าพารามิเตอร์นี้',
...
'rclsub'                  => '(ไปที่หน้าลิงก์จาก "$1")',
'newpages'                => 'หน้าใหม่',
'newpages-username'       => 'ชื่อผู้ใช้:',
'ancientpages'            => 'หน้าเก่ามาก',
'intl'                    => 'ลิงก์ข้ามภาษา',
'move'                    => 'เปลี่ยนชื่อ',
'movethispage'            => 'เปลี่ยนชื่อหน้านี้',
'unusedimagestext'        => '<p>คำแนะนำ: ภาพนี้อาจจะถูกใช้จากเว็บไซต์อื่นสิ่งลิงก์มาภาพนี้โดยตรง </p>',
'unusedcategoriestext'    => 'หมวดหมู่ต่อไปนี้ยังมีอยู่ถึงแม้ว่าจะไม่มีว่าไม่มีหน้าไหนหรือบทความไหนใช้ส่วนนี้',

# Book sources
'booksources'               => 'ที่มาของหนังสือ',
'booksources-search-legend' => 'ค้นหาที่มาของหนังสือ',
...
'categoriespagetext' => 'หมวดหมู่ต่อไปนี้มีอยู่ในวิกิ',
'data'               => 'ข้อมูล',
...
'logempty'             => 'ไม่พบค่าในส่วนบันทึก',
'log-title-wildcard'   => 'ค้นหาชื่อเรื่องเริ่มต้นจากข้อความ',

# Special:Allpages
'nextpage'          => 'ถัดไป ($1)',
'prevpage'          => 'ก่อนหน้า ($1)',
'allpagesfrom'      => 'แสดงผลโดยเริ่มจาก:',
...
'mywatchlist'          => 'รายการเฝ้าดูของฉัน',
...
'addedwatchtext'       => 'หน้า "[[:$1]]" ถูกใส่เข้าไปใน[[Special:Watchlist|รายการเฝ้าดู]]ของคุณ ถ้ามีการเปลี่ยนแปลงเกิดขึ้นในหน้าเหล่านี้ รวมถึงหน้าพูดคุยของหน้าเหล่านี้
...
'deletesub'                   => '(กำลังลบ "$1")',
'historywarning'              => 'คำเตือน: หน้าที่กำลังจะถูกลบมีประวัติ:',
'confirmdeletetext'           => 'คุณกำลังจะลบหน้าหรือภาพนี้ รวมไปถึงประวัติหน้าอย่างถาวรออกจากฐานข้อมูล
กรุณายืนยันว่าต้องการดำเนินการต่อและแน่ใจว่าได้เข้าใจและสอดคล้องกับ[[{{MediaWiki:policy-url}}]].',
...
'protect-unchain'             => 'ปลดล็อกการเปลี่ยนชื่อ',
...
'protect-default'             => '(ค่าพื้นฐาน)',
'protect-level-autoconfirmed' => 'บล็อกผู้ใช้ไม่ลงทะเบียน',
'protect-level-sysop'         => 'ผู้ดูแลระบบเท่านั้น',
...
'minimum-size'                => 'ขนาดน้อยสุด',
'maximum-size'                => 'ขนาดมากสุด',
'pagesize'                    => '(ไบต์)',
...
'undeletepage'             => 'ดูและเรียกคืนที่ถูกลบ',
...
'namespace' => 'เนมสเปซ:',
'invert'    => 'กลับสิ่งที่เลือก',

# Contributions
'contributions' => 'เรื่องที่ผู้ใช้นี้เขียน',
...
'nolinkshere'         => "ไม่มีหน้าใดลิงก์ไปที่ '''[[:$1]]'''",
'nolinkshere-ns'      => "ไม่มีหน้าใดลิงก์ไปที่ '''[[:$1]]''' ในเนมสเปซที่เลือกไว้",
...
'ipadressorusername'          => 'หมายเลขไอพี หรือชื่อผู้ใช้:',
'ipbexpiry'                   => 'หมดอายุ:',
'ipbreason'                   => 'สาเหตุ:',
'ipbreasonotherlist'          => 'สาเหตุอื่น',
'ipbreason-dropdown'          => '
...
'ipbenableautoblock'          => 'บล็อกหมายเลขไอพีนี้ และไอพีที่ผู้ใช้นี้อาจจะใช้งานอัตโนมัติ',
'ipbsubmit'                   => 'บล็อกชื่อผู้ใช้',
'ipbother'                    => 'เวลาอื่น:',
'ipboptions'                  => '2 ชั่วโมง:2 ชั่วโมง,1 วัน:1 วัน,3 วัน:3 วัน,1 อาทิตย์:1 อาทิตย์,2 อาทิตย์:2 อาทิตย์,1 เดือน:1 เดือน,3 เดือน:3 เดือน,6 เดือน:6 เดือน,1 ปี:1 ปี,ตลอดไป:ตลอดไป',
'ipbotheroption'              => 'อื่น',
...
<br />ดู  [[Special:Ipblocklist|รายการไอพีที่ถูกบล็อกำ]] เพื่อตรวจสอบการบล็อก',
...
'movepagetext'            => "ใช้แบบฟอร์มด้านล่างในการเปลี่ยนชื่อหน้า โดยประวัติการแก้ไขของหน้านี้จะย้ายตามไปด้วย
ชื่อของหน้าเก่าจะกลายเป็นหน้าเปลี่ยนทาง โดยลิงก์อื่นที่มายังหน้าเก่าจะลิงก์ต่อมาที่หน้าใหม่ แต่ยังคงใช้ชื่อเดิม
อย่าลืมตรวจสอบหน้าเปลี่ยนทางที่เสีย หรือเปลี่ยนทางซ้ำซ้อนที่อาจจะเกิดขึ้น

การเปลี่ยนชื่อจะ'''ไม่'''สามารถเปลี่ยนชื่อทับชื่อเดิมได้ หากชื่อเดิมไม่ได้เป็นหน้าว่างหรือหน้าเปลี่ยนทาง
...
# Export
'export'            => 'ส่งข้ามหน้า',
'exporttext'        => 'สามารถส่งข้ามข้อความและประวัติของหน้าใดหรือหลายหน้า เก็บไว้ในรูปแบบเอกซ์เอ็มแอล ซึ่งสามารถนำข้ามไปใช้งานในวิกิอื่นที่ใช้ซอฟต์แวร์มีเดียวิกิเหมือนกัน ผ่านคำสั่ง [[Special:Import|นำข้ามหน้า]]
...
'allmessagestext'           => 'รายการแสดงข้อวามในเนมสเปซมีเดียวิกิ',
...
'allmessagesfilter'         => 'กรองชื่อข้อความ:',
...
'djvu_page_error'          => 'หน้าเดจาวูเกินขนาด',
'djvu_no_xml'              => 'ไม่สามารถส่งเอกซ์เอ็มแอลสำหรับไฟล์เดจาวู',
...
'tooltip-pt-preferences'          => 'การตั้งค่าส่วนตัว',
'tooltip-pt-watchlist'            => 'รายการที่กำหลังเฝ้าดูการเปลี่ยนแปลง',
...
'tooltip-n-recentchanges'         => 'รายการแสดงการปรับปรุงล่าสุดในวิกินี้',
'tooltip-n-randompage'            => 'สุ่มหน้าขึ้นมา',
'tooltip-n-help'                  => 'แหล่งอธิบายการใช้งาน',
...
'tooltip-ca-nstab-mediawiki'      => 'ดูหน้าข้อความของระบบ',
...
'subcategorycount'       => 'มี $1 หมวดหมู่ย่อยในหมวดหมู่นี้',
'categoryarticlecount'   => 'มี $1 บทความในหมวดหมู่นี้',
'category-media-count'   => 'มี $1 ไฟล์ในหมวดหมู่นี้',
...
'imagemaxsize'         => 'จำหัดภาพหรือคำอธิบายภาพไว้ที่:',
...
'exif-exposurebiasvalue'           => 'เอกโพเชอร์ไบแอส',
