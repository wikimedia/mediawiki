...
<span class="plainlinks"> [{{fullurl: {{# Специальные: Вход}} | страница = {{FULLPAGENAMEE}}}} найти соответствующие записи журналов],
или [{{fullurl: {{FULLPAGENAME}} | действия = Изменить}} создать страницу] </ SPAN>.',
