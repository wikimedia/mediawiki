...
'userrights-available-remove'      => 'Bạn có thể dời thành viên khỏi {{PLURAL:$2|nhóm|các nhóm}}: $1.',
...
'userrights-changeable-col'        => 'Các nhóm mà bạn có thể thay đổi',
'userrights-unchangeable-col'      => 'Các nhóm mà bạn không có thể thay đổi',
