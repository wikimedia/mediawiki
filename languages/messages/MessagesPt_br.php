...
'badsiglength'               => 'Assinatura muito longa. Ela deveria ter menos de $1 caracteres.',
'email'                      => 'E-mail',
...
'throttled-mailpassword'     => 'Um lembrete de senha já foi enviado nas últimas $1 horas. Para prevenir abusos, apenas um lembrete poderá ser enviado a cada
$1 horas.',
...
'revdelete-hide-restricted'   => 'Aplicar estas restrições a administradores e travar esta interface',
...
'overlogpagetext' => 'Abaixo é exibida uma lista das deleções e bloqueios mais recentes envolvendo conteúdos ocultados por Administradores. Veja a [[{{ns:special}}:Ipblocklist|lista de bloqueios]] para ter uma listagem dos bloqueios e banimentos atualmente vigentes.',

# History merging
'mergehistory'                     => 'Fundir histórico de páginas',
'mergehistory-header'              => 'Esta página deixa você fundir revisões do histórico de uma página de origem em uma página mais nova.
Certifique-se de que esta alteração irá manter a continuidade do conteúdo da página.',
...
'userrights-groupsremovable'       => 'Grupos removíveis:',
...
'filepageexists'              => 'A página de descrição para este arquivo já foi criada em <strong><tt>$1</tt></strong>, mas nenhum arquivo com este nome existe no momento.
O sumário que você digitar não irá aparecer na página de descrição.
Para fazer com que seu sumário apareça lá, você precisará editá-la manualmente.',
...
'withoutinterwiki-header'  => 'As seguintes páginas não possuem ligações para versões em outros idiomas:',
...
** Violação de direitos de autor
** Vandalismo',
'delete-toobig'               => 'Esta página tem um histórico de edição longo, com mais de $1 revisões. A exclusão de tais páginas foi restrita para evitar problemas acidentais em {{SITENAME}}.',
'delete-warning-toobig'       => 'Esta página possui um longo histórico de edições, com mais de $1 revisões. Eliminá-la poderá causar problemas no banco de dados de {{SITENAME}}; prossiga com cuidado.',
...
'undeleterevdel'               => 'O restauro não será executado se dele resultar a remoção de parte da versão mais recente da página. Em tais casos, você devedesmarcar ou reverter a ocultação das versões apagadas mais recentes.
Revisões de arquivos para as quais você não tem permissão de visualização não serão restauradas.',
...
'confirmemail_body'       => 'Alguém, provavelmente você, com o endereço de IP $1, registrou uma conta "$2" com este endereço de \'\'e-mail\'\' no {{SITENAME}}.

Para confirmar que esta conta realmente é sua, e para ativar as funcionalidades de e-mail no {{SITENAME}}, abra o seguinte endereço no seu navegador:
...
'lag-warn-normal' => 'As alterações mais recentes do que $1 segundos podem não ser exibidas nesta lista.',
'lag-warn-high'   => 'Devido ao longo período de latência no servidor do banco de dados, alterações feitas há menos de $1 segundos poderão não aparecer nesta lista.',
