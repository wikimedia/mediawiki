...
'tog-minordefault' => 'డిఫాల్టుగా నా మార్పులను చిన్న మార్పులుగా గుర్తించు',
...
'underline-default' => 'రూపు యొక్క లేదా విహారిణి యొక్క అప్రమేయం',
...
'category-subcat-count' => '{{PLURAL:$2|ఈ వర్గంలో కింద చూపిన ఒకే ఉపవర్గం ఉంది.|ఈ వర్గంలో కింది {{PLURAL:$1|ఉపవర్గం ఉంది|$1 ఉపవర్గాలు ఉన్నాయి}}, మొత్తం $2 లో.}}',
...
'actionthrottledtext' => 'స్పామును నిరోధించేందుకు గాను, తక్కువ సమయంలో మరీ ఎక్కువ సార్లు ఈ పని చేయకుండా పరిమితి విధించాం. మీరు దాన్ని అధిగమించారు. కొన్ని నిమిషాలు ఆగి మరలా ప్రయత్నించండి.',
...
'blocked-mailpassword' => 'దిద్దుబాట్లు చెయ్యకుండా మీ ఐపీఅడ్రసును నిరోధించాం. అంచేత, దుశ్చర్యల నివారణ కోసం గాను, మరచిపోయిన సంకేతపదాన్ని పొందే వీలు ఈ ఐపీకి లేదు.',
...
'right-apihighlimits' => 'API ప్రశ్నల్లో ఉన్నత పరిమితులను వాడడం',
...
'right-importupload' => 'ఫైలు ఎక్కింపు నుండి పేజీలను దిగుమతి చేసుకోవడం',
...
'overwrite' => 'ఇప్పటికే ఉన్న దస్త్రాన్ని తిరగరాయడానికి అనుమతి లేదు.',
'unknown-error' => 'ఏదో తెలియని లోపం దొర్లింది.',
...
* ఎక్కిస్తున్న ఫైలు పేరు: <strong>[[:$1]]</strong>
...
'backend-fail-opentemp' => 'తాత్కాలిక దస్త్రాన్ని తెరవలేకపోయాం.',
...
'filehist-thumbtext' => '$1 నాటి కూర్పు యొక్క నఖచిత్రం',
...
'sharedupload' => 'ఈ ఫైలు $1 లోనిది. దీనిని ఇతర ప్రాజెక్టులలో కూడా ఉపయోగిస్తూ ఉండి ఉండవచ్చు.',
'sharedupload-desc-there' => 'ఈ ఫైలు $1 లోనిది. అలానే ఇతర ప్రాజెక్టులలో కూడా ఉపయోగిస్తూ ఉండి ఉండవచ్చు.
...
'allpages-bad-ns' => '{{SITENAME}} లో "$1" అనే పేరుబరి లేదు.',
...
'listgrouprights-addgroup-self' => '{{PLURAL:$2|గుంపును|గుంపులను}} తన స్వంత ఖాతాకు చేర్చుకోగలగడం: $1',
...
'tooltip-ca-unwatch' => 'ఈ పేజీని మీ వీక్షణ జాబితా నుండి తొలగించండి',
'tooltip-search' => '{{SITENAME}} లో వెతకండి',
'tooltip-search-go' => 'కచ్చితంగా ఇదే పేరుతో పేజీ ఉంటే అక్కడికి తీసుకెళ్ళు',
...
'tooltip-t-whatlinkshere' => 'ఇక్కడికి లింకై ఉన్న అన్ని వికీ పేజీల జాబితా',
...
'tooltip-watch' => 'ఈ పేజీని మీ వీక్షణ జాబితాకు చేర్చండి',
