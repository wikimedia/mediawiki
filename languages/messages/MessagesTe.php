...
'mainpagetext'      => "<span style="font-size:larger">'''మీడియా వికీని విజయవంతంగా ప్రతిష్టించాం.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''మీరు అడిగిన ప్రత్యేకపేజీ సరైనది కాదు.'''</span>
...
'blockedtext'                      => '<span style="font-size:larger">\'\'\'మీ వాడుకరి పేరుని లేదా ఐ.పీ. చిరునామాని నిరోధించారు.\'\'\'</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 ను పునస్థాపించాం'''</span>
...
'movepage-moved'               => '<span style="font-size:larger">\'\'\'"$1"ని "$2"కి తరలించాం\'\'\'</span>',
