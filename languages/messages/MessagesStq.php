...
'mainpagetext'      => "<span style="font-size:larger">'''Ju MediaWiki Software wuude mäd Ärfoulch installierd.'''</span>",
...
'blockedtext'                      => '<span style="font-size:larger">\'\'\'Din Benutsernoome of dien IP-Adrässe wuud fon $1 speerd.\'\'\'</span> 
...
'copyrightwarning'                 => "'''<span style="font-size:larger">Kopier neen Websieden,</span> do nit dien oaine sunt, benuts neen uurhääbergjuchtelk schutsede Wierke sunner Ferlof fon dän Copyright-Inhääber!'''<br />
...
'movepage-moved'               => "<span style="font-size:larger">'''Ju Siede „$1“ wuude ätter „$2“ ferschäuwen.'''</span>",
