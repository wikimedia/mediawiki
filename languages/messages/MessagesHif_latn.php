...
'diff-sub'                => 'Niche waala akchhar',
'diff-sup'                => 'Uppar waala akchhar',
'diff-strike'             => 'Kaata gais akchhar',
...
'exif-orientation-2' => 'Baraabar ultawa gais hae', # 0th row: top; 0th column: right
'exif-orientation-3' => '180° ghumawa gais hae', # 0th row: bottom; 0th column: right
'exif-orientation-4' => 'Khrraa ultawa gais hae', # 0th row: bottom; 0th column: left
'exif-orientation-5' => '90° CCW ghumawa aur kharraa ultawa gais hae', # 0th row: left; 0th column: top
'exif-orientation-6' => '90° CW ghumawa gais hae', # 0th row: right; 0th column: top
'exif-orientation-7' => '90° CW ghumawa aur kharraa ultawa gais hae', # 0th row: right; 0th column: bottom
'exif-orientation-8' => '90° CCW ghumawa gais hae', # 0th row: left; 0th column: bottom
...
# Special:Version
'version'              => 'Badlao', # Not used as normal message but as header for the special page itself
