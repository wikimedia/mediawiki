...
'mainpagetext' => "<span style="font-size:larger">'''میڈیاوکی کو کامیابی سے چالو کردیا گیا ہے۔.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''آپ نے ایک ناقص خاص صفحہ کی درخواست کی ہے.'''</span>
...
'uploadtext'        => "
<span style="font-size:larger">'''یادآوری''': اگر آپ اپنی ملف (فائل) زبراثقال کرتے وقت ، خلاصہ کے خانے میں ،  درج ذیل دو باتوں کی وضاحت نہیں کرتے تو ملف کو حذف کیا جاسکتا ہے:</span>
