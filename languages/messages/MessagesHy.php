...
'mainpagetext'      => "<span style="font-size:larger">'''«MediaWiki» ծրագիրը հաջողությամբ տեղադրվեց։'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Ձեր հայցված սպասարկող էջը գոյություն չունի։'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Ձեր մասնակցի անունը կամ IP-հասցեն արգելափակված է։'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''«$1» էջը վերականգնված է։'''</span>
...
'movepage-moved'          => "<span style="font-size:larger">'''«$1» էջը վերանվանվել է «$2»'''</span>",
