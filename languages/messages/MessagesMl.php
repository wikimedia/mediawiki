...
$specialPageAliases = array(
	...
	'Userrights'                => array( 'ഉപയോക്തൃഅവകാശങ്ങള്‍', 'കാര്യനിർവാഹകസൃഷ്ടി', 'യന്ത്രസൃഷ്ടി' ),
	'MIMEsearch'                => array( 'മൈംതിരയൽ' ),
	'FileDuplicateSearch'       => array( 'പ്രമാണത്തിന്റെ അപരനുള്ള തിരച്ചില്‍' ),
	'Unwatchedpages'            => array( 'ആരുംശ്രദ്ധിക്കാത്തതാളുകള്‍' ),
...
'jumptosearch'      => 'തിരയൂ',
'view-pool-error'   => 'ക്ഷമിക്കണം, ഈ നിമിഷം സെര്‍വറുകള്‍ അമിതഭാരം കൈകാര്യം ചെയ്യുകയാണ്.
ധാരാളം ഉപയോക്താക്കള്‍ ഈ താള്‍ കാണുവാന്‍ ശ്രമിച്ചുകൊണ്ടിരിക്കുകയാണ്.
ഇനിയും താള്‍ ലഭ്യമാക്കുവാന്‍ താങ്കള്‍ ശ്രമിക്കുന്നതിന് മുന്‍പ് ദയവായി അല്പസമയം കാത്തിരിക്കുക. 
...
'protectedpagewarning'             => "'''മുന്നറിയിപ്പ്:  ഈ താള്‍ കാര്യനിർവാഹക പദവിയുള്ളവർക്കു മാത്രം തിരുത്താന്‍ സാധിക്കാവുന്ന തരത്തില്‍ സം‌രക്ഷിക്കപ്പെട്ടിരിക്കുന്നു.''' അവലംബമായി രേഖകളിൽ ലഭ്യമായ ഏറ്റവും പുതിയ വിവരം താഴെ നൽകിയിരിക്കുന്നു:",
'semiprotectedpagewarning'         => "'''ശ്രദ്ധിക്കുക:'''അംഗത്വമെടുത്തിട്ടുള്ളവര്‍ക്കുമാത്രം തിരുത്താന്‍ സാധിക്കുന്ന വിധത്തിൽ ഈ താൾ സംരക്ഷിക്കപ്പെട്ടിരിക്കുന്നു. അവലംബമായി രേഖകളിലെ ഏറ്റവും പുതിയ വിവരം താഴെ കൊടുത്തിരിക്കുന്നു:",
...
'titleprotectedwarning'            => "'''മുന്നറിയിപ്പ്: [[Special:ListGroupRights|പ്രത്യേക അവകാശമുള്ള]] ഉപയോക്താക്കള്‍ക്ക് മാത്രം സൃഷ്ടിക്കാൻ സാധിക്കുന്ന വിധത്തിൽ ഈ താൾ സംരക്ഷിക്കപ്പെട്ടിരിക്കുന്നു.''' അവലംബമായി രേഖകളിൽ ലഭ്യമായ ഏറ്റവും പുതിയ വിവരം താഴെ നൽകിയിരിക്കുന്നു:",
'templatesused'                    => 'ഈ താളില്‍ ഉപയോഗിച്ചിരിക്കുന്ന {{PLURAL:$1|ഫലകം|ഫലകങ്ങൾ}}:',
'templatesusedpreview'             => 'ഈ പ്രിവ്യൂവിൽ ഉപയോഗിച്ചിരിക്കുന്ന {{PLURAL:$1|ഫലകം|ഫലകങ്ങള്‍}}:',
...
'currentrev-asof'        => '$1 -ല്‍ നിലവിലുള്ള രൂപം',
...
{{SITENAME}} സം‌രംഭത്തിലെ മറ്റു കാര്യനിര്‍‌വാഹകര്‍ക്ക് ഈ മറഞ്ഞിരിക്കുന്ന ഉള്ളടക്കം പരിശോധിക്കുവാനും താങ്കള്‍ മായ്ച്ചതു തിരസ്ക്കരിക്കുവാനും സാധിക്കും.  മറ്റു കൂടുതല്‍ സം‌രക്ഷണ പരിമിതികള്‍ സജ്ജീകരിച്ചിട്ടില്ലെങ്കില്‍ ഇതേ സമ്പർക്കമുഖം ഉപയോഗിച്ചു തന്നെ അത്തരത്തില്‍ പ്രവര്‍ത്തിക്കുന്നതിനു അവര്‍ക്ക് സാധിക്കും.",
...
'prefs-display'                 => 'പ്രദര്‍ശന ഐച്ഛികങ്ങള്‍',
...
'historywarning'         => "'''മുന്നറിയിപ്പ്''': താങ്കൾ മായ്ക്കുവാന്‍ പോകുന്ന താളിനു ഏകദേശം {{PLURAL:$1|ഒരു നാൾപ്പതിപ്പ്|$1 നാൾപ്പതിപ്പുകൾ}} ഉള്ള നാൾവഴി ഉണ്ട്:",
...
'protectedpagemovewarning'     => "'''മുന്നറിയിപ്പ്:'''  കാര്യനിർവാഹക പദവിയുള്ളവർക്കു മാത്രം മാറ്റാന്‍ കഴിയുന്ന വിധത്തിൽ ഈ താൾ സംരക്ഷിക്കപ്പെട്ടിരിക്കുന്നു. അവലംബമായി രേഖകളിലെ ഏറ്റവും പുതിയ വിവരം താഴെ നൽകിയിരിക്കുന്നു:",
'semiprotectedpagemovewarning' => "'''കുറിപ്പ്:''' അംഗത്വമെടുത്ത ഉപയോക്താക്കൾക്കു മാത്രം മാറ്റാന്‍ കഴിയുന്ന വിധത്തിൽ ഈ താൾ സംരക്ഷിക്കപ്പെട്ടിരിക്കുന്നു. അവലംബമായി രേഖകളിലെ ഏറ്റവും പുതിയ വിവരം താഴെ കൊടുത്തിരിക്കുന്നു:",
