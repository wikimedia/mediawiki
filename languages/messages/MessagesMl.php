...
$specialPageAliases = [
    ...
    'ApiHelp'                 => [ 'എപിഐസഹായം' ],
    'ApiSandbox'             => [ 'എപിഐസാന്റ്ബോക്സ്' ],
    'ChangeContentModel'     => [ 'ഉള്ളടക്കമാതൃകമാറ്റുക' ],
    'CreateAccount'          => [ 'അംഗത്വമെടുക്കൽ', 'അക്കൗണ്ടുണ്ടാക്കുക' ],
    'EditRecovery'           => [ 'തിരുത്തൽപുനരുദ്ധരണം' ],
    'GlobalBlock'            => [ 'ആഗോളതടയൽ' ],
    'GlobalBlockList'        => [ 'ആഗോളതടയൽപട്ടിക' ],
    'GlobalPreferences'      => [ 'ആഗോളക്രമീകരണങ്ങൾ' ],
    'GlobalRenameRequest'    => [ 'ആഗോളപുനർനാമകരണാനുവാദം' ],
    'GlobalUserRights'       => [ 'ആഗോളഉപയോക്തൃഅവകാശങ്ങൾ' ],
    'GrowthManagement'       => [ 'വളർച്ചാഭരണകൂടം' ],
    'HideUser'               => [ 'ഉപയോക്താവിനെമറയ്ക്കുക' ],
    'Insights'               => [ 'ഉൾദർശനങ്ങൾ' ],
    'IntegrationTest'        => [ 'സംയോജനപരീക്ഷണം' ],
    'IPInfo'                 => [ 'ഐപിവിവരം' ],
    'LinkAccounts'           => [ 'അക്കൗണ്ടുകൾയോജിപ്പിക്കുക' ],
    'ListGrantees'           => [ 'അനുമതിദാതാക്കളുടെപട്ടിക' ],
    'Login'                  => [ 'പ്രവേശിക്കുക', 'ലോഗിൻ' ],
    'Logout'                 => [ 'പുറത്തുകടക്കുക', 'ലോഗൗട്ട്' ],
    'ManageWiki'             => [ 'വിക്കിനിയന്ത്രണം' ],
    'MIMEsearch'             => [ 'മൈംതിരയൽ', 'MIMEതിരയൽ' ],
    'MobileOptions'          => [ 'മൊബൈൽഐച്ഛികങ്ങൾ' ],
    'NewSection'             => [ 'പുതിയവിഭാഗം' ],
    'OAuth'                  => [ 'ഓഓത്ത്' ],
    'OAuthConsumerRegistration' => [ 'ഓഓത്ത്ഉപഭോക്തൃരജിസ്ട്രേഷൻ' ],
    'PageData'               => [ 'താളിന്റെവിവരം' ],
    'PageInfo'               => [ 'താളിന്റെവിവരങ്ങൾ' ],
    'PageLanguage'           => [ 'താളിന്റെഭാഷ' ],
    'PasswordPolicies'       => [ 'രഹസ്യവാക്ക്‌നയങ്ങൾ' ],
    'PasswordReset'          => [ 'രഹസ്യവാക്ക്‌പുനക്രമീകരണം', 'പാസ്‌വേഡ്‌റീസെറ്റ്' ],
    'PendingChanges'         => [ 'തീർച്ചപ്പെടാത്തമാറ്റങ്ങൾ' ],
    'PhpErrors'              => [ 'പിഎച്ച്പിതിരകൾ' ],
    'Plugin'                 => [ 'പ്ലഗിൻ' ],
    'Promote'                => [ 'പദോന്നതി' ],
    'ProtectedPages'         => [ 'സംരക്ഷിതതാളുകൾ' ],
    'ProtectedTitles'        => [ 'സംരക്ഷിതശീർഷകങ്ങൾ' ],
    'Purge'                  => [ 'തിരുത്തം' ],
    'RandomInCategory'       => [ 'വർഗ്ഗത്തിൽനിന്ക്ക്രമരഹിതം' ],
    'RandomRedirect'         => [ 'ക്രമരഹിതതിരിച്ചുവിടൽ' ],
    'RecentChanges'          => [ 'സമീപകാലമാറ്റങ്ങൾ' ],
    'Renameuser'             => [ 'ഉപയോക്തൃപുനർനാമകരണം' ],
    'ResetTokens'            => [ 'ടോക്കണുകൾപുനഃസജ്ജീകരിക്കുക' ],
    'RevisionDelete'         => [ 'നാൾപ്പതിപ്പ്മായ്ക്കൽ' ],
    'Search'                 => [ 'തിരയുക', 'അന്വേഷണം' ],
    'SecurePoll'             => [ 'സുരക്ഷിതവോട്ടെടുപ്പ്' ],
    'SiteMatrix'             => [ 'സൈറ്റുകളുടെമാട്രിക്സ്' ],
    'Sitemap'                => [ 'സൈറ്റ്മാപ്പ്' ],
    'Statistics'             => [ 'സ്ഥിതിവിവരണം' ],
    'Tags'                   => [ 'ടാഗുകൾ', 'അടയാളങ്ങൾ' ],
    'ThemeDesigner'          => [ 'തീംഡിസൈനർ' ],
    'TitleBlacklist'         => [ 'തലക്കെട്ടുകളുടെകരിമ്പട്ടിക' ],
    'Unblock'                => [ 'തടയൽനീക്കുക' ],
    'UnlinkAccounts'         => [ 'അക്കൗണ്ടുകൾവേർപെടുത്തുക' ],
    'Upload'                 => [ 'അപ്‌ലോഡ്', 'ശേഖരം' ],
    'UploadStash'            => [ 'അപ്‌ലോഡ്മറയ്ക്കൽ' ],
    'UserLogin'              => [ 'ഉപയോക്തൃപ്രവേശനം' ],
    'UserLogout'             => [ 'ഉപയോക്തൃപുറത്തുകടക്കൽ' ],
    'UserRights'             => [ 'ഉപയോക്തൃഅവകാശങ്ങൾ' ],
    'ViewAvatar'             => [ 'അവതാരംകാണുക' ],
    'WebChat'                => [ 'വെബ്‌ചാറ്റ്' ],
    'WikiForum'              => [ 'വിക്കിഫോറം' ],
...
$magicWords = [
	...
	'staticredirect'            => [ '1', '__സ്ഥിരസ്ഥിതതിരിച്ചുവിടൽ__', '__STATICREDIRECT__' ],
    ...
    'anchorencode'           => [ '0', 'അങ്കർഎൻകോഡ്', 'ANCHORENCODE' ],
    'cascadingsources'       => [ '1', 'കാസ്കേഡിംഗ്‌സോഴ്സുകൾ', 'CASCADINGSOURCES' ],
    'contentlanguage'        => [ '1', 'ഉള്ളടക്കഭാഷ', 'CONTENTLANGUAGE', 'CONTENTLANG' ],
    'currentdayname'         => [ '1', 'ഇന്നത്തെദിവസത്തിന്റെപേര്', 'CURRENTDAYNAME' ],
    'currentmonthnames'      => [ '1', 'ഈമാസത്തിന്റെപേരുകൾ', 'CURRENTMONTHNAMES' ],
    'currentversion'         => [ '1', 'ഇപ്പോഴത്തെപതിപ്പ്', 'CURRENTVERSION' ],
    'currentweek'            => [ '1', 'ഈആഴ്ച', 'CURRENTWEEK' ],
    'directionmark'          => [ '1', 'ദിശാസൂചിക', 'DIRECTIONMARK', 'DIRMARK' ],
    'displaytitle'           => [ '1', 'ശീർഷകംപ്രദർശിപ്പിക്കുക', 'DISPLAYTITLE' ],
    'filepath'               => [ '0', 'പ്രമാണപഥം:', 'FILEPATH:' ],
    'forcetoc'               => [ '0', '__ഉള്ളടക്കംഇടുക__', '__FORCETOC__' ],
    'formatnum'              => [ '0', 'സംഖ്യാഘടന', 'FORMATNUM' ],
    'fullpagename'           => [ '1', 'മുഴുവൻതാളിന്റെപേര്', 'FULLPAGENAME' ],
    'fullurl'                => [ '0', 'മുഴുവൻയുആർഎൽ:', 'FULLURL:' ],
    'gender'                 => [ '0', 'ലിംഗം:', 'GENDER:' ],
    'grammar'                => [ '0', 'വ്യാകരണം:', 'GRAMMAR:' ],
    'hiddencat'              => [ '1', '__മറഞ്ഞിരിക്കുന്നവർഗ്ഗം__', '__HIDDENCAT__' ],
    'img_alt'                => [ '1', 'ബദൽ=$1', 'alt=$1' ],
    'img_border'             => [ '1', 'അതിർരേഖ', 'border' ],
    'img_center'             => [ '1', 'മധ്യം', 'center', 'centre' ],
    'img_framed'             => [ '1', 'ചട്ടം', 'frame', 'framed' ],
    'img_frameless'          => [ '1', 'ചട്ടമില്ലാത്ത', 'frameless' ],
    'img_left'               => [ '1', 'ഇടത്', 'left' ],
    'img_link'               => [ '1', 'കണ്ണി=$1', 'link=$1' ],
    'img_manualthumb'        => [ '1', 'ലഘുചിത്രം=$1', 'thumbnail=$1', 'thumb=$1' ],
    'img_middle'             => [ '1', 'മധ്യം', 'middle' ],
    'img_none'               => [ '1', 'ഒന്നുമില്ല', 'none' ],
    'img_right'              => [ '1', 'വലത്', 'right' ],
    'img_thumbnail'          => [ '1', 'ലഘുചിത്രം', 'thumb', 'thumbnail' ],
    'img_top'                => [ '1', 'മുകളിൽ', 'top' ],
    'img_upright'            => [ '1', 'നേരെകുത്തനെ', 'upright' ],
    'language'               => [ '0', '#ഭാഷ', '#LANGUAGE' ],
    'lc'                     => [ '0', 'ലോവർകേസ്:', 'LC:' ],
    'lcfirst'                => [ '0', 'ആദ്യംലോവർകേസ്:', 'LCFIRST:' ],
    'localday'               => [ '1', 'പ്രാദേശികദിവസം', 'LOCALDAY' ],
    'localdayname'           => [ '1', 'പ്രാദേശികദിവസത്തിന്റെപേര്', 'LOCALDAYNAME' ],
    'localhour'              => [ '1', 'പ്രാദേശികമണിക്കൂർ', 'LOCALHOUR' ],
    'localmonth'             => [ '1', 'പ്രാദേശികമാസം', 'LOCALMONTH' ],
    'localmonthname'         => [ '1', 'പ്രാദേശികമാസത്തിന്റെപേര്', 'LOCALMONTHNAME' ],
    'localtime'              => [ '1', 'പ്രാദേശികസമയം', 'LOCALTIME' ],
    'localurl'               => [ '0', 'പ്രാദേശികയുആർഎൽ:', 'LOCALURL:' ],
    'localweek'              => [ '1', 'പ്രാദേശികആഴ്ച', 'LOCALWEEK' ],
    'localyear'              => [ '1', 'പ്രാദേശികവർഷം', 'LOCALYEAR' ],
    'namespace'              => [ '1', 'നാമമേഖല', 'NAMESPACE' ],
    'newsectionlink'         => [ '1', '__പുതിയവിഭാഗംകണ്ണി__', '__NEWSECTIONLINK__' ],
    'nocontentconvert'       => [ '0', '__ഉള്ളടക്കംമാറ്റേണ്ട__', '__NOCONTENTCONVERT__', '__NOCC__' ],
    'noeditsection'          => [ '0', '__സംശോധിക്കേണ്ട__', '__NOEDITSECTION__' ],
    'nogallery'              => [ '0', '__ഗാലറിവേണ്ട__', '__NOGALLERY__' ],
    'noindex'                => [ '1', '__സൂചികവേണ്ട__', '__NOINDEX__' ],
    'nonewsectionlink'       => [ '1', '__പുതിയവിഭാഗംകണ്ണിവേണ്ട__', '__NONEWSECTIONLINK__' ],
    'notitleconvert'         => [ '0', '__തലക്കെട്ട്മാറ്റേണ്ട__', '__NOTITLECONVERT__', '__NOTC__' ],
    'notoc'                  => [ '0', '__ഉള്ളടക്കംവേണ്ട__', '__NOTOC__' ],
    'ns'                     => [ '0', 'നാമമേഖല:', 'NS:' ],
    'numberofactiveusers'    => [ '1', 'സജീവഉപയോക്താക്കളുടെഎണ്ണം', 'NUMBEROFACTIVEUSERS' ],
    'numberofadmins'         => [ '1', 'കാര്യനിർവാഹകരുടെഎണ്ണം', 'NUMBEROFADMINS' ],
    'numberofarticles'       => [ '1', 'ലേഖനങ്ങളുടെഎണ്ണം', 'NUMBEROFARTICLES' ],
    'numberofedits'          => [ '1', 'തിരുത്തലുകളുടെഎണ്ണം', 'NUMBEROFEDITS' ],
    'numberoffiles'          => [ '1', 'പ്രമാണങ്ങളുടെഎണ്ണം', 'NUMBEROFFILES' ],
    'numberofpages'          => [ '1', 'താളുകളുടെഎണ്ണം', 'NUMBEROFPAGES' ],
    'numberofusers'          => [ '1', 'ഉപയോക്താക്കളുടെഎണ്ണം', 'NUMBEROFUSERS' ],
    'padleft'                => [ '0', 'ഇടത്തുനിറക്കുക', 'PADLEFT' ],
    'padright'               => [ '0', 'വലത്തുനിറക്കുക', 'PADRIGHT' ],
    'pagename'               => [ '1', 'താളിന്റെപേര്', 'PAGENAME' ],
    'pagesincategory'        => [ '1', 'വർഗ്ഗത്തിലുള്ളതാളുകൾ', 'PAGESINCATEGORY', 'PAGESINCAT' ],
    'pagesize'               => [ '1', 'താൾവലിപ്പം', 'PAGESIZE' ],
    'plural'                 => [ '0', 'ബഹുവചനം:', 'PLURAL:' ],
    'protectionlevel'        => [ '1', 'സംരക്ഷണതലം', 'PROTECTIONLEVEL' ],
    'raw'                    => [ '0', 'അസംസ്കൃതം:', 'RAW:' ],
    'redirect'               => [ '0', '#തിരിച്ചുവിടൽ', '#REDIRECT' ],
    'revisionid'             => [ '1', 'നാൾപ്പതിപ്പ്ഐഡി', 'REVISIONID' ],
    'revisionuser'           => [ '1', 'നാൾപ്പതിപ്പുഉപയോക്താവ്', 'REVISIONUSER' ],
    'safesubst'              => [ '0', 'സുരക്ഷിതമായബദൽ:', 'SAFESUBST:' ],
    'scriptpath'             => [ '0', 'സ്ക്രിപ്റ്റ്പാത്', 'SCRIPTPATH' ],
    'server'                 => [ '0', 'സെർവർ', 'SERVER' ],
    'sitename'               => [ '1', 'സൈറ്റിന്റെപേര്', 'SITENAME' ],
    'special'                => [ '0', 'പ്രത്യേകം', 'special' ],
    'staticredirect'         => [ '1', '__സ്ഥിരതിരിച്ചുവിടൽ__', '__STATICREDIRECT__' ],
    'stylepath'              => [ '0', 'സ്റ്റൈല്പാത്', 'STYLEPATH' ],
    'subpagename'            => [ '1', 'ഉപതാളിന്റെപേര്', 'SUBPAGENAME' ],
    'subst'                  => [ '0', 'ബദൽ:', 'SUBST:' ],
    'tag'                    => [ '0', 'ടാഗ്', 'tag' ],
    'talkspace'              => [ '1', 'സംവാദമേഖല', 'TALKSPACE' ],
    'toc'                    => [ '0', '__ഉള്ളടക്കം__', '__TOC__' ],
    'uc'                     => [ '0', 'അപ്പർകേസ്:', 'UC:' ],
    'ucfirst'                => [ '0', 'ആദ്യംഅപ്പർകേസ്:', 'UCFIRST:' ],
    'urlencode'              => [ '0', 'യുആർഎൽഎൻകോഡ്:', 'URLENCODE:' ],
];
