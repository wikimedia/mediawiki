...
'category-subcat-count'          => '{{PLURAL:$2|ഈ വർഗ്ഗത്തിനു്‌ താഴെ പ്രദർശിപ്പിച്ചിരിക്കുന്ന ഒരു ഉപവർഗ്ഗം മാത്രമേ ഉള്ളൂ.|ഈ വർഗ്ഗത്തിനു്‌ മൊത്തം $2 ഉപവർഗ്ഗങ്ങളുള്ളതിൽ {{PLURAL:$1|ഉപവർഗ്ഗം|$1 ഉപവർഗ്ഗങ്ങൾ}} ഈ താളിൽ പ്രദർശിപ്പിച്ചിരിക്കുന്ന.}}',
...
'externaldberror'            => 'ഒന്നുകിൽ ആധികാരികതാ വിവരശേഖരത്തിൽ പ്രശ്നം ഉണ്ടായിരുന്നു അല്ലെങ്കിൽ നവീകരിക്കുവാൻ താങ്കളുടെ ബാഹ്യ അംഗത്വം താങ്കളെ അനുവദിക്കുന്നില്ല.',
'login'                      => 'പ്രവേശിക്കുക',
...
'blocked-mailpassword'       => 'താങ്കളുടെ ഐ.പി. വിലാസത്തെ ഈ വിക്കി തിരുത്തുന്നതിൽ നിന്നു തടഞ്ഞിട്ടുള്ളതാണ്‌. അതിനാൽ രഹസ്യവാക്കു വീണ്ടെടുക്കുന്ന സജ്ജീകരണം ഉപയോഗിക്കുന്നതിനു താങ്കൾക്കു അവകാശമില്ല.',
...
'throttled-mailpassword'     => 'കഴിഞ്ഞ {{PLURAL:$1|മണിക്കൂറിനുള്ളിൽ |$1 മണിക്കൂറുകൾക്കുള്ളിൽ}} രഹസ്യവാക്കു ഓർമ്മപ്പെടുത്താനുള്ള ഒരു മെയിൽ അയച്ചിട്ടുണ്ട്. ദുർവിനിയോഗം ഒഴിവാക്കാൻ {{PLURAL:$1|ഒരു മണിക്കൂറിനുള്ളിൽ |$1 മണിക്കൂറുകൾക്കുള്ളിൽ}} രഹസ്യവാക്കു ഓർമ്മപ്പെടുത്താനുള്ള ഒരു മെയിൽ മാത്രമേ അനുവദിക്കൂ.',
...
'createaccount-text'         => '{{SITENAME}} സംരംഭത്തിൽ ($4) താങ്കളുടെ ഇമെയിൽ വിലാസത്തിൽ ആരോ ഒരു അംഗത്വം "$2" എന്ന ഉപയോക്തൃനാമത്തിൽ ഉണ്ടാക്കിയിരിക്കുന്നു (രഹസ്യവാക്ക്: "$3").  താങ്കൾ ഇപ്പോൾ ലോഗിൻ ചെയ്തു രഹസ്യവാക്കു മാറ്റേണ്ടതാകുന്നു.

അംഗത്വം അബദ്ധവശാൽ ഉണ്ടാക്കിയതാണെങ്കിൽ താങ്കൾക്കു ഈ സന്ദേശം നിരാകരിക്കാവുന്നതാണ്‌.',
...
'whitelistedittitle'               => 'തിരുത്താൻ ലോഗിൻ ആവശ്യമാണ്‌',
...
'right-block'                 => 'മറ്റുള്ള ഉപയോക്താക്കളെ മാറ്റിയെഴുതുന്നതിൽനിന്നും വിലക്കുക',
'right-blockemail'            => 'ഉപയോക്താവിനെ ഇമെയിൽ അയക്കുന്നതിൽ നിന്നും വിലക്കുക',
...
'action-createtalk'           => 'സംവാദ താളുകൾ നിർമിക്കുക',
...
'rclinks'                           => 'കഴിഞ്ഞ $2 ദിവസങ്ങൾക്കുള്ളിലുണ്ടായ $1 മാറ്റങ്ങൾ കാട്ടുക<br />$3',
'diff'                              => 'മാറ്റം',
'hist'                              => 'നാൾ‌വഴി',
'hide'                              => 'മറയ്ക്കുക',
...
'http-host-unreachable' => 'യു.ആർ.എൽ.-ൽ എത്തിപ്പെടാൻ സാധിച്ചില്ല',
...
'disambiguations'      => 'നാനാർത്ഥ താളുകൾ',
'disambiguationspage'  => 'Template:നാനാർത്ഥം',
'disambiguations-text' => 'താഴെ കൊടുത്തിരിക്കുന്ന താളുകൾ നാനാർത്ഥതാളിലേക്കു കണ്ണി ചേർക്കപ്പെട്ടിരിക്കുന്നു. അതിനു പകരം അവ ലേഖനതാളുകളിലേക്കു കണ്ണി ചേക്കേണ്ടതാണ്‌. <br /> ഒരു താളിനെ നാനാർത്ഥതാൾ ആയി പരിഗണിക്കണമെങ്കിൽ അതു  [[MediaWiki:Disambiguationspage]] എന്ന താളിൽ നിന്നു കണ്ണി ചേർക്കപ്പെട്ട ഒരു ഫലകം ഉപയോഗിക്കണം.',
...
'withoutinterwiki-legend'  => 'പൂർവപ്രത്യയം',
...
'unusedcategoriestext'    => 'താഴെ പറയുന്ന വർഗ്ഗത്താൾ നിലവിലുണ്ട്, എങ്കിലും മറ്റു താളുകളോ വർഗ്ഗങ്ങളോ അവ ഉപയോഗിക്കുന്നില്ല.',
...
*താങ്കൾ താഴെയുള്ള ചെൿബോക്സ് ഉപയോഗിച്ചിട്ടില്ലങ്കിൽ
...
'immobile-source-page'         => 'ഈ താൾ നീക്കാൻ സാധ്യമല്ല',
...
'tooltip-ca-talk'                 => 'ഉള്ളടക്കം താളിനെക്കുറിച്ചുള്ള ചർച്ച',
...
'tooltip-ca-nstab-main'           => 'ഉള്ളടക്കം താൾ കാണുക',
...
'confirmemail_success'     => 'താങ്കളുടെ ഇമെയിൽ വിലാസം സ്ഥിരീകരിക്കപ്പെട്ടിരിക്കുന്നു. ഇനി താങ്കൾക്ക് ലോഗിൻ ചെയ്തശേഷം വിക്കി ആസ്വദിക്കാം.',
...
'dberr-problems'    => 'ക്ഷമിക്കണം! ഈ സൈറ്റിന് സങ്കേതിക തകരാറുകൾ അനുഭവപ്പെടുന്നുണ്ട്.',
