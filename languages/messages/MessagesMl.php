...
'resetpass-logtext'         => 'കാര്യനിർവാഹകരുടെ സഹായത്തോടെ പാസ്‌വേഡ് പുനക്രമീകരിച്ച ഉപയോക്താക്കളുടെ പട്ടിക താഴെക്കൊടുത്തിരിക്കുന്നു.',
'resetpass-logentry'        => '$1 -ന്റെ പാസ്‌വേഡ് മാറ്റിയിരിക്കുന്നു',
'resetpass-comment'         => 'പാസ്‌വേഡ് മാറ്റുന്നതിനുള്ള കാരണം',
...
'deletelog-fulllog'                => 'മൊത്തം രേഖകളും കാണുക',
...
'rev-deleted-unhide-diff'     => "ഈ മാറ്റത്തിനിടയിലുള്ള ഒരു നാൾപ്പതിപ്പ് '''നീക്കം ചെയ്തിട്ടുണ്ട്'''.
[{{fullurl:Special:Log/delete|page={{FULLPAGENAMEE}}}} മായ്ക്കൽ രേഖയിൽ] ഈ വിവരങ്ങളുണ്ടായിരിക്കാം.
എങ്കിലും ഒരു കാര്യനിർവാഹകനായതിനാൽ നിങ്ങൾക്ക് വേണമെങ്കിൽ [$1 ഈ മാറ്റം കാണാനാകും].",
