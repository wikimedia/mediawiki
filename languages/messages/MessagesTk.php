...
'passwordremindertext'       => 'Kimdir biri (ähtimal özüňiz $1 IP adresinden) {{SITENAME}} ($4) üçin täze parol iberilmegini talap etdi. "$2" ulanyjysy üçin wagtlaýynça "$3" paroly döredildi. Eger bu siziň öz talabyňyz bolsa, onda sessiýa açyp, bir täze parol saýlap almagyňyz zerurdyr. 
...
Bu sahypa wersiýasy jemgyýetçilik arhiwlerinden öçürilipdir.
...
'searchprofile-articles'           => 'Mazmun sahypalary',
...
'rcnotefrom'                        => "Aşakda '''$2''' senesinden bäri edilen üýtgeşmeler ('''$1''' çenli görkezilýär)",
...
'sharedupload'                   => 'Bu faýl umumy ammardan, özem beýleki taslamalarda ulanylýan bolmagy ahmal.',
...
'shareduploadduplicate'          => 'Bu faýl umumy ammardaky $1 faýlynyň dublikatydyr.',
'shareduploadduplicate-linktext' => 'başga faýl',
'shareduploadconflict'           => 'Bu faýlyň ady umumy ammardaky $1 faýlynyň ady bilen birmeňzeş.',
'shareduploadconflict-linktext'  => 'başga faýl',
'noimage'                        => 'Şeýle atly faýl ýok. Siz $1.',
'noimage-linktext'               => 'ýükläň',
'uploadnewversion-linktext'      => 'Bu faýlyň täze wersiýasyny ýükläň',
'imagepage-searchdupe'           => 'Dublikat faýllary gözle',
...
'expiringblock'                   => '$1 senesinde gutarýar',
...
'move-subpages'                => 'Kiçi sahypalaryň ählisiniň adyny üýtget, mümkin bolsa',
'move-talk-subpages'           => 'Çekişme sahypasynyň kiçi sahypalarynyň ählisiniň adyny üýtget, mümkin bolsa',
...
# Media information
'mediawarning'         => "'''Duýduryş''': Bu faýlda zyýanly kod bar bolmagy ahmal we ol iş ulgamyňyza zeper ýetirip biler.<hr />",
...
'confirmemail_pending'     => '<div class="error">Tassyklama kody size eýýäm ugradylypdyr;
eger hasabyňyzy ýaňy-ýakynda açan bolsaňyz, ol gelýänçä biraz tagapyl ediň, bolmasa täze kod sorap bilersiňiz.</div>',
...
# Trackbacks
'trackbackbox'      => '<div id="mw_trackbacks">Bu sahypa üçin trackbackler:<br />
$1
</div>',
