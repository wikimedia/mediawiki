...
$specialPageAliases = [
	...
	'ComparePages'               => [ '頁面比較' ],
	'Confirmemail'               => [ '確認信箱', '確認電郵', '確認電子郵件' ],
	'Contribute'                 => [ '做出貢獻' ],
	'Contributions'              => [ '使用者貢獻', '用戶貢獻' ],
	'CreateAccount'              => [ '建立帳號', '建立帳戶', '創建賬戶' ],
	'Deadendpages'               => [ '無連結頁面', '斷鏈頁面', '斷連頁面' ],
	'DeletedContributions'       => [ '已刪除的貢獻', '已刪除的用戶貢獻' ],
	'DeletePage'                 => [ '刪除頁面', '刪除' ],
	'Diff'                       => [ '編輯差異', '差異' ],
	'DoubleRedirects'            => [ '雙重的重新導向', '雙重重定向頁面', '雙重重新導向' ],
	'EditPage'                   => [ '編輯頁面', '編輯' ],
	'EditRecovery'               => [ '編輯恢復' ],
	'EditTags'                   => [ '編輯標籤' ],
	'EditWatchlist'              => [ '編輯監視清單', '編輯監視列表' ],
	'Emailuser'                  => [ '寄信給使用者', '寄信', '電郵使用者', '電郵聯絡' ],
	'ExpandTemplates'            => [ '展開模板' ],
	'Export'                     => [ '匯出', '匯出頁面', '導出頁面' ],
	'Fewestrevisions'            => [ '最少修訂頁面' ],
	'FileDuplicateSearch'        => [ '搜尋重複檔案', '重複檔案搜尋', '搜尋重復檔案' ],
	'Filepath'                   => [ '檔案路徑', '文件路徑' ],
	'GoToInterwiki'              => [ '前往跨wiki頁面' ],
	'Import'                     => [ '匯入', '匯入頁面', '導入頁面' ],
	'Interwiki'                  => [ '跨wiki', '跨維基' ],
	'Invalidateemail'            => [ '無效的信箱', '無法識別的電郵位址', '不可識別的電郵位址' ],
	'JavaScriptTest'             => [ 'JavaScript測試' ],
	'LinkAccounts'               => [ '連結帳號' ],
	'LinkSearch'                 => [ '連結搜尋', '搜尋網頁連結', '鏈接搜索' ],
	'Listadmins'                 => [ '管理員清單', '管理員列表' ],
	'Listbots'                   => [ '機器人清單', '機械人列表', '機械人清單' ],
	'ListDuplicatedFiles'        => [ '重複檔案清單', '重複檔案列表' ],
	'Listfiles'                  => [ '檔案清單', '圖片清單', '檔案列表', '圖像列表' ],
	'Listgrants'                 => [ '列出授權' ],
	'Listgrouprights'            => [ '群組權限清單', '使用者群組權限', '群組權限列表', '群組權限' ],
	'Listredirects'              => [ '重新導向清單', '重新導向頁面清單', '重定向頁面列表' ],
	...
	'Newimages'                  => [ '新增檔案', '新增圖片', '新建檔案' ],
	'Newpages'                   => [ '新增頁面', '新頁面', '最新頁面' ],
	'NewSection'                 => [ '新章節' ],
	'PageData'                   => [ '頁面資料' ],
	'PageHistory'                => [ '頁面歷史', '歷史' ],
	'PageInfo'                   => [ '頁面資訊', '資訊' ],
	...
	'Randompage'                 => [ '隨機頁面' ],
	'Randomredirect'             => [ '隨機重新導向', '隨機重新導向頁面', '隨機重定向頁面' ],
	'Randomrootpage'             => [ '隨機根頁面' ],
	'Recentchanges'              => [ '近期變更', '最近變更', '最近更改', '近期變動' ],
	'Recentchangeslinked'        => [ '已連結的最近變更', '相關變更', '連出更改', '鏈出更改' ],
	'Redirect'                   => [ '重新導向', '重定向' ],
