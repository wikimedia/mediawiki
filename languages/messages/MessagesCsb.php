...
'hidden-category-category'      => 'Zataconé kategòrëje', # Name of the category where hidden categories will be listed
...
'sharedupload'              => 'Nen lopk je na $1 ë mòże bëc brëkòwóny w jinych ùdbach.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
...
'ipbreason'                => 'Przëczëna:',
'ipboptions'               => '2 gòdzënë:2 hours,1 dzéń:1 day,3 dni:3 days,1 tidzéń:1 week,2 tigòdnie:2 weeks,1 ksãżëc:1 month,3 ksãżëcë:3 months,6 ksãżëców:6 months,1 rok:1 year,na wiedno:infinite', # display1:time1,display2:time2,...
