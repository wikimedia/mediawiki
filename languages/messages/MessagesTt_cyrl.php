...
# User rights
'userrights'                     => 'Кулланучы хокуклары белән идарә итү', # Not used as normal message but as header for the special page itself
...
'noimage'                   => 'Мондый исемле файл  юк, ләкин  сез $1 булдырасыз.',
'noimage-linktext'          => 'аны йөкләргә',
'uploadnewversion-linktext' => 'Бу файлның яңа юрамасын йөкләү',
'shared-repo-from'          => '$1 дән', # $1 is the repository name
...
'editcomment'    => "Үзгәртү өчен тасвир: \"''\$1''\".", # only shown if there is an edit comment
'revertpage'     => '[[Special:Contributions/$2|$2]] үзгәртүләре ([[User talk:$2|бәхәс]])  [[User:$1|$1]] юрамасына кадәр кире кайтарылды', # Additionally available: $3: revid of the revision reverted to, $4: timestamp of the revision reverted to, $5: revid of the revision reverted from, $6: timestamp of the revision reverted from
