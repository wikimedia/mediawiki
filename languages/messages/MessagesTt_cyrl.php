...
'explainconflict'                  => 'Сез бу битне төзәткән вакытта кемдер аңа үзгәрешләр кертте. Өстәге тәрәзәдә Сез хәзерге текстны күрәсез. Астагы тәрәзәдә Сезнең вариант урнашкан. Эшләгән төзәтмәләрегезне астагы тәрәзәдән өстәгенә күчерегез. «Битне саклау» төймәсенә баскач өстәге битнең тексты сакланаячак.',
