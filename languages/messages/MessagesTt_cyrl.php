...
# Special:ChangeEmail
'changeemail'          => 'Электрон әрҗә адресын үзгәртергә',
...
'revdelete-hide-comment'      => 'Үзгәртүләр тасвирламасын яшерергә',
'revdelete-hide-user'         => 'Үзгәртүченең исемен/IP адресын яшер',
'revdelete-hide-restricted'   => 'Мәгълүматларны идарәчеләрдән дә яшерергә',
'revdelete-radio-same'        => '(үзгәртмәү)',
'revdelete-radio-set'         => 'Әйе',
'revdelete-radio-unset'       => 'Юк',
'revdelete-suppress'          => 'Мәгълүматларны идарәчеләрдән дә яшерергә',
