...
'undo-summary' => '[[Special:Contributions/$2|$2]] кулланучысының ([[User talk:$2|фикер алышу]]) $1 үзгәртүеннән баш тарту',
...
# History pages
'viewpagelogs'           => 'Бу битнең журналларын карарга',
...
'revdelete-nologtype-title'   => 'Журнал тибы билгеләнмәгән',
'revdelete-nologtype-text'    => 'Гамәл башкарылырга тиешле ңурнал тибын билгеләргә оныттыгыз.',
'revdelete-nologid-title'     => 'Журналдагы язма хаталы',
