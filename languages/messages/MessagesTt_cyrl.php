...
<span class=\"plainlinks\">[{{fullurl:{{#Special:Log}}|page={{urlencode:{{FULLPAGENAME}}}}}} көндәлекләрдәге язмаларны] таба 
...
Сез [[Special:Search/{{PAGENAME}}|бу исем кергән башка мәкаләләрне]], 
<span class="plainlinks">[{{fullurl:{{#Special:Log}}|page={{urlencode:{{FULLPAGENAME}}}}}} көндәлекләрдәге язмаларны] таба аласыз.',
...
'templatesused'                    => 'Бу биттә {{PLURAL:$1|шаблон|шаблон}} кулланыла.',
...
'page_first'             => 'беренче',
'page_last'              => 'соңгы',
'histlegend'             => "Аңлатмалар: '''({{int:cur}})''' = хәзерге версиядән аерымлыклар, '''({{int:last}})''' = баягы версиядән аерымлыклар, '''{{int:minoreditletter}}''' = әһәмиятсез үзгәртүләр.",
...
'recentchanges-legend-minor'        => '$1 — әһәмиятсез үзгәртү',
...
'rcshowhideminor'                   => 'әһәмиятсез үзгәртүләрне $1',
...
'unwatch'           => 'Күзәтмәскә',
'watchlist-details' => 'Күзәтү исемлегегездә, бәхәс битләрен санамыйча, $1 бит бар.',
'wlshowlast'        => 'Баягы $1 сәгать $2 көн эчендә яки $3ны күрсәт',
'watchlist-options' => 'Күзәтү исемлеге параметрлары',
...
'movedto'        => 'күчерелгән:',
'movetalk'       => 'Бәйләнешле бәхәс битне күчерергә',
