...
'mainpagetext'      => "<span style="font-size:larger">'''Softvér MediaWiki bol úspešne nainštalovaný.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Vyžiadali ste si neplatnú špeciálnu stránku.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Vaše používateľské meno alebo IP adresa bola zablokovaná.'''</span>
...
'undeletedpage'                => "<span style="font-size:larger">'''$1 bol obnovený'''</span>
...
'movepage-moved'               => "<span style="font-size:larger">'''„$1” bolo presunuté na „$2”'''</span>",
