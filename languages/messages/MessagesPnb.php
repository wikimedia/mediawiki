...
'blockedtext'                      => "<span style="font-size:larger">'''تواڈا ورتن والا ناں یا فیر آئی پی ایڈریس روک دتا گیا اے۔'''</span>
...
'movepage-moved'          => '<span style="font-size:larger">\'\'\'"$1" نوں "$2" لے جایا گیا اے\'\'\'</span>',
