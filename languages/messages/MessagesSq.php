...
'sharedupload'              => 'Kjo skedë është nga $1 dhe mund të përdoret në projekte të tjera.', # $1 is the repo name, $2 is shareduploadwiki(-desc)
...
'shared-repo-from'          => 'nga $1', # $1 is the repository name
'shared-repo'               => 'një magazinë e përbashkët', # used when shared-repo-NAME does not exist
...
'editcomment'      => "Përmbledhja e redaktimit ishte: \"''\$1''\".", # only shown if there is an edit comment
