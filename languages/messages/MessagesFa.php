...
'tog-hidepatrolled'           => 'نهفتن ویرایش‌های نگهبانی شده در تغییرات اخیر',
...
'tog-watchlisthidepatrolled'  => 'نهفتن ویرایش‌های نگهبانی شده از فهرست پیگیری',
...
'right-patrol'                => 'به ویرایش‌های دیگران برچسب نگهبانی بزند',
'right-autopatrol'            => 'به ویرایش‌های خودش به صورت خودکار برچسب نگهبانی بزند',
'right-patrolmarks'           => 'مشاهدهٔ برچسب نگهبانی تغییرات اخیر',
...
'action-patrol'               => 'به ویرایش دیگران برچسب نگهبانی بزنید',
'action-autopatrol'           => 'به ویرایش خودتان برچسب نگهبانی بزنید',
...
'recentchanges-label-unpatrolled'   => 'این ویرایش هنوز نگهبانی نشده‌است',
...
# Patrolling
'markaspatrolleddiff'                 => 'برچسب نگهبانی بزن',
'markaspatrolledtext'                 => 'به این صفحه برچسب نگهبانی بزن',
'markedaspatrolled'                   => 'برچسب نگهبانی زده شد',
'markedaspatrolledtext'               => 'به نسخهٔ انتخاب شده از [[:$1]] برچسب نگهبانی زده شد.',
'rcpatroldisabled'                    => 'نگهبانی تغییرات اخیر غیر فعال است',
'rcpatroldisabledtext'                => 'امکان نگهبانی تغییرات اخیر در حال حاضر غیر فعال است.',
'markedaspatrollederror'              => 'برچسب نگهبانی زده نشد',
'markedaspatrollederrortext'          => 'باید یک نسخه را مشخص کنید تا برچسب نگهبانی بخورد.',
'markedaspatrollederror-noautopatrol' => 'شما نمی‌توانید به تغییرات انجام شده توسط خودتان برچسب نگهبانی بزنید.',

# Patrol log
'patrol-log-page'      => 'سیاههٔ نگهبانی',
'patrol-log-header'    => 'این سیاهه‌ای از ویرایش‌های نگهبانی شده‌است.',
'patrol-log-line'      => 'به $1 از $2 برچسب نگهبانی زد $3',
'patrol-log-auto'      => '(خودکار)',
'patrol-log-diff'      => 'نسخه $1',
'log-show-hide-patrol' => 'سیاههٔ نگهبانی $1',
