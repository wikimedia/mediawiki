...
'lastmodifiedat'    => 'این صفحه آخرین بار در $2, $1 تغییر کرده است.', # $1 date, $2 time
...
معتبری در [[Special:Preferences|ترجیحات کاربری]]‌تان ثبت کرده باشید.
...
'''<nowiki>[[</nowiki>{{ns:image}}:file.jpg]]''' or
'''<nowiki>[[</nowiki>{{ns:image}}:file.png|alt text]]''' or
'''<nowiki>[[</nowiki>{{ns:media}}:file.ogg]]''' for sounds.
...
<br />برای بررسی بسته‌شدن‌ها، به [[Special:Ipblocklist|فهرست IPهای بسته]] مراجعه کنید.',
