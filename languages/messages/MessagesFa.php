...
'listgrouprights-summary'  => 'فهرست زير، گروه‌های کاربری تعريف شده در اين ويکی و دسترسی‌های متناظرشان است. اطلاعات بیشتر را [[{{int:Listgrouprights-helppage}}|این‌جا]] بیابید.',
...
'ipb_modifying_block'         => 'تغییر قطع دسترسی قبلی:',
'ipb_tweak_block'             => 'هشدار: دسترسی این کاربر ($1) هم‌اینک بسته است.
شما می‌توانید از این فرم برای تغییر تنظیمات قطع دسترسی استفاده کنید.',
