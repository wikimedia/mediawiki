...
'tog-watchlisthideliu'        => 'نهفتن ویرایش‌های کاربران وارد شده به سیستم از فهرست پی‌گیری‌های من',
'tog-watchlisthideanons'      => 'نهفتن ویرایش‌های کاربران ناشناس از فهرست پی‌گیری‌ها',
...
صفحه‌هایی که در فهرست پی‌گیری‌های شما باشند به صورت '''سیاه''' نشان داده می‌شوند.",
...
'watchlist-hide-bots'  => 'نهفتن ویرایش ربات‌ها',
'watchlist-show-own'   => 'نمایش ویرایش‌های من',
'watchlist-hide-own'   => 'نهفتن ویرایش‌های من',
'watchlist-show-minor' => 'نمایش ویرایش‌های جزئی',
'watchlist-hide-minor' => 'نهفتن ویرایش‌های جزئی',
'watchlist-show-anons' => 'نمایش ویرایش‌های کاربران ناشناس',
'watchlist-hide-anons' => 'نهفتن ویرایش‌های کاربران ناشناس',
'watchlist-show-liu'   => 'نمایش ویرایش‌های کاربران ثبت‌نام‌کرده',
'watchlist-hide-liu'   => 'نهفتن ویرایش‌های کاربران ثبت‌نام‌کرده',
