...
'mainpagetext'      => "<span style="font-size:larger">'''MediaWiki пасьпяхова ўсталяваная.'''</span>",
...
'nospecialpagetext' => "<span style="font-size:larger">'''Вы зьвярнуліся на няслушную спэцыяльную старонку.'''</span>
...
'blockedtext'                      => "<span style="font-size:larger">'''Ваш рахунак ўдзельніка ці IP-адрас быў заблякаваны.'''</span>
...
'right-root'                  => 'выкананьне ўсіх дзеяньняў у {{GRAMMAR:месны|{{SITENAME}}}}',
...
'undeletedpage'                => "<span style="font-size:larger">'''Старонка $1 была адноўленая'''</span>
...
'movepage-moved'               => "<span style="font-size:larger">'''Старонка «$1» была перанесеная ў «$2»'''</span>",
