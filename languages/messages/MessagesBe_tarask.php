...
Ён мусіць быць не даўжэй за $1 {{PLURAL:$1|сымбаль|сымбалі|сымбаляў}}.',
'yourgender'                 => 'Пол:',
...
Імёны ўдзельнікаў гэта вельмі важная справа.
...
'accmailtext'                      => "Выпадкова створаны пароль для [[User talk:$1|$1]] быў адасланы на адрас $2.

Пароль для гэтага новага рахунка можа быць зьменены на старонцы ''[[Special:ChangePassword|зьмены пароля]]'' пасьля ўваходу.",
'newarticle'                       => '(Новы)',
...
'recentchangescount'        => 'Колькасьць рэдагаваньняў для паказу ў апошніх зьменах, гісторыях старонак і ў журналах, па змаўчаньню:',
...
'prefixindex'             => 'Усе старонкі па прэфіксу',
...
'editcomment'      => 'Апсаньне рэдагаваньня было: «<i>$1</i>».', # only shown if there is an edit comment
...
'tooltip-pt-mycontris'            => 'Сьпіс Вашых рэдагаваньняў',
...
'patrol-log-diff'      => 'выпраўленьне $1',
