...
'prefs-help-gender'          => 'Дадаткова: выкарыстоўваецца для дакладнай полавай пераадрасацыі ў праграмным забесьпячэньні. Гэта інфармацыя будзе ў агульным карыстаньні.',
...
Вялікія і малыя літары адрозьніваюцца ў імёнах ўдзельнікаў.
