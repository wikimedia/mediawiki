...
'passwordreset-emailerror-capture' => 'Электронны ліст з напамінам быў створаны, што паказана ніжэй, але адбылася памылка адпраўкі яго {{GENDER:$2|ўдзельніку|ўдзельніцы}}: $1',
