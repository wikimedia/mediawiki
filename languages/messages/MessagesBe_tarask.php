...
'userpage-userdoesnotexist' => 'Рахунак удзельніка «$1» не зарэгістраваны. Калі ласка, ўдакладніце, ці жадаеце Вы стварыць/рэдагаваць гэтую старонку.',
...
'usercssjsyoucanpreview'    => '<strong>Падказка:</strong> Выкарыстоўвайце кнопку «Папярэдні прагляд», каб папробаваць новы код CSS/JS перад тым як яго запісаць.',
