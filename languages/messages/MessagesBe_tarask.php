...
'log-title-wildcard'   => 'Шукаць назвы, якія пачынаюцца з гэтых сымбаляў',
...
'categoriesfrom'                => 'Паказаць катэгорыі, якія пачынаюцца з:',
...
'listgrouprights-summary'  => 'Ніжэй прадстаўлены сьпіс групаў удзельнікаў гэтай вікі, разам зь іх правамі.
Дадатковую інфармацыю аб іх асабістых правах можна знайсьці [[{{MediaWiki:Listgrouprights-helppage}}|тут]].',
'listgrouprights-group'    => 'Група',
'listgrouprights-rights'   => 'Правы',
'listgrouprights-helppage' => 'Help:Правы групаў удзельнікаў',
'listgrouprights-members'  => '(сьпіс удзельнікаў)',

# E-mail user
'mailnologin'     => 'Няма адрасу адпраўленьня',
'mailnologintext' => 'Вам неабходна [[Special:Userlogin|ўвайсьці ў сыстэму]] і мець пацьцверджаны адрас электроннай пошты ў Вашых [[Special:Preferences|наладах]] каб дасылаць электронныя лісты іншым удзельнікам.',
