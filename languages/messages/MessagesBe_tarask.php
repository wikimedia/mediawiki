...
'interwiki-not-enabled'    => 'Рэдагаваньне табліцы інтэрвікі было адключана.',
'interwiki_prefix'         => 'Прэфікс',
'interwiki_reasonfield'    => 'Прычына',
'interwiki_trans'          => 'Дазволіць інтэрвікі ўключэньні',
'interwikilogpage'         => 'Журнал зьменаў табліцы інтэрвікі',
'interwikilogpagetext'     => 'Гэта журнал зьменаў [[Special:Interwiki|табліцы інтэрвікі]].',
