...
'tooltip-pt-anonuserpage'         => 'Старонка ўдзельніка для IP-адраса, зь якога вы рэдагуеце',
...
'tooltip-ca-nstab-main'           => 'Прагляд зьместа старонкі',
'tooltip-ca-nstab-user'           => 'Паказаць старонку ўдзельніка',
'tooltip-ca-nstab-media'          => 'Прагляд старонкі з медыа файламі',
...
'tooltip-ca-nstab-mediawiki'      => 'Прагляд сыстэмнага паведамленьня',
...
'tooltip-recreate'                => 'Аднавіць старонку, ня гледзячы на тое, што яна была выдалена',
'tooltip-upload'                  => 'Пачаць загрузку',

# Metadata
'nodublincore'      => 'Мэтазьвесткі Dublin Core RDF забаронены для гэтага сэрвэра.',
'nocreativecommons' => 'Мэтазьвесткі Creative Commons RDF забаронены на гэтым сэрвэры.',
...
'creditspage'      => 'Падзякі',
'nocredits'        => 'Няма інфармацыі аб аўтарах гэтай старонкі.',
