...
'accmailtext'               => 'تم إرسال كلمة السر الخاصة ب"$1" إلى العنوان $2.',
'newarticle'                => '(جديد)',
...
'revdelete-logaction'         => 'تم ضبط {{PLURAL:$1|تعديل|تعديلين|$1 تعديلات|$1 تعديل|$1 تعديلا}} للوضع $2',
...
لرؤية أو البحث في الملفات المرفوعة سابقا، راجع [[Special:Imagelist|قائمة الملفات المرفوعة]]، عمليات الرفع (وإعادة الرفع) مسجلة في [[Special:Log/upload|سجل الرفع]].
...
'alreadyrolled'               => 'لم يمكن استرجاع آخر تعديل ل[[:$1]] بواسطة [[User:$2|$2]] ([[User talk:$2|نقاش]])؛
...
# Attribution
'anonymous'        => 'مستخدم(ون) مجهول(ون) ل{{SITENAME}}',
...
'category-media-count'   => 'يوجد {{PLURAL:$1|ملف واحد|$1 ملف}} في هذا التصنيف.',
