...
'tog-ccmeonemails'            => 'أرسل لي نسخا من البريد الإلكتروني الذي أرسله للمستخدمين الآخرين',
...
'longpagewarning'           => '<strong>تحذير: هذه صفحة طويلة وحجمها $1 كيلوبايت، بعض متصفحات الشبكة قد تواجه مشاكل عند محاولة تحرير صفحات يزيد حجمها عن 32 كيلوبايت. يرجى تقسيم الصفحة إلى أقسام أصغر حجما  إن أمكن.</strong>',
...
'autoblocker'                 => 'تم منعك تلقائيا لأن الأيبي الخاص بك تم استخدامه مؤخرا بواسطة "[[User:$1|$1]]". سبب منع $1 هو: "$2"',
