...
#	'grammar'                => array( 0,    'GRAMMAR:'               ),
	...
	'currentdow'             => array( 1,    'رقم_يوم'      ,     'CURRENTDOW'           ),
...
'tog-highlightbroken'         => 'اظهر الوصلات المكسورة <a href="" class="new">بهذا الشكل</a> (البديل بهذا الشكل<a href="" class="internal">؟</a>).',
...
'tog-showtoolbar'             => 'اظهر شريط التحرير (يتطلب جافا سكريبت)',
'tog-editondblclick'          => 'اذهب إلى صفحة التحرير عند النقر المزدوج على المقالة (يتطلب جافا سكريبت)',
'tog-editsection'             => 'مكّن تعديل الأقسام في المقال عن طريق روابط [تحرير]',
'tog-editsectiononrightclick' => 'مكّن تحرير الأقسام في المقال عن طريق كبسة الفأرة اليمين على عناوين الأقسام (يتطلب جافا سكريبت)',
'tog-showtoc'                 => 'اظهر فهرس المحتويات (للمقالات التي تحتوي على أكثر من 3 أقسام)',
'tog-rememberpassword'        => 'تذكر عبر الجلسات',
'tog-editwidth'               => 'صندوق التحرير يأخذ كامل عرض المساحة المتاحة',
'tog-watchcreations'          => 'أضف صفحات التي أنشأها إلى قائمة مراقبتي',
'tog-watchdefault'            => 'أضف الصفحات التي تقوم بتحريرها إلى قائمة مراقبتي',
...
'tog-previewontop'            => 'اظهر العرض المسبق قبل صندوق التحرير',
'tog-previewonfirst'          => 'اعرض الصفحة عند حفظها بعد أول تعديل',
'tog-nocache'                 => 'امنع حفظ نسخة من الصفحة بعد زيارتها',
'tog-enotifwatchlistpages'    => 'ارسل لي رسالة بالتغييرات على الصفحة',
'tog-enotifusertalkpages'     => 'ارسل لي رسالة عندما يتم تحرير صفحة نقاشي',
'tog-enotifminoredits'        => 'ارسل لي رسالة للتغييرات الطفيفة أيضًا',
'tog-enotifrevealaddr'        => 'اظهر عنوان بريدي الإلكتروني في رسائل التنويه',
'tog-shownumberswatching'     => 'اظهر عدد المستخدمين المراقبين للصفحة',
...
'tog-ccmeonemails'            => 'إرسال نسخ من الرسائل التي أرسلها للمستخدمين الأخرين إلى بريدي الخاص',
...
'metadata_help' => 'معطيات ميتا (انظر [[{{ns:project}}:معطيات ميتا]] لمزيد من المعلومات):',
...
'lastmodifiedat'    => 'أخر تعديل لهذه الصفحة كان في $2, $1.', # $1 date, $2 time
...
'badaccess-group0' => 'لا يسمح لكم بتنفيذ الاجراءات طلبتم.',
...
'nosuchactiontext'  => 'الأمر في عنوان الصفحة لم يتم التعرف عليه من خلال الويكي',
...
أخر استعلام طُلب من قاعدة البيانات كان:
...
'noconnect'            => 'عفوا! تعاني الويكي من بعض المشاكل التقنية, و لا يمكن الاتصال بخادوم قاعدة البيانات. <br />
$1',
...
عادة ما يكون السبب في ذلك اتّباع صفحة فروق قديمة أو رابط لتاريخ صفحة محذوفة. إذا كنت تعتقد أن السبب غير ذلك، فمن الممكن أن يكون هنالك ثغرة في البرنامج. الرجاء إعلام الإداريين عن هذا الخطأ مع ذكر الوصلة.',
'internalerror'        => 'خطأ داخلي',
'filecopyerror'        => 'لا يمكن نسخ الملف من  "$1" إلى "$2".',
'filerenameerror'      => 'لا يمكن تغيير إسم الملف من  "$1" إلى "$2".',
...
'cannotdelete'         => 'لم يتم مسح الصفحة أو الملف المطلوب. ( ربما يكون قد تم مسحه من قبل مستخدم أخر. )',
'badtitle'             => 'عنوان خاطئ',
'badtitletext'         => 'عنوان الصفحة المطلوبة إما خاطئ أو فارغ، و ربما يكون الرابط بين اللغات أو بين المشاريع خاطئ. من الممكن وجود رموز لا تصلح للإستعمال في العنوان.',
...
'protectedinterface'   => 'هذه الصفحة تتضمن نص الواجهة للبرنامج، لقد تم إغلاقها لمنع التخريب.',
'editinginterface'     => "'''تحذير''': أنت تقوم بتحرير صفحة تستخدم في الواجهة النصية للبرنامج. أية تغييرات لهذه الصفحة سوف يظهر في واجهة المستخدم لجميع المستخدمين الآخرين.",
...
'blockedtext'               => "<big>'''تم منع إسم المستخدم أو عنوان الأيبي الخاص بك.'''</big>
...
'copyrightwarning2'         => 'من فضلك لاحظ أن حميع المشاركات في {{SITENAME}} يمكن أن تعدل أو تتغير أو تحذف من قبل المشاركين الأخرين. إذا لم تكن ترغب أن تعدل مشاركاتك بهذا الشكل, لا تضعها هنا.<br />
...
'edittools'                 => '<!-- النص هنا سيظهر تحت صناديق التحرير و تحميل الصور. -->',
...
'undo-summary' => 'الرجوع عن التعديل $1 بواسطة [[خاص:Contributions/$2|$2]] ([[نقاش المستخدم:$2|نقاش]])',
...
'history-feed-empty'          => 'الصفحة المطلوبة غير موجودة. من المحتمل أن تكون هذه الصفحة قد حذف أو نقلت. حاول [[خاص:Search|البحث في الويكي]] عن صفحات جديدة ذات صلة.',
...
'allowemail'               => 'السماح بتلقي رسائل الكترونية من المستخدمين الأخرين',
...
'rcnote'                            => 'ستجد بالأسفل أخر <strong>$1</strong> تعديل في أخر <strong>$2</strong> يوم, منذ $3.',
...
'rcshowhidepatr'                    => '$1 تعديل تمت مراجعته',
...
'reuploaddesc'                => 'ارجع إلى صفحة التحميل.',
'uploadnologin'               => 'لم تقم بتسجيل الدخول',
'uploadnologintext'           => 'يجب أن تكون [[Special:Userlogin|مسجلا الدخول]] لتتمكن من تحميل الملفات.',
'upload_directory_read_only'  => 'لا يمكن الكتابة على مجلد التحميل ($1) من قبل خادم الشبكة.',
'uploaderror'                 => 'خطأ في التحميل',
'uploadtext'                  => "استعمل الصندوق بالأسفل لتحميل الصور, لعرض أو البحث في الصور المحملة سابقا, راجع [[Special:Imagelist|قائمة الملفات المحملة]], سجل التحميلات و المسح موجود في [[Special:Log/upload|سجل التحميل]].
...
'illegalfilename'             => 'يحتوي اسم الملف $1 على رموز غير مقبولة. أعد تسمية الملف من فضلك و قم بتحميله مرة أخرى.',
'badfilename'                 => 'تم تغيير إسم الصورة إلى "$1".',
'filetype-badmime'            => 'من غير المسموح به تحميل ملفات من النوع "$1".',
...
إن كان هو نفس الملف بالحجم الأصلي فلا داع من تحميل تصغير إضافي.',
...
'fileuploaded'                => "تمّ تحميل الملف $1 بنجاح. الرجاء اتّباع الوصلة التالية: $2 للذهاب إلى صفحة وصف الملف وإضافة معلومات عنه. يمكنك إضافة معلومات عن مصدر الملف وتاريخ إنشائها وأي معلومات أخرى عنها. إذا كان هذا الملف عبارة عن صورة فبإمكانك استعماله في المقالات بإضافة النص التالي:

'''<tt><nowiki>[[صورة:$1|تصغير|عنوان الصورة]]</nowiki></tt>'''",
'uploadwarning'               => 'تحذير تحميل الملفات',
'savefile'                    => 'حفظ الملف',
'uploadedimage'               => 'تم تحميل "[[$1]]"',
'uploaddisabled'              => 'عذرا، تم إيقاف خاصية تحميل الملفات.',
'uploaddisabledtext'          => 'تم منع تحميل الملفات على هذه الويكي.',
'uploadscripted'              => 'يضم هذا الملف قن HTML أو قن آخر يمكنه أن يأول بطريقة خاطئة بواسطة المتصفح.',
'uploadcorrupt'               => 'هذا الملف غير سليم أو له امتداد خاطيء. الرجاء التأكد من الملف وإعادة التحميل مرة أخرى.',
'uploadvirus'                 => 'هذا الملف يحتوي على فيروس. التفاصيل: $1',
'sourcefilename'              => 'ملف التحميل',
'destfilename'                => 'تخرين الملف باسم',
'watchthisupload'             => 'راقب هذه الصفحة',
'filewasdeleted'              => 'تم تحميل ثم مسح ملف بهذا الاسم من قبل. من الأفضل مراجعة $1 قبل تحميلها مرة أخرى.',
...
'license'            => 'ترخيص',
'nolicense'          => 'غير محدّد (هذا يعني أن الملف سيمسح خلال سبعة أيام إذا لم يتم تصحيح هذا الأمر)',
...
'imagelistforuser'          => 'يعرض هذا الصور التي قام $1 بتحميلها.',
'getimagelist'              => 'جاري إحضار قائمة الملفات',
'ilsubmit'                  => 'بحث',
'showlast'                  => 'اعرض آخر $1 ملف مرتبة $2.',
'byname'                    => 'على الإسم',
'bydate'                    => 'على التاريخ',
'bysize'                    => 'على الحجم',
'imgdelete'                 => 'حذف',
'imgdesc'                   => 'وصف',
'imgfile'                   => 'ملف',
'imglegend'                 => 'مفتاح: (وصف) = اعرض أو عدّل صفحة الوصف.',
...
'uploadnewversion-linktext' => 'تحميل نسخة جديدة للملف',
...
'unusedtemplatestext' => 'تحتوي هذه الصفحة على قائمة بالصفحات من نطاق «قالب» غير المستعملة في صفحات أخرى. تذكر بأن تتحقق من عدم وجود روابط أخرى لهذه القوالب قبل حذفها.',
'unusedtemplateswlh'  => 'روابط أخرى',
...
'doubleredirectstext' => "كل سطر في القائمة التالية يحتوي على وصلات للتحويلة الأولى والثانية بالإضافة إلى أول سطر من المقالة الثانية المحولة والذي عادة ما يشير إلى المقال ''المفترض'' أن يتم التحويل إليه مباشرة.",
...
'alllogstext'          => 'عرض شامل لعمليات تحميل الملفات، وعمليات حذف أو حماية المقالات، وعمليات منع المستخدمين، وعمليات التغيير في الإداريين. باستطاعتك جعل القائمة أكثر تحديدًا وذلك باختيار نوع العملية، أو اسم المستخدم، أو الصفحات المتأثّرة.',
...
'allpagesfrom'      => 'اعرض الصفحات التي تبدأ في:',
...
'allpagesnext'      => 'التالي',
'allpagessubmit'    => 'اذهب',
'allpagesprefix'    => 'اعرض الصفحات التي تبدأ ب:',
...
'watchlist-show-bots'  => 'اعرض تعديلات البوتات',
'watchlist-hide-bots'  => 'اخف تعديلات البوتات',
'watchlist-show-own'   => 'اعرض تعديلاتي',
'watchlist-hide-own'   => 'اخف تعديلاتي',
'watchlist-show-minor' => 'اعرض التعديلات الصغيرة',
'watchlist-hide-minor' => 'اخف التعديلات الصغيرة',
'wldone'               => 'تم بنجاح.',
...
'viewdeletedpage'          => 'اعرض الصفحات المحذوفة',
...
'undelete-search-prefix'   => 'اعرض الصفحات التي تبدأ بـ:',
...
'ipb-blocklist-addr'          => 'اعرض المنع الحالي لـ $1',
'ipb-blocklist'               => 'اعرض المنع الحالي',
...
هنالك مقال تحت الاسم - [[$1]] - الذي طلبت أن ينقل إليه هذا المقال. هل ترغب بحذف ذلك المقال لإتمام عملية النقل؟',
'delete_and_move_confirm' => 'نعم، احذف هذه الصفحة.',
'delete_and_move_reason'  => 'حذف لإفساح مجال للنقل',
'selfmove'                => 'لا يوجد إختلاف في عنوان المصدر و الهدف ، لا يمكن نقل الصفحة على نفسها.',
'immobile_namespace'      => 'لا يمكن النقل إلى العنوان المراد، النطاق غير مسموح بالنقل إليه.',

# Export
'export'            => 'صدّر صفحات',
'exporttext'        => 'يمكنك تصدير النص و تاريخ تعديلات صفحة أو مجموعة صفحات خاصة في xml. و ذلك قصد استيرادها في ويكي آخر باستعمال ميدياويكي بواسطة الصفحة خاص:استيراد.

لتصدير صفحات، اكتب العناوين في الصندوق أسفله، عنوان في السطر، مع اختيار إذا رغبت النسخة الحالية كالنسخ القديمة، مع سطور تاريخ الصفحة، أو فقط النسخة الحالية.

في الحالة الأخيرة يمكنك استعمال ربط، مثلا [[{{ns:Special}}:Export/{{Mediawiki:mainpage}}]] للصفحة {{Mediawiki:mainpage}}.',
...
'allmessagesnotsupportedUI' => 'خاص:لغة الواجهة الحالية الخاصة بك < b>$1</b > غير مدعمة من طرف كافة رسائل النظام هنا.',
'allmessagesnotsupportedDB' => 'خاص:كافة رسائل النظام غير مدعمة لأن المتغير wgUseDatabaseMessages غير مشغل.',
...
'importtext'                 => 'من فضلك صدّر الملف من الويكي المصدر عن طريق خاص:Export، احفظها على جهازك ثم ارفعها هنا.',
'importstart'                => 'استيراد صفحات...',
'import-revision-count'      => 'تعديل(ات) $1',
'importnopages'              => 'لا صفحات للإستيراد',
'importfailed'               => 'فشل استيراد: $1',
'importunknownsource'        => 'نوع مجهول لمصدر الإستيراد',
...
'tooltip-t-upload'                => 'تحميل صور أو ملفات وسائط أخرى',
'tooltip-t-specialpages'          => 'قائمة بكل الصفحات الخاصة',
'tooltip-ca-nstab-main'           => 'اعرض صفحة المقال',
...
'spam_reverting'         => 'استرجاع أخر نسخة ليس بها وصلات إلى $1',
...
'markaspatrolledtext'                 => 'هذا المقال تمت مراجعته',
...
'metadata-help'     => 'هذا الملف يحتوي معلومات إضافية، غالبا ما تكون أضيفت من قبل آلة التصوير الإلكترونية أو الماسح الضوئي المستخدم في تحميل الصورة إلى الحاسوب. إذا كان الملف قد عُدّل عما كان عليه عند تحميل الصورة فإن  المعلومات الواردة هنا قد لا تعبر عن هذه الصورة المعدلة.',
