...
'shared-repo-from'          => 'no $1', # $1 is the repository name
'shared-repo'               => 'kopējā krātuve', # used when shared-repo-NAME does not exist
...
'exif-orientation-1' => 'Normāls', # 0th row: top; 0th column: left
'exif-orientation-2' => 'Pagriezts horizontāli', # 0th row: top; 0th column: right
'exif-orientation-3' => 'Pagriezts par 180°', # 0th row: bottom; 0th column: right
'exif-orientation-4' => 'Pagriezts vertikāli', # 0th row: bottom; 0th column: left
'exif-orientation-5' => 'Pagriezta 90° CCW un apgriezta vertikāli', # 0th row: left; 0th column: top
'exif-orientation-6' => 'Pagriezta 90° CW', # 0th row: right; 0th column: top
'exif-orientation-7' => 'Pagriezta 90° CW un apgriezta vertikāli', # 0th row: right; 0th column: bottom
'exif-orientation-8' => 'Pagriezta 90° CCW', # 0th row: left; 0th column: bottom
