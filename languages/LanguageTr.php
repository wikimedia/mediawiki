...
'category' => 'kategori',
'category_header' => '"$1" kategorisindeki maddeler',
...
'disclaimerpage' => 'Project:Genel Feragatname',
...
'undelete_short1' => 'Bir değişikliği geri al',
'protect' => 'Korumaya al',
...
'nospecialpagetext' => 'Bulunmayan bir özel sayfaya girdiniz. Varolan tüm özel sayfaları [[{{ns:special}}:Specialpages]] sayfasında görebilirsiniz.',
...
'readonly' => 'Veritabanına yazma durduruldu',
...
'nologinlink' => 'Buradan kayıt olun',
'createaccount' => 'Yeni hesap aç',
'gotaccount' => 'Daha önceden kayıt oldunuz mu? $1.',
'gotaccountlink' => 'Evet ise bu bağlantıdan giriş yapınız',
...
'eauthentsent' => 'Kaydedilen adrese onay kodu içeren bir e-posta gönderildi. Başka bir e-posta gönderilmeden, e-postadaki yönergeyi uygulanıp adresin size ait olduğu onaylanmanız gerekmektedir.',
...
'emailconfirmlink' => 'E-mail adresinizi doğrulayın',
...
'lineno' => '$1. satır:',
'editcurrent' => 'Sayfanın şu anki sürümünü değiştirin',
...
'showhideminor' => 'Küçük değişiklikleri $1 | Robotları $2 | Kayıtlı kullanıcıları $3',
...
'sitestatstext' => '<p style="font-size:125%;margin-bottom:0">Şu anda \'\'\'$2\'\'\' madde var.</p>
...
'disambiguations' => 'Anlam ayrım sayfalarına olan bağlantılar',
...
'brokenredirects' => 'Boş maddeye yönlendirmeler',
...
'wlhideshowbots' => 'Bot tarafından yapılan $1 değişiklik.',
'wlshow' => 'göster',
'wlhide' => 'gizle',
...
'blockipsuccesstext' => '[[{{ns:Special}}:Contributions/$1|$1]] engellendi.
...
'categoryarticlecount1' => 'Bu kategoride $1 madde bulunmaktadır.',
...
# Media Warning
'mediawarning' => '\'\'\'DİKKAT!\'\'\': Bu tür dosyalarda kötü amaçlı (virüs gibi) kısımlar bulunabilir ve işletim sisteminize zarar verebilir.
<hr>',
...
# delete conflict
'deletedwhileediting' => 'Uyarı: Bu sayfa siz değişiklik yaparken silindi!',
