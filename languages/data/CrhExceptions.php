...
class CrhExceptions {
	...
	function loadRegs() {
		...
		$this->Cyrl2LatnRegexes = [
			...
			# о => ö
			'/\b(['.CRH_C_M_CONS.'])о(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => '$1ö$2$3$4',
			'/\bо(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ö$1$2$3',
			'/\b(['.CRH_C_M_CONS.'])О(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => '$1Ö$2$3$4',
			'/\bО(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => 'Ö$1$2$3',

			'/\b(['.CRH_C_M_CONS.'])о(['.CRH_C_CONS.'])([еиэюьü])/u' => '$1ö$2$3',
			'/\bо(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ö$1$2',
			'/\b(['.CRH_C_M_CONS.'])О(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => '$1Ö$2$3',
			'/\bО(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => 'Ö$1$2',

			# ё => yö
			'/\bё(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([ьеюü])/u' => 'yö$1$2$3',
			'/\bЁ(['.CRH_C_CONS_LC.'])(['.CRH_C_CONS_LC.'])([ьеюü])/u' => 'Yö$1$2$3',
			'/\bЁ(['.CRH_C_CONS_UC.'])(['.CRH_C_CONS_UC.'])([ЬЕЮÜ])/u' => 'YÖ$1$2$3',
			'/\bё(['.CRH_C_CONS.'])([ьеюü])/u' => 'yö$1$2',
			'/\bЁ(['.CRH_C_CONS_LC.'])([ьеюü])/u' => 'Yö$1$2',
			'/\bЁ(['.CRH_C_CONS_UC.'])([ЬЕЮÜ])/u' => 'YÖ$1$2',

			# у => ü, ую => üyü
			'/\b(['.CRH_C_M_CONS.'])у(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => '$1ü$2$3$4',
			'/\bу(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ü$1$2$3',
			'/\bую(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => 'üyü$1$2$3',
			'/\b(['.CRH_C_M_CONS.'])У(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => '$1Ü$2$3$4',
			'/\bУ(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => 'Ü$1$2$3',
			'/\bУю(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => 'Üyü$1$2$2',
			'/\bУЮ(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ÜYÜ$1$2$3',

			'/\b(['.CRH_C_M_CONS.'])у(['.CRH_C_CONS.'])([еиэюьü])/u' => '$1ü$2$3',
			'/\bу(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ü$1$2',
			'/\bую(['.CRH_C_CONS.'])([еиэюьü])/u' => 'üyü$1$2',
			'/\b(['.CRH_C_M_CONS.'])У(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => '$1Ü$2$3',
			'/\bУ(['.CRH_C_CONS.'])([еиэюьüЕИЭЮЬÜ])/u' => 'Ü$1$2',
			'/\bУю(['.CRH_C_CONS.'])([еиэюьü])/u' => 'Üyü$1$2',
			'/\bУЮ(['.CRH_C_CONS.'])([еиэюьü])/u' => 'ÜYÜ$1$2',

			# ю => yü
			'/\b([аыоуеиёюАЫОУЕИЁЮ]?)ю(['.CRH_C_CONS.'])(['.CRH_C_CONS.'])([ьеюü])/u' => '$1yü$2$3$4',
			'/\b([АЫОУЕИЁЮ]?)Ю(['.CRH_C_CONS_LC.'])(['.CRH_C_CONS_LC.'])([ьеюü])/u' => '$1Yü$2$3$4',
			'/\b([АЫОУЕИЁЮ]?)Ю(['.CRH_C_CONS_UC.'])(['.CRH_C_CONS_UC.'])([ЬЕЮÜ])/u' => '$1YÜ$2$3$4',
			'/\b([аыоуеиёюАЫОУЕИЁЮ]?)ю(['.CRH_C_CONS.'])([ьеюü])/u' => '$1yü$2$3',
			'/\b([АЫОУЕИЁЮ]?)Ю(['.CRH_C_CONS_LC.'])([ьеюü])/u' => '$1Yü$2$3',
			'/\b([АЫОУЕИЁЮ]?)Ю(['.CRH_C_CONS_UC.'])([ЬЕЮÜ])/u' => '$1YÜ$2$3',

			# e => ye, я => ya
			'/\bе/u' => 'ye',
			'/\bЕ(['.CRH_C_LC.'cğñqöü])/u' => 'Ye$1',
			'/\bЕ(['.CRH_C_UC.'CĞÑQÖÜ])/u' => 'YE$1',
			'/\bя/u' => 'ya',
			'/\bЯ(['.CRH_C_LC.'cğñqöü])/u' => 'Ya$1',
			'/\bЯ(['.CRH_C_UC.'CĞÑQÖÜ])/u' => 'YA$1',
			'/([аеёиоуыэюяйьъaeöüАЕЁИОУЫЭЮЯЙЬЪAEÖÜ])е/u' => '$1ye',
			'/([аеёиоуыэюяйьъaeöüАЕЁИОУЫЭЮЯЙЬЪAEÖÜ])Е(['.CRH_C_LC.'cğñqöü])/u' => '$1Ye$2',
			'/([аеёиоуыэюяйьъaeöüАЕЁИОУЫЭЮЯЙЬЪAEÖÜ])Е(['.CRH_C_UC.'CĞÑQÖÜ])/u' => '$1YE$2',
			'/([аеёиоуыэюяйьъaeöüğqАЕЁИОУЫЭЮЯЙЬЪAEÖÜĞQ])я/u' => '$1ya',
			'/([аеёиоуыэюяйьъaeöüğqАЕЁИОУЫЭЮЯЙЬЪAEÖÜĞQ])Я(['.CRH_C_LC.'cğñqöü])/u' => '$1Ya$2',
			'/([аеёиоуыэюяйьъaeöüğqАЕЁИОУЫЭЮЯЙЬЪAEÖÜĞQ])Я(['.CRH_C_UC.'CĞÑQÖÜ])/u' => '$1YA$2',
		...
		$this->Latn2CyrlRegexes = [
			...
			# гъ, къ, нъ
			# гъ, къ, нъ
			'/Ğ(['.CRH_L_UC.CRH_C_UC.'Ъ])/u' => 'ГЪ$1',
			'/Q(['.CRH_L_UC.CRH_C_UC.'Ъ])/u' => 'КЪ$1',
			'/Ñ(['.CRH_L_UC.CRH_C_UC.'Ъ])/u' => 'НЪ$1',
