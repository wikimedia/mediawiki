...
class CrhExceptions {
	...
	private $ManyToOneC2LMappings = [
		...
		# awaiting confirmation on ordering
		'beyüde' => 'бейуде', 'beyude' => 'бейуде',
	...
	private $multiCaseMappings = [
		...
		'буксир' => 'buksir', 'бульбуль' => 'bülbül', 'бульвар' => 'bulvar', 'бульдог' => 'buldog',
	...
	private $exactCaseMappings = [
		...
		'ШСДжБ' => 'ŞSCB', 'КъМШСДж' => 'QMŞSC', 'КъДМПУ' => 'QDMPU', 'КъМПУ' => 'QMPU',
	];
	...
	private $suffixMapping = [
		...
		'льская' => 'lskaya', 'льский' => 'lskiy', 'льское' => 'lskoye', 'ополь' => 'opol', 'щее' => 'şçeye',
		'щий' => 'şçiy', 'щая' => 'şçaya', 'цепс' => 'tseps',
