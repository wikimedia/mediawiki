...
/* private */ $wgDeveloperSpecialPagesHe = array(
	"Lockdb"		=> "הפוך את מסד הנתונים לקריא-בלבד",
	"Unlockdb"		=> "החזר הרשאת כתיבה למסד הנתונים",
...
מהפונקציה \"<tt>$2</tt>\".
מסד-הנתונים החזיר את השגיאה: \"<tt>$3: $4</tt>\" ",
"noconnect"		=> "לא הצליח נסיון ההתחברות למסד-הנתונים על $1",
"nodb"			=> "לא ניתן לבחור את מסד-הנתונים $1",
...
"newarticle"	=> "(חדש)",
"newarticletext" => "כתוב את הטקסט עבור הדף החדש כאן.",
...
"longpagewarning" => "אזהרה: גודל דף זה הוא $1 קב'. בדפדפנים מסוימים יהיו בעיות בעריכת דף הגדול מ32 קב'. אנא שקול לחלק דף זה לדפים קטנים יותר",
"readonlywarning" => "אזהרה: מסד-הנתונים ננעל לצורך תחזוקה. אי אפשר לשמור את העריכות בזמן זה. אתם יכולים להשתמש בעורך חיצוני עד שתסוים התחזוקה.",
"protectedpagewarning" => "אזהרה: דף זה הוא [[ויקיפדיה:דף מוגן|דף מוגן]] וניתן לעריכה רק על ידי מפעילים, אנא ודאו שאתם פועלים לפי העקרונות לעריכת דפים אלו",
...
"revisionasof"	=> "גרסא מתאריך $1",
"cur"			=> "נוכ",
"next"			=> "הבא",
"last"			=> "אחרון",
"orig"			=> "מקור",
"histlegend"	=> "מקרא: (נוכ) = הבדלים עם הגרסה הנוכחית, (אחרון) = הבדלים עם הגרסה הקודמת, מ = שינוי משני",
...
"showingresultsnum" => ".#<b>$2</b>תוצאות ממספר <b>$1</b>מציג",
...
"rcnote"		=> "להלן השינויים האחרונים שבוצעו ב- <strong>$1</strong> ב$2 הימים האחרונים",
...
"uploadnologintext"	=> "עליך להיכנב לחשבון במערכת כדי להעלות קובץ",
"uploadfile"	=> "העלה קובץ",
"uploaderror"	=> "שגיאה בהעלאת הקובץ",
"uploadtext"	=> "<strong>עצור!</strong> לפני שאתה מעלה קובץ אנא וודא שקראת ופעלת לפי [[ויקיפדיה:נהלי שימוש בתמונות|נהלי השימוש בתמונות]] של ויקיפדיה.
...
ויקיפדיות בשפות אחרות עשויות לבצע קישור לתמונה באמצעות  הפניה ישירה לכתובתה, ולכן עלולות להופיע כאן תמונות שנמצאות בשימוש שוטף.",
"booksources"	=> "משאבי ספרות חיצוניים",
...
"mailnologintext" => "עליך להיכנס לחשבון ולהגדיר כתובת דואר אלקרוני תקינה (בהעדפות המשתמש) כדי לשלוח דואר",
...
"confirm"		=> "אשר",
"excontent" => "תוכן היה:",
"exbeforeblank" => "תוכן לפני ניקוי היה:",
"exblank" => "הדף היה ריק",
...
"cantrollback"	=> "לא יכול לגלגל אחורנית, הגירסה הראשונה של העמוד נכתבה על ידי משתמש זה",
...
אם כבר יש דף חדש באותו שם, הגרסאות והשינויים יופיעו בהיסטוריה קודמת, והגירסה הנוכחית לא תוחלף אוטומטית.",
