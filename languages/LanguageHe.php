...
/* private */ $wgUserTogglesHe = array(
	...
	"highlightbroken" => "סמן קישורים לדפים שלא נכתבו באדום",
	"justify"	=> "ישר פסקאות",
...
"nonefound"		=> "לא נמצאו מאמרים עם תוכן תואם, אנא ודאו שהיקשתם את החיפוש נכונה. אם הקשתם נכונה אז נסו לחפש נושא כללי יותר",
"powersearch" => "חפש",
"powersearchtext" => "
חפש במרחבי שם:<br>
$1<br>
$2 הצג גם דפים מצביעים
$3 $9",
...
"prefslogintext" => "מספרך הסידורי הוא $2 \"$1\" נכנסת בשם",
...
"recentchangeslinked" => "שינויים לדפים המקושרים",
