...
"tog-watchdefault"            => "עקוב אחרי דפים שיצרתי או ערכתי",
...
"mainpagedocfooter" => "היעזרו ב[http://meta.wikimedia.org/wiki/MediaWiki_localisation תיעוד על התאמת הממשק] וב[http://meta.wikimedia.org/wiki/Help:Contents מדריך למשתמש] למידע על התאמה ושימוש בתוכנת הוויקי.
...
"poweredby"         => "האתר {{SITENAME}} מופעל על־ידי [http://www.mediawiki.org/ MediaWiki], מנוע ויקי בקוד פתוח.",
"printsubtitle"     => "(מתוך {{SERVER}})",
...
"noconnect"            => "נסיון ההתחברות לבסיס הנתונים על $1 לא הצליח",
...
"cannotdelete"         => "מחיקת הדף או קובץ התמונה לא הצליחה. (יתכן שהוא נמחק כבר על־ידי מישהו אחר.)",
...
"perfcached"           => "המידע הבא הוע עותק שמור של המידע, ועשוי שלא להיות מעודכן:",
"wrong_wfQuery_params" => "הפרמטרים שהוזנו ל־wfQuery() אינם נכונים:<br />
פונקציה: $1<br />
שאילתה: $2",
"viewsource"           => "הצג מקור",
"protectedtext"        => "דף זה הינו '''דף מוגן''' ולא ניתן לערוך אותו. עם זאת, אתם מוזמנים [[שיחה:{{PAGENAME}}|לדון עליו עם משתמשים אחרים]].
----
...
"newusersonly"       => "(משתמשים חדשים בלבד)",
...
"yourrealname"               => "שמך האמיתי*",
"yourlanguage"               => "שפת הממשק:",
"yourvariant"                => "שינוי",
"yournick"                   => "בחרו כינוי (לחתימות)",
"email"                      => 'דוא"ל',
"emailforlost"               => '<p>שדות המסומנים בכוכבית הם רשות. הזנת כתובת דוא"ל תאפשר לאנשים ליצור אתכם קשר דרך האתר בלי שתצטרכו לגלות להם את כתובת הדוא"ל שלכם, וכן תאפשר לכם לבקש שסיסמה חדשה תישלח אליכם באם תשכחו את סיסמתכם.</p>
<p>שמכם האמיתי, אם תבחרו לספקו, יאפשר לכם לייחס את עבודתכם אליכם.</p>',
"prefs-help-email-enotif"    => 'כתובת זו משמשת גם למשלוח עדכונים דרך הדוא"ל (אם אפשרת זאת).',
"prefs-help-realname"        => "¹ שם אמיתי (אופציונאלי): אם תבחרו לספק שם זה, הוא ישמש לייחוס עבודתכם אליכם.",
"loginerror"                 => "שגיאה בכניסה לאתר",
"prefs-help-email"           => '² דוא"ל (אופציונאלי): אפשרו לאחרים לשלוח לכם מסר דרך דף המשתמש שלכם ללא צורך לחשוף את כתובתכם.',
"nocookiesnew"               => "נוצר חשבון המשתמש שלך, אך לא נכנסתם כמשתמשים רשומים למערכת כיוון שניטרלתם את העוגיות, שהאתר משתמש בהן לצורך כניסה למערכת. אנא הפעילו אותן מחדש, ולאחר מכן תוכלו להכנס למערכת עם שם המשתמש והסיסמה החדשים שלכם.",
"nocookieslogin"             => "לא הצלחתם להיכנס למערכת כמשתמשים רשומים כיוון שניטרלתם את העוגיות, שהאתר משתמש בהן לצורך כניסה למערכת. אנא הפעילו אותן מחדש, ולאחר מכן תוכלו להכנס למערכת עם שם המשתמש והסיסמה שלכם.",
"noname"                     => "לא הזנתם שם משתמש חוקי",
"loginsuccesstitle"          => "הכניסה הושלמה בהצלחה",
"loginsuccess"               => 'נכנסתם לאתר בשם "$1".',
...
"loginend"                   => "'''הרשמה אורכת רגעים ספורים בלבד, ויש בה יתרונות רבים.'''
* אנא המנעו משמות פוגעניים, מטרידים או מבלבלים.
* בחרו שם קריא, לא מספר.
* המנעו מבחירת שמות בעלי הקשר פוליטי, צבאי או דתי.

אנו לא דורשים אישור חשבון באמצעות כתובת דואר אלקטרוני. אין חובה למלא אותה. עם זאת, הזנת כתובת דואר אלקטרוני מאפשרת למשתמשים אחרים לשלוח לכם הודעות בלי לצפות בכתובתכם באופן ישיר. בנוסף, נוכל לשלוח לכם את סיסמתכם, במידה ותאבדו אותה. '''אנו מתחייבים שלא למסור את כתובת הדואר האלקטרוני שלכם לאיש.'''",
...
"infobox"         => "לחצו על לחצן כדי לקבל טקסט לדוגמה",
# alert box shown in browsers where text selection does not work, test e.g. with mozilla or konqueror
"infobox_alert"   => "אנא הקלידו את הטקסט שברצונכם שיעוצב.\\nהוא יוצג בתיבת המידע להעתקה והדבקה.\\nדוגמה:\\n$1\\nיהפוך ל:\\n$2",
...
"loginreqpagetext"         => "עליך [[מיוחד:Userlogin|להיכנס לחשבון]] כדי לצפות בדפים אחרים.",
...
----",
"noarticletext"            => "אין עדיין טקסט בדף זה. באפשרותכם [[{{ns:special}}:Search/{{PAGENAME}}|לחפש את {{PAGENAME}} באתר]], או [{{SERVER}}{{localurl:{{NAMESPACE}}:{{PAGENAME}}|action=edit}} ליצור דף זה].",
...
* ב־'''Konquorer''', פשוט לחצו על '''העלה מחדש''' (Reload), או הקישו על F5.
...
"yourdiff"                 => "הבדלים",
"copyrightwarning"         => '<div id="editing-warn">\'\'\'שימו לב:\'\'\' תרומתכם לאתר תפורסם תחת תנאי הרישיון $2 (ראו $1 לפרטים נוספים). אם אינכם רוצים שעבודתכם תהיה זמינה לעריכה על־ידי אחרים, שתופץ לעיני כל, ושאחרים יוכלו להעתיק ממנה בציון המקור - אל תפרסמו אותה פה. כמו־כן, אתם מבטיחים לנו כי כתבתם את הטקסט הזה בעצמכם, או העתקתם אותו ממקור שאינו מוגן על־ידי זכויות יוצרים. \'\'\'אל תעשו שיפמוש בחומר המוגן בזכויות יוצרים ללא רשות!\'\'\'<br /></div>',
"copyrightwarning2"        => '<div id="editing-warn">\'\'\'שימו לב:\'\'\' תורמים אחרים עשויים לערוך או אף להסיר את תרומתכם לאתר. אם אינכם רוצים שעבודתכם תהיה זמינה לעריכה על־ידי אחרים - אל תפרסמו אותה פה. כמו־כן, אתם מבטיחים לנו כי כתבתם את הטקסט הזה בעצמכם, או העתקתם אותו ממקור שאינו מוגן על־ידי זכויות יוצרים (ראו $1 לפרטים נוספים). \'\'\'אל תעשו שיפמוש בחומר המוגן בזכויות יוצרים ללא רשות!\'\'\'<br />',
...
"history_copyright"           => "גרסה זו של הדף שונתה. ייתכן שהסיבה לכך היא הפרת זכויות יוצרים,<br />
ועל־כן התוכן בדף זה אינו ניתן לשימוש תחת תנאי הרשיון הרגילים באתר.",
"deletedrev"                  => "[נמחק]",
"histfirst"                   => "ראשונות",
"histlast"                    => "אחרונות",
...
"nogomatch"         => 'אין דף שכותרתו "$1". באפשרותכם [{{SERVER}}{{localurl:$1|action=edit}} ליצור את הדף].',
...
"prefsnologintext"      => "עליכם להיכנס לחשבון כדי לשנות העדפות משתמש.",
"prefslogintext"        => 'שם המשתמש שלך הוא "[[משתמש:$1|$1]]" ([[שיחת משתמש:$1|שיחה]] | [[{{ns:special}}:Contributions/$1|תרומות]]).
...
"emailflag"            => 'בטל קבלת דוא"ל ממשתמשים אחרים',
...
"showhideminor"                     => "$1 שינויים משניים | $2 בוטים | $3 משתמשים רשומים | $4 עריכות בדוקות",
...
"largefile"                   => "מומלץ שגודל התמונה לא יחרוג מ־$1 בייטים (גודל התמונה שהעליתם הוא $2 בייטים).",
...
"shareduploadwiki"          => "למידע נוסף, ראו את [$1 דף תיאור הקובץ].",
"shareddescriptionfollows"  => "-",
"noimage"                   => "לא נמצא קובץ בשם זה, אך יש באפשרותכם [$1 להעלות קובץ] חלופי.",
...
"sitestatstext" => 'בבסיס הנתונים יש בסך הכל \'\'\'$1\'\'\' דפים. מספר זה כולל דפים שאינם דפי תוכן, כגון דפי שיחה, דפים אודות האתר, קצרמרים, דפי תוכן ללא קישורים פנימיים, הפניות, וכיוצא בזה. אם לא סופרים את הדפים שאינם דפי תוכן, נשארים \'\'\'$2\'\'\' דפים שהם ככל הנראה דפי תוכן לכל דבר.
...
"selflinkstext"              => "הדפים שלהלן מקושרים אל עצמם, אך הם לא אמורים לעשות זאת.",
"mispeelings"                => "דפים עם שגיאות כתיב",
"mispeelingstext"            => "בדפים הבאים קיימות שגיאות כתיב נפוצות. רשימה של שגיאות אלו נמצאת בדף $1. הכתיב הנכון עשוי להיות מוצג (כך).",
...
"missinglanguagelinkstext"   => "ערכים אלו '''אינם''' מקושרים לערכים הדומים להם ב־$1. הפניות ותתי־דפים '''אינם''' מוצגים.",
...
"protectpage"             => "שנו את מצב ההגנה של הדף",
...
"categoriespagetext" => "אלה הקטגוריות הקיימות באתר.",
"data"               => "נתונים",
...
"wlhideshowown"        => "$1 עריכות שנעשו על־ידכם.",
"wlshow"               => "הצג",
"wlhide"               => "הסתר",
...
משוב ועזרה נוספת:
{{SERVER}}{{localurl:{{ns:project}}:עזרה}}",
...
"imagereverted"               => "שיחזור לגרסה קודמת הצליח.",
...
ראו את [[{{ns:special}}:Ipblocklist|רשימת כתובות ה־IP החסומות]] כדי לצפות בחסימות.",
...
ראו את [[{{ns:special}}:Ipblocklist|רשימת כתובת ה־IP החסומות]] לרשימת המשתמשים החסומים הנוכחית.',
...
"val_revision"                        => "גרסה",
"val_time"                            => "שעה",
"val_user_stats_title"                => "סקירת אימות של המשתמש $1",
"val_my_stats_title"                  => "סקירת האימות שלי",
"val_list_header"                     => "<th>#</th><th>נושא</th><th>טווח</th><th>פעולה</th>",
"val_add"                             => "הוספה",
"val_del"                             => "מחיקה",
"val_show_my_ratings"                 => "הצג את האימותים שלי",
"val_revision_number"                 => "גרסה #$1",
"val_warning"                         => "<b>לעולם אל תשנו דבר ללא קונצנזוס מפורש מצד הקהילה!</b>",
"val_rev_for"                         => "גרסאות ל־$1",
"val_details_th_user"                 => "משתמש $1",
"val_validation_of"                   => 'אימות של "$1"',
"val_revision_of"                     => "גרסה של $1",
"val_revision_changes_ok"             => "הדירוגים שלך אוחסנו!",
"val_rev_stats"                       => 'ראו את סטטיסטיקות האימות ל־"$1" <a href="$2">כאן</a>.',
"val_revision_stats_link"             => "פרטים",
"val_iamsure"                         => "סמנו תיבה זו אם אתם באמת מתכוונים לכך!",
"val_details_th"                      => "<sub>משתמש</sub> \\ <sup>נושא</sup>",
"val_clear_old"                       => "נקה את מידע האימות הישן",
"val_merge_old"                       => 'השתמש בהערכתי הקודמת כנבחר "ללא דעה"',
"val_form_note"                       => '\'\'\'טיפ:\'\'\' הכוונה במיזוג נתוניך היא שלגרסת הדף שאתה בוחר, כל האפשרויות שבהן ציינת "ללא דעה" יוגדר לערך ולהערה של הגרסה העדכנית ביותר שעליה הבעת דעה. לדוגמה, אם ברצונכם לשנות את דעתכם על גרסה חדשה יותר, אבל גם לשמור את הגדרותיכם לדף זה בגרסה זו, פשוט בחרו איזו דעה ברצונכם \'\'\'לשנות\'\'\', ומיזוג יגדיר את האפשרויות האחרות עם הגדרותיכם הקודמות.',
"val_noop"                            => "ללא דעה",
"val_topic_desc_page"                 => "{{ns:project}}:אימות נושאים",
"val_votepage_intro"                  => 'שנה את הטקסט <a href="{{SERVER}}{{localurl:{{ns:mediawiki}}:Val votepage intro}}">כאן</a>!',
"val_percent"                         => "<b>$1%</b><br />($2 מ־$3 נקודות<br />של $4 משתמשים)",
"val_percent_single"                  => "<b>$1%</b><br />($2 מ־$3 נקודות<br />של משתמש אחד)",
"val_total"                           => "סך הכל",
"val_version"                         => "גרסה",
"val_tab"                             => "אימות",
"val_this_is_current_version"         => "זוהי הגרסה האחרונה",
"val_version_of"                      => "גרסה של $1" ,
"val_table_header"                    => "<tr><th>מחלקה</th>$1<th colspan=4>דעה</th>$1<th>הערה</th></tr>\n",
"val_stat_link_text"                  => "סטטיסטיקות האימות לדף זה",
"val_view_version"                    => "צפו בגרסה זו",
"val_validate_version"                => "אמתו גרסה זו",
"val_user_validations"                => "משתמש זה אימת $1 דפים.",
"val_no_anon_validation"              => "עליכם להיכנס כדי לאמת דפים.",
"val_validate_article_namespace_only" => "ניתן לאמת רק דפי תוכן, אך דף זה אינו במרחב דפי התוכן.",
"val_validated"                       => "האימות בוצע.",
"val_article_lists"                   => "רשימת דפים שאומתו",
"val_page_validation_statistics"      => "סטטיסקטית אימות דפים לדף $1",
...
# Media Warning
"mediawarning" => "'''אזהרה:''' קובץ זה עלול להכיל קוד זדוני, שהרצתו עלולה לסכן את המערכת שלך.
<hr />",
