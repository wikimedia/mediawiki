...
"aboutpage"		=> "{$wgMetaNamespace}:אודות",
"help"			=> "עזרה",
"helppage"		=> "{$wgMetaNamespace}:עזרה",
"wikititlesuffix" => "ויקיפדיה",
"bugreports"	=> "דווח על באגים",
"bugreportspage" => "{$wgMetaNamespace}:דווח_על_באגים",
"faq"			=> "שאלות ותשובות",
"faqpage"		=> "{$wgMetaNamespace}:שאלות_ותשובות",
"edithelp"		=> "עזרה לעריכה",
"edithelppage"	=> "{$wgMetaNamespace}:איך_עורכים_דף",
"cancel"		=> "בטל",
"qbfind"		=> "חפש",
"qbbrowse"		=> "דפדף",
"qbedit"		=> "ערוך",
...
הסיבה שניתנה היא:<br>''$2''<p>אתה יכול ליצור קשר עם $1 או אחד מ[[{$wgMetaNamespace}:מפעילי_מערכת]] כדי לדון בחסימה.",
"newarticle"	=> "(חדש)",
...
"searchhelppage" => "{$wgMetaNamespace}:חיפוש",
...
"copyrightpage" => "{$wgMetaNamespace}:זכויות_יוצרים",
...
"disambiguationspage"	=> "{$wgMetaNamespace}:דפי_רב_משמעות",
...
אנא אשר שאכן זה מה שאתה מתכוון לעשות, ושאתה מבין את התוצאות של מעשה כזה, ושאתה מבצע אותו בהתאם ל[[{$wgMetaNamespace}:נהלים]].",
...
ראה את [[{$wgMetaNamespace}:יומן_מחיקות]] לרשימה של מחיקות ושיחזורים אחרונים.",
...
חסימת משתמש צריכה להתבצע אך ורק בכדי למנוע ונדליזם, ובהתאם ל-[[{$wgMetaNamespace}:נהלים]]. פרט את הסיבה הספציפית למטה. (לדוגמה - ציין דפים ספציפיים שהושחתו על ידי המשתמש)",
"ipaddress"		=> "כתובת IP",
"ipbreason"		=> "סיבה",
