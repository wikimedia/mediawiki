...
Наступныя зьмены ў гэтым артыкуле і зьвязанай зь ім старонцы абмеркаваньняў будуць бачныя там, і старонка будзе выглядаць '''тлустай''' на [[Спэцыяльныя:Recentchanges|старонцы са сьпісам апошніх зьменаў]], каб зьмены было лягчэй заўважыць.
...
'categoriespagetext' => 'У {{ГРАМАТЫКА:месны|{{НАЗВА_САЙТУ}}}} існуюць наступныя катэгорыі:',
'category' => 'катэгорыя',
'category_header' => 'Артыкулы ў катэгорыі «$1»',
'categoryarticlecount' => 'У гэтай катэгорыі ёсьць $1 {{МНОЖНЫ_ЛІК:$1|артыкул|артыкулы|артыкулаў}}.',
...
'nbytes' => '$1 {{МНОЖНЫ_ЛІК:$1|байт|байта|байтаў}}',
'ncategories' => '$1 {{МНОЖНЫ_ЛІК:$1|катэгорыя|катэгорыі|катэгорый}}',
'newarticle' => '(Новы)',
'newarticletext' =>
"Вы прыйшлі па спасылцы на старонку, якая яшчэ не існуе.
Каб стварыць яе, напішыце тэкст у полі ніжэй (глядзіце [[Дапамога:Зьмест|старонку дапамогі]] дзеля дадатковай інфармацыі).
...
'nlinks' => '$1 {{МНОЖНЫ_ЛІК:$1|спасылка|спасылкі|спасылак}}',
'noarticletext' => 'Зараз тэкст на гэтай старонцы адсутнічае. Вы можаце [[{{ns:special}}:Search/{{НАЗВА_СТАРОНКІ}}|пашукаць гэтую назву]] ў іншых старонках альбо [{{ПОЎНЫ_АДРАС:{{ПРАСТОРА_НАЗВАЎ}}:{{НАЗВА_СТАРОНКІ}}|action=edit}} рэдагаваць гэтую старонку].',
'nodb' => 'Немагчыма выбраць базу зьвестак $1',
'noemailtitle' => 'Адрас электроннай пошты адсутнічае',
'nogomatch' => "'''Старонкі з гэткай назвай не існуе.''' Вы можаце '''[[:$1|стварыць гэтую старонку]]'''.",
...
'nrevisions' => '$1 {{МНОЖНЫ_ЛІК:$1|вэрсія|вэрсіі|вэрсій}}',
...
'recentchangestext' => 'Сачыце за апошнімі зьменамі ў {{ГРАМАТЫКА:месны|{{НАЗВА_САЙТУ}}}} на гэтай старонцы.',
...
'searchresulttext' => 'Для атрыманьня больш падрабязнай інфармацыі пра пошук у {{ГРАМАТЫКА:месны|{{НАЗВА_САЙТУ}}}}, глядзіце [[{{ns:Project}}:Пошук|Пошук у {{ГРАМАТЫКА:месны|{{НАЗВА_САЙТУ}}}}]].',
'sep' => '09',
'september' => 'верасьня',
...
'sitestats' => 'Статыстыка {{ГРАМАТЫКА:родны|{{НАЗВА_САЙТУ}}}}',
'sitesubtitle' => '',
'sitesupport' => 'Ахвяраваньні',
'sitetitle' => '{{SITENAME}}',
'siteuser' => 'Удзельнік/удзельніца {{ГРАМАТЫКА:родны|{{НАЗВА_САЙТУ}}}} $1',
'skin' => 'Афармленьне',
'skinpreview' => '(Прагляд)',
...
'subcategorycount' => 'У гэтай катэгорыі ёсьць $1 {{МНОЖНЫ_ЛІК:$1|падкатэгорыя|падкатэгорыі|падкатэгорый}}.',
'subject' => 'Тэма/назва',
