...
'val_max_topics' => '評価基準は最大 $1 まで許可されています',
'val_no_topics_defined' => '評価基準が設定されていません',
'val_no_topics_defined_text' => '評価基準が設定されていないためページを評価できません。管理者で[[{{ns:Special}}:Validate]]にアクセスし、評価基準と点数の範囲を設定してください。',
