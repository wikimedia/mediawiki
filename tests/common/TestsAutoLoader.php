...
$wgAutoloadClasses += [
	...
	'FakeDatabaseMssql' => "$testDir/phpunit/includes/libs/database/FakeDatabaseMssql.php",
	'FakeDatabaseSqlite' => "$testDir/phpunit/includes/libs/database/FakeDatabaseSqlite.php",
