...
class TitleSecurityTest extends MediaWikiLangTestCase {
	...
	public function testQuickPermissions() {
		...
		foreach ( array( "edit", "protect", "" ) as $action ) {
			...
			$this->assertEquals( $check[$action][0],
				$this->titleSecurity->getUserPermissionsErrors( $this->title, $action, $this->user, 'secure' ) );
	...
	public function testUserBlock() {
		...
		$this->assertEquals( true, $this->titleSecurity->userCan( $this->title, 'move-target', $this->user ) );
		...
		$this->assertEquals( false, $this->titleSecurity->userCan( $this->title, 'move-target', $this->user ) );
		// quickUserCan should ignore user blocks
		$this->assertEquals( true, $this->titleSecurity->quickUserCan( $this->title, 'move-target', $this->user ) );
