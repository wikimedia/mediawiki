	...
	public static function provideMakeResourceLoaderLink() {
		...
		return array(
			...
			array(
				...
				'<script src="http://127.0.0.1:8080/w/load.php?debug=false&amp;lang=' . $wgLanguageCode . '&amp;modules=test.foo&amp;only=scripts&amp;skin=vector&amp;*"></script>
'
			),
			...
			array(
				...
				'<link rel=stylesheet href="http://127.0.0.1:8080/w/load.php?debug=false&amp;lang=' . $wgLanguageCode . '&amp;modules=test.bar%2Cbaz%2Cfoo&amp;only=styles&amp;skin=vector&amp;*">
'
			),
...
'
			...
			array(
				...
				'<script><esi:include src="http://127.0.0.1:8080/w/load.php?debug=false&amp;lang=' . $wgLanguageCode . '&amp;modules=test.foo&amp;only=scripts&amp;skin=vector&amp;*" /></script>
'
			),
			// Load module styles with with ESI
			array(
				array( 'test.foo', ResourceLoaderModule::TYPE_STYLES, true ),
				'<style><esi:include src="http://127.0.0.1:8080/w/load.php?debug=false&amp;lang=' . $wgLanguageCode . '&amp;modules=test.foo&amp;only=styles&amp;skin=vector&amp;*" /></style>
',
			),
		);
	}
