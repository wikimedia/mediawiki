...
class OutputPageTest extends MediaWikiTestCase {
	...
	/**
	 * Each case can contain the following
	 ...
	 *
	 * @return array array key-value array of arguments as shown above
	 */
	public function provideTransformCssMedia() {
		$cases = array();
	 ...
	 */
	public function testTransformCssMedia( $args ) {
		$queryData = array();
