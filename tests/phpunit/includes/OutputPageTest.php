...
class OutputPageTest extends MediaWikiTestCase {
	...
	const RSS_RC_LINK = '<link rel="alternate" type="application/rss+xml" title=" RSS feed" ' .
		'href="/w/index.php?title=Special:RecentChanges&amp;feed=rss"/>';
	const ATOM_RC_LINK = '<link rel="alternate" type="application/atom+xml" title=" Atom feed" ' .
		'href="/w/index.php?title=Special:RecentChanges&amp;feed=atom"/>';

	const RSS_TEST_LINK = '<link rel="alternate" type="application/rss+xml" ' .
		'title="&quot;Test&quot; RSS feed" href="fake-link"/>';
	const ATOM_TEST_LINK = '<link rel="alternate" type="application/atom+xml" ' .
		'title="&quot;Test&quot; Atom feed" href="fake-link"/>';
