...
'
			...
			array(
				array( array( 'mediawiki.skinning.interface', 'mediawiki.ui.button', 'mediawiki.hidpi' ), ResourceLoaderModule::TYPE_STYLES ),
				'<link rel="stylesheet" href="http://127.0.0.1:8080/w/load.php?debug=false&amp;lang=en&amp;modules=mediawiki.hidpi%7Cmediawiki.skinning.interface%7Cmediawiki.ui.button&amp;only=styles&amp;skin=vector&amp;*" />
'
			),
