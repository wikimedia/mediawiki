	...
	public function providePreloadLinkHeaders() {
		return [
			[
				...
				'Link: </img/default.png>;rel=preload;as=image;media=not all and (min-resolution: 1.5dppx),</img/one-point-five.png>;rel=preload;as=image;media=(min-resolution: 1.5dppx) and (max-resolution: 1.999999dppx),</img/two-x.png>;rel=preload;as=image;media=(min-resolution: 2dppx)'
			],
			[
				[
					'Logo' => '/img/default.png',
			...
			[
				...
				'Link: </img/default.png>;rel=preload;as=image;media=not all and (min-resolution: 2dppx),</img/two-x.png>;rel=preload;as=image;media=(min-resolution: 2dppx)'
			],
		];
	}
