...
class TitleTest extends MediaWikiTestCase {
	...
	public function provideGetWrappedPrefixedText() {
		return [
			...
			[
				Title::makeTitle( NS_MAIN, 'Foo bar' ),
				'<span class="mw-title" dir="ltr" lang="en">Foo bar</span>'
			],
			...
			[
				...
				'<span class="mw-title" dir="ltr" lang="en">Talk:Foo bar</span>'
			],
			// Fixme: In the User namespace the title should have an isolation for the user name.
			// ns = 2
			[
				Title::makeTitle( NS_USER, 'Foo bar' ),
				'<span class="mw-title" dir="ltr" lang="en">User:Foo bar</span>'
			],
			...
			[
				...
				'<span class="mw-title" dir="ltr" lang="de">MediaWiki:Edit/de</span>'
			],
			// ns = 8
			[
				Title::makeTitle( NS_MEDIAWIKI, 'Edit/ar' ),
				'<span class="mw-title" dir="rtl" lang="ar">MediaWiki:Edit/ar</span>'
			],
		];
	}
