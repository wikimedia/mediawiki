...
class TitleTest extends MediaWikiTestCase {
	 ...
	 */
	function testConvertByteClassToUnicodeClass( $byteClass, $unicodeClass, $message = null ) {
		$this->assertEquals( $unicodeClass, Title::convertByteClassToUnicodeClass( $byteClass ), $message );
	}
