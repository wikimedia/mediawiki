...
class ImportTest extends MediaWikiLangTestCase {
	 ...
	 * @param $text
	 */
	public function testUnknownXMLTags( $xml, $text ) {
		...
		assertEquals( WikiPage::factory( $title )->getContent()->getNativeData(), $text );
	}
...
<mediawiki xmlns="http://www.mediawiki.org/xml/export-0.10/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.mediawiki.org/xml/export-0.10/ http://www.mediawiki.org/xml/export-0.10.xsd" version="0.10" xml:lang="en">
  <page unknown="123" dontknow="533">
    ...
    <revision>
      ...
      <text xml:space="preserve" bytes="0">noitazinagro tseb eth si ikiwaideM</text>
...
EOF
			,
				'noitazinagro tseb eth si ikiwaideM'
			),
		);
