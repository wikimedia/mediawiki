...
class MediaWikiPageNameNormalizerTest extends PHPUnit_Framework_TestCase {
	...
	public function testNormalizePageTitle( $expected, $pageName, $getResponse ) {
		MediaWikiPageNameNormalizerTest_MockHttp::$response = $getResponse;
	...
	public function normalizePageTitleProvider() {
		...
		// https://www.wikidata.org/w/api.php?action=query&prop=info&redirects=1&converttitles=1&format=json&titles=…
		// https://sr.wikipedia.org/w/api.php?action=query&prop=info&redirects=1&converttitles=1&format=json&titles=…
		return [
			'universe (Q1)' => [
				'Q1',
				'Q1',
 ...
 * @see Http
 */
class MediaWikiPageNameNormalizerTest_MockHttp extends Http {
