...
class CachingFileSiteStoreTest extends MediaWikiTestCase {
	...
	public function testGetSites_expiredWithManualRecache() {
		$cacheFile = $this->getCacheFile();

		$store = $this->newCachingFileSiteStore( $cacheFile, true );
		$this->setExpectedException( 'MWException' );
		$store->getSites();
	}

	/**
	 * @depends testGetSites_expiredWithManualRecache
	 */
	public function testGetSites_withFreshRecache() {
		$cacheFile = $this->getCacheFile();

		$store = $this->newCachingFileSiteStore( $cacheFile, false );
	...
	/**
	 * @depends testGetSites_withFreshRecache
	 */
	public function testGetSites_fromCacheOnly( $cacheFile ) {
	...
	/**
	 * @depends testGetSites_fromCacheOnly
	 */
	 ...
	 * @depends testGetSites_fromCacheOnly
	 */
	public function testSaveSites_inManualRecacheMode() {
		$cacheFile = $this->getCacheFile();
		$store = $this->newCachingFileSiteStore( $cacheFile, true );
		$this->setExpectedException( 'MWException' );

		$site = new Site();
		$site->setGlobalId( 'gggwiki' );
		$site->setLanguageCode( 'ga' );
		$sites = array( $site );
	...
	/**
	 * @depends testSaveSites_inManualRecacheMode
	 */
	public function testClear_inManualRecacheMode() {
		$cacheFile = $this->getCacheFile();
		$store = $this->newCachingFileSiteStore( $cacheFile, true );
		$this->setExpectedException( 'MWException' );
		$store->clear();
	...
	/**
	 * @depends testClear_inManualRecacheMode
	 */
	...
	private function newCachingFileSiteStore( $cacheFile, $manualRecache ) {
