...
class SiteInfoSiteLookupTest extends PHPUnit_Framework_TestCase {
	...
	public function provideGetSite() {
		...
		$commons->setExtraData( [
			'paths' => [
				Site::PATH_LINK => 'https://commons.wikimedia.org/wiki/$1',
				MediaWikiSite::PATH_PAGE => 'https://commons.wikimedia.org/wiki/$1',
				MediaWikiSite::PATH_FILE => 'https://commons.wikimedia.org/w/$1',
			]
		] );
		...
		$enwiki->setExtraData( [
			'paths' => [
				Site::PATH_LINK => 'https://en.wikipedia.org/wiki/$1',
				MediaWikiSite::PATH_PAGE => 'https://en.wikipedia.org/wiki/$1',
				MediaWikiSite::PATH_FILE => 'https://en.wikipedia.org/w/$1',
			]
		] );
		...
		$acme->setExtraData( [
			'paths' => [
				Site::PATH_LINK => 'https://www.acme.test/page/$1',
				MediaWikiSite::PATH_PAGE => 'https://www.acme.test/page/$1',
				MediaWikiSite::PATH_FILE => 'https://www.acme.test/$1',
			]
		] );
	...
	public function testSetSiteDefaults() {
		...
		$enwiki->setExtraData( [
			'paths' => [
				Site::PATH_LINK => 'https://en.wikipedia.org/ARTICLE/$1',
				MediaWikiSite::PATH_PAGE => 'https://en.wikipedia.org/ARTICLE/$1',
				MediaWikiSite::PATH_FILE => 'https://en.wikipedia.org/SCRIPT/$1',
			]
		] );
