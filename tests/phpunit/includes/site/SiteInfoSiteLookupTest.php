	...
	public function provideGetSite() {
		...
		$commons->setExtraData( [
			'paths' => [
				...
				MediaWikiSite::PATH_FILE => 'https://commons.wikimedia.org/w/',
			]
		] );
		...
		$enwiki->setExtraData( [
			'paths' => [
				...
				MediaWikiSite::PATH_FILE => 'https://en.wikipedia.org/w/',
			]
		] );
		...
		$acme->setExtraData( [
			'paths' => [
				...
				MediaWikiSite::PATH_FILE => 'https://www.acme.test/',
			]
		] );
	...
	public function testSetSiteDefaults() {
		...
		$enwiki->setExtraData( [
			'paths' => [
				...
				MediaWikiSite::PATH_FILE => 'https://en.wikipedia.org/SCRIPT/',
			]
		] );
