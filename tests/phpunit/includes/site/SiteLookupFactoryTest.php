...
class SiteLookupFactoryTest extends PHPUnit_Framework_TestCase {
	 ...
	 */
	public function testGetSiteLookup( Config $config ) {
		$siteLookupFactory = new SiteLookupFactory( $config );
	...
	public function getSiteLookupProvider() {
		...
		$config->set( 'SitesCacheFile', $cacheFile );

		$configNoCache = new HashConfig();
		$configNoCache->set( 'SitesCacheFile', false );
