...
class PoolCounterTest extends MediaWikiTestCase {
	...
	/**
	 * Convenience method for cleverer autocompletion
	 * @return PHPUnit_Framework_MockObject_MockBuilder|PoolCounter
	 */
	protected function getPoolCounterMock() {
		return $this->getMockBuilder( 'PoolCounterAbstractMock' );
	}
}
