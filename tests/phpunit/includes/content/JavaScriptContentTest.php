	...
	*/
	...
	public static function provideUpdateRedirect() {
		return array(
			...
			array(
				'/* #REDIRECT */mw.loader.load("//example.org/w/index.php?title=MediaWiki:MonoBook.js\u0026action=raw\u0026ctype=text%2Fjavascript");',
				'/* #REDIRECT */mw.loader.load("//example.org/w/index.php?title=TestUpdateRedirect_target\u0026action=raw\u0026ctype=text%2Fjavascript");'
			)
		);
	}
	...
	public static function provideGetRedirectTarget() {
		return array(
			...
			// No #REDIRECT comment
			array( null, 'mw.loader.load("//example.org/w/index.php?title=MediaWiki:NoRedirect.js\u0026action=raw\u0026ctype=text%2Fjavascript");' ),
			// Different domain
			array( null, '/* #REDIRECT */mw.loader.load("//example.com/w/index.php?title=MediaWiki:OtherWiki.js\u0026action=raw\u0026ctype=text%2Fjavascript");' ),
		);
	}
}
