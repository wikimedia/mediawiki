	...
	public static function dataGetChangeTag() {
		...
		return [
			[
				...
				'#REDIRECT [[Foo]]',
				0,
				in_array( 'mw-redirect', $wgCoreTags ) ? 'mw-redirect' : null
			],
			...
			[
				...
				'Lorem ipsum dolor',
				EDIT_NEW,
				in_array( 'mw-newpage', $wgCoreTags ) ? 'mw-newpage' : null
			],
			...
			[
				...
				'',
				EDIT_NEW,
				in_array( 'mw-newblank', $wgCoreTags ) ? 'mw-newblank' : null
			],
			...
			[
				...
				'',
				0,
				in_array( 'mw-blank', $wgCoreTags ) ? 'mw-blank' : null
			],
			...
			[
				...
				'Ipsum',
				0,
				in_array( 'mw-replace', $wgCoreTags ) ? 'mw-replace' : null
			],
