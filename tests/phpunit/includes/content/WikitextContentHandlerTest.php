	...
	public static function dataGetChangeTag() {
		return [
			[
				...
				'#REDIRECT [[Foo]]',
				0,
				in_array( 'mw-new-redirect', ChangeTags::getSoftwareTags() ) ?
					'mw-new-redirect' :
					null
			],
			...
			[
				...
				'Lorem ipsum dolor',
				0,
				in_array( 'mw-removed-redirect', ChangeTags::getSoftwareTags() ) ?
					'mw-removed-redirect' :
					null
			],
			...
			[
				...
				'#REDIRECT [[Bar]]',
				0,
				in_array( 'mw-changed-redirect-target', ChangeTags::getSoftwareTags() ) ?
