...
END;
	...
	public function testOutgoingLinks() {
		$text = <<<END
Here I add link to [[Some Page]]. And [[mw:Page on other wiki|Another page]].
And [[Some Page|This same page]] gets linked twice. 
...
END;
		...
		Hooks::register( 'TitleExists', function ( Title $title, &$exists ) {
