...
class BlockTest extends MediaWikiLangTestCase {
	...
	public function testBlockoptionConstructor(){
		...
		$positionalagrs = array(
			array(5, "auto", Block::AUTO),
			array(7, "anonOnly", Block::ANON_ONLY),
			array(8, "createAccount", Block::CREATE_ACCOUNT),
			array(9, "enableAutoblock", Block::ENABLE_AUTOBLOCK),
			array(10, "hideName", Block::HIDE_NAME),
			array(11, "blockEmail", Block::BLOCK_EMAIL),
			array(12, "allowUsertalk", Block::ALLOW_USERTALK)
  	);
