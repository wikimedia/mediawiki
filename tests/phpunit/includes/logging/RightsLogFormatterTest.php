	...
	public static function provideRightsLogDatabaseRows() {
		return array(
			...
			array(
				...
				array(
					'text' => 'Sysop changed group membership for User:User from (none) to administrator and bureaucrat',
					'api' => array( 'rights' => array( 'new' => 'sysop, bureaucrat', 'old' => '' ) ),
				),
			),
	...
	public static function provideAutopromoteLogDatabaseRows() {
		return array(
			...
			array(
				...
				array(
					'text' => 'Sysop was automatically promoted from administrator to administrator and bureaucrat',
					'api' => array( 'rights' => array( 'new' => 'sysop, bureaucrat', 'old' => 'sysop' ) ),
				),
			),
