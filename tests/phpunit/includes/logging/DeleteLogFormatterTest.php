	...
	public static function provideSuppressRevisionLogDatabaseRows() {
		return array(
			...
			array(
				...
				array(
					'text' => 'User secretly changed visibility of 3 revisions on page Page: edit summary hidden, content unhidden and applied restrictions to administrators',
					'api' => array(
						'type' => 'archive',
						'ids' => array( '1', '3', '4' ),
						'old' => array(
	...
	public static function provideSuppressEventLogDatabaseRows() {
		return array(
			...
			array(
				...
				array(
					'text' => 'User secretly changed visibility of 3 log events on Page: edit summary hidden, content unhidden and applied restrictions to administrators',
					'api' => array(
						'type' => 'logging',
						'ids' => array( '1', '3', '4' ),
						'old' => array(
