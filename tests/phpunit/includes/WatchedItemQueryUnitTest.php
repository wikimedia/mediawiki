...
class WatchedItemQueryUnitTest extends PHPUnit_Framework_TestCase {
	...
	public function getWatchedItemsWithRecentChangeInfoOptionsProvider() {
		return [
			...
			[
				[ 'dir' => WatchedItemQuery::DIR_OLDER, 'start' => '20151212010101' ],
				[],
				[ "rc_timestamp <= '20151212010101'" ],
				[ 'ORDER BY' => [ 'rc_timestamp DESC', 'rc_id DESC' ] ]
			],
			[
				[ 'dir' => WatchedItemQuery::DIR_OLDER, 'end' => '20151212010101' ],
				[],
				[ "rc_timestamp >= '20151212010101'" ],
				[ 'ORDER BY' => [ 'rc_timestamp DESC', 'rc_id DESC' ] ]
			],
			...
			[
				[ 'dir' => WatchedItemQuery::DIR_NEWER, 'start' => '20151212010101' ],
				[],
				[ "rc_timestamp >= '20151212010101'" ],
				[ 'ORDER BY' => [ 'rc_timestamp', 'rc_id' ] ]
			],
			[
				[ 'dir' => WatchedItemQuery::DIR_NEWER, 'end' => '20151212010101' ],
				[],
				[ "rc_timestamp <= '20151212010101'" ],
				[ 'ORDER BY' => [ 'rc_timestamp', 'rc_id' ] ]
			],
			...
			[
				[ 'startFrom' => [ '20151212010101', 123 ], 'dir' => WatchedItemQuery::DIR_OLDER ],
				[],
				[
			...
			[
				[ 'startFrom' => [ '20151212010101', 123 ], 'dir' => WatchedItemQuery::DIR_NEWER ],
				[],
				[
					"(rc_timestamp > '20151212010101') OR ((rc_timestamp = '20151212010101') AND (rc_id >= 123))"
				],
	...
	public function mysqlIndexOptimizationProvider() {
		return [
			...
			[
				'mysql',
				[ 'start' => '20151212010101', 'dir' => WatchedItemQuery::DIR_OLDER ],
				[ "rc_timestamp <= '20151212010101'" ],
			],
			[
				'mysql',
				[ 'end' => '20151212010101', 'dir' => WatchedItemQuery::DIR_OLDER ],
				[ "rc_timestamp >= '20151212010101'" ],
			],
			[
				'postgres',
	...
	public function getWatchedItemsWithRecentChangeInfoInvalidOptionsProvider() {
		return [
			...
			[
				[ 'dir' => WatchedItemQuery::DIR_OLDER, 'startFrom' => '20151212010101' ],
			...
			[
				[ 'dir' => WatchedItemQuery::DIR_OLDER, 'startFrom' => [ '20151212010101', 123, 'foo' ] ],
				'Bad value for parameter $options[\'startFrom\']: must be a two-element array',
			],
			[
	...
	public function testGetWatchedItemsWithRecentChangeInfo_invalidOptions(
		...
		$this->setExpectedException( ParameterAssertionException::class, $expectedInExceptionMessage );
