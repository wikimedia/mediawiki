...
class TestUser {
	...
	private function setPassword( $password ) {
		...
		$oldDefaultType = $passwordFactory->getDefaultType();
		 ...
		 // A is unsalted MD5 (thus the fastest) ... we don't care about security here, this is test only
		$passwordFactory->setDefaultType( 'B' ); // FIXME: Change this to A once that is fixed
