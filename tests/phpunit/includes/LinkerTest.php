	...
	public static function provideCasesForLinkUrl() {
		return [
			[
				...
				'FooBar',
				[],
				'<a href="/wiki/index.php?title=FooBar&amp;action=edit&amp;redlink=1" class="new"'
			...
			[
				...
				'FooBar',
				[ 'canonical' ],
				'<a href="http://localhost/wiki/index.php?title=FooBar&amp;action=edit'
				. '&amp;redlink=1" class="new" title="FooBar (page does not exist)">FooBar</a>'
			],
			[
				'http://localhost',
				'FooBar',
			...
			[
				...
				'FooBar',
				[ 'canonical' ],
				'<a href="https://localhost/wiki/index.php?title=FooBar&amp;action=edit'
				. '&amp;redlink=1" class="new" title="FooBar (page does not exist)">FooBar</a>'
			],
