 ...
 * @group Diff
 */
class UnifiedDifferenceEngineTest extends MediaWikiTestCase {
	/**
	 * @covers UnifiedDifferenceEngine::generateTextDiffBody
	 */
...
END;
		$diff = new UnifiedDifferenceEngine( new RequestContext( new FauxRequest ) );
		$this->assertEquals(
