...
class CoreMagicVariablesTest extends MediaWikiIntegrationTestCase {
	...
	public static function provideCurrentUnitTimestampWords() {
		return [
			...
			[ 'currenthour', '20200208153011', '15', 1812 ],
			...
			[ 'currenthour', '20200208223011', '22', 1812 ],
	...
	public static function provideLocalUnitTimestampWords() {
		...
		return [
			...
			[ 'localhour', '20200208153011', '16', 1812 ],
			...
			[ 'localday', '20200208223011', '8', 1812 ],
			[ 'localday2', '20200208223011', '08', 1812 ],
			[ 'localdayname', '20200208223011', 'Saturday', 1812 ],
			[ 'localyear', '20200208223011', '2020', 604800 ],
			[ 'localhour', '20200208223011', '23', 1812 ],
			[ 'localweek', '20200208223011', '6', 1812 ],
			[ 'localdow', '20200208223011', '6', 1812 ],
			...
			[ 'localhour', '20200208233011', '00', 1812 ],
