 ...
 */
class ParserCacheTest extends ParserCacheTestBase {
	...
	private function makeParserCache(
	...
	public function testParserCacheSaveCompleteHook() {
		...
		$cache = $this->makeParserCache( hookContainer: $hookContainer );
		$cache->save(
			$parserOutput,
			$this->page,
			$options,
