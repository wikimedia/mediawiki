...
/**
 * @covers \MediaWiki\Storage\MutableRevisionRecordBase
 */
class MutableRevisionRecordTest extends MediaWikiTestCase {

	public function testSimpleSetGetId() {
		$record = new MutableRevisionRecordBase( Title::newFromText( 'Foo' ) );
	...
	public function testSimpleSetGetVisibility() {
		...
		$record->setVisibility( RevisionRecordBase::DELETED_USER );
		$this->assertSame( RevisionRecordBase::DELETED_USER, $record->getVisibility() );
	}
