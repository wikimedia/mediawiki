...
class McrRevisionStoreDbTest extends RevisionStoreDbTestBase {
	...
	public function testInsertRevisionOn_multi() {
		$this->fail( 'TODO: test writing multiple slots, inheriting some' );
	}

	public function testNewNullRevision_multi() {
		$this->fail( 'TODO: test writing multiple slots' );
	}

	public function testNewMutableRevisionFromArray_multi() {
		$this->fail( 'TODO: test construction from array with multiple slots' );
	}
