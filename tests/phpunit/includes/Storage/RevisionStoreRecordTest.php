...
class RevisionStoreRecordTest extends MediaWikiTestCase {
	 ...
	 *
	 * @param \MediaWiki\Page\PageIdentity $pageIdentity
	...
	public function testConstructorAndGetters(
		\MediaWiki\Page\PageIdentity $pageIdentity,
		UserIdentity $user,
	 ...
	 *
	 * @param \MediaWiki\Page\PageIdentity $page
	 * @param UserIdentity $user
	 * @param CommentStoreComment $comment
	 * @param object $row
	 * @param RevisionSlots $slots
	...
	public function testConstructorFailure(
		\MediaWiki\Page\PageIdentity $page,
		UserIdentity $user,
		CommentStoreComment $comment,
		$row,
		RevisionSlots $slots,
