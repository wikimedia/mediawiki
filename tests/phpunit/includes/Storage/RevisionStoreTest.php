...
class RevisionStoreTest extends MediaWikiTestCase {
	...
	private function getMockLoadBalancer() {
		...
		return $this->getMockBuilder( LoadBalancer::class )->disableOriginalConstructor()->getMock(
			);
	}
	...
	private function getMockSqlBlobStore() {
		...
		return $this->getMockBuilder( SqlBlobStore::class )->disableOriginalConstructor()->getMock(
			);
	}
