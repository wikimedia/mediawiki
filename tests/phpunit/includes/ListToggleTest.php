...
class ListToggleTest extends MediaWikiTestCase {
	...
	public function testGetHTML() {
		...
		$this->assertEquals('<div class="mw-checkbox-toggle-controls">' .
			'Select: <a class="mw-checkbox-all" role="button" tabindex="0">' .
			'All</a>, <a class="mw-checkbox-none" role="button" tabindex="0">' .
			'None</a>, <a class="mw-checkbox-invert" role="button" tabindex="0">' .
			'Invert</a></div>',
			$html);
	}
}
