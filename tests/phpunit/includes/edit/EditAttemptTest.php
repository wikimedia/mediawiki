...
class EditAttemptTest extends MediaWikiLangTestCase {
	...
	protected function assertInternalAttemptSave( $title, $user, $edit, $info = [], $options = [],
...
';
	...
	public function testAutoMerge( $baseUser, $text, $adamsEditData, $bertasEditData,
		...
		// first edit
		$this->assertInternalAttemptSave( 'EditAttemptTest_testAutoMerge', 'Adam', $adamsEdit,
			[], [], null, EditAttempt::AS_SUCCESS_UPDATE, null, "expected successfull update" );

		// second edit
		$this->assertInternalAttemptSave( 'EditAttemptTest_testAutoMerge', 'Berta', $bertasEdit,
