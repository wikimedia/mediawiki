...
class WANObjectCacheTest extends MediaWikiTestCase {
	...
	/**
	 * @dataProvider getWithSetCallbackDelete_provider
	 * @param array $extOpts
	 * @param $versioned
	 */
	public function testGetWithSetCallbackDelete( array $extOpts, $versioned ) {
		$cache = $this->cache;
	...
	public static function getWithSetCallbackDelete_provider() {
		return [
			[ [], false ],
			[ [ 'version' => 1 ], true ]
		];
