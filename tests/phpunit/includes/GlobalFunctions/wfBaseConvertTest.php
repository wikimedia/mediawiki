...
class wfBaseConvertTest extends MediaWikiTestCase {
	...
	public function testInvalid() {
		$this->assertSame( false, wfBaseConvert( '101', 1, 15 ) );
		$this->assertSame( false, wfBaseConvert( '101', 15, 1 ) );
		$this->assertSame( false, wfBaseConvert( '101', 37, 15 ) );
		$this->assertSame( false, wfBaseConvert( '101', 15, 37 ) );
		$this->assertSame( false, wfBaseConvert( 'abcde', 10, 11 ) );
		$this->assertSame( false, wfBaseConvert( '12930', 2, 10 ) );
		$this->assertSame( false, wfBaseConvert( '101', 'abc', 15 ) );
		$this->assertSame( false, wfBaseConvert( '101', 15, 'abc' ) );
	}
