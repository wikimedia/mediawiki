...
class SpecialUserloginTest extends MediaWikiTestCase {
	...
	public function testNoUsername() {
		...
		$result = $ul->createAndValidateUsername( '', 'password', 'test@domain.test' );
	...
	public function testUserExists() {
		...
		$result = $ul->createAndValidateUsername( 'ThisUserExists', 'password', 'test@domain.test' );
	...
	public function testPasswordTooShort() {
		...
		$result = $ul->createAndValidateUsername( 'Username', 'justthewronglength', 'test@domain.test' );
	...
	public function testInvalidEmail() {
		...
		$result = $ul->createAndValidateUsername( 'Username', 'password', 'invalid' );
	...
	public function testSuccess() {
		...
		$result = $ul->createAndValidateUsername( $username, $password, $email );
