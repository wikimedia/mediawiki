...
class SpecialRecentchangesTest extends MediaWikiTestCase {
	...
	public function testFilterUserExpLevel() {
		...
		$this->assertArrayEquals(
			[ 'MoreExperienced1' ],
			$this->fetchUsers( [ 'userExpLevel' => 'moreexperienced', 'hideliu' => 0 ] )
		);
		...
		$this->assertArrayEquals(
			...
			$this->fetchUsers( [ 'userExpLevel' => 'experienced,moreexperienced', 'hideliu' => 0 ] )
		);
		...
		$this->assertArrayEquals(
			...
			$this->fetchUsers( [ 'userExpLevel' => 'newcomer,experienced,moreexperienced', 'hideliu' => 0 ] )
		);
		...
		$this->assertArrayEquals(
			...
			$this->fetchUsers( [ 'userExpLevel' => 'all', 'hideliu' => 0 ] )
		);
	}
