...
class LoadBalancerTest extends MediaWikiTestCase {
	...
	public function testWithGroups() {
		...
		$db = $lb->getConnection( $lb->getReaderIndex(), [ 'foo' ] );
		$this->assertSame( 'def-replica', $db->getLBInfo( 'test-name' ), 'getReaderIndex forces group' );

		$db = $lb->getConnection( DB_REPLICA, [ 'xyzzy' ] );
		$this->assertSame( 'def-replica', $db->getLBInfo( 'test-name' ), 'bad group falls back to default' );
