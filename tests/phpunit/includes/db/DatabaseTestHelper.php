...
/**
 * Helper for testing SQLs from the DatabaseBase class
 * @since 1.21
 */
class DatabaseTestHelper extends DatabaseBase {
	...
	/**
	 * Array of lastSqlss passed to query(),
	 * cleared when calling getlastSqls()
	 * This is a array, because some methods in DatabaseBase doing more than one query
	 */
	private $lastSqls;

	/**
	 * Array of tables, which treated as exist in tableExist
	 */
	...
	private function checkFunctionName( $fname ) {
