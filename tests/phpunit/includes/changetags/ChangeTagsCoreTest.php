...
class ChangeTagsCoreTest extends ChangeTagsTest {
	...
	public function provideGetAutotagsForEditUpdate() {
		return array(
			array( 'Hi', '#REDIRECT [[Main Page]]', 'Main Page', array( 'core-redirect-self', 'core-redirect-new' ) ),
			array( '#REDIRECT [[Main Page]]', 'nothing', 'Some Page', array( 'core-redirect-removed' ) ),
			array( 'Lorem ipsum', '', 'Some Page', array( 'core-edit-blank' ) ),
			array( 'Lorem ipsum', 'Lorem ipsum dolor sit amet', 'Some Page', array() ),
		);
	}
	 ...
	 */
	public function testGetAutotagsForMove( $oldNs, $oldPage, $newNs, $newPage, $userName, $expected ) {
	...
	public function provideGetAutotagsForMove() {
		return array(
			array( NS_USER, 'John', NS_USER, 'James', 'John', array( 'core-move-rename' ) ),
			array( NS_Main, 'Foo', NS_PROJECT, 'Foo', 'Caesar', array( 'core-move-crossnamespace' ) ),
		);
	}
}
