...
class RunningStatTest extends MediaWikiTestCase {
	 ...
	 */
	function testRunningStatAccuracy() {
		// Create a RunningStat instance and push half of the values.
		...
		$this->assertEquals( $rstat->n, count( $this->points ) );
