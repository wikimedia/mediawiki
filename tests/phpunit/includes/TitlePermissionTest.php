...
class TitlePermissionTest extends MediaWikiLangTestCase {
	...
	public function testCssAndJavascriptPermissions() {
		...
		$this->runCSSandJSPermissions(
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'sitejsprotected' ) ),
			array( array( 'badaccess-group0' ) )
		);

		$this->setTitle( NS_MEDIAWIKI, 'Common.css' );
		$this->runCSSandJSPermissions(
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			...
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ), array( 'sitecssprotected' ) ),
			array( array( 'badaccess-group0' ) ),
			array( array( 'badaccess-group0' ), array( 'sitecssprotected' ) )
		);

		$this->setTitle( NS_MEDIAWIKI, 'tempo' );
		$this->runCSSandJSPermissions(
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface' ) ),
	...
	protected function runCSSandJSPermissions( $result0, $result1, $result2, $result3, $result4, $result5, $result6, $result7, $result8 ) {
		$this->setUserPerm( '' );
