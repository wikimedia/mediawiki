...
class TitlePermissionTest extends MediaWikiLangTestCase {
	...
	public function testCssAndJavascriptPermissions() {
		...
		$this->runCSSandJSPermissions(
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitejsprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitejsprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitejsprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitejsprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitejsprotected', 'bogus' ) ),
		...
		$this->runCSSandJSPermissions(
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitecssprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitecssprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitecssprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitecssprotected', 'bogus' ) ),
			array( array( 'badaccess-group0' ), array( 'protectedinterface', 'bogus' ), array( 'sitecssprotected', 'bogus' ) ),
