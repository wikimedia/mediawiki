...
class LinkRendererTest extends MediaWikiLangTestCase {
	...
	public function testMakeLink() {
		...
		$this->assertEquals(
			'<a href="/wiki/Special:Foobar" class="new" title="Special:Foobar (page does not exist)">foo</a>',
		...
		$this->assertEquals(
			'<a href="/wiki/Special:Foobar" class="new" title="Special:Foobar (page does not exist)">&lt;script&gt;evil()&lt;/script&gt;</a>',
