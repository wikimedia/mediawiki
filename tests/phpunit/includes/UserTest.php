...
class UserTest extends MediaWikiTestCase {
	...
	public function testSetCookie($expiry, $actualWgLoginCookieExpiration, $expectedExpiry) {
		...
		$user->setLoginCookie( 'name', 'value', $expiry );
		...
		// TODO (phuedx, 2014/09/21): ± 60 seconds compensates for slow-running
		// tests. However, the dependency on the time function needs to be
		// removed.
...
class UserProxy extends User {
	...
	public function setLoginCookie( $name, $value, $exp = 0, $secure = null, $params = array() ) {
		$this->user->setLoginCookie( $name, $value, $exp, $secure, $params );
	}
}
