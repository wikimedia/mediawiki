...
class NoWriteWatchedItemStoreUnitTest extends MediaWikiTestCase {
	...
	public function testCountVisitingWatchers() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'countVisitingWatchers' )->willReturn( __METHOD__ );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
	...
	public function testCountWatchersMultiple() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'countVisitingWatchersMultiple' )->willReturn( __METHOD__ );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
	...
	public function testGetWatchedItemsForUser() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'getWatchedItemsForUser' )->willReturn( __METHOD__ );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
	...
	public function testGetNotificationTimestampsBatch() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'getNotificationTimestampsBatch' )->willReturn( __METHOD__ );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
	...
	public function testCountUnreadNotifications() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'countUnreadNotifications' )->willReturn( __METHOD__ );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
	...
	public function testDuplicateAllAssociatedEntries() {
		/** @var WatchedItemStoreInterface|PHPUnit_Framework_MockObject_MockObject $innerService */
		$innerService = $this->getMockForAbstractClass( WatchedItemStoreInterface::class );
		$innerService->expects( $this->once() )->method( 'duplicateAllAssociatedEntries' );
		$noWriteService = new NoWriteWatchedItemStore( $innerService );
