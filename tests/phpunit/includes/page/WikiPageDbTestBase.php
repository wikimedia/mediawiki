...
abstract class WikiPageDbTestBase extends MediaWikiLangTestCase {
	...
	public function testPrepareContentForEdit() {
		...
		$edit2 = $page->prepareContentForEdit( $rev->getContent(), $rev, $user, null, false );
		$this->assertNotEquals( $edit, $edit2 );
		$this->assertSame( $rev->getId(), $edit2->revid, "revid field" );

		$edit3 = $page->prepareContentForEdit( $rev->getContent(), $rev, $sysop, null, false );
