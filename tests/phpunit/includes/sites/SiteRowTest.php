...
class SiteRowTest extends ORMRowTest {
	...
	public function constructorTestProvider() {
		$rows = array(
			array( 'en', Site::GROUP_WIKIPEDIA, 'https://en.wikipedia.org', '/wiki/$1', 'en' ),
			array( 'en', Site::GROUP_WIKIPEDIA, 'https://en.wikipedia.org', '/wiki/$1', 'en', Site::TYPE_MEDIAWIKI ),
			array(
				'en', Site::GROUP_WIKIPEDIA, 'https://en.wikipedia.org',
