...
class StatusTest extends MediaWikiLangTestCase {
	...
	public function testGetWikiText(
		...
		$this->assertEquals( $wrappedWikitext, $status->getWikiText( 'wrap-short', 'wrap-long', $lang ) );
	}
	...
	public function testGetHtml(
		...
		$lang = Language::factory( 'qqx' );
		$this->assertEquals( $wrappedHtml, $status->getHTML( 'wrap-short', 'wrap-long', $lang ) );
	}
	...
	public function testGetMessage(
		...
		$lang = Language::factory( 'qqx' );
		$message = $status->getMessage( null, null, $lang );
