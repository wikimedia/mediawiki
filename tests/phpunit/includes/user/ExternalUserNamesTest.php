...
class ExternalUserNamesTest extends MediaWikiTestCase {
	...
	/**
	 * @covers ExternalUserNames::getUnknownUsername
	 */
	public function testGetUnknownUsername() {
		$externalUserNames = new ExternalUserNames( 'testPrefix', true );
		$this->assertSame(
			'testPrefix>Unknown user',
			$externalUserNames->getUnknownUsername()
		);
	}
}
