...
class TestPageProps extends MediaWikiLangTestCase {
	...
	public function testGetSingleProperty() {
		...
		$props = PageProps::getInstance();
		$value = $props->getProperty( $title, "property1" );
	...
	public function testGetAllProperties() {
		$title = $this->the_page->getTitle();
		$props = PageProps::getInstance();
		$this->assertEquals( $this->getProperties(), $props->getProperties( $title ), "Get all properties" );
	}

	public function testSingleCache() {
		$title = $this->the_page->getTitle();
		$props = PageProps::getInstance();
		$value1 = $props->getProperty( $title, "property1" );
		$this->setProperty( "property1", "another value" );
		$value2 = $props->getProperty( $title, "property1" );
	...
	public function testMultiCache() {
		$title = $this->the_page->getTitle();
		$props = PageProps::getInstance();
		$properties1 = $props->getProperties( $title );
		$this->setProperty( "property1", "another value" );
		$properties2 = $props->getProperties( $title );
