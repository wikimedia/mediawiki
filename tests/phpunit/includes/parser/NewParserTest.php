	...
	private function teardownUploads() {
		...
		self::deleteFiles(
			array(
				...
				"$base/local-thumb/f/fc/Portrait.svg/124px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/165px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/180px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/247px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/270px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/330px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/360px-Portrait.svg.png",
				"$base/local-thumb/f/fc/Portrait.svg/82px-Portrait.svg.png",
