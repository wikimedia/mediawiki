...
class NewParserTest extends MediaWikiTestCase {
	...
	protected function setUp() {
		...
		//DjVu support
		$tmpGlobals['wgDjvuRenderer'] = $wgDjvuRenderer ? $wgDjvuRenderer : '/usr/local/bin/ddjvu';
		$tmpGlobals['wgDjvuDump'] = $wgDjvuDump ? $wgDjvuDump : '/usr/local/bin/djvudump';
		$tmpGlobals['wgDjvuToXML'] = $wgDjvuToXML ? $wgDjvuToXML : '/usr/local/bin/djvutoxml';
		$tmpGlobals['wgFileExtensions'][] = 'djvu';
		if (
			$this->checkIfToolExists( $tmpGlobals['wgDjvuRenderer'] ) &&
			$this->checkIfToolExists( $tmpGlobals['wgDjvuDump'] ) &&
			$this->checkIfToolExists( $tmpGlobals['wgDjvuToXML'] )
		) {
			$this->runDjVu = true;
		}
