	...
	private function teardownUploads() {
		...
		self::deleteFiles(
			array(
				...
				"$base/local-thumb/5/5f/page2-2480px-LoremIpsum.djvu.jpg",
				"$base/local-thumb/5/5f/page2-3720px-LoremIpsum.djvu.jpg",
				"$base/local-thumb/5/5f/page2-4960px-LoremIpsum.djvu.jpg",
