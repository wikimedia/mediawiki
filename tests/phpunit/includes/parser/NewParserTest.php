...
class NewParserTest extends MediaWikiTestCase {
	...
	/**
	 * @var DjVuSupportDetector
	 */
	private $djVuSupportDetector;
	...
	protected function setUp() {
		...
		//DjVu support
		$this->djVuSupportDetector = new DjVuSupportDetector();
		$this->djVuSupportDetector->initializeGlobals();
...
<PARAM name="GAMMA" value="2.2" />
	...
	public function testParserTest( $desc, $input, $result, $opts, $config ) {
		...
		if ( isset( $opts['djvu'] ) ) {
			if ( !$this->djVuSupportDetector->isDjVuSupportEnable() ) {
