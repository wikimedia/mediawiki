...
class SanitizerTest extends MediaWikiTestCase {
	...
	/**
	 * Test escapeIdReferenceList for consistency with escapeIdForHtml
	 *
	 ...
	 *
	 * @covers Sanitizer::escapeIdForHtml()
	...
	public function provideEscapeIdForStuff() {
		...
		return [
			...
			[ 'Html', $legacy, $text, $legacyEncoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $legacy, $text, false, Sanitizer::ID_FALLBACK ],
			...
			[ 'Html', $legacyNew, $text, $legacyEncoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $legacyNew, $text, $html5Encoded, Sanitizer::ID_FALLBACK ],
			[ 'Link', $legacyNew, $text, $legacyEncoded ],
			[ 'ExternalInterwiki', $legacyNew, $text, $legacyEncoded ],

			// New world: HTML5 links, legacy fallbacks
			[ 'Html', $newLegacy, $text, $html5Encoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $newLegacy, $text, $legacyEncoded, Sanitizer::ID_FALLBACK ],
			...
			[ 'Html', $new, $text, $html5Encoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $new, $text, false, Sanitizer::ID_FALLBACK ],
			...
			[ 'Html', $allNew, $text, $html5Encoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $allNew, $text, false, Sanitizer::ID_FALLBACK ],
			[ 'Link', $allNew, $text, $html5Escaped ],
			[ 'ExternalInterwiki', $allNew, $text, $html5Escaped ],

			// Someone flipped $wgExperimentalHtmlIds on
			[ 'Html', $experimentalLegacy, $text, $html5Experimental, Sanitizer::ID_PRIMARY ],
			[ 'Html', $experimentalLegacy, $text, $legacyEncoded, Sanitizer::ID_FALLBACK ],
			...
			[ 'Html', $newExperimental, $text, $html5Encoded, Sanitizer::ID_PRIMARY ],
			[ 'Html', $newExperimental, $text, $html5Experimental, Sanitizer::ID_FALLBACK ],
	...
	public function testInvalidFragmentThrows() {
		...
		Sanitizer::escapeIdForHtml( 'This should throw' );
	}
