...
class SanitizerTest extends MediaWikiTestCase {
	...
	public static function provideTagAttributesToDecode() {
		return [
			...
			[ [ 'ńgh' => 'bar' ], 'ńgh=bar', 'Combining accent' ],
			...
			// Ensure that you can't use any of the characters from
			// https://github.com/html5lib/html5lib-python/issues/11#issuecomment-19879445
			// in an attribute name, because old browsers might think they
			// are whitespace.
			[ [], 'foo`bar=b', 'Grave accents are not allowed (Old IE)' ],
			[ [], 'foo/bar=b', 'Slash not allowed' ],
			[ [], "foo\0bar=b", 'Special character 0 not allowed attribute name' ],
			[ [], "foo\1bar=b", 'Special character 1 not allowed attribute name' ],
			[ [], "foo\2bar=b", 'Special character 2 not allowed attribute name' ],
			[ [], "foo\3bar=b", 'Special character 3 not allowed attribute name' ],
			[ [], "foo\4bar=b", 'Special character 4 not allowed attribute name' ],
			[ [], "foo\5bar=b", 'Special character 5 not allowed attribute name' ],
			[ [], "foo\6bar=b", 'Special character 6 not allowed attribute name' ],
			[ [], "foo\x07bar=b", 'Special character 7 not allowed attribute name' ],
			[ [], "foo\x08bar=b", 'Special character 8 not allowed attribute name' ],
			[ [], "foo\x0bbar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x0ebar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x0fbar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x10bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x11bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x12bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x13bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x14bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x15bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x16bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x17bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x18bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\x19bar=b", 'Special character not allowed attribute name' ],
			[ [], "foo\xc2\xa0bar=b", 'Special character U+00A0 not allowed attribute name' ],
			[ [], "foo\xe1\x9a\x80bar=b", 'Special U+1680 character not allowed attribute name' ],
			[ [], "foo\xe1\xa0\x8ebar=b", 'Special U+180E character not allowed attribute name' ],
			[ [], "foo\xe1\xa0\x8fbar=b", 'Special U+180F character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x80bar=b", 'fancy space U+2000 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x81bar=b", 'fancy space U+2001 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x82bar=b", 'fancy space U+2002 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x83bar=b", 'fancy space U+2003 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x84bar=b", 'fancy space U+2004 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x85bar=b", 'fancy space U+2005 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x86bar=b", 'fancy space u+2006 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x87bar=b", 'fancy space U+2007 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x88bar=b", 'fancy space U+2008 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x89bar=b", 'fancy space U+2009 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\x8abar=b", 'fancy space U+200a character not allowed attribute name' ],
			[ [], "foo\xe2\x80\xa8bar=b", 'fancy space U+2028 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\xa9bar=b", 'fancy space U+2029 character not allowed attribute name' ],
			[ [], "foo\xe2\x80\xafbar=b", 'fancy space U+202f character not allowed attribute name' ],
			[ [], "foo\xe2\x81\x9fbar=b", 'fancy space U+205f character not allowed attribute name' ],
			[ [], "foo\xe3\x80\x80bar=b", 'fancy space U+3000 character not allowed attribute name' ],
