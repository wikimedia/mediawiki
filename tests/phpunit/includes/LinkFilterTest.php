...
class LinkFilterTest extends MediaWikiLangTestCase {
	...
	protected function setUp() {
		...
		$this->oldUrlProtocols = $wgUrlProtocols;
	...
	protected function tearDown() {
		global $wgUrlProtocols;
		$wgUrlProtocols = $this->oldUrlProtocols;
		parent::tearDown();
	}
	 ...
	 *
	 * @param $like Array as created by LinkFilter::makeLikeArray()
	 * @return string: Regex
	 */
	...
	public static function provideValidPatterns() {
		...
		return array(
			...
			array( '' , 'http://name:pass@www.test.com:12345/dir/dir/file.xyz.php#__se__?arg1=_&arg2[]=4rtg' ,
			...
			array( 'http://' , 'name:pass@*.test.com:12345/dir/dir/file.xyz.php#__se__?arg1=_&arg2[]=4rtg' ,
				'http://name:pass@www.test.com:12345/dir/dir/file.xyz.php#__se__?arg1=_&arg2[]=4rtg' ),
			// This one only works in PHP >= 5.3.7, due to a bug in parse_url which eats the path from the url
			// https://bugs.php.net/bug.php?id=54180
			//  array( '' , 'http://xx23124:__ffdfdef__@www.test.com:12345/dir' ,
			//	    'http://name:pass@www.test.com:12345/dir/dir/file.xyz.php#__se__?arg1=_&arg2[]=4rtg' ),
	 ...
	 *
	 * Tests whether the LIKE clause produced by LinkFilter::makeLikeArray($pattern, $protocol) will find one
	 * of the URL indexes produced by wfMakeUrlIndexes($url)
	 *
	 * @dataProvider provideValidPatterns
	 *
	 * @param $protocol String Protocol, e.g. 'http://' or 'mailto:'
	 * @param $pattern String Search pattern to feed to LinkFilter::makeLikeArray
	 * @param $url String URL to feed to wfMakeUrlIndexes
	 */
