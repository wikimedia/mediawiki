...
class LinkFilterTest extends MediaWikiLangTestCase {
	...
	/**
	 * The old list of protocols
	 *
	 * @var array $oldUrlProtocols
	 */
	private $oldUrlProtocols;
	...
	public static function provideValidPatterns() {
		...
		return array(
			...
			//
			// The following only work in PHP >= 5.3.7, due to a bug in parse_url which eats the path from the url
	 ...
	 * @param $shouldBeFound bool Should the URL be found? (defaults True)
	 */
