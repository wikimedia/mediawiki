...
class LocalPasswordPrimaryAuthenticationProviderTest extends \MediaWikiTestCase {
	...
	public static function provideProviderChangeAuthenticationData() {
		return [
			[ AuthenticationRequest::class, false, false ],
			[ PasswordAuthenticationRequest::class, false, true ],
			[ AuthenticationRequest::class, true, false ],
			[ PasswordAuthenticationRequest::class, true, true ],
		];
	}
