...
class AbstractPasswordPrimaryAuthenticationProviderTest extends \MediaWikiTestCase {
	...
	public static function provideGetAuthenticationRequests() {
		return array(
			array( AuthManager::ACTION_LOGIN, array( new PasswordAuthenticationRequest ) ),
			array( AuthManager::ACTION_CREATE, array( new PasswordAuthenticationRequest( true ) ) ),
			array( AuthManager::ACTION_LINK, array() ),
			array( AuthManager::ACTION_CHANGE, array( new PasswordAuthenticationRequest( true ) ) ),
			array( AuthManager::ACTION_REMOVE, array( new PasswordAuthenticationRequest ) ),
		);
	}
