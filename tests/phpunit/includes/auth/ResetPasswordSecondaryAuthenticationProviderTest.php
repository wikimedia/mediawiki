...
class ResetPasswordSecondaryAuthenticationProviderTest extends MediaWikiTestCase {
	...
	protected function getProvider() {
		...
		$sessionProvider = $this->getMockForAbstractClass( 'AbstractAuthenticationSessionProvider' );
		$sessionProvider->method( 'provideAuthenticationSession' )->willReturn( new NullAuthenticationSession() );
