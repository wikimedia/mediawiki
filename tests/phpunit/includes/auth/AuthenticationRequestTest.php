...
class AuthenticationRequestTest extends \MediaWikiTestCase {
	...
	public static function provideLoadFromSubmission() {
		return array(
			...
			'Simple field, not supplied' => array(
				array(
					'field' => array(
						'type' => 'string',
					),
			...
			'Simple field, optional, not supplied' => array(
				array(
					'field' => array(
						'type' => 'string',
						'optional' => true,
			...
			'Simple field, optional, empty' => array(
				array(
					'field' => array(
						'type' => 'string',
						'optional' => true,
			...
			'Checkbox, optional, unchecked' => array(
				array(
					'check' => array(
						'type' => 'checkbox',
						'optional' => true,
			...
			'Multiselect, string for some reason' => array(
				array(
					'choose' => array(
						'type' => 'multiselect',
						'options' => array(
			...
			'Multiselect, invalid choice' => array(
				array(
					'choose' => array(
						'type' => 'multiselect',
						'options' => array(
			...
			'Multiselect, optional, nothing submitted' => array(
				array(
					'choose' => array(
						'type' => 'multiselect',
						'options' => array(
