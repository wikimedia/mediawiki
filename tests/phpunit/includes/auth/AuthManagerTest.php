	...
	public function provideAuthentication() {
		...
		return array(
			...
			array(
				...
				StatusValue::newGood(),
				$tmp = array(
					AuthenticationResponse::newUI( array( $req ), $this->messageSpecifier( '...' ) ),
			...
			array(
				...
				StatusValue::newGood(),
				array(
					$tmp = AuthenticationResponse::newUI( array( $req ), $this->messageSpecifier( '...' ) ),
	...
	public function provideAccountCreation() {
		...
		return array(
			...
			array(
				...
				$good, $good, $good,
				array(
					$tmp1 = AuthenticationResponse::newUI( array( $req ), $this->messageSpecifier( '...' ) ),
					AuthenticationResponse::newPass(),
				),
				array(
					AuthenticationResponse::newAbstain(),
