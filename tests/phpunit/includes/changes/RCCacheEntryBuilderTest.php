...
class RCCacheEntryBuilderTest extends MediaWikiLangTestCase {
	...
	/**
	 * @dataProvider buildEditEntryProvider
	 */
	public function testBuildEditEntry( $expected, $context, $messages, $recentChange, $watched ) {
	...
	public function buildEditEntryProvider() {
		return array(
			array(
				array(
					'title' => 'Xyz',
	...
	/**
	 * @dataProvider buildDeleteEntryProvider
	 */
	public function testDeleteEntryBuild( $expected, $context, $messages, $recentChange, $watched ) {
		$cacheEntryBuilder = new RCCacheEntryBuilder( $context, $messages );
		$cacheEntry = $cacheEntryBuilder->build( $recentChange, $watched );
	...
	public function buildDeleteEntryProvider() {
		return array(
			array(
				array(
					'title' => 'Abc',
	...
	/**
	 * @dataProvider buildRevUserDeleteEntryProvider
	 */
	public function testRevUserDeleteEntryBuild( $expected, $context, $messages, $recentChange, $watched ) {
		$cacheEntryBuilder = new RCCacheEntryBuilder( $context, $messages );
		$cacheEntry = $cacheEntryBuilder->build( $recentChange, $watched );
	...
	public function buildRevUserDeleteEntryProvider() {
		return array(
			array(
				array(
					'title' => 'Zzz',
