...
class JsonTest extends MediaWikiTestCase {
	...
	private static function provideEncoderDefaultTestCases() {
		return self::provideEncoderTestCases( false, false );
	}

	private static function provideEncoderUtf8OkTestCases() {
		return self::provideEncoderTestCases( false, true );
	}

	private static function provideEncoderXmlMetaOkTestCases() {
		return self::provideEncoderTestCases( true, false );
	}

	private static function provideEncoderAllOkTestCases() {
		return self::provideEncoderTestCases( true, true );
	}

	private static function provideEncoderTestCases( $X, $U ) {
		$rules = array(
