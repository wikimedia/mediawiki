...
class MediaWikiTitleCodecTest extends MediaWikiTestCase {
	...
	public function provideFormatForDisplay() {
		return array(
			array( new TitleValue( TitleValue::DBKEY_FORM, NS_MAIN, 'Foo_Bar' ), TitleFormatter::INCLUDE_ALL, 'en', 'Foo Bar' ),
			array( new TitleValue( TitleValue::DBKEY_FORM, NS_USER, 'Hansi_Maier', 'stuff' ), TitleFormatter::INCLUDE_ALL, 'en', 'User:Hansi Maier#stuff' ),
			array( new TitleValue( TitleValue::DBKEY_FORM, NS_USER, 'Hansi_Maier', 'stuff' ), TitleFormatter::INCLUDE_BASE, 'en', 'Hansi Maier' ),
			array( new TitleValue( TitleValue::UNKNOWN_FORM, NS_USER_TALK, 'Hansi_Maier' ), TitleFormatter::INCLUDE_ALL, 'en', 'User talk:Hansi Maier' ),
			array( new TitleValue( TitleValue::DBKEY_FORM, NS_USER, 'Lisa_Müller', 'stuff' ), TitleFormatter::INCLUDE_NAMESPACE, 'de', 'Benutzerin:Lisa Müller' ),
		);
	}
	...
	public function provideFormatForDatabase() {
		return array(
			array( new TitleValue( TitleValue::TITLE_FORM, NS_MAIN, 'Foo Bar' ), 'en', 'Foo_Bar' ),
			array( new TitleValue( TitleValue::DBKEY_FORM, NS_USER, 'Hansi_Maier', 'stuff' ), 'en', 'Hansi_Maier' ),
		);
	}
	...
	public function provideParseTitle() {
		...
		return array(
			array( ':Hansi_Maier', NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_MAIN, 'Hansi Maier', '' ) ),
			array( ':Hansi_Maier', NS_CATEGORY, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_MAIN, 'Hansi Maier', '' ) ),
			array( ' lisa Müller', NS_USER, TitleValue::DBKEY_FORM, 'de', new TitleValue( TitleValue::DBKEY_FORM, NS_USER, 'Lisa_Müller', '' ) ),
			array( 'benutzerin:lisa Müller#stuff', NS_MAIN, TitleValue::TITLE_FORM, 'de', new TitleValue( TitleValue::TITLE_FORM, NS_USER, 'Lisa Müller', 'stuff' ) ),
			array( 'benutzerin:lisa Müller#stuff', NS_MAIN, TitleValue::DBKEY_FORM, 'en', new TitleValue( TitleValue::DBKEY_FORM, NS_MAIN, 'Benutzerin:lisa_Müller', 'stuff' ) ),
			...
			array( '"', NS_MAIN, TitleValue::TITLE_FORM, 'en', ),
			array( '\'', NS_MAIN, TitleValue::TITLE_FORM, 'en', ),
			array( 'Talk:Sandbox', NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_TALK, 'Sandbox' ) ),
			array( 'Talk:Foo:Sandbox', NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_TALK, 'Foo:Sandbox' ) ),
			array( 'File:Example.svg', NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_FILE, 'Example.svg' ) ),
			array( 'File_talk:Example.svg', NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_FILE_TALK, 'Example.svg' ) ),
			array( 'Foo/.../Sandbox', NS_MAIN, TitleValue::TITLE_FORM, 'en', ),
			array( 'Sandbox/...', NS_MAIN, TitleValue::TITLE_FORM, 'en', ),
			array( 'A~~', NS_MAIN, TitleValue::TITLE_FORM, 'en', ),
			// Length is 256 total, but only title part matters
			array( 'Category:' . str_repeat( 'x', 248 ), NS_MAIN, TitleValue::TITLE_FORM, 'en', new TitleValue( TitleValue::TITLE_FORM, NS_CATEGORY, 'X' . str_repeat( 'x', 247 ) ) ),
			array( str_repeat( 'x', 252 ), NS_MAIN, TitleValue::TITLE_FORM, 'en', 'X' . str_repeat( 'x', 251 ) )
		);
	}
