...
class MediaWikiTitleCodecTest extends MediaWikiTestCase {
	...
	public function provideNormalizeForDisplay() {
		return array(
			...
			array( new TitleValue( TitleValue::UNKNOWN_FORM, NS_MAIN, ' _ Foo __ Bar_ _' ),
				new TitleValue( TitleValue::TITLE_FORM, NS_MAIN, 'Foo Bar' ) ),
		);
	}
	...
	public function provideParseTitle() {
		...
		return array(
			...
			array( 'a b c', NS_MAIN, TitleValue::DBKEY_FORM, 'en',
				new TitleValue( TitleValue::DBKEY_FORM, NS_MAIN, 'A_b_c' ) ),
			array( ' a  b  c ', NS_MAIN, TitleValue::DBKEY_FORM, 'en',
				new TitleValue( TitleValue::DBKEY_FORM, NS_MAIN, 'A_b_c' ) ),
			array( ' _ Foo __ Bar_ _', NS_MAIN, TitleValue::TITLE_FORM, 'en',
				new TitleValue( TitleValue::TITLE_FORM, NS_MAIN, 'Foo Bar' ) ),
