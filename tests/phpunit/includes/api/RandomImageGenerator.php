...
class RandomImageGenerator {
	 ...
	 *
	 * @param Integer $number number of filenames to write
	 ...
	 * @param Integer $x x-coordinate number
	 * @param Integer $y y-coordinate number
	 ...
	 *
	 * @param Integer $number number of pairs
