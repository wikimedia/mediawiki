...
/**
 * Unit tests for the HTMLRadioMatrix
 * @covers HTMLRadioMatrix
 */
class HtmlRadioMatrixTest extends MediaWikiTestCase {
	...
	public function testInstantiationWithMinimumRequiredParameters() {
		new HTMLRadioMatrix( self::$defaultOptions );
	...
	public function testValidateCallsUserDefinedValidationCallback() {
		$called = false;
		$field = new HTMLRadioMatrix( self::$defaultOptions + array(
	...
	public function testValidateRequiresArrayInput() {
		$field = new HTMLRadioMatrix( self::$defaultOptions );
