...
class WatchedItemStoreUnitTest extends MediaWikiTestCase {
	...
	public function getWatchedItemsForUserBadOptionsProvider() {
		return [
			[ [ 'sort' => 'foo' ], 'Bad value for parameter $options[\'sort\']' ],
			[ [ 'filter' => 'foo' ], 'Bad value for parameter $options[\'filter\']' ],
			[
				[ 'from' => new TitleValue( 0, 'SomeDbKey' ), ],
	...
	/**
	 * @dataProvider getWatchedItemsForUserBadOptionsProvider
	 */
	public function testGetWatchedItemsForUser_badOptionThrowsException(
		array $options,
		...
		$this->setExpectedException( 'InvalidArgumentException', $expectedInExceptionMessage );
