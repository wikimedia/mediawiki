...
class BalancerTest extends MediaWikiTestCase {
	...
	protected function setUp() {
		...
		parent::setUp();
		$tags = Sanitizer::getRecognizedTagData( [
			'a', 'address', 'annotation-xml', 'aside', 'button', 'circle',
			'col', 'colgroup', 'desc', 'foreignobject', 'image', 'img',
			'input', 'legend', 'malignmark', 'marquee', 'math', 'mi', 'mglyph',
			'mn', 'mo', 'mrow', 'ms', 'mtext', 'nobr', 'object', 'option',
			'path', 'style', 'svg', 'tbody', 'template', 'tfoot', 'thead',
			# and a few more used in test cases
			'dummy', 'foo', 'potato', 'sarcasm', 'test', 'x'
		] );
		$this->balancer = new Balancer( $tags['htmlelements'], true );
	}
