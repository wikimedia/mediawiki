...
class EditPageTest extends MediaWikiLangTestCase {
	 ...
	 *              * parentRevId: base revision ID for this edit
	...
	protected function assertEdit( $title, $baseText, $user = null, array $edit,
		...
		if ( !isset( $edit['parentRevId'] ) ) {
			$edit['parentRevId'] = $page->getLatest();
		}
		...
		$ep->setParentRevId( $edit['parentRevId'] );
...
';
	...
	public function testAutoMerge( $baseUser, $text, $adamsEdit, $bertasEdit,
		...
		$adamsEdit['parentRevId'] = $baseRevId;
		$bertasEdit['parentRevId'] = $baseRevId;
