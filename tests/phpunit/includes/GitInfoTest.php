...
class GitInfoTest extends MediaWikiTestCase {
	...
	public function testValidJsonData() {
		$dir = __DIR__ . '/../data/gitinfo/testValidJsonData';
		$this->assertFileExists( "${dir}/.mw-git-info.json" );
	...
	public function testMissingJsonData() {
		$dir = __DIR__ . '/../data/gitinfo/testMissingJsonData';
		$this->assertFileNotExists( "${dir}/.mw-git-info.json" );
		$this->assertFileNotExists( "${dir}/.git" );
