...
class GitInfoTest extends MediaWikiTestCase {
	...
	protected $priorCacheDirectory;

	protected function setUp() {
		parent::setUp();
		$this->priorCacheDirectory = $GLOBALS['wgCacheDirectory'];
		$GLOBALS['wgCacheDirectory'] = __DIR__ . '/../data';
	}

	protected function tearDown() {
		$GLOBALS['wgCacheDirectory'] = $this->priorCacheDirectory;
		parent::tearDown();
	}
