...
class MWSessionPHPSessionHandlerTest extends MediaWikiTestCase {
	...
	private function getResetter( &$rProp = null ) {
		...
		$rProp = new ReflectionProperty( 'MWSessionPHPSessionHandler', 'instance' );
		...
		if ( $rProp->getValue() ) {
			...
			$reset[] = new ScopedCallback(
				array( 'MWSessionPHPSessionHandler', 'install' ),
	...
	public function testInstall() {
		...
		MWSessionPHPSessionHandler::install( $manager );
	...
	public function testManagerInstall() {
		$realManager = MWSessionManager::singleton();
