...
class CookieSessionProviderTest extends MediaWikiTestCase {
	...
	public function testBasics() {
		...
		$extendedCookies = array( 'UserID', 'UserName', 'Token' );

		// Can be extended by extensions like CentralAuth
		$this->assertEquals( $extendedCookies, array_intersect( $extendedCookies, \TestingAccessWrapper::newFromObject( $provider )->getExtendedLoginCookies() ), 'List of extended cookies should include the core ones' );
