...
class SessionTest extends MediaWikiTestCase {
	...
	public static function provideMethods() {
		return array(
			...
			array( 'getIdRef', array(), false, true ),
	...
	public function testDataAccess() {
		...
		$backend->data = array( 'foo' => array( 'bar' => 42 ) );
		$session['foo']['bar'] = 43;
		$session['foo']['baz'] = 44;
		$this->assertSame( array( 'foo' => array( 'bar' => 43, 'baz' => 44 ) ), $backend->data );
	}
	...
	public function testSessionWithRequest() {
		...
		$backend = $this->getMock( 'MediaWiki\\Session\\DummySessionBackend', array( 'getSession' ) );
