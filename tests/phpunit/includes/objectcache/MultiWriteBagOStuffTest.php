...
class MultiWriteBagOStuffTest extends MediaWikiTestCase {
	...
	public function testSetImmediate() {
		...
		// Set in tier 1
		$this->assertEquals( $this->cache1->get( $key ), $value, 'Written to tier 1' );
		// Set in tier 2
		$this->assertEquals( $this->cache2->get( $key ), $value, 'Written to tier 2' );
	}
	...
	public function testSetDelayed() {
		...
		$this->assertEquals( $this->cache2->get( $key ), false, 'Not written to tier 2' );
