...
class MemcachedBagOStuffTest extends MediaWikiTestCase {
	...
	public function testKeyNormalization() {
		...
		$this->assertEquals(
			...
			'test:but%20spaces:and%0Anewlines:are_not%21'
		);
		...
		$this->assertEquals(
			...
			'test:!!c1508151ac083c8484748b48e77e3ab4'
		);

		$this->assertEquals(
			$this->cache->makeKey( 'test:!!c1508151ac083c8484748b48e77e3ab4' ),
			'test:test:%21%21c1508151ac083c8484748b48e77e3ab4'
		);
	}
}
