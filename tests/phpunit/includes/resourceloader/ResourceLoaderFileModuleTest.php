...
class ResourceLoaderFileModuleTest extends MediaWikiTestCase {
	private $modules = array(
		'templateModule' => array(
			'templates' => array(
				'templates/template.html', 'templates/templates/template2.html',
			)
		),
	...
	public function providerGetTemplateScript() {
		...
		return array(
			...
			array(
				$moduleHandlebars,
				'mw.template.add("templates/template_awesome.handlebars","wow\n");',
			),
			array(
				$module,
				'mw.template.add("templates/template.html","hello\n");' .
				'mw.template.add("templates/template2.html","goodbye\n");'
			)
		);
	}
