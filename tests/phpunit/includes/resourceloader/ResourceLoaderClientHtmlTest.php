...
class ResourceLoaderClientHtmlTest extends PHPUnit_Framework_TestCase {
	...
	protected static function makeSampleModules() {
		$modules = [
			...
			'test.styles.shouldembed' => [ 'shouldEmbed' => true, 'styles' => '.shouldembed{}' ],
	...
	public static function provideMakeLoad() {
		return [
			...
			[
				...
				'only' => ResourceLoaderModule::TYPE_COMBINED,
				'output' => '<script>(window.RLQ=window.RLQ||[]).push(function(){mw.loader.implement("test.shouldembed@09p30q0",function($,jQuery,require,module){},{"css":[]});mw.loader.load("/w/load.php?debug=false\u0026lang=nl\u0026modules=test\u0026skin=fallback");});</script>',
			],
			[
				'context' => [],
