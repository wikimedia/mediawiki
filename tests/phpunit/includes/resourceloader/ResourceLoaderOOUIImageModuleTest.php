...
class ResourceLoaderOOUIImageModuleTest extends ResourceLoaderTestCase {
	...
	public function testNonDefaultSkin() {
		...
		$this->assertRegExp( '/magnifying-glass-apex/', $styles['all'], 'Generated styles use the non-default image (embed)' );
		$this->assertRegExp( '/fakemonobook/', $styles['all'], 'Generated styles use the non-default image (link)' );

		$styles = $module->getStyles( $this->getResourceLoaderContext() );
		$this->assertRegExp( '/magnifying-glass-mediawiki/', $styles['all'], 'Generated styles use the default image (embed)' );
		$this->assertRegExp( '/vector/', $styles['all'], 'Generated styles use the default image (link)' );
	}
