...
/**
 * @covers \MediaWiki\Specials\Redirects\SpecialMyuploads
 * @group Database
 */
class SpecialMyuploadsTest extends RedirectSpecialPageThatRequiresLoginTestBase {
	...
	public function testRedirectsToSpecialPage(): void {
		...
		$this->assertSame(
			$expectedSpecialPageTarget->getFullUrlForRedirect( [ 'limit' => '12' ] ),
	...
	protected function newSpecialPage() {
		return $this->getServiceContainer()->getSpecialPageFactory()->getPage( 'Myuploads' );
	}
}
