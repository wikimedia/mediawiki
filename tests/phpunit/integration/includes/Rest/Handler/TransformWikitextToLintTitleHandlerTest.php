...
use MediaWiki\Rest\Handler\TransformWikitextToLintTitleHandler;
 ...
 * @group Database
 */
class TransformWikitextToLintTitleHandlerTest extends MediaWikiIntegrationTestCase {
	 ...
	 * @covers \MediaWiki\Rest\Handler\TransformWikitextToLintRevisionHandler::execute
	 */
	public function testRequest(
		...
		$handler = new TransformWikitextToLintTitleHandler(
			$revisionLookup,
			$siteConfig,
			$pageConfigFactory,
			$dataAccess
