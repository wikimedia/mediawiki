...
$PHPUnit_Command_Class = 'PHPUnit_TextUI_Command';
...
class PHPUnitMaintClass extends Maintenance {
	...
	public function __construct() {
		parent::__construct();
		$this->addOption( 'with-phpunitclass', 'Class name of the PHPUnit entry point to use', false, true );
		$this->addOption(
			'debug-tests',
	...
	public function execute() {
		...
		if ( $this->hasOption( 'with-phpunitclass' ) ) {
			global $PHPUnit_Command_Class;
			$PHPUnit_Command_Class = $this->getOption( 'with-phpunitclass' );
...
if ( !class_exists( $PHPUnit_Command_Class ) ) {
