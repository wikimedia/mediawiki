 ...
 */
class CloakingLBFactoryTest extends PHPUnit_Framework_TestCase {
	...
	public function testCloak() {
		/** @var DatabaseDomain $dbDomain */
		$dbDomain = $this->getLBFactoryConf()['localDomain'];
		$prefix = $dbDomain->getTablePrefix();
