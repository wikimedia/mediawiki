...
class LanguageBe_taraskTest extends LanguageClassesTestCase {
	...
	function testCommafy() {
		$this->assertEquals( '1,234,567', self::getLang()->commafy( '1234567' ) );
		$this->assertEquals(    '12,345', self::getLang()->commafy(   '12345' ) );
	}
	/** see bug 23156 & r64981 */
	function testDoesNotCommafyFourDigitsNumber() {
		$this->assertEquals(      '1234', self::getLang()->commafy(    '1234' ) );
	}
