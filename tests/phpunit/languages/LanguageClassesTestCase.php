 ...
 * can retrieve in your test using the self::getLang() method:
 *
 * @par Using the crafted language object:
 * @code
 * function testHasLanguageObject() {
 *   $langObject = self::getLang();
...
abstract class LanguageClassesTestCase extends MediaWikiTestCase {
	...
	*/
	...
	static protected function getLang() {
	...
	protected function setUp() {
		parent::setUp();
		self::$languageObject = Language::factory(
