...
эрдоган банк гарантияләргә гайнетдин аурупалы подкаст шагыйре эстәрлебаш вазыйфаларын
Гатаулла Гыйниятулла Гарифулла эластик гевея согын сокны Колумбия
...
Шри-Ланка Гамбия Кот-д\'Ивуар Галмудуг нерв Туберкулез Маргарита ризыклары сервер
...
'mäqälläre yoldıznamä kombayn ğanieva ğalimov däwalayaçaqlar Ğ. Kamal  kuşnarenko
häläkätendä idaräse rizıq qäderle gölnisa ğazimcanovnı çukotkalarnı sitdiq vuzlarda
...
däwalayaçaqlar şağıyre'
		),
	);
...
эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		// }
		$this->oneConversionToLatin( $this->textPairs[32] );
		...
		$this->assertEquals(
			$this->convertToLatin(
'Нами́бия бер­ничә режиссёр режиссер флера флёра мэн гимнастерка Артем козыреклы
волонтерлар'
			),
'Namibiä berniçä rejissyor rejissyor flyora flyora men gimnastyorka Artyom kozıryoklı
'
		);
		/*
