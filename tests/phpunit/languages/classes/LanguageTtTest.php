...
Dawıtoğlu mäğärif, turizm häm sälamätlek saqlaw
...
aqyeget ir-yeget atel\'ye музее .'
		...
		array(
			'вагон вак гаять таяк гаярь гаяре гаеп гаепләде гаебе гаере чәе бае гәп гүләп
...
яклар-төбәкләр лельвиж янил югары комар чокырча плаксиха укытучылык эльвира кирпеч',
			'vagon waq ğäyät tayaq ğäyär ğäyäre ğäyep ğäyepläde ğäyebe ğäyere çäye bayı gäp güläp
...
täräqqiäwi täräqqiy täräqqie täräqqiä
...
куярга яратабыз. Бүген заман икенче, шуңа күрә иҗади эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		// }
		$this->oneConversionToLatin($this->textPairs[2]);
		/*
 ...
 * kiäwe * riyaw *üendä *uquwı *üä *üe *KLYO *KL'Yo fevğa yevğa fovğa fofovğa çiä
 ...
 * кийәве * рийав *Үендә *укувы *үә *үе *КЛЁ *КЛЬЁ февга евга фовга фофовга чийә
