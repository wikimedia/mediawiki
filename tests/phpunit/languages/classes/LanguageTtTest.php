...
эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		// $this->oneConversionToLatin( $this->textPairs[14] );
		...
		// here and to converter only one word - режиссер, for now
		$this->assertEquals(
'Namibiä berniçä säyäsi rejissyor rejissyor',
			$this->convertToLatin(
'Нами́бия бер­ничә сә­я­си режиссёр режиссер'
			)
		);
		/*
