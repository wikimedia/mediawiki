...
häläkätendä idaräse rizıq qäderle gölnisa ğazimcanovnı çukotkalarnı sitdıyq vuzlarda
...
Lokk indiwid Gabiniä Galliä Gay Kaligula öyrätüwe stroyı rezervı Qahinnär '
		],
		// 34
...
Бәкбау гласные юрист ихтыяҗлары ',
...
Bäkbau glasnıyı yurist ixtıyacları '
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда мәдәният мәдәният Сүрия Сүрия ия ия риваяте вакыйга Гыйрак Нью-Йорк',
			$this->convertToCyrillic(
'Äfğänstanda mädäniät mädäniyät Süriyä Süriä iä iyä riwayäte waqiğa Ğiraq Nyu-York'
			)
		);
		/*
