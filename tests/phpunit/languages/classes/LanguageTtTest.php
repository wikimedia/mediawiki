...
тыйбб круз друз әхлагы әхлагында тибы',
...
tıybb kruz druz äxläğı äxläğında tibı'
		],
		// 34
...
Äfğanstanda waqıyğalar Qazaqstan Qazaq'
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда мәдәният мәдәният Сүрия Сүрия ия ия',
			$this->convertToCyrillic(
'Äfğänstanda mädäniät mädäniyät Süriyä Süriä iä iyä'
			)
		);
		/*
