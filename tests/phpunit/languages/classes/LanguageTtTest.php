...
Унъеллык стенкасы клетчаткага клетчатка Кафка
...
İlyas Çığanaqlar Yaroslav iyün iyül iyünendä iyülendä oktyaberendä
Unyıllıq stenkası kletçatkağa kletçatka Qafqa
stenkasınnan ğibärät gazın berqayçan da çıganakları kodı
Käwciäk Qolmät Küktaw Yultimer Oskar Räfiqov Melwin İogann qaraboday
kombinatı Aqkiräy Lagerka Karmalka Qadi Deviç\'ya Saminovka Sosnovka
...
эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		// }
		$this->oneConversionToLatin($this->textPairs[29]);
