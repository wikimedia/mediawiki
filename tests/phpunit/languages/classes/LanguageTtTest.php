...
vagon waq ğayət tayaq ğəyər ğəyəre ğəyep ğəyepləde ğəyebe ğəyere çəye bayı gəp güləp gɵber goa gɵlbaqça
 ...
 revolütsiələr revolyutsiyalar evolyutsiyağa evolütsiəgə ambitsiəgə ambitsiyağa qawiə rawiə
...
karyer lyugdon kompyuter kommunal' fizika konstruktor buşuyev
 ...
 variant versiə noyaberdən məşəqət ğataullin yagfarovağa yağafarovağa yağfarovağa yagfar
 ...
 [zakaz]zakaz qotoçqıç [ukaz]ukaz ministrlığında yazarğa yomğaqlayaçaq Rusiə
EOD
,
			$this->convertToLatin( <<<'EOD'
...
EOD
		...
		$this->assertEquals( <<<'EOD'
 QUAsı QUa QIYAsı kARAwATlar EVOLyutsİYAğA KİENÜEndə KİENÜendə UQUı UQUIn KamAZ.
 mɵstəqİl YeRE Ye A Yu YEFək
EOD
,
			$this->convertToLatin( <<<'EOD'
...
EOD
 ...
 YUM'YA YUMYA FEYA QIYA QIYASI KİENÜE DƟNYA UQUI QUA
EOD
,
			$this->convertToLatin( <<<'EOD'
 ...
 * bel'yo *belyo *belyo * feye * feyu *feyo * fei * izyan *iz'yan *iz'an *iz'-an *iz-an *izan
 ...
 tigra tigr aktsiz küəm Yolqa YOLka Yo YeRE *baqçə *kiyenüwe *bvg *bv *abv
 *tuğrı *ğu *gɵa *uğrı *uğlan *qıyraq * kompyuter kamennıy kl'uç TYaG yomğaqlayaçaq
