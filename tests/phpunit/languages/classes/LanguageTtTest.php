...
ihtiyacnıñ galereyä galereyäse'
		],
		[
...
'Dirijabl\' (frantsuzça -{dirigeable}- — idärä itelüçe)
...
// i am going to fix them all later.
...
// ıy - i (using both) also was propsed in earlier version of rules:
...
Lyubovqa Preobrajenovqa Ryazanovqa Sokolovqa Strelkovqa Talalayevqa Otradovqa'
		],
		// 30
		[
'клуб гамьле гаме гамь беркайдан да викимәгълүмат мәкалә дәһлига карамзин
...
б. э. к. меңъеллык баварлар утызъеллык бавар франк литваны делегациясе
...
сервис Ростелеком хоккее Тимербулатов дирижёр Газимов гафиятуллин Әүхәдиева
...
lavsan laykra kambiy kambiynıñ poyasta kambie savannalarda korab matdäse töyäw
...
admirallıq Vasiliy qamalış Savin predpriyatie kapitalı Kanaş Nijgar Çabaksar
...
servis Rostelekom xokkeyı Timerbulatov dirijyor Gazimov ğafiyatullin Äwxädieva
Mö\'min Konstantinovqa Qolsäyet Çabaksa Perm\' Barnaul ğafiyatulla'
		],
		// 32
		[
'мәкальләре йолдызнамә комбайн ганиева галимов дәвалаячаклар Г. Камал кушнаренко
һәлакәтендә идарәсе ризык кадерле гөлниса газимҗановны чукоткаларны ситдыйк вузларда
...
häläkätendä idäräse rizıq qäderle gölnisa ğazimcanovnı çukotkalarnı sitdıyq vuzlarda
...
Velasko Kosta Uaskaran Syerra Amazonka Titikaka gummi gummilastik bilbawları Singapur
Şri-Lanka Gambiä Kot-d\'İvuar Galmudug nerv Margarita rizıqları server
...
тыйбб круз друз әхлагы әхлагында тибы славяннар кириллица Перешчепкино Коми Эпикур
...
obyektınıñ Kaluga Kalugastat Balabanovo Belousovo Jukov Yuxnov Babıninskiy
äyye bayyeget mayya sänğät bankı bogdanova kamal qolmämät dautov qärdäş sotsial\'
tıybb kruz druz äxläğı äxläğında tibı slavyannar kirillitsa Pereşçepkino Komi Epikur
Lokk individ Gabiniä Galliä Gay Kaligula öyrätüe stroyı rezervı Qahinnär '
		...
		// i have seen Äfğän but i use here only Äfğan
		// because it should work in both directions
		[
...
Бәкбау гласные юрист ихтыяҗлары Шәрыкле отрядлар Пьетро геноцид Нәкъ мөһаҗирләр Донецк
канцлеры Меркель принцибы транзакция акция функциясе зәгыйфьлеге дисциплинар Аньелли
цифрлы Вице-президент индеец булуына фьючерс мөстәкыйллеген Циклон цементобетон
консертында яшүсмерләр',
...
'entsiklopediä astyazuı entsiklopediäbez muskul follikullar Gubanov Povaryonka motouqçılar
Äfğanstanda waqıyğalar Qazaqstan Qazaq prodrazverstka Kakurinnı Garri Kolburn arxipelağ
ä VI—VIII yözlärdä tönyaq-könçığış Qıtayda N\'yu-York umarta qortları markasında vassalı
xorvatlar Gaiti Kuba Bagamalar Kayman rabfagında Rabfaknı Karl Fuks Petropavel tqr.
Bäkbaw glasnıyı yurist ixtıyacları Şäreqle otryadlar Pyetro genotsid Näq möhäcirlär Donetsk
kantslerı Merkel\' printsibı tranzaktsiä aktsiä funktsiäse zäğiflege distsiplinar Anyelli
tsifrlı Vitse-prezident indeyets buluına fyuçers möstäqillegen Tsiklon tsementobeton
kontsertında yäşüsmerlär'
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда Сүрия Сүрия ия риваяте вакыйга Гыйрак Нью-Йорк идарә
вакыйгалары үзидарәнең хакимияте Ньютон ',
			$this->convertToCyrillic(
'Äfğänstanda mädäniät Süriä iä riwayäte waqiğa Ğiraq Nyu-York idärä
waqiğaları üzidäräneñ xäkimiäte Nyuton '
			)
			// these tests are not needed
			// 'мәдәният мәдәният ия конференция транзакция акция станциясе '
			// 'mädäniyät Süriyä iyä konferensiä tranzaksiä aksiä stansiäse '
		);
		/*
...
эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		$this->assertEquals(
'Namibiä berniçä rejissyor rejissyor flyora flyora men gimnastyorka
Artyom kozıryoklı volontyorlar Tuberkulyoz',
			$this->convertToLatin(
'Нами́бия бер­ничә режиссёр режиссер флера флёра мэн гимнастерка
Артем козыреклы волонтерлар Туберкулез'
			)
		);
		/*
