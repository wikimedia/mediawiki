...
Lokk indiwid Gabiniä Galliä Gay Kaligula öyrätüwe stroyı rezervı Qahinnär '
		...
		[
'энциклопедия астъязуы энциклопедиябез
Әфганстанда вакыйгалар Казакъстан Казакъ
ә VI—VIII йөзләрдә төньяк-көнчыгыш Кытайда',
'entsiklopediä astyazuı entsiklopediäbez
Äfğanstanda waqıyğalar Qazaqstan Qazaq
ä VI—VIII yözlärdä tönyaq-könçığış Qıtayda'
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда мәдәният мәдәният Сүрия Сүрия ия ия риваяте вакыйга Гыйрак',
			$this->convertToCyrillic(
'Äfğänstanda mädäniät mädäniyät Süriyä Süriä iä iyä riwayäte waqiğa Ğiraq'
			)
		);
		/*
