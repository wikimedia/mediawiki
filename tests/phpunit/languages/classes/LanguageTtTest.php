...
цифрлы Вице-президент индеец булуына ',
...
tsifrlı Vitse-prezident indeyets buluına '
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда мәдәният мәдәният Сүрия Сүрия ия ия риваяте вакыйга Гыйрак Нью-Йорк идарә
вакыйгалары конференция үзидарәнең транзакция акция ',
			$this->convertToCyrillic(
'Äfğänstanda mädäniät mädäniyät Süriyä Süriä iä iyä riwayäte waqiğa Ğiraq Nyu-York idärä
waqiğaları konferensiä üzidäräneñ tranzaksiä aksiä '
			)
		);
		/*
