...
karyer l'ugdon kompyuter kommunal' fizika konstruktor buşuyev
 ...
 rizaetdin niyazğa əxmətwəlievağa sadrievqa vergazovqa qorbanovqa soltanğalievqa miñnebaeva
...
EOD
		...
		$this->assertEquals( <<<'EOD'
 QUAsı QUa QIYAsı kARAwATlar EVOL'utsİYAğA KİENÜEndə KİENÜendə UQUı UQUIn KamAZ.
EOD
,
			$this->convertToLatin( <<<'EOD'
