...
концертында яшүсмерләр шәһәр думасы гласные',
...
konsertında yäşüsmerlär şähär duması glasnıyı'
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		// $this->assertEquals(
// 'Әфганстанда мәдәният Сүрия ия риваяте вакыйга Гыйрак Нью-Йорк идарә
