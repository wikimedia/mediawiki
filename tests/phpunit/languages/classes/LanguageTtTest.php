...
taralğan yazulardan berse. Qayber mäğlümätlarğa
...
turındağı mäğlümätlarnı xätergä töşeregez. Granit kisäge dä, börtek tä — fizik cisemnär,
...
'klub ğämle ğäme ğäm berqaydan da wikimäğlümät mäqälä dähliğa karamzin
...
Нәзарәте хакимияттә мәгълүматләр йортсыз сәркатибе провинциаль
...
Näzäräte xakimiättä mäğlümätlär yortsız särkätibe provintsial\'
...
'
	...
	public function testConversionToCyrillic() {
		...
		// but for now tests here are for using of ', see test #33 above,
		// and ' is used in wikipedia, as i see, and since 2000's rules are canceled,
		// 2012's rules do not say about it, let it be used so).
		...
		// kult, kolonial, ultrafiolet, spektakl, Skulptor,
