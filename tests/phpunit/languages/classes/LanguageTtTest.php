...
Qaybıç bol\'şeviklarnıqı brigadası bul\'var yalğızlarnı'
		...
		// 36
		[
'куркума яктылык казан гидротөененнән кошаева налимка танайка урсалинка утчанка ',
'kurkuma yaqtılıq qazan gidrotöyenennän koşayeva nalimka tanayka ursalinka utçanka '
		],
	];
...
Muravyov prizyorı ğazimcanovnı ',
