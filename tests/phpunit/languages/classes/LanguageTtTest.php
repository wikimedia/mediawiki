...
Lyubovqa Preobrajenovqa Ryazanovqa Sokolovqa Strelkovqa Talalayevqa Otradovqa'
		...
		// 30
		array(
'клуб гамьле гаме беркайдан да викимәгълүмат авар мәкалә дәһлига карамзин
...
б. э. к. меңъеллык баварлар утызъеллык бавар франк литваны делегациясе фиркасе
апрель октябрь ноябрь сентябрь гыйнвар югославия актын һамбург дуйсбург шверин
шлезвиг югалтса аугуст мәшгуль га ихтияҗның мәдәнияткә галереясе ядкарьлекләре
югалтмаган шонгауэр кауфман картиналар википедиясенең болгария латвия литва
македония молдавия хорватия мэн канада алфавит',
'klub ğämle ğäme berqaydan da wikimäğlümat avar mäqälä dähliğa karamzin
gdan\'sk wikipediyanı wikipediäse tuğandaş wikisüzlek wikisäfär wiki-proyektlar
gollandiä ğibädätxänäse ğibädät firdäüs gauk tbiğäte qarlar wiki-tekstnı
b. e. q. meyıllıq bavarlar utızyıllıq bavar frank litvanı delegatsiäse firqäse
aprel oktäber noyäber sentäber ğinwar yugoslaviä aktın hamburg duysburg verin
lezvig yuğaltsa awgust mäşğül ga ihtiyacnıñ mädäniätkä galereyäse yädkärlekläre
yuğaltmağan şongawer kawfman kartinalar wikipediseneñ bolgariä latviä litva
makedoniä moldaviä xorvatiä men kanada alfavit'
		),
	);
...
эшләү ысуллары да башка төрле, дибез.' )
	...
	public function testConversionToLatin() {
		...
		// }
		$this->oneConversionToLatin( $this->textPairs[30] );
		...
		$this->assertEquals(
'Namibiä berniçä säyäsi rejissyor rejissyor flyora flyora',
			$this->convertToLatin(
'Нами́бия бер­ничә сә­я­си режиссёр режиссер флера флёра'
			)
		);
		/*
