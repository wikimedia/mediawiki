...
Камалов һектар вилаяте штанганы калибры статьялар миллиметровкасын орудиелар эскадра
генерал-лейтенант',
...
substansiä substansiägä substansiağa gönahqa qolbiläwçelekne kofi Vangari Gor Satyartxi
...
Kamalov hektar wiläyäte ştanganı kalibrı stat\'yalar millimetrovkasın orudielar eskadra
general-leytenant'
		],
// i do not add proper nouns for now, but add them here
// Borisoglebskoye Krutuşka Goluboye qolmämät Krutovka Popovka Koşçak Konstantinovka Säfärğali
// Avnyuga Vaşington Truen Furutaka Kümertaw Auy Billeqılıç Lamyan Çuwalkipka Krasnousol Küzyılğa
// Barskoye Balıqlıkül Stepanovka Mejgorye kuşnarin
	];
...
Muravyov prizyorı ğazimcanovnı vyorstka Fyodor bayrağı posyolok',
...
Муравьев призеры газимҗановны верстка Федор байрағы поселок'
