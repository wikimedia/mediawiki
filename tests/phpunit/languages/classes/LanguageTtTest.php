...
Кагъбә Шәфигый Коръән тәмугка тәмуг франция кулъязма дьаргент Ильич Ульянов
...
интервью сурәт медиа иҗтимагыйлык',
...
Qäğbä Şäfiği Qor\'än tämuğqa tämuğ fransiä qulyazma d\'argent İlyiç Ulyanov
Başqortstan yılyazmalarında rayun mä\'müri Sofya inqıylab periodı täqwimdäge fidaqär
Ananyino yaman dialektları konferentsiä Xristianlıq fil\'m ştatski
intervyu sürät media ictimağilıq'
		],
	];
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals(
'Әфганстанда риваяте Риваятьләрдә Нью-Йорк конференция транзакция акция'
			$this->convertToCyrillic(
'Äfğänstanda riwayäte Riwayätlärdä N\'yu-York konferensiä tranzaksiä aksiä'
			)
		);
