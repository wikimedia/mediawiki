...
çınayaq fiğel ğilfan şiğer şifır şifr şofyor şofer misır latıyf rasix qıyssa ğisyan
...
колониаль әгъза Мөбарәк артъягыннан сәнагате юлязма викториан һәрьяклап хәрабәләре
...
cinäyät yulian gregorian sulyaq personal\' konstitutsiä häläq potentsial\'
...
Башкортстан елъязмаларында раюн мәэмүри Софья инкыйлаб периоды тәкъвимдәге фидакарь
Ананьино яман диалектлары конференция Христианлык фильм штатски
интервью сурәт медиа иҗтимагыйлык шәрехләрне Л.Р. Л. Р. Л Р ЛР комиссариятын',
...
Äfğanstanda waqiğalar Qazaqstan Qazaq prodrazverstka Kakurinnı Garri Kolburn arxipelag
...
Başqortstan yılyazmalarında rayun mä\'müri Sofya inqıylab periodı täqwimdäge fidaqär
...
intervyu sürät media ictimağilıq şärexlärne L.R. L. R. L R LR komissariatın'
	...
	public function testConversionToCyrillic() {
		...
		// only phonetic palatalisation sign according to 2000's resolution. (it is also
		// used in places of morpheme border in words like д'артаньян, and it is used
		// by some people between latin and cyrillic morphemes, for example Windows'та,
		// i use - in that place: Windows-та; and also same with abbreviations:
		// TASSR'nıñ, i would write TASSR-nıñ or TASSRnıñ; also with digits).
...
Bolşevik etnokultur särkätibe qäğäz cinayät İtalyan'
		...
		$this->assertEquals(
'тәнкыйть булуына эләгүе алуы үсүенә мәдәният Сүрия ия иелмичә',
			$this->convertToCyrillic(
'tänqiyt buluwına elägüwe aluwı üsüwenä mädäniyät Süriyä iyä iyelmiçä'
			)
		);
		// erroneus spellings, but i would like converter works appropriately
		// i do not add Al'aska here
		$this->assertEquals(
'Кенъяга көзгыдәй Массачусеттс',
			$this->convertToCyrillic(
'Kenyağa közğedäy Massaçusetts'
			)
		);
		// controversial spellings
		$this->assertEquals(
'Владимир I-нең АКШ-та Красная Поляна-га Сәгъди-нең Ачеһ-тә Ачеһ-тән Ачеһ-кә
Ачеһ-ле Ачеһ-леләр Ачеһ-не Ачеһ Тамиянг-та Мк-Кинли Вирджиния-да ',
			$this->convertToCyrillic(
'Vladimir I\'neñ AQŞ\'ta Krasnaya Polyana\'ğa Säğdi\'neñ Açeh\'tä Açeh\'tän Açeh\'kä
Açeh\'le Açeh\'lelär Açeh\'ne Açeh Tamiang\'ta Mk\'Kinli Virdjiniä\'da'
			)
		);
		/*
...
Artyom kozıryoklı volontyorlar Tuberkulyoz iqtisadi',
// iqtisadie iqtisadiendä
			$this->convertToLatin(
'Нами́бия бер­ничә режиссёр режиссер флера флёра мен мэн гимнастерка
Артем козыреклы волонтерлар Туберкулез икътисадый'
