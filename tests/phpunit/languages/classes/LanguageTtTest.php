...
Hakan Fidan “Ğadälät häm qalqınu” partiäsennän xalıq
...
oçraşuında “Premyer-ministr Hakan Fidannı qabat milli
...
milliard lira külämendä investitsiya ayırılıp quyılaçağın äytte.
...
EOD
		...
		$this->assertEquals( <<<'EOD'
Дирижабль (французча dirigeable — идарә ителүче) - һавадан җиңелрәк булган куәт җайланмасы
...
,
			$this->convertToCyrillic( <<<'EOD'
Dirijabl (frantsuzça -{dirigeable}- — idarä itelüçe) - hawadan ciñelräk bulğan qüät caylanması
...
EOD
		...
		$this->assertEquals( <<<'EOD'
Funktsiä — iñ möhim matematik töşençälärneñ berse, x üzgäreşleseneñ här qimmätenä u üzgäreşleseneñ
...
,
			$this->convertToLatin( <<<'EOD'
Функция — иң мөһим математик төшенчәләрнең берсе, х үзгәрешлесенең һәр кыйммәтенә у үзгәрешлесенең
