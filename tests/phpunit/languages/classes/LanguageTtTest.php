...
küzallana Mark superqullanuçı gigabayt kodirovqalarda kodirovqa kodlı Karmik Koala
azköçle Duglasnıñ Galaktika avtotuqtalışlar fol\'gadan timerçıbıqnı fiziğı bankalarnıñ
vakuum obkladkalı obkladka obkladkaları konstantası şkala effektı korpus Şkalanıñ'
		),
		// 33
		array(
'5енче 5 энче 5-энче Кох Пугачев Агалега округының командиры Дивизия субъекты округында
...
'entsiklopediä astyazuı entsiklopediäbez Äfğänstanda waqıyğalar Qazaqstan Qazaq'
		),
	);
	...
	public function testConversionToCyrillic() {
		...
		// $this->oneConversionToCyrillic( $this->textPairs[33] );
		/*
