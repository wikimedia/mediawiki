...
class LanguageTtTest extends LanguageClassesTestCase {
	...
	public $textPairs = array(
		...
		array(
			'2018нче никях ассимиляция',
			'2018nçe nikax assimilätsiä'
		),
		*/
		array(
			'Төркия
...
гөбер гоа гөлбакча гитара гүл гел үгетләү кабер калеб *кайык каек каенсар каеш
...
[кукмарага]кукмарага цетнер щетка щётка счетка счётка юеш юкә юри юнь юан
...
göber goa gölbaqça gitara gül gel ügetläw qäber qäleb *qayıq qayıq qayınsar qayış
...
[kukmarağa]kukmarağa tsetner şçotka şçotka sçotqa sçotqa yüeş yükä yüri yün yuan
yäräş yäki yäş yäşläre yäşlek yan awır [avatar]avatar revolütsiälär revolyutsiyalar
evolyutsiyağa evolütsiägä ambitsiägä ambitsiyağa qawiä rawiä möxämmädiä avariya
...
враг все взрыв бавлы әнвәр трамвай авыл штутгард вепс карт акт аяу Юнь
...
vrağ vse vzrıw bawlı änwär tramvay awıl ştutğard veps qart akt ayaw Yün
...
Бу битнең латинчасына сылтама тәнкыйть кыйл кыйлган бакый тәрәккыя кыя гагауз
 гагаузча Әхмәтшин Шина нижнекамскшина akhmetshin',
			'[ligası]ligası wasiät wasiäte wasiäwi ğömer
...
Gömbälär — geterotroflar, yağni alarnıñ fotosintez
