...
class LanguageUzTest extends LanguageClassesTestCase {
	...
	public function testConversionToCyrillic() {
		...
		$this->assertEquals( 'нажотсиз Ниҳоятсиз БУТСИ вақтсиз регистрация боцман Корреляция',
			$this->convertToCyrillic( 'najotsiz Nihoyatsiz BUTSI vaqtsiz registratsiya botsman Korrelyatsiya' )
		);
		$this->assertEquals( 'конвейер пойандоз мойупа майонез каратэ ич-эт мусҳаф акцент',
			$this->convertToCyrillic( 'konveyer poyandoz moyupa mayonez karate ich-et mushaf aksent' )
		);
	}
