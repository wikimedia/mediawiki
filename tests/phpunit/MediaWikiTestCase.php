...
abstract class MediaWikiTestCase extends PHPUnit_Framework_TestCase {
	...
	private static function installTestServices(
		...
		if (
			...
			// Rebase issue!!!!!!!
			// TODO FIXME, LBFactoryConf doesn't container any server configuration
			// thus everything that tries to access a db once tis cloaking lb factor is used throws
			// InvalidArgumentException: No server with index '0'.
