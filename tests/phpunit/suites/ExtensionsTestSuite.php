...
class ExtensionsTestSuite extends PHPUnit_Framework_TestSuite {
	public function __construct() {
		...
		$extRegistrationPaths = ExtensionRegistry::getInstance()->getAttribute( 'UnitTestsPaths' );
		...
		// add remaining unit test files from extension registration
		$paths = array_merge( $paths, $extRegistrationPaths );
