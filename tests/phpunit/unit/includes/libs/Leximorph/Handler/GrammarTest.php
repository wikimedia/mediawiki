...
class GrammarTest extends TestCase {
	...
	public static function provideGrammarCases(): Generator {
		...
		yield 'Azerbaijani locative at → atda'           => [ 'az', 'at', 'locative', 'atda' ];
		yield 'Azerbaijani locative ev → evdə'           => [ 'az', 'ev', 'locative', 'evdə' ];
		yield 'Azerbaijani locative qız → qızda'         => [ 'az', 'qız', 'locative', 'qızda' ];
		yield 'Azerbaijani locative gül → güldə'         => [ 'az', 'gül', 'locative', 'güldə' ];
		yield 'Azerbaijani locative dost → dostda'       => [ 'az', 'dost', 'locative', 'dostda' ];
		yield 'Azerbaijani locative dəmir → dəmirdə'     => [ 'az', 'dəmir', 'locative', 'dəmirdə' ];
		yield 'Azerbaijani locative alma → almada'       => [ 'az', 'alma', 'locative', 'almada' ];
		yield 'Azerbaijani locative hücrə → hücrədə'     => [ 'az', 'hücrə', 'locative', 'hücrədə' ];
		yield 'Azerbaijani locative çörək → çörəkdə'     => [ 'az', 'çörək', 'locative', 'çörəkdə' ];
		yield 'Azerbaijani locative kitab → kitabda'     => [ 'az', 'kitab', 'locative', 'kitabda' ];
		yield 'Azerbaijani locative Azərbaycan → Azərbaycanda' => [ 'az', 'Azərbaycan', 'locative', 'Azərbaycanda' ];
		yield 'Azerbaijani locative məktəb → məktəbdə'   => [ 'az', 'məktəb', 'locative', 'məktəbdə' ];
		yield 'Azerbaijani locative şəhər → şəhərdə'     => [ 'az', 'şəhər', 'locative', 'şəhərdə' ];
		yield 'Azerbaijani yerlik at → atda'             => [ 'az', 'at', 'yerlik', 'atda' ];
		yield 'Azerbaijani locative gənclər evi → gənclər evində'                   => [ 'az', 'gənclər evi', 'locative', 'gənclər evində' ];
		yield 'Azerbaijani locative yemək ensiklopediyası → yemək ensiklopediyasında' => [ 'az', 'yemək ensiklopediyası', 'locative', 'yemək ensiklopediyasında' ];
		yield 'Azerbaijani locative Azərbaycan dili → Azərbaycan dilində'           => [ 'az', 'Azərbaycan dili', 'locative', 'Azərbaycan dilində' ];
		yield 'Azerbaijani locative mədəniyyət evi → mədəniyyət evində'             => [ 'az', 'mədəniyyət evi', 'locative', 'mədəniyyət evində' ];
		yield 'Azerbaijani dative at → ata'                => [ 'az', 'at', 'dative', 'ata' ];
		yield 'Azerbaijani dative ev → evə'                => [ 'az', 'ev', 'dative', 'evə' ];
		yield 'Azerbaijani dative qız → qıza'              => [ 'az', 'qız', 'dative', 'qıza' ];
		yield 'Azerbaijani dative gül → gülə'              => [ 'az', 'gül', 'dative', 'gülə' ];
		yield 'Azerbaijani dative alma → almaya'           => [ 'az', 'alma', 'dative', 'almaya' ];
		yield 'Azerbaijani dative hücrə → hücrəyə'        => [ 'az', 'hücrə', 'dative', 'hücrəyə' ];
		yield 'Azerbaijani dative dolu → doluya'           => [ 'az', 'dolu', 'dative', 'doluya' ];
		yield 'Azerbaijani dative gənclər evi → gənclər evinə'                    => [ 'az', 'gənclər evi', 'dative', 'gənclər evinə' ];
		yield 'Azerbaijani dative yemək ensiklopediyası → yemək ensiklopediyasına' => [ 'az', 'yemək ensiklopediyası', 'dative', 'yemək ensiklopediyasına' ];
		yield 'Azerbaijani dative Azərbaycanca Vikipediya → Azərbaycanca Vikipediyaya' => [ 'az', 'Azərbaycanca Vikipediya', 'dative', 'Azərbaycanca Vikipediyaya' ];
		yield 'Azerbaijani ablative at → atdan'             => [ 'az', 'at', 'ablative', 'atdan' ];
		yield 'Azerbaijani ablative ev → evdən'             => [ 'az', 'ev', 'ablative', 'evdən' ];
		yield 'Azerbaijani ablative qız → qızdan'           => [ 'az', 'qız', 'ablative', 'qızdan' ];
		yield 'Azerbaijani ablative gül → güldən'           => [ 'az', 'gül', 'ablative', 'güldən' ];
		yield 'Azerbaijani ablative alma → almadan'         => [ 'az', 'alma', 'ablative', 'almadan' ];
		yield 'Azerbaijani ablative hücrə → hücrədən'       => [ 'az', 'hücrə', 'ablative', 'hücrədən' ];
		yield 'Azerbaijani ablative dolu → doludan'         => [ 'az', 'dolu', 'ablative', 'doludan' ];
		yield 'Azerbaijani ablative gənclər evi → gənclər evindən'                   => [ 'az', 'gənclər evi', 'ablative', 'gənclər evindən' ];
		yield 'Azerbaijani ablative yemək ensiklopediyası → yemək ensiklopediyasından' => [ 'az', 'yemək ensiklopediyası', 'ablative', 'yemək ensiklopediyasından' ];
		yield 'Azerbaijani ablative Azərbaycanca Vikipediya → Azərbaycanca Vikipediyadan' => [ 'az', 'Azərbaycanca Vikipediya', 'ablative', 'Azərbaycanca Vikipediyadan' ];
		yield 'Azerbaijani ablative 0 → 0-dan'             => [ 'az', '0', 'ablative', '0-dan' ];
		yield 'Azerbaijani ablative 1 → 1-dən'             => [ 'az', '1', 'ablative', '1-dən' ];
		yield 'Azerbaijani ablative 2 → 2-dən'             => [ 'az', '2', 'ablative', '2-dən' ];
		yield 'Azerbaijani ablative 3 → 3-dən'             => [ 'az', '3', 'ablative', '3-dən' ];
		yield 'Azerbaijani ablative 4 → 4-dən'             => [ 'az', '4', 'ablative', '4-dən' ];
		yield 'Azerbaijani ablative 5 → 5-dən'             => [ 'az', '5', 'ablative', '5-dən' ];
		yield 'Azerbaijani ablative 6 → 6-dan'             => [ 'az', '6', 'ablative', '6-dan' ];
		yield 'Azerbaijani ablative 7 → 7-dən'             => [ 'az', '7', 'ablative', '7-dən' ];
		yield 'Azerbaijani ablative 8 → 8-dən'             => [ 'az', '8', 'ablative', '8-dən' ];
		yield 'Azerbaijani ablative 9 → 9-dən'             => [ 'az', '9', 'ablative', '9-dən' ];
		yield 'Azerbaijani ablative 10 → 10-dan'            => [ 'az', '10', 'ablative', '10-dan' ];
		yield 'Azerbaijani ablative 20 → 20-dən'            => [ 'az', '20', 'ablative', '20-dən' ];
		yield 'Azerbaijani ablative 30 → 30-dan'            => [ 'az', '30', 'ablative', '30-dan' ];
		yield 'Azerbaijani ablative 40 → 40-dan'            => [ 'az', '40', 'ablative', '40-dan' ];
		yield 'Azerbaijani ablative 50 → 50-dən'            => [ 'az', '50', 'ablative', '50-dən' ];
		yield 'Azerbaijani ablative 60 → 60-dan'            => [ 'az', '60', 'ablative', '60-dan' ];
		yield 'Azerbaijani ablative 100 → 100-dən'          => [ 'az', '100', 'ablative', '100-dən' ];
		yield 'Azerbaijani ablative 500 → 500-dən'          => [ 'az', '500', 'ablative', '500-dən' ];
		yield 'Azerbaijani ablative 1000 → 1000-dən'        => [ 'az', '1000', 'ablative', '1000-dən' ];
		yield 'Azerbaijani ablative 1000000 → 1000000-dən'  => [ 'az', '1000000', 'ablative', '1000000-dən' ];
		yield 'Azerbaijani ablative 1000000000 → 1000000000-dan' => [ 'az', '1000000000', 'ablative', '1000000000-dan' ];
	}
