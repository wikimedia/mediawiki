...
class PluralTest extends TestCase {
	...
	public static function providePluralCases(): Generator {
		...
		yield 'Levantine Arabic Few 0' => [ 'apc', 0, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic One' => [ 'apc', 1, [ 'one', 'two', 'few', 'other' ], 'one' ];
		yield 'Levantine Arabic Two' => [ 'apc', 2, [ 'one', 'two', 'few', 'other' ], 'two' ];
		yield 'Levantine Arabic Few 3' => [ 'apc', 3, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Few 9' => [ 'apc', 9, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Few 10' => [ 'apc', 10, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Other 11' => [ 'apc', 11, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 12' => [ 'apc', 12, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 99' => [ 'apc', 99, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 100' => [ 'apc', 100, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 101' => [ 'apc', 101, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 102' => [ 'apc', 102, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Few 103' => [ 'apc', 103, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Few 104' => [ 'apc', 104, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Few 109' => [ 'apc', 109, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Few 110' => [ 'apc', 110, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Other 111' => [ 'apc', 111, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 112' => [ 'apc', 112, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 9999' => [ 'apc', 9999, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Other 1000' => [ 'apc', 1000, [ 'one', 'two', 'few', 'other' ], 'other' ];
		yield 'Levantine Arabic Few 1003' => [ 'apc', 1003, [ 'one', 'two', 'few', 'other' ], 'few' ];
		yield 'Levantine Arabic Other 1.7' => [ 'apc', 1.7, [ 'one', 'two', 'few', 'other' ], 'other' ];
