...
class TextPassDumperTest extends DumpTestCase {
	...
	function testPlain() {
		...
		$this->validateXmlFileAgainstXsd( $nameFull );
	...
	/*
	 * Test, if the xml generated by setUpStub is valid
	 * against the current export.xsd
	 *
	 * @group large
	 */
	function testStubXml() {
		$fname = $this->setUpStub( /* one iteration is enough */ );
