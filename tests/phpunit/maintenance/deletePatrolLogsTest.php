...
class DeletePatrolLogsTest extends MaintenanceBaseTestCase {
	...
	public function testRunWithAll() {
		$this->setExpectedException( \MWException::class );
		$this->maintenance->loadWithArgv( [ '--sleep', '0', '--delete-all' ] );

		$this->maintenance->execute();
	}

	public function testDryRun() {
		$this->maintenance->loadWithArgv( [ '--sleep', '0', '--dry-run' ] );
	...
	public function testRunWithTimestamp() {
		$this->maintenance->loadWithArgv( [ '--sleep', '0', '--before', '20060123210426' ] );
	...
	public function testRunWithTimestampAndAll() {
		$this->maintenance->loadWithArgv(
			[ '--sleep', '0', '--before', '20060123210426', '--delete-all' ]
		);
