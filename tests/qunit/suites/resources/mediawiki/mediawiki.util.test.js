( function ( mw, $ ) {
	...
	QUnit.test( 'escapeId', 34, function ( assert ) {
		var wgExperimentalHtmlIds = mw.config.get( 'wgExperimentalHtmlIds' );

		mw.config.set( 'wgExperimentalHtmlIds', true );
		$.each( {
			'+': '+',
			'&': '_',
			'=': '=',
		...
		mw.config.set( 'wgExperimentalHtmlIds', wgExperimentalHtmlIds );
	} );
