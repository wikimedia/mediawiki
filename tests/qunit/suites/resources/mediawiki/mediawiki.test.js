...
test( 'mw.loader erroneous indirect dependency', function () {
	expect(3);
	mw.loader.register ([['test.module1', '0'], ['test.module2', '0', ['test.module1']], ['test.module3', '0', ['test.module2']]]);
...
test( 'mw.loader out-of-order implementation', function () {
	expect(9);
	mw.loader.register ([['test.module4', '0'], ['test.module5', '0', ['test.module4']], ['test.module6', '0', ['test.module5']]]);
...
test( 'mw.loader missing dependency', function () {
	expect(13);
	mw.loader.register ([['test.module7', '0'], ['test.module8', '0', ['test.module7']], ['test.module9', '0', ['test.module8']]]);
	...
	strictEqual (mw.loader.getState ('test.module8'), 'error', 'Expected "error" state for test.module8');
	strictEqual (mw.loader.getState ('test.module9'), 'error', 'Expected "error" state for test.module9');
	mw.loader.using (['test.module7'],
		function () { ok (false, "Success fired despite missing dependency"); },
...
test( 'mw.loader real missing dependency', function () {
	...
	mw.loader.register(
		[['test.missing', '0', [], null, 'test'], ['test.missing2', '0', [], null, 'test'],
		 ['test.use_missing', '0', ['test.missing'], null, 'test'], ['test.use_missing2', '0', ['test.missing2'], null, 'test']
		]
	);
