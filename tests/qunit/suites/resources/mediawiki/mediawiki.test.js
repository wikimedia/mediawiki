( function ( mw, $ ) {
	...
	QUnit.test( 'mw.message & mw.messages', 68, function ( assert ) {
		...
		assert.htmlEqual( mw.message( 'multiple-square-brackets-and-ampersand' ).parse(), 'Visit the ' +
			'<a title="Project:Community portal" href="' + mw.util.wikiGetlink( 'Project:Community portal' ) + '">community portal</a>' +
			' &amp; <a title="Project:Help desk" href="' + mw.util.wikiGetlink( 'Project:Help desk' ) + '">help desk</a>', 'Internal links work with parse' );
