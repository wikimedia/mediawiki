...
( function ( mw, $ ) {
	...
	QUnit.asyncTest( 'mw.loader skin-function handling', 4, function ( assert ) {
		mw.loader.register( [
			// [module, version, dependencies, group, source, skip]
			['testSkipped', '1', [], null, 'testloader', function () { return true; }],
			['testNotSkipped', '1', [], null, 'testloader', function () { return false; }],
