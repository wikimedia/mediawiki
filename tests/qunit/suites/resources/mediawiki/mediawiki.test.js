...
QUnit.asyncTest( 'mw.loader.implement( styles={ "url": { media-type: [url, ..] } } )', 4, function ( assert ) {
...
QUnit.test( 'mw.loader.implement( styles={ media-type: text } ) (back-compat)', 2, function ( assert ) {
...
// Backwards compatibility
QUnit.asyncTest( 'mw.loader.implement( styles={ media-type: [url, ..] } ) (back-compat)', 4, function ( assert ) {
