...
( function ( mw, $ ) {
	...
	QUnit.test( 'mw.loader.resolve', function ( assert ) {
		assert.strictEqual( mw.loader.resolve( 'abc', 'any.base.path' ), 'abc' );
		assert.strictEqual( mw.loader.resolve( './abc', 'any.base.path' ), 'any.base.abc' );
		assert.strictEqual( mw.loader.resolve( '../abc', 'any.base.path' ), 'any.abc' );
		assert.strictEqual( mw.loader.resolve( './../abc', 'any.base.path' ), 'any.abc' );
		assert.strictEqual( mw.loader.resolve( '../../abc', 'any.base.path' ), 'abc' );
		assert.strictEqual( mw.loader.resolve( './foo/../abc', 'any.base.path' ), 'any.base.abc' );
