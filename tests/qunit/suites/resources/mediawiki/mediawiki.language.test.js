( function ( mw, $ ) {
	...
	QUnit.test( 'mw.language.commafy test', 9, function ( assert ) {
		...
		assert.equal( mw.language.commafy( 1234.567, '###0.#####' ), '1234.567', 'Pattern with no decimal seperator defined' );
		assert.equal( mw.language.commafy( 123456789.567, '###0.#####' ), '123456789.567', 'Pattern with no decimal seperator defined, bigger decimal part' );
