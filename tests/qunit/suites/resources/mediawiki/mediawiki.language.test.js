( function ( mw, $ ) {
	...
	QUnit.test( 'mw.language.commafy test', function ( assert ) {
		...
		mw.language.setData( 'en', 'keepFourDigitNumbersUngrouped', null );
	...
	QUnit.test( 'mw.language.convertNumber', function ( assert ) {
		...
		mw.language.setData( 'en', 'keepFourDigitNumbersUngrouped', true );
		assert.equal( mw.language.convertNumber( 180 ), '180', 'formatting 3-digit with keepFourDigitNumbersUngrouped' );
		assert.equal( mw.language.convertNumber( 1800 ), '1800', 'formatting 4-digit with keepFourDigitNumbersUngrouped' );
		assert.equal( mw.language.convertNumber( 18000 ), '18.000', 'formatting 5-digit with keepFourDigitNumbersUngrouped' );
	} );
	...
	QUnit.test( 'mw.language.convertNumber - digitTransformTable', function ( assert ) {
		...
		mw.language.setData( 'hi', 'keepFourDigitNumbersUngrouped', null );
