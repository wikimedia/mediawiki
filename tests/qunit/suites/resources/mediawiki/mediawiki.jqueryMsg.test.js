...
QUnit.test( 'Links', 3, function ( assert ) {
	...
	*/
	...
	assert.equal(
		...
		'注册<a href=\"/wiki/Special:ListUsers\">用户</a>',
		'Piped wikilink'
	);
	...
	assert.equal(
		...
		'The following pages contain at least one link to a disambiguation page.\nThey may have to link to a more appropriate page instead.<br>\nA page is treated as a disambiguation page if it uses a template that is linked from <a href="/wiki/MediaWiki:Disambiguationspage">MediaWiki:Disambiguationspage</a>.',
