...
( function( QUnit, sinon, mw, $ ) {
	...
	QUnit.test( 'should set the cookie to expire immediately when expire is undefined', 1, function( assert ) {
		var options;
	...
	QUnit.test( 'should set the cookie to expire immediately when expire is null', 1, function( assert ) {
		var options;
	...
	QUnit.test( 'shouldn\'t set the cookie to expire immediately when expire is 0 and wgCookieExpiration is null', 1, function( assert ) {
		var options;
