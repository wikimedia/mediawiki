( function ( $ ) {
	...
	QUnit.test( 'Confirm properties and attributes set', 3, function ( assert ) {
		var $el, $elA, $elB;
		...
		assert.strictEqual( $el.attr( 'maxlength' ), undefined, 'Pre-set maxlength attribute removed' );
		...
		assert.strictEqual( $el.attr( 'maxlength' ), undefined, 'Different maxlength attribute removed' );
