( function ( $, mw ) {
	...
	QUnit.test( 'Basic planet table: one unsortable column', function ( assert ) {
		...
		assert.equal(
			$cell.children().hasClass( 'headerSortUp' ) || $cell.children().hasClass( 'headerSortDown' ),
			false,
