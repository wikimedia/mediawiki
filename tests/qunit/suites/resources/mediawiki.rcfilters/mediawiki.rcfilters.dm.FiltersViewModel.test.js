( function ( mw, $ ) {
	...
	QUnit.test( 'getParametersToFilters', function ( assert ) {
		...
		assert.deepEqual(
			...
			'One falsey parameter in a group makes the rest of the filters in the group truthy (checkd) in the interface'
		);
		...
		assert.deepEqual(
			...
			'Two falsey parameters in a group makes the rest of the filters in the group truthy (checkd) in the interface'
		);
		...
		assert.deepEqual(
			...
			'All parementers in the same group false is equivalent to none are truthy (checked) in the interface'
		);
		...
		assert.deepEqual(
			...
			'After unchecking 2 of 3 filters via separate updateFilters calls, the third is still checked.'
		);
		...
		assert.deepEqual(
			model.getState(),
			{
				hidefilter1: true, // The text is "show filter 1"
				hidefilter2: true, // The text is "show filter 2"
				hidefilter3: true, // The text is "show filter 3"
				hidefilter4: false, // The text is "show filter 4"
				hidefilter5: false, // The text is "show filter 5"
