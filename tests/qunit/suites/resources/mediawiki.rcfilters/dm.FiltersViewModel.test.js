...
( function ( mw, $ ) {
	var filterDefinition = [ {
		...
		emptyParamRepresentation = {
			...
			// group8__filter13_color: null, // Highlight isn't supported
			// group8__filter14_color: null, // Highlight isn't supported
			// group8__filter15_color: null, // Highlight isn't supported
	...
	QUnit.test( 'Setting up filters', function ( assert ) {
		...
		model.toggleFiltersSelected( {
			...
			group8__filter13: true // filter14?
		} );
		assert.deepEqual(
			model.getSelectedState(),
