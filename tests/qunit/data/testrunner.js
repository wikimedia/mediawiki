...
( function ( $, mw, QUnit, undefined ) {
	...
	/**
	 * Recursively Converts an array of nodes, ignoring everything except elements and text nodes
	 *
	 * @param {jQuery} $nodes jQuery set of nodes to convet
	 *
	 * @return {Array} Array of JSON structures for the element and text nodes
	 */
	 ...
	 *
	 * @param {string} html HTML markup for one or nodes
	 */
