...
test.describe( 'User', function () {
	...
	test.it( 'should be able to create account', function () {
		driver.get( process.env.MW_SERVER + process.env.MW_SCRIPT_PATH + 'Special:CreateAccount' );
	...
	test.it( 'should be able to log in', function () {
		driver.get( process.env.MW_SERVER + process.env.MW_SCRIPT_PATH + 'Special:UserLogin' );
	...
	test.it( 'should be able to change preferences', function () {
		...
		driver.get( process.env.MW_SERVER + process.env.MW_SCRIPT_PATH + 'Special:Preferences' );
