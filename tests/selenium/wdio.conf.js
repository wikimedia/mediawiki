...
exports.config = {
	...
	// ==================
	specs: [
		relPath( './wdio-mediawiki/specs/**/*.js' ),
	...
	// Base for expanding urls passed to browser.url().
	baseUrl: (
	...
	// Hooks
	// =====
	// WebdriverIO provides several hooks. The specified functions are allowed to be
	// asynchronous or return a Promise, which WebdriverIO will await.
	//
	// See also http://webdriver.io/guide/testrunner/configurationfile.html

	/**
	 * Function to be executed after a test case ends.
	 *
	 * - Saves a screenshot if a test failed.
	 *   Code from <https://github.com/webdriverio/webdriverio/issues/269#issuecomment-306342170>
	 *
