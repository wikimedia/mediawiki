...
$messages['he'] = array(
	...
	'mwe-preview_insert' => 'הוספת תצוגה מקדימה',
	...
	'fogg-check_for_fogg' => 'מתבצעת בדיקה אחר Firefogg <blink>...</blink>',
	'fogg-installed' => 'Firefogg מותקן',
	'fogg-for_improved_uplods' => 'להעלאות משופרות:',
	'fogg-please_install' => '<a href="$1">להתקין את Firefogg</a>. עוד <a href="http://commons.wikimedia.org/wiki/Commons:Firefogg">אודות Firefogg</a>',
	'fogg-use_latest_fox' => 'ראשית יש להתקין את <a href="http://www.mozilla.com/en-US/firefox/upgrade.html?from=firefogg">Firefox 3.5</a> (ומעלה). <i>ואז לבקר בדף זה שוב כדי להתקין את ההרחבה <b>Firefogg</b>.</i>',
	...
	'fogg-badtoken' => 'האסימון אינו תקני',
	'fogg-help-sticky' => 'עזרה (לחצו להצמדה)',
	'fogg-cg-preset' => 'ערכה: <strong>$1</strong>',
	'fogg-cg-meta' => 'נתוני מטא עבור קטע הווידאו',
	...
	'mwe-unknown_license' => 'רשיון לא ידוע',
	'mwe-results_from' => 'תוצאות מ־<a href="$1" target="_new" >$2</a>',
	'rsd_config_error' => 'שגיאה בהגדרות אשף הוספת המידה: $1',
	'mwe-upload_a_file' => 'העלאת קובץ חדש',
	'mwe-watch_this_page' => 'מעקב אחר דף זה',
	...
	'mwe-upload-unknown-size' => 'גודל לא ידוע',
	'mwe-cancel-confim' => 'האם אתם בטוחים שברצונכם לבטל?',
	'mwe-successfulupload' => 'ההעלאה הצליחה',
	...
	'mwe-file-exists-duplicate' => 'קובץ זה הוא עותק של הקובץ הבא:',
	...
	'mwe-missing_video_stream' => 'קובץ הווידאו עבור תזרים זה חסר',
	'mwe-play_clip' => 'נגינת הסרטון',
	'mwe-pause_clip' => 'השהיית הסרטון',
	'mwe-volume_control' => 'פקד עוצמת השמע',
	...
	'mwe-current_clip_msg' => 'המשך בנגינת הסרטון',
