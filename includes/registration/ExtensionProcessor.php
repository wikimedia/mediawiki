...
class ExtensionProcessor implements Processor {
	...
	protected function extractExtensionMessagesFiles( $dir, array $info ) {
		if ( isset( $info['ExtensionMessagesFiles'] ) ) {
			$tempExtensionMessagesFiles = $info['ExtensionMessagesFiles'];
			foreach ( $tempExtensionMessagesFiles as &$file ) {
				$file = "$dir/$file";
			}
			$this->globals["wgExtensionMessagesFiles"] += $tempExtensionMessagesFiles;
		}
	}
