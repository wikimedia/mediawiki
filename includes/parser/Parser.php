	...
	function getVariableValue( $index, $frame = false ) {
		...
		switch ( $index ) {
			...
			case 'pageid': // requested via bug 23427
				...
				if( $pageid == 0 ) {
					# 0 is returned when the page doesn't exist yet in the
					# database, which means the user is previewing a page that
					# is being created.
					# Thus we need to set the vary-revision flag because the
					# magic word will have a different value once the page is
					# saved.
