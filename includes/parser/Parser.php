...
class Parser {
	...
	public function doDoubleUnderscore( $text ) {
		...
		$key = 'Ns: ' . $this->mTitle->getNamespace();
		if ( isset( $wgMandatoryCategoryPolicy[$key] ) ) {
			# Set mandatory category policy for this namespace
			$this->mOutput->setCategoryPolicy( $wgMandatoryCategoryPolicy[$key] );
			# Destroy these variables as irrelevant
			...
			if ( isset( $this->mDoubleUnderscores['onlyhiddencat'] ) ) {
				unset( $this->mDoubleUnderscores['onlyhiddencat'] );
			}
