...
interface PPFrame {
	 ...
	 * its ancestor frames.
	 *
	 * @param int $levels The number of parent frames that this affects.
	 * Zero causes only this frame to be affected, and negative values cause
	 * all of the frame's ancestors to be affected.
	 */
