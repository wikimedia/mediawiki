...
interface PPFrame {
	 ...
	 *
	 * Note that this is not a guarantee that an expansion will "properly"
	 * express side effects. Side effects in general should be avoided, as
	 * elements of pages can be parsed in any order, even with this flag
	 * set.
	 *
	 * @see self::isVolatile()
	 * @param bool $flag
