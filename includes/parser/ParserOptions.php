...
class ParserOptions {
	 ...
	 * @return bool
	 */
	public function getAllowUnsafeHtml() {
	 ...
	 * @return bool Current value for allowUnsafeHtml
	 * @since 1.29
	 */
	public function setAllowUnsafeHtml( $x ) {
		return wfSetVar( $this->allowUnsafeHtml, $x );
	}
