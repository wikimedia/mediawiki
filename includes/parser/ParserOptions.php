...
class ParserOptions {
	 ...
	 * but might be the user language if the page is in MediaWiki namespace, is
	 * an interface language, or possibly if the userlang parser option is used,
	 * or if setTargetLanguage is called, then would be that language.
	 *
	 * @since 1.26
	 *
