...
class ParserOutput extends CacheTime {
	 ...
	 *  $key-top-text: Used in multi-line mode for NewPP report. No fallback.
	 *  $key-bottom-text: Used in multi-line mode for NewPP report. No fallback.
	 *
	 * Options are:
	 *  multiline: Enable multiline mode. In multi-line mode, $value must be an
	 *      array. First the -top message is output, then the -value
	 *      message is used for each element in the $value array, and then the
	 ...
	 * @param mixed $value Appropriate for Message::params(), or an array of such.
