...
class ParserOutput extends CacheTime {
	...
	const REPORT_JS_VAR = 'wgPageParseReport';
	...
	public function getLimitReportData() {
		return isset( $this->mJsConfigVars[self::REPORT_JS_VAR] )
			? $this->mJsConfigVars[self::REPORT_JS_VAR]
			: [];
	}
	...
	public function setLimitReportData( $key, $value ) {
		...
		if ( strpos( $key, '-' ) ) {
			...
			$this->mJsConfigVars[self::REPORT_JS_VAR][$ns][$name] = $data;
		} else {
			$this->mJsConfigVars[self::REPORT_JS_VAR][$key] = $data;
		}
	}
