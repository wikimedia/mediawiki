...
class ParserOutput extends CacheTime {
	...
	public function __get( $name ) {
		if ( property_exists( get_called_class(), $name ) ) {
			...
			wfDeprecatedMsg( "ParserOutput::{$name} public read access deprecated", '1.36' );
			return $this->$name;
	...
	public function __set( $name, $value ) {
		if ( property_exists( get_called_class(), $name ) ) {
			// Direct access to a public property, deprecated.
			wfDeprecatedMsg( "ParserOutput::{$name} public write access deprecated", '1.36' );
			$this->$name = $value;
		} else {
			// Dynamic property access, deprecated.
			wfDeprecatedMsg( "ParserOutput::{$name} dynamic property write access deprecated", '1.36' );
			$this->$name = $value;
		}
	}
}
