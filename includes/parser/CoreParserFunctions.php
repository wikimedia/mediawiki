...
class CoreParserFunctions {
	...
	static function pagesincategory( $parser, $name = '', $arg1 = null, $arg2 = null ) {
		...
		if( self::isRaw( $arg1 ) ) {
			//{{pagesincategory:|raw[|typ]}}
			$raw = $arg1;
			$typ = $magicWords->matchStartToEnd( $arg2 );
		} else {
			//{{pagesincategory:[|typ[|raw]]}}
			$typ = $magicWords->matchStartToEnd( $arg1 );
			$raw = $arg2;
		}
		if( !$typ ) { //backward compatibility
			$typ = 'pagesincategory_all';
		}
