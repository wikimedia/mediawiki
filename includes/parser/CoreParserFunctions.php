...
class CoreParserFunctions {
	...
	static function displaytitle( $parser, $text = '' ) {
		...
		$sanitizedTitle = CoreParserFunctions::sanitizeDisplayTitle( $parser->mTitle, $text );
		if( $sanitizedTitle !== '' ){
	...
	/**
	 * Sanitizes display title which will normalise to the canonical title
	 *
	 * @param $realTitle String: title of the page
	 * @param $text String: desired title text
	 * @return String
	 */
	static function sanitizeDisplayTitle( $realTitle, $text = '' ) {
		...
		if( !$wgRestrictDisplayTitle ) {
			...
			if ( $title instanceof Title && $title->getFragment() == '' && $title->equals( $realTitle ) ) {
				return $text;
			}
		}
