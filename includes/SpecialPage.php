...
class SpecialPage {
	 ...
	 *
	 * @since 1.23
	 * @param string|Message $reason [optional] Passed on to UserNotLoggedIn constructor. Strings will
	 *     be used as message keys. If a string is given, the message will also receive a formatted
	 *     login link (generated using the 'loginreqlink' message) as first parameter. If a Message is
	 *     given, it will be passed on verbatim.
	 * @param string|Message $title [optional] Passed on to UserNotLoggedIn constructor. Strings will
	 *     be used as message keys.
