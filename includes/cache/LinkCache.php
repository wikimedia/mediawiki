...
class LinkCache {
	 ...
	 * @return string
	 */
	private function getPrefixedDBKey( LinkTarget $target ) {
		$text = $this->titleFormatter->getPrefixedText( $target );
	...
	public function getGoodLinkFieldObj( LinkTarget $target, $field ) {
		$dbkey = $this->getPrefixedDBKey( $target );
