...
class LinkCache {
	...
	public function getGoodLinkID( $title ) {
		if ( is_string( $title ) ) {
			...
			$title = Title::newFromDBkey( $title )->getTitleValue();
		}
		$key = (string)$title;
	...
	public function isBadLink( $title ) {
		...
		return array_key_exists( (string)$title, $this->mBadLinks );
	}
	...
	public function clearBadLink( $title ) {
		$this->clearBadLinkObj(
			Title::newFromDBkey( $title )->getTitleValue()
		);
	}
