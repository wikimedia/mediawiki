...
class ProcessCacheLRU {
	...
	protected $maxCacheSize; // integer; max entries

	/**
	 * @param $maxSize integer Maximum number of entries allowed
	 */
	...
	public function set( $key, $prop, $value ) {
		if ( count( $this->cache ) >= $this->maxCacheSize ) { // LRU
			reset( $this->cache );
