...
class MessageCache {
	...
	/**
	 * @var bool[] Map of (language code => boolean) for recently purged cache data
	 */
	...
	public function replace( $title, $text ) {
		...
		DeferredUpdates::addCallableUpdate( function () use ( $title, $msg, $code ) {
	 ...
	 * @return string|bool|null The message, or false if it does not exist, or null on error
	 */
	public function getMsgFromNamespace( $title, $code ) {
		...
		if ( $this->mCacheVolatile[$code] ) {
			...
			wfDebugLog( 'MessageCache', __METHOD__ . ": loading volatile key '$titleKey'" );
		} else {
