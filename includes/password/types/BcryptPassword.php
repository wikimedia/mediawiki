...
class BcryptPassword extends ParameterizedPassword {
	...
	function crypt( $password ) {
		...
		// Try to use PHP 5.5 password hashing library first, then try normal crypt().
	...
	function tests() {
		...
		return array(
			...
			array( true, "{$prefix}05$/OK.fbVrR/bpIqNJ5ianF.nqd1wy.pTMdcvrRWxyiGL2eMz.2a85.", "\xff\xff\xa3" ),
			...
			array( true, "{$prefix}05$/OK.fbVrR/bpIqNJ5ianF.ZC1JEJ8Z4gPfpe1JOr/oyPXTWl9EFd.", "\xff\xa334\xff\xff\xff\xa3345" ),
