...
/**
 * A PBKDF2-hashed password (the default in MW as of 1.22)
 *
...
class Pbkdf2Password extends ParameterizedPassword {
	...
	function tests() {
		...
		return array(
			array( true, "$prefix:sha1:1:20:c2FsdA==:DGDID5YfDnHzqbUkr2ASBi/gN6Y=", 'password' ),
			array( true, "$prefix:sha1:2:20:c2FsdA==:6mwBTcctb4zNHtkqzh1B8NjeiVc=", 'password' ),
			array( true, "$prefix:sha1:4096:20:c2FsdA==:SwB5AbdlSJq+rUnZJvch0GWkKcE=", 'password' ),
			array( true, "$prefix:sha1:4096:16:c2EAbHQ=:Vvpqp1VICZ3MN9fwNCXgww==", "pass\x00word" ),
		);
	}
}