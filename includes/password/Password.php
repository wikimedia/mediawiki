...
abstract class Password implements Serializable {
	 ...
	 *
	 * @param array $configs Mapping of type names to configurations
	 * @param string $default Name of default type
	 */
	final public static function init( array $configs, $default ) {
