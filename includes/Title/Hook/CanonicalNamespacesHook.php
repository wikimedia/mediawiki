...
interface CanonicalNamespacesHook {
	 ...
	 * @since 1.35
	 *
	 * @param array<int,string> &$namespaces Array of namespace numbers with corresponding canonical names
...
class_alias( CanonicalNamespacesHook::class, 'MediaWiki\\Hook\\CanonicalNamespacesHook' );
