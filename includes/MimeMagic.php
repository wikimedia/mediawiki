...
class MimeMagic {
	...
	function __construct() {
		...
		wfRunHooks( 'MimeMagicCustomTypes', array( &$this, function ( $extraTypes ) use ( &$types ) {
			$types = $types . "\n" . $extraTypes;
		} ) );
		...
		wfRunHooks( 'MimeMagicCustomInfo', array( &$this, function ( $extraInfo ) use ( &$info ) {
			$info = $info . "\n" . $extraInfo;
		} ) );
	...
	private function doGuessMimeType( $file, $ext ) { // TODO: remove $ext param
		...
		wfRunHooks( 'MimeMagicGuessFromContent', array( &$this, &$head, &$tail, $file, &$mime ) );
