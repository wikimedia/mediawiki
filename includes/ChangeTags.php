...
class ChangeTags {
	 ...
	 * @param[in,out] int|null $rc_id The rc_id of the change to add the tags to.
	 * Pass a variable whose value is null if the rc_id is not relevant or unknown.
	 * @param[in,out] int|null $rev_id The rev_id of the change to add the tags to.
	 * Pass a variable whose value is null if the rev_id is not relevant or unknown.
	 * @param[in,out] int|null $log_id The log_id of the change to add the tags to.
	...
	public static function canAddTagsAccompanyingChange( array $tags,
		...
		if ( $disallowedTags ) {
			return self::restrictedTagError( 'tags-apply-not-allowed',
	...
	public static function canUpdateTags( array $tagsToAdd, array $tagsToRemove,
		...
		if ( $diff ) {
			return self::restrictedTagError( 'tags-update-add-not-allowed',
		...
		if ( $diff ) {
			...
			if ( $intersect ) {
				return self::restrictedTagError( 'tags-update-remove-not-allowed',
