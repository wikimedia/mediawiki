...
class PageArchive {
	 ...
	 *
	 * @deprecated since 1.32, appears unused. In the MCR schema, ar_text_id no longer exists.
	 ...
	 *
	 * @deprecated since 1.32, appears unused. For compatibility with the MCR schema,
	 * calling code should switch to getArchiveRevision().
	 *
	 * @todo remove in 1.33
	 *
