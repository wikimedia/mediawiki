...
class WikiPage implements Page, IDBAccessObject {
	...
	public function getUpdater() {
		...
		global $wgUseAutomaticEditSummaries, $wgUseNPPatrol, $wgUseRCPatrol;
	 ...
	 *
	 * @deprecated since 1.31, use PageUpdater::commitUpdate instead.
	 *
	...
	public function doEditContent(
		...
		if ( $revRec ) {
			// Convert RevisionRecord to old-style Revision object
			$status->value['revision'] = new Revision( $revRec );

			// update cached fields
			// TODO: this is currently redundant to what is done in updateRevisionOn.
			// But updateRevisionOn() should move into PageUpdater, and then this will be needed.
			$this->setLastEdit( $status->value['revision'] ); // TODO: use RevisionRecord
