...
class WikiPage implements Page, IDBAccessObject {
	...
	public function getPageUpdater( User $user ) {
		...
		// with pre-1.31 behavior. Applying the 'autopatrol' right should be done in the same
		// place the 'bot' right is handled, which is currently in EditPage::EditPage::attemptSave.
		if ( $needsPatrol && $this->getTitle()->userCan( 'autopatrol', $user ) ) {
			$pageUpdater->setPatrolled( true );
		}
	 ...
	 *
	 * @deprecated since 1.31, use PageUpdater::createRevision instead.
	 *
	...
	public function doEditContent(
		...
		// TODO: this check is here for backwards-compatibility with pre-1.31 behavior.
	...
	public function prepareContentForEdit(
		...
		if ( !$updater->isUpdatePrepared() ) {
			$updater->prepareRevisionCreation( $user, $slots, [], $useCache );
