...
class WikiPage implements Page, IDBAccessObject {
	...
	public function getUpdater() {
		...
		// FIXME: make sure $this->updater is purged when appropriate!
		if ( !$this->updater ) {
	...
	public function doEditContent(
		...
		// FIXME: deprecate
		// FIXME: convert $summary if needed
		// FIXME: get $user if null

		$updater = $this->getUpdater();

		$status = $updater->setContent( 'main', $content );

		// FIXME: the 'value' field in $status needs to be converted!
	...
	public function prepareContentForEdit(
		...
		// FIXME: deprecate
		// FIXME: convert $revision if not null
		// FIXME: get $user if null

		return $updater->prepareContentForEdit( 'main', $content, $revision, $user, $serialFormat, $useCache );
	}
	...
	public function doEditUpdates( Revision $revision, User $user, array $options = [] ) {
		...
		// FIXME: deprecate
		// FIXME: convert $revision

		return $updater->doEditUpdates( $revision, $user, $options );
	}
