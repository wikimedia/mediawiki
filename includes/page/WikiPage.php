...
class WikiPage implements Page, IDBAccessObject {
	 ...
	 *
	 * @deprecated since 1.31, use exists() instead, or simply omit the EDIT_UPDATE
	...
	public function getPageUpdater( User $user ) {
		global $wgAjaxEditStash, $wgUseAutomaticEditSummaries;
