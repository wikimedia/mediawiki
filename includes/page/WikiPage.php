...
class WikiPage implements Page, IDBAccessObject {
	 ...
	 * and to protected such conflict resolutio nfrom concurrent edits using a check-and-set
	 * mechanism.
	 *
	 * @param User $user
	 *
	...
	public function prepareContentForEdit(
		...
		if ( !$udpater->isUpdatePrepared() ) {
			$udpater->prepareEdit( $user, $slots, [], $useCache );
