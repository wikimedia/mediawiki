...
class WikiPage implements Page, IDBAccessObject {
	 ...
	 * @param array $tags Tags to apply to the rollback
	 *
	...
	public function doRollback(
		$fromP, $summary, $token, $bot, &$resultDetails, User $user, $tags
	) {
		$resultDetails = null;
	 ...
	 * @return array
	 */
	public function commitRollback( $fromP, $summary, $bot, &$resultDetails, User $guser, $tags ) {
