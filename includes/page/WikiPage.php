...
class WikiPage implements Page, IDBAccessObject {
	...
	public static function onArticleCreate( Title $title ) {
		...
		// Add per-category editnotice page_prop
		// So that users don't need to null edit the category page after creating the editnotice
			...
			if ( $category !== '' ) {
				DeferredUpdates::addCallableUpdate( function() use ( $category ) {
					...
					$dbw->insert( 'page_props', array(
						'pp_page' => $categoryTitle->getArticleID(),
