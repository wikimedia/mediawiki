...
class WikiPage implements Page, IDBAccessObject {
	...
	private function newDerivedDataUpdater() {
		...
		$metaDataUpdater = new DerivedPageDataUpdater(
	 ...
	 *
	 * If neither $forRevision nor $forContent is given, a new DerivedPageDataUpdater is always
	 ...
	 * @return DerivedPageDataUpdater
	 */
	public function getDerivedDataUpdater(
		User $forUser = null,
		...
		if ( $this->derivedDataUpdater && !$this->derivedDataUpdater->isPrepared() ) {
	 ...
	 *
	 * @deprecated since 1.31, use getDerivedDataUpdater instead.
	 *
	...
	public static function onArticleCreate( Title $title ) {
		// TODO: move this into DerivedPageDataUpdater, make non-static.
