 ...
 */
class ForeignTitleDumpParser implements TitleParser {
	/**
	 * @var array|null
	 */
	...
	/**
	 * Creates a ForeignTitleValue object based on the <title> and <ns> attributes
	 ...
	 */
	public function parseTitle( $title, $ns ) {
	...
	protected function parseTitleNoNs( $title ) {
		...
		if ( is_null( $this->foreignNamespaces ) ) {
			...
			$ns = ForeignTitleValue::UNKNOWN_NAMESPACE;
		} else {
		...
		return new ForeignTitleValue( $ns, $namespaceName, $pageName );
	}
