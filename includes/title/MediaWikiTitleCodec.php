...
class MediaWikiTitleCodec implements TitleFormatter, TitleParser {
	...
	public function parseTitle( $text, $defaultNamespace ) {
		...
		return new TitleValue( $parts['namespace'], $parts['dbkey'], $parts['fragment'], $parts['interwiki'] );
	}
	...
	public function getPrefixedText( LinkTarget $title ) {
		return $this->formatTitle( $title->getNamespace(), $title->getText(), '', $title->getInterwiki() );
	}
