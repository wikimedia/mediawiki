...
class SubpageImportTitleFactory implements ImportTitleFactory {
	...
	public function __construct( Title $rootPage ) {
		if ( is_null( $rootPage ) ) {
			throw new MWException( 'You can\'t specify a null $rootPage' );
		}
	...
	public function createTitleFromForeignTitle( ForeignTitle $foreignTitle ) {
		return Title::newFromText( $this->getTitleAsString( $foreignTitle ) );
	}
	...
	public function getTitleAsString( ForeignTitle $foreignTitle ) {
		return $this->rootPage->getPrefixedDBkey() . '/' .
