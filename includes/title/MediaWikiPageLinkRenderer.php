...
class MediaWikiPageLinkRenderer implements PageLinkRenderer {
	 ...
	 * @param string $baseUrl (currently unused, pending refactoring of Linker). Defaults to $wgArticlePath.
	 */
	...
	public function getPageUrl( TitleValue $page, $params = array() ) {
		...
		$name = $this->formatter->formatForDatabase( $page, TitleFormatter::INCLUDE_NAMESPACE );
	 ...
	 * @return string
	 */
	public function renderHtmlLink( TitleValue $page, $text ) {
	 ...
	 * @return string
	 */
	public function renderWikitextLink( TitleValue $page, $text ) {
		$name = $this->formatter->formatForDisplay( $page );
