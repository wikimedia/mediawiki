...
class TitleValue {
	 ...
	 * @param $text string The (normalized) page title, without prefix or section (typically the DBKey).
	 *        Note that TitleValue is agnostic about the form of the title used.
	...
	/**
	 * Returns the title text (without prefix or section). This is not guaranteed
	 * to be in any particular form, or even be valid as an actual title. Use
	 * TitleNormalizer for getting the appropriate canonical form of the title.
	 *
	 * @return string
	 */
