...
/**
 * @deprecated This class was temporary added to test transitioning to the
 * JobQueueEventBus and will removed after the transition is completed.
 */
class JobQueueTempMulti extends JobQueue {
	...
	protected function logException( Exception $e ) {
		wfDebugLog( 'JobQueueTempMulti', $e->getMessage() . "\n" . $e->getTraceAsString() );
	}
}
