...
class JobRunner implements LoggerAwareInterface {
	...
	private function executeJob( Job $job, $stats, $popTime ) {
		...
		$rssDelta = $this->getMaxRssKb() - $rssStart;
		...
		$stats->increment( "jobqueue.rss_delta.$jType", $rssDelta );
