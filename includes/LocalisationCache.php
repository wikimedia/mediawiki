...
class LocalisationCache {
	...
	protected function readPluralRules() {
		$CLDRPlural = dirname( __FILE__ ) . "/../languages/data/plurals.xml";
		$MWPlural = dirname( __FILE__ ) . "/../languages/data/plurals-mediawiki.xml";
		# Load CLDR plural rules
		if ( !file_exists( $CLDRPlural ) ) {
			wfDebug( __METHOD__ . "Could not find CLDR Plural rules file : $cldrPlural\n" );
			return;
		}
