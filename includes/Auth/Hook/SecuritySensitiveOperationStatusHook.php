...
interface SecuritySensitiveOperationStatusHook {
	 ...
	 * @param int $timeSinceAuth The time since last reauthentication for this security level.
	 *   PHP_INT_MAX if the time of last auth is unknown, or -1 if authentication is not possible.
