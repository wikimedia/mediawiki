...
interface AuthManagerLoginAuthenticateAuditHook {
	 ...
	 * @param array{appId?:string,performer?:User,securityLevel?:string} $extraData Array with extra
	 ...
	 *   - securityLevel: security level, only if the login was for an elevated-security reauthentication
