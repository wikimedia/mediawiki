...
class Title {
	...
	public function quickUserCan( $action, $user = null ) {
		...
		return TitleSecurity::instance()->quickUserCan( $this, $action, $user );
	}
	...
	public function userCan( $action, $user = null, $rigor = 'secure' ) {
		...
		return TitleSecurity::instance()->userCan( $this, $action, $user, $rigor );
	}
	...
	public function getUserPermissionsErrors(
		...
		return TitleSecurity::instance()->getUserPermissionsErrors(
	...
	public function getRestrictionTypes() {
		return TitleSecurity::instance()->getRestrictionTypes( $this );
	}
	...
	public function getTitleProtection() {
		return TitleSecurity::instance()->getTitleProtection( $this );
	}
	...
	public function deleteTitleProtection() {
		TitleSecurity::instance()->deleteTitleProtection( $this );
	}
	...
	public function isSemiProtected( $action = 'edit' ) {
		return TitleSecurity::instance()->isSemiProtected( $this, $action );
	}
	...
	public function isProtected( $action = '' ) {
		return TitleSecurity::instance()->isProtected( $this, $action );
	}
	...
	public function isNamespaceProtected( User $user ) {
		return TitleSecurity::instance()->isNamespaceProtected( $this, $user );
	}
	...
	public function isCascadeProtected() {
		return TitleSecurity::instance()->isCascadeProtected( $this );
	}
	...
	public function getCascadeProtectionSources( $getPages = true ) {
		return TitleSecurity::instance()->getCascadeProtectionSources( $this, $getPages );
	}
	...
	public function getRestrictions( $action ) {
		return TitleSecurity::instance()->getRestrictions( $this, $action );
	}
	...
	public function getAllRestrictions() {
		return TitleSecurity::instance()->getAllRestrictions( $this );
	}
	...
	public function getRestrictionExpiry( $action ) {
		return TitleSecurity::instance()->getRestrictionExpiry( $this, $action );
	}
	...
	function areRestrictionsCascading() {
		return TitleSecurity::instance()->areRestrictionsCascading( $this );
	}
	...
	public function loadRestrictionsFromRows( $rows, $oldFashionedRestrictions = null ) {
		TitleSecurity::instance()->loadRestrictionsFromRows( $this, $rows, $oldFashionedRestrictions );
	}
	...
	public function loadRestrictions( $oldFashionedRestrictions = null ) {
		TitleSecurity::instance()->loadRestrictions( $this, $oldFashionedRestrictions );
	}
