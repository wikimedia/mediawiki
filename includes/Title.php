...
class Title {
	...
	public function userCan( $action, $user = null, $rigor = 'secure' ) {
		...
		return $this->getTitleSecurity()->userCan( $action, $user, $rigor );
	}
	...
	public function getUserPermissionsErrors(
		...
		return $this->getTitleSecurity()->getUserPermissionsErrors(
			$action, $user, $rigor, $ignoreErrors
		);
	}
	...
	public function getTitleProtection() {
		return $this->getTitleSecurity()->getTitleProtection();
	}
	 ...
	 */
	public function getTitleSecurity() {
