...
class Title {
	...
	public function isValidMoveOperation( &$nt, $auth = true, $reason = '' ) {
		...
		$err = null;
		// Deprecated, won't always be called, use MovePageCheckPermissions or MovePageIsValidMove hooks
		if ( !wfRunHooks( 'AbortMove', array( $this, $nt, $wgUser, &$err, $reason ), '1.25' ) ) {
