...
class Title {
	...
	/** @var TitleSecurity manages protection and restrictions */
	protected $mTitleSecurity;
	// @}
	...
	public function quickUserCan( $action, $user = null ) {
		return $this->getTitleSecurity()->quickUserCan( $this, $action, $user );
	}
	...
	public function userCan( $action, $user = null, $doExpensiveQueries = true ) {
		return $this->getTitleSecurity()->userCan( $this, $action, $user, $doExpensiveQueries );
	}
	...
	public function getUserPermissionsErrors( $action, $user, $doExpensiveQueries = true,
		...
		return $this->getTitleSecurity()->getUserPermissionsErrors(
			$action, $user, $doExpensiveQueries, $ignoreErrors
		);
	}
	...
	public static function getFilteredRestrictionTypes( $exists = true ) {
		return TitleSecurity::getFilteredRestrictionTypes( $exists );
	}
	...
	public function getRestrictionTypes() {
		return $this->getTitleSecurity()->getRestrictionTypes( $this );
	}
	...
	public function deleteTitleProtection() {
		$this->getTitleSecurity()->deleteTitleProtection( $this );
	}
	...
	public function isSemiProtected( $action = 'edit' ) {
		return $this->getTitleSecurity()->isSemiProtected( $this, $action );
	}
	...
	public function isProtected( $action = '' ) {
		return $this->getTitleSecurity()->isProtected( $this, $action );
	}
	...
	public function isNamespaceProtected( User $user ) {
		return $this->getTitleSecurity()->isNamespaceProtected( $this, $user );
	}
	...
	public function isCascadeProtected() {
		return $this->getTitleSecurity()->isCascadeProtected( $this );
	}
	...
	public function areCascadeProtectionSourcesLoaded( $getPages = true ) {
		return $this->getTitleSecurity()->areCascadeProtectionSourcesLoaded( $this, $getPages );
	}
	...
	public function getCascadeProtectionSources( $getPages = true ) {
		return $this->getTitleSecurity()->getCascadeProtectionSources( $this, $getPages );
	}
	...
	public function areRestrictionsLoaded() {
		return $this->getTitleSecurity()->newFromTitle( $this )->areRestrictionsLoaded( $this );
	}
	...
	public function getRestrictions( $action ) {
		return $this->getTitleSecurity()->newFromTitle( $this )->getRestrictions( $this, $action );
	}
	...
	public function getAllRestrictions() {
		return $this->getTitleSecurity()->newFromTitle( $this )->getAllRestrictions( $this );
	}
	...
	public function getRestrictionExpiry( $action ) {
		return $this->getTitleSecurity()->getRestrictionExpiry( $this, $action );
	}
	...
	function areRestrictionsCascading() {
		return $this->getTitleSecurity()->areRestrictionsCascading( $this );
	}
	...
	public function loadRestrictionsFromRows( $rows, $oldFashionedRestrictions = null ) {
		$this->getTitleSecurity()->loadRestrictionsFromRows( $this, $rows, $oldFashionedRestrictions );
	}
	...
	public function loadRestrictions( $oldFashionedRestrictions = null ) {
		$this->getTitleSecurity()->loadRestrictions( $this, $oldFashionedRestrictions );
	}
	...
	public function flushRestrictions() {
		$this->getTitleSecurity()->flushRestrictions( $this );
	}
	...
	public static function purgeExpiredRestrictions() {
		TitleSecurity::purgeExpiredRestrictions();
	}
	...
	public function isValidMoveOperation( &$nt, $auth = true, $reason = '' ) {
		...
		if ( 0 != $newid ) { # Target exists; check for validity
			...
			$tp = $nt->getTitleSecurity()->getTitleProtection();
	...
	/**
	 * Get the protection helper for this Title
	 *
	 * @return TitleSecurity
	 */
	protected function getTitleSecurity() {
		if ( !$this->mTitleSecurity ) {
			$this->mTitleSecurity = TitleSecurity::newFromTitle( $this );
		}
		return $this->mTitleSecurity;
	}
}
