...
class Title {
	...
	public function getPageLanguage() {
		...
		if ( $this->isSpecialPage() ) {
			...
			wfProfileOut( __METHOD__ );
			return $wgLang;
		} else if ( $this->getNamespace() == NS_MEDIAWIKI ) {
	 ...
	 * Parameter $lang(string) is the language code to set the language in
	 *
	 * @since 1.24
	 */
	public function setPageLanguage( $lang ) {
		...
		// Separate the title text and the namespace
		$title = $this->getDBkey();
