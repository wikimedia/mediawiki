...
-->";
	...
	public function getRedirectsHere() {
		$redirs = array();
		$dbr = wfGetDB( DB_SLAVE );
		list($table,$redirect) = $dbr->tableNamesN( 'page', 'redirect' );
		$result = $dbr->query( "SELECT page_title, page_namespace FROM $table JOIN $redirect ON page_id = rd_from WHERE rd_title = "
