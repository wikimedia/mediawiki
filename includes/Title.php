...
class Title implements LinkTarget {
	 ...
	 * page changes
	 *
	 * @deprecated since 1.29, use CdnUpdateController::getDependentResources()
	 *
	...
	/**
	 * @deprecated since 1.27 use getCdnUrls(); from 1.29, use CdnUpdateController::getDependentResources()
	 */
	 ...
	 *
	 * @deprecated since 1.29, use CdnUpdateController::purgeDependentResources()
	 */
