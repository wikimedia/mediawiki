...
class Title {
	...
	public function quickUserCan( $action, $user = null ) {
		...
		return TitleSecurity::get()->quickUserCan( $this, $action, $user );
	}
	...
	public function userCan( $action, $user = null, $rigor = 'secure' ) {
		...
		return TitleSecurity::get()->userCan( $this, $action, $user, $rigor );
	}
	...
	public function getUserPermissionsErrors(
		...
		return TitleSecurity::get()->getUserPermissionsErrors(
			$this, $action, $user, $rigor, $ignoreErrors
		);
	}
	...
	public function getRestrictionTypes() {
		return TitleSecurity::get()->getRestrictionTypes( $this );
	}
	...
	public function getTitleProtection() {
		return TitleSecurity::get()->getTitleProtection( $this );
	}
	...
	public function deleteTitleProtection() {
		TitleSecurity::get()->deleteTitleProtection( $this );
	}
	...
	public function isSemiProtected( $action = 'edit' ) {
		return TitleSecurity::get()->isSemiProtected( $this, $action );
	}
	...
	public function isProtected( $action = '' ) {
		return TitleSecurity::get()->isProtected( $this, $action );
	}
	...
	public function isNamespaceProtected( User $user ) {
		return TitleSecurity::get()->isNamespaceProtected( $this, $user );
	}
	...
	public function isCascadeProtected() {
		return TitleSecurity::get()->isCascadeProtected( $this );
	}
	...
	public function areCascadeProtectionSourcesLoaded( $getPages = true ) {
		return TitleSecurity::get()->areCascadeProtectionSourcesLoaded( $this, $getPages );
	}
	...
	public function getCascadeProtectionSources( $getPages = true ) {
		return TitleSecurity::get()->getCascadeProtectionSources( $this, $getPages );
	}
	...
	public function areRestrictionsLoaded() {
		return TitleSecurity::get()->areRestrictionsLoaded( $this );
	}
	...
	public function getRestrictions( $action ) {
		return TitleSecurity::get()->getRestrictions( $this, $action );
	}
	...
	public function getAllRestrictions() {
		return TitleSecurity::get()->getAllRestrictions( $this );
	}
	...
	public function getRestrictionExpiry( $action ) {
		return TitleSecurity::get()->getRestrictionExpiry( $this, $action );
	}
	...
	function areRestrictionsCascading() {
		return TitleSecurity::get()->areRestrictionsCascading( $this );
	}
	...
	public function loadRestrictionsFromRows( $rows, $oldFashionedRestrictions = null ) {
		TitleSecurity::get()->loadRestrictionsFromRows( $this, $rows, $oldFashionedRestrictions );
	}
	...
	public function loadRestrictions( $oldFashionedRestrictions = null ) {
		TitleSecurity::get()->loadRestrictions( $this, $oldFashionedRestrictions );
	}
	...
	public function flushRestrictions() {
		TitleSecurity::get()->flushRestrictions( $this );
	}
