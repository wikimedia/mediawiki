...
class Title {
	...
	public function getEditNotices( $oldid = 0 ) {
		...
		if ( $editnotice_ns_message->exists() ) {
			$notices[$editnotice_ns] = "<div class=\"mw-editnotice mw-editnotice-namespace mw-$editnotice_ns\">";
			$notices[$editnotice_ns] .= $editnotice_ns_message->parseAsBlock() . '</div>';
		}
		if ( MWNamespace::hasSubpages( $this->getNamespace() ) ) {
			...
			while ( count( $parts ) > 0 ) {
				...
				if ( $editnotice_base_msg->exists() ) {
					$notices[$editnotice_base] = "<div class=\"mw-editnotice mw-editnotice-base mw-$editnotice_base\">";
					$notices[$editnotice_base] .= $editnotice_base_msg->parseAsBlock() . '</div>';
				}
			}
		} else {
			...
			if ( $editnoticeMsg->exists() ) {
				$notices[$editnoticeText] = "<div class=\"mw-editnotice mw-editnotice-page mw-$editnoticeText\">";
				$notices[$editnoticeText] .= $editnoticeMsg->parseAsBlock() . '</div>';
			}
		}
