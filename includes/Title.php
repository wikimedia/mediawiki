...
class Title {
	...
	public function quickUserCan( $action, $user = null ) {
		...
		return $this->getTitleSecurity()->quickUserCan( $action, $user );
	}
	...
	public function userCan( $action, $user = null, $doExpensiveQueries = true ) {
		...
		return $this->getTitleSecurity()->userCan( $action, $user, $doExpensiveQueries );
	}
	...
	public function getRestrictionTypes() {
		return $this->getTitleSecurity()->getRestrictionTypes();
	}
	...
	public function deleteTitleProtection() {
		$this->getTitleSecurity()->deleteTitleProtection();
	}
	...
	public function isSemiProtected( $action = 'edit' ) {
		return $this->getTitleSecurity()->isSemiProtected( $action );
	}
	...
	public function isProtected( $action = '' ) {
		return $this->getTitleSecurity()->isProtected( $action );
	}
	...
	public function isNamespaceProtected( User $user ) {
		return $this->getTitleSecurity()->isNamespaceProtected( $user );
	}
	...
	public function isCascadeProtected() {
		return $this->getTitleSecurity()->isCascadeProtected();
	}
	...
	public function areCascadeProtectionSourcesLoaded( $getPages = true ) {
		return $this->getTitleSecurity()->areCascadeProtectionSourcesLoaded( $getPages );
	}
	...
	public function getCascadeProtectionSources( $getPages = true ) {
		return $this->getTitleSecurity()->getCascadeProtectionSources( $getPages );
	}
	...
	public function areRestrictionsLoaded() {
		return $this->getTitleSecurity()->areRestrictionsLoaded();
	}
	...
	public function getRestrictions( $action ) {
		return $this->getTitleSecurity()->getRestrictions( $action );
	}
	...
	public function getAllRestrictions() {
		return $this->getTitleSecurity()->getAllRestrictions();
	}
	...
	public function getRestrictionExpiry( $action ) {
		return $this->getTitleSecurity()->getRestrictionExpiry( $action );
	}
	...
	function areRestrictionsCascading() {
		return $this->getTitleSecurity()->areRestrictionsCascading();
	}
	...
	public function loadRestrictionsFromRows( $rows, $oldFashionedRestrictions = null ) {
		$this->getTitleSecurity()->loadRestrictionsFromRows( $rows, $oldFashionedRestrictions );
	}
	...
	public function loadRestrictions( $oldFashionedRestrictions = null ) {
		$this->getTitleSecurity()->loadRestrictions( $oldFashionedRestrictions );
	}
	...
	public function flushRestrictions() {
		$this->getTitleSecurity()->flushRestrictions();
	}
