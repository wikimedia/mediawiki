...
class Title implements LinkTarget {
	 ...
	 * @return array|bool True on success, getUserPermissionsErrors()-like array on failure
	 */
	public function moveTo( &$nt, $auth = true, $reason = '', $createRedirect = true, $changeTags = [] ) {
		global $wgUser;
	 ...
	 *     were moved
	 */
	public function moveSubpages( $nt, $auth = true, $reason = '', $createRedirect = true, $changeTags = [] ) {
