...
class Title {
	...
	public function getCascadeProtectionSources( $getPages = true ) {
		...
		if ( $this->getNamespace() == NS_FILE ) {
			$sources = array_merge( $sources, $this->getCascadeProtectionSourcesInternal(
				$getPages,
				$pagerestrictions,
				array( 'imagelinks' ),
				array(
	 ...
	 * @return array Title objects of the pages from which cascading restrictions
	 *        have come, false for none, or true if such restrictions exist but
