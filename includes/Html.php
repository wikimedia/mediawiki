...
class Html {
	...
	public static function expandAttributes( $attribs ) {
		...
		foreach ( $attribs as $key => $value ) {
			...
			// anyway.)
			// Bug 49232: As a special case if the string ends with a backslash
			// we always quote the string to ensure our edittoken's protection
			// against badly written PHP proxies is not broken.
			#
