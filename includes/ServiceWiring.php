...
use MediaWiki\Cdn\NoCdnUpdateController;
...
return [
	...
	'CdnUpdateController' => function( MediaWikiServices $services ) {
		...
		if ( $useSquid ) {
			...
			$cdnCtrl = new CdnController( $squidMaxAge, $squidServers );
		...
		return new NoCdnUpdateController();
	},
