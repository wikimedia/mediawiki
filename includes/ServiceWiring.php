...
return [
	...
	'RevisionStore' => function ( MediaWikiServices $services ) {
		...
		$store = new RevisionStore(
			...
			$services->getMainConfig()->get( 'RevisionStoreMultiSlot' )
		);
	...
	'ContentModelSqlStore' => function ( MediaWikiServices $services ) {
	...
	'SlotRoleSqlStore' => function ( MediaWikiServices $services ) {
		return new NameTableSqlStore(
			$services->getDBLoadBalancer(),
			$services->getMainWANObjectCache(),
			LoggerFactory::getInstance( 'NameTableSqlStore' ),
