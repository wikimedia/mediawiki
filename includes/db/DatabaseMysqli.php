...
class DatabaseMysqli extends DatabaseMysqlBase {
	...
	protected function doQuery( $sql ) {
		...
		if ( $wgLogDBWarnings && $ret !== false ) {
			...
			if ( ( $bufferResults || $ret === true ) && $this->mConn->warning_count ) {
	...
	protected function logMysqlWarnings( $msg ) {
		...
		$warningsToLog = array();
		$ret = $this->mConn->query( 'SHOW WARNINGS' );
	...
	function affectedRows() {
		...
		// This is the value of $this->mConn->affected_rows we got during
		// the most recent doQuery() call. It is not necessarily the same
		// as the current value of that property.
