...
class DatabaseMysqli extends DatabaseMysqlBase {
	...
	protected function mysqlConnect( $realServer ) {
		...
		$port = null;
		// IPv6 of format [::1]:3306 or [fe80::e0ca:7d0d:17d:ef0a]:3306
		$hostnameParts = explode( "]:", $realServer );
		if ( isset( $hostnameParts[1]) ) {
			$port = $hostnameParts[1];
		} else {
			// IPv4 of format 127.0.0.1:3306 or localhost:3306
			$hostnameParts = explode( ":", $realServer );
			if ( isset( $hostnameParts[1]) ) {
				$port = $hostnameParts[1];
			}
