...
class LoadBalancer {
	...
	public function approveMasterChanges( array $options ) {
		...
		$this->forEachOpenMasterConnection( function ( DatabaseBase $conn ) use ( $options ) {
			// Assert that the time to replicate the transaction will be sane.
			// If this fails, then all DB transactions will be rollback back together.
			$time = $conn->pendingWriteQueryDuration();
			$limit = $options['maxWriteDuration'];
	...
	public function commitMasterChanges( $fname = __METHOD__ ) {
		$this->forEachOpenMasterConnection( function ( DatabaseBase $conn, $fname ) {
