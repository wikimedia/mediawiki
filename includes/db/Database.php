...
interface DatabaseType {
	 ...
	 *
	 * @param ResultWrapper|stdClass $res As returned from DatabaseBase::query(), etc.
	 ...
	 *
	 * @param mixed $res A SQL result
	 * @param ResultWrapper|array $row Either MySQL row or ResultWrapper
	 */
...
# ------------------------------------------------------------------------------
	 ...
	 * @return ResultWrapper|bool Result object to feed to fetchObject, fetchRow, ...; or false on failure
	 */
	 ...
	 *
	 * @param bool|ResultWrapper $result
	 * @return bool|ResultWrapper
	 */
