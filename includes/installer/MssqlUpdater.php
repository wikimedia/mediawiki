...
class MssqlUpdater extends DatabaseUpdater {
	...
	protected function getCoreUpdateList() {
		return [
			...
			[ 'addIndex', 'archive', 'ar_usertext_timestamp', 'patch-add-ar_usertext_timestamp-index.sql' ],
			[ 'dropIndex', 'archive', 'usertext_timestamp', 'patch-kill-usertext_timestamp-index.sql' ],
