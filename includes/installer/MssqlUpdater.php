...
class MssqlUpdater extends DatabaseUpdater {
	...
	protected function updateConstraints( $constraintType, $table, $field ) {
		...
		$constraintMap = array(
			...
			'major_mime'     =>
				"($field in('unknown', 'application', 'audio', 'image', 'text', 'video', 'message', 'model', 'multipart'))",
			'media_type'     =>
				"($field in('UNKNOWN', 'BITMAP', 'DRAWING', 'AUDIO', 'VIDEO', 'MULTIMEDIA', 'OFFICE', 'TEXT', 'EXECUTABLE', 'ARCHIVE'))"
		);
