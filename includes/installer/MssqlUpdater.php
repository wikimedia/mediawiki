...
class MssqlUpdater extends DatabaseUpdater {
	...
	protected function getCoreUpdateList() {
		return [
			...
			// scripts were updated in 1.27 due to SQL errors; retaining old updatekeys so that people updating from 1.23->1.25->1.27
			// do not execute these scripts twice even though the updatekeys no longer make sense as they are.
			[ 'updateSchema', 'categorylinks', 'cl_type-category_types-ck', 'patch-categorylinks-constraints.sql' ],
			[ 'updateSchema', 'filearchive', 'fa_major_mime-major_mime-ck', 'patch-filearchive-constraints.sql' ],
			[ 'updateSchema', 'oldimage', 'oi_major_mime-major_mime-ck', 'patch-oldimage-constraints.sql' ],
			[ 'updateSchema', 'image', 'img_major_mime-major_mime-ck', 'patch-image-constraints.sql' ],
			[ 'updateSchema', 'uploadstash', 'us_media_type-media_type-ck', 'patch-uploadstash-constraints.sql' ],
