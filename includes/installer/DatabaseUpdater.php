...
abstract class DatabaseUpdater {
	 ...
	 * @param bool $skipBothIndexExistWarning Whether to warn if both the old and the new indexes exist. [facultative; by default, false]
	 * @param string $sqlPath The path to the SQL change path
	 */
	 ...
	 * @param bool $skipBothIndexExistWarning Whether to warn if both the old and the new indexes exist.
	 * @param string $patch Path to the patch file
	 * @param bool $fullpath Whether to treat $patch path as a relative or not
	 * @return bool False if this was skipped because schema changes are skipped
	 */
