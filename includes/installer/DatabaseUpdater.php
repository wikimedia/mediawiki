...
abstract class DatabaseUpdater {
	...
	public function renameExtensionIndex( $tableName, $oldIndexName, $newIndexName, $sqlPath ) {
		$this->extensionUpdates[] = array( 'renameIndex', $tableName, $oldIndexName, $newIndexName, $sqlPath, true );
	}
	 ...
	 * @return Boolean false if this was skipped because schema changes are skipped
	 */
	protected function renameIndex( $table, $oldIndex, $newIndex, $patch, $fullpath = false ) {
