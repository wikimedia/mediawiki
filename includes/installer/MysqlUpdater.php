...
class MysqlUpdater extends DatabaseUpdater {
	protected function getCoreUpdateList() {
		...
		if ( $dbType === 'mysql' && $this->db->getServerVersion() >= 5.6 ) {
			$SearchIndexAddTable1 = [ 'addTable', 'searchindex_old', 'patch-mysql-5.6-copy-searchindex.sql' ];
			$SearchIndexDrop = [ 'dropTable', 'searchindex' ];
			$SearchIndexAddTable2 = [ 'addTable', 'searchindex', 'patch-mysql-5.6-searchindex.sql' ];
		} else {
