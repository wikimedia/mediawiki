...
class MysqlUpdater extends DatabaseUpdater {
	...
	protected function doUnsignedSyncronisation() {
		$sync = [
			[ 'table' => 'bot_password', 'field' => 'bp_user', 'patch' => '.sql' ],
			[ 'table' => 'change_tag', 'field' => 'ct_log_id', 'patch' => '.sql' ],
			[ 'table' => 'change_tag', 'field' => 'ct_rev_id', 'patch' => '.sql' ],
			[ 'table' => 'page_restrictions', 'field' => 'pr_user', 'patch' => '.sql' ],
			[ 'table' => 'tag_summary', 'field' => 'ts_log_id', 'patch' => '.sql' ],
			[ 'table' => 'tag_summary', 'field' => 'ts_rev_id', 'patch' => '.sql' ],
			[ 'table' => 'user_newtalk', 'field' => 'user_id', 'patch' => 'patch-user-newtalk-userid-unsigned.sql' ],
			[ 'table' => 'user_properties', 'field' => 'up_user', 'patch' => '.sql' ],
		];
