...
class MysqlUpdater extends DatabaseUpdater {
	protected function getCoreUpdateList() {
		return [
			...
			[ 'renameIndex', 'user_newtalk', 'user_id', 'PRIMARY', false, 'patch-user_newtalk-fix-pk.sql' ],
			[ 'renameIndex', 'user_newtalk', 'un_user_id', 'PRIMARY', false, 'patch-user_newtalk-fix-pk2.sql' ],
		];
	}
