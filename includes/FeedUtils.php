...
class FeedUtils {
	...
	public static function applyDiffStyle( $text ) {
		$styles = array(
			...
			'diff-addedline'   => 'background-color: #cfc; color:black; font-size: 88%; border-color: #a3d3ff;',
			'diff-deletedline' => 'background-color: #ffa; color:black; font-size: 88%; border-color: #ffe49c;',
			'diff-context'     => 'background-color: #f9f9f9; color: #333333; font-size: 88%; border-color: #e6e6e6;',
