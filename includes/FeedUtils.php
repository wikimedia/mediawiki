...
class FeedUtils {
	...
	public static function applyDiffStyle( $text ) {
		$styles = array(
			...
			'diff-addedline'   => 'background: #cfc; color:black; font-size: smaller; border-color: #a3d3ff;',
			'diff-deletedline' => 'background: #ffa; color:black; font-size: smaller; border-color: #ffe49c;',
			'diff-context'     => 'background: #f9f9f9; color:#333333; font-size: smaller; border-color: #e6e6e6;',
