...
/**
 * Default login cookie lifetime, in seconds. As with $wgCookieExpiration,
 * setting $wgExtendLoginCookieExpiration to 0 will make login cookies session-
 * only.
 */
$wgExtendedLoginCookieExpiration = $wgCookieExpiration;
