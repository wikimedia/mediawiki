 ...
 *                    PreprocessorHash, which uses plain PHP arrays for temporary
 *                    storage, and PreprocessorDOM, which uses the DOM module for
 *                    temporary storage. PreprocessorDOM generally uses less memory;
 *                    the speed of the two is roughly the same.
 *
 *                    If this parameter is not given, it uses PreprocessorDOM if the
 *                    DOM module is available, otherwise it uses PreprocessorHash.
 *
