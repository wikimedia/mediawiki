 ...
 * fast enough to make it worthwhile. For single data-center setups, this can simply be
 * pointed to a cache in $wgWANObjectCaches that uses a local $wgObjectCaches cache with
 * a relayer of type EventRelayerNull.
 *
 * The options are:
 *   - CACHE_NONE:       Do not cache
 *   - (other):          A string may be used which identifies a cache
