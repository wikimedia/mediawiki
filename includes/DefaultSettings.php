 ...
 * creation allowed). This was designed to prevent anonymous edits from
 * shared infrastructure where bots are run. That way, the bot will not
 * continue to edit if it accidentally got logged-out.
 * @since 1.29
 * @var string[]
 */
$wgSoftBlockRanges = [];
