 ...
 * this feature.  With MySQL, run set $wgProfileToDatabase to true in
 * LocalSettings.php and run maintenance/update.php or otherwise add
 * patch-profiling.sql to your database.
 *
 * To enable profiling, edit StartProfiler.php
 */
