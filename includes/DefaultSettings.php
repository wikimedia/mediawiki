 ...
 *
 * The **key** is the name of the block that the icons will be wrapped in. Depending on skin, the key becomes:
 *
 *  - **Vector** and **Monobook** turn `poweredby` into `f-poweredbyico`
 *  - **Modern** turns `poweredby` into `mw_poweredby`
 *
