 ...
 * ech value, in the reverse of the order (meaning that the first array element will be the default
 * and the others used as fallbacks for browsers which do not understand it).
 *
