 ...
 *
 * When constructing a set of conditions, there are 13 operands available:
 *  - `&` (**AND**):
 ...
 *      promote if user has a confirmed e-mail
 *  - array( APCOND_EDITCOUNT, number of edits ):
 *      promote if user has the same number of edits as the passed parameter
 *  - array( APCOND_AGE, seconds since registration ):
 *      promote if the length of time since the user created his/her account matches the passed parameter
 *  - array( APCOND_AGE_FROM_EDIT, seconds since first edit ):
 *      promote if the length of time since the user made his/her first edit matches the passed parameter
 *  - array( APCOND_INGROUPS, group1, group2, ... ):
 *      promote if the user is a member of each of the passed groups
 *  - array( APCOND_ISIP, ip ):
 *      promote if the user has the passed IP address
 *  - array( APCOND_IPINRANGE, range ):
 *      promote if the user has an IP address in the range of the passed parameter
 *  - array( APCOND_BLOCKED ):
 *      promote if the user is blocked
 *  - array( APCOND_ISBOT ):
 *      promote if the user is a bot
 *
