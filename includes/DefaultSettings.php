 ...
 *
 * The only required option is 'class' or 'uri'. If 'uri' is set instead of 'class',
 * then RecentChange::getEngine() is used to determine the class. All options are passed to the constructor.
 *
 * Common options:
