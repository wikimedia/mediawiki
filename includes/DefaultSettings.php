...
/**
 * Expiry to use for the caching of tag usage statistics (hitcounts)
 * 24 hours by default
 */
 ...
 * 24 hours by default
 */
$wgTagRegistrationCacheDuration = 60*60*24;
...
/**
 * List of custom tags (defined by admins at Special:Tags, stored in valid_tag table)
 * that should be considered 'problem' tags.
 */
$wgProblemCustomTags = array();
