...
$wgResourceLoaderLESSFunctions = array(
	 ...
	 *
	 * The function produces two url() properties: one containing a data URI,
	 * and the other containing the original URI as a fallback. Because calls
	 * to embed() expand to two values, it should not be used in shorthand
	 * properties.
	 *
	 * @par Example:
	 * @code
