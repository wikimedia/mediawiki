 ...
 *
 * Abandoned experiment with HTML5-stlye ID escaping. Normalized IDs a bit
 ...
 * - 'legacy' is old MediaWiki-style encodng, e.g. 啤酒 turns into .E5.95.A4.E9.85.92
 ...
 * a page.
 *
 * The optional second element defines an optional fallback mode, useful for migrations.
 ...
 * set it to [ 'http5' ]. After all, pages get edited, breaking incoming links no matter which
 ...
 * this setting should probably alwats be 'legacy', unless every wiki you link to has converted
 * to 'html5'.
 */
