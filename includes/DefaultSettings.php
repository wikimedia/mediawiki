...
/**
 * Whether to apply IP blocks based on data in potentially untrusted
 * X-Forwarded-For headers to allow blocking people using proxies without
 * needing to block the entire proxy itself.
 */
