...
/**
 * Variable for the AllowJavaUploads setting, for use in LocalSettings.php
...
/**
 * Variable for the MultiContentRevisionSchemaMigrationStage setting, for use in LocalSettings.php
 * @see MainConfigSchema::MultiContentRevisionSchemaMigrationStage
 * @note Do not change manually, generated by maintenance/generateConfigDefaultSettings.php!
 * @var int
 */
$wgMultiContentRevisionSchemaMigrationStage = 768;
...
/**
 * Variable for the WikiFarmSiteDetector setting, for use in LocalSettings.php
