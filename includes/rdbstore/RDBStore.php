 ...
 *
 * Note that cross-DB transactions are not totally atomic. When commit() is called,
...
abstract class RDBStore {
	 ...
	 * A shard is returned for each (shard column, column value) tuple given.
	 ...
	 *
	 * @param $table string Virtual table name
	 * @param $map Array Map of shard key column names to column values
	 * @param $wiki string Wiki ID; defaults to the current wiki
