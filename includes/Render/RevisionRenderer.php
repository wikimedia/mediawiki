...
class RevisionRenderer {
	...
	public function renderRevisionForUser(
		...
		return $this->renderRevisionSlots( $title, $slots, $options, $slotRendering, $revId, true );
	}
	...
	public function processRevisionForUpdate(
		...
		return $this->renderRevisionSlots( $title, $slots, $options, $slotRendering, $revId, false );
	}
	...
	public function renderRevisionSlots(
		...
		if ( $slotRenderingProvider ) {
			return $slotRenderingProvider->getSlotRendering( $this->slot, $generateHtml );
		}
	 ...
	 * @return Rendering
	 */
	private function getSlotRendering(
		Title $title,
		SlotRecord $slot,
		ParserOptions $options,
		$revisionId,
