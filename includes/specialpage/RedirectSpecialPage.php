...
// Old class name deprecated since 1.23
class_alias( 'RedirectSpecialPageToSpecial', 'SpecialRedirectToSpecial' );
...
// Old class name deprecated since 1.23
class_alias( 'RedirectSpecialPageToPage', 'RedirectSpecialArticle' );
