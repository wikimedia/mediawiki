...
abstract class ChangesListSpecialPage extends SpecialPage {
	...
	/**
	 * Return the alias to use for the recentchanges table in database queries.
	 *
	 * @return string|null Null if no alias
	 */
	public function getRecentChangesAlias() {
		return null;
	}
	...
	public function buildMainQueryConds( FormOptions $opts ) {
		...
		$alias = $this->getRecentChangesAlias();
		$alias = ( $alias ? "$alias." : '' );
