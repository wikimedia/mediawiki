...
abstract class ChangesListSpecialPage extends SpecialPage {
	...
	public function execute( $subpage ) {
		...
		if ( !$this->optionsValid ) {
			...
			// HACK but still execute the ChangesList initialization so that RL modules are added (T169835)
			$this->pager->getStartBody();
			$this->pager->getEndBody();
			return;
		}
