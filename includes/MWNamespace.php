...
class MWNamespace {
	 ...
	 * @param int $index Namespace index
	 * @return int
	 * @throws MWException if called on a special 8negative) namespace index
	 */
	 ...
	 * If the given namespace is not a talk namespace, it is itself will be returned.
	 ...
	 * Will return true if the given namespace is itself a (defined) talk namespace.
