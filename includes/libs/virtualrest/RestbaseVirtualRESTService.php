...
class RestbaseVirtualRESTService extends VirtualRESTService {
	 ...
	 *   - forwardCookies : cookies to forward to Restbase/Parsoid (as a Cookie header string) or false (optional)
	 *                       Note: forwardCookies will in the future be a boolean only, signifing request cookies
	 *                       should be forwarded to the service; the current state is due to the way VE handles
