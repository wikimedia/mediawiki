...
class RestbaseVirtualRESTService extends VirtualRESTService {
	/**
	 * The following globals govern the use of Restbase instead of Parsoid:
	 *  $wgParsoidVRSUseRestbase {boolean} whether to use Restbase as a back-end
	 *  $wgRestbaseServer {string} the base URL of the Restbase service (form: http://host:port)
	 * 
	 * Example requests:
	 ...
	 *   - forwardCookies : Cookies to forward to Restbase/Parsoid, or false. (optional)
