...
abstract class VirtualRESTService {
	 ...
	 * must be added back (with the same key) in replaceOutgoing() or replaceIncoming();
	 ...
	 * will be passed through replaceOutgoing() to handle any munging required as normal.
	 *
	 * The incoming URL parameter will be relative to the service mount point.
	 *
