...
abstract class VirtualRESTService {
	 ...
	 * must be added back (with the same key) in digestRequests() or digestResponses();
	 ...
	 * will be passed through digestRequests() to handle any munging required as normal.
	 *
	 * The incoming URL parameter will be relative to the service mount point.
	 *
