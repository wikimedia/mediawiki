...
class ParsoidVirtualRESTService extends VirtualRESTService {
	 ...
	 *   - parsoidForwardCookies : Cookies to forward to Parsoid, or false.
	...
	public function onRequests( array $reqs, Closure $idGeneratorFunc ) {
		...
		foreach ( $reqs as $key => $req ) {
			...
			$req['reqTomeout'] = $this->params['parsoidTimeout'];

			// Forward cookies
			if ( isset( $this->params['parsoidForwardCookies'] ) ) {
				$req['headers']['Cookie'] = $this->params['parsoidForwardCookies'];
			}
