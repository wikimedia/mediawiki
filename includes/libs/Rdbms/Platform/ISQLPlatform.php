...
interface ISQLPlatform {
	 ...
	 * @param string|int|Subquery $caseTrueExpression SQL expression to return when the condition is true
	 * @param string|int|Subquery $caseFalseExpression SQL expression to return when the condition is false
	 * @return string SQL fragment
	 */
