...
class MapCacheLRU {
	...
	/**
	 * @param array $values Key/value map in LRU order (first as "most-recent")
	 * @param int $maxKeys
	 * @return MapCacheLRU
	 * @since 1.30
	 */
	public static function newFromArray( array $values, $maxKeys ) {
		...
		$mapCache->cache = ( count( $values ) > $maxKeys )
			? array_slice( $values, 0, $maxKeys, true )
			: $values;
	...
	/**
	 * @return array Key/value map in LRU order (first as "most-recent")
	 * @since 1.30
	 */
