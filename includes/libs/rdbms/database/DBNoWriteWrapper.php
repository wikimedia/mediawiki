 ...
 * single database setup. Failing on attempts to write to such a connection makes it
...
class DBNoWriteWrapper extends DBConnectionProxy {
	...
	/**
	 * @todo move to a trait, so we don't have to duplicate the code from the Database class.
	 *
	 * @param string $sql
	 * @return bool
	 */
