...
class MySQLMasterPos implements DBMasterPos {
	...
	private $style;
	/** @var string|null Binary Log file base name */
	private $binLog;
	/** @var int[]|null Binary Log file position tuple */
	private $logPos;
	...
	/**
	 * @return int[]|null Tuple of (binlog file number, event position)
	 * @since 1.31
	 */
	...
	/**
	 * @return string|null Name of the binlog file for this position
	 * @since 1.31
	 */
	public function getLogFile() {
		return $this->gtids ? null : "{$this->binLog}.{$this->logPos[0]}";
	}
