...
class WANObjectCache implements IExpiringStore, LoggerAwareInterface {
	...
	final public function getWithSetCallback( $key, $ttl, $callback, array $opts = [] ) {
		...
		// Try the process cache if enabled and the cache callback is not with a cache callback.
		// Process cache use in nested callbacks is not fllly lag-safe with regard to HOLDOFF_TTL.
