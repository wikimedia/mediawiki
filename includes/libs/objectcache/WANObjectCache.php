...
class WANObjectCache implements IExpiringStore, LoggerAwareInterface {
	 ...
	 * ground between using blind TTLs and constant verification. The adaptiveTTL() method can
	 * be used to dynamically adjust this time. The initial time can possibly make use of the
