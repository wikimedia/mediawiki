 ...
 *
 * Usage of cache instances may be wrapped in declareTransactionPresent()
 * and declareTransactionEnding() calls. In between such calls, all of
 ...
 * to both transactional and non-transactional data stores. Also, the
 * declareSnapshotStartTime() method can be used to detect potentially
 * unsafe stale DB reads before writing them to cache.
 *
...
class WANObjectCache {
	 ...
	 *               [Default: WANObjectCache::TSE_NONE seconds]
	 * @return bool Success
	 */
	...
	final public function getWithSetCallback(
		...
		if ( $value !== false && $ttl >= 0 ) {
			...
			$this->set( $key, $value, $ttl, array( 'unsafeTTL' => $lockTSE ) );
		}
