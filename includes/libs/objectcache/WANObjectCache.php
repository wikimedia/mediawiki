...
class WANObjectCache implements IExpiringStore, LoggerAwareInterface {
	 ...
	 *   - b) The $callbackFactory argument expects a callback which takes these arguments:
	 *          - An entitiy ID
	 *          - This WANObjectCache instance
	 *        It should return a callback which renegerates the cache for the entity.
	 *        This is the callback which will be passed directly to getWithSetCallback().
