...
abstract class BagOStuff implements LoggerAwareInterface {
	 ...
	 * (e.g. nothing relies on the TTL), then set the READ_VERIFIED flag should
	 * be set. This lets tiered backends know they can safely upgrade a cached
	 * value to higher tiers using standard TTLs.
	 *
	 * @param string $key
