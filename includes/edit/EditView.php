 ...
 *
 * This class provides an edit box, a summary input / preview and an edit button.
 *
...
abstract class EditView {
	 ...
	 * @param string $action
	 */
	final public function __construct( IContextSource $context, EditFormDataSource $dataSource,
