 ...
 */
class ApiEditController extends EditController {
	...
	final public function importFormData( array $requestArray ) {
		...
		# Rremove trailing whitespace, but don't remove _initial_
		# whitespace from the text boxes. This may be significant formatting.
		$this->data->textbox1 = rtrim( $requestArray['wpTextbox1'] );
		...
		$hookArgs = [ $this->page, $this->user, $this->data, $requestArray ];
		Hooks::run( 'ApiEditController::importFormData', $hookArgs );
	}
