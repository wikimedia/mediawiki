...
abstract class EditController {
	 ...
	 * @param User $user
	 */
	final public function __construct( WikiPage $page, User $user, array $configOptions = [] ) {
		$this->page = $page;
		...
		$this->data = $this->dataWrapper->getData();
	}
	...
	final public function attemptSave( &$resultDetails = false ) {
		...
		Hooks::run( 'EditController::attemptSave:after', [ $this, $status, $resultDetails ] );
