 ...
 */
class WebEditController extends AbstractEditController {
	...
	final public function importFormData( WebRequest $request ) {
		...
		if ( $request->wasPosted() ) {
			...
			$this->data->recreate = $request->getCheck( 'wpRecreate' );
		...
		Hooks::run( 'WebEditController::importFormData', [ $this->page, $this->user, $this->data, $request ] );
	}
