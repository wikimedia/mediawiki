 ...
 * a preview, a diff, a view of the content that tried to be saved in
 * case of conflict. It also provides additional information such as
 * templates used, hidden categories and parser output metadata.
 *
 */
class ExtendedEditView extends BasicEditView {
	...
	public function outputAnonWarning() {
		if ( !$this->dataSource->preview ) {
			...
			$this->output->wrapWikiMsg( "<div id=\"mw-anon-preview-warning\" class=\"warningbox\">\n$1</div>",
				'anonpreviewwarning'
			);
		}
	}
