 ...
 *
 * This class makes permission checks and handles the status returned by EditMediator::attemptSave.
...
abstract class Editor {
	...
	final public function __construct( Article $article, User $user, Title $contextTitle ) {
		$this->facilitator = new WebEditFacilitator( $article->getPage(), $user );
		$this->dataWrapper = $this->facilitator->getDataWrapper(); // shortcut
