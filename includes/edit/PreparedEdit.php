...
class PreparedEdit {
	...
	public function __construct(
		...
		$this->slotParserOutput = $output;

		$this->revid = $revid;
		$this->popts = $popts;

		// Backwards compatibility, remove in 1.32:
		$this->output = $output['main']; // assume that the main slot always exists.
	...
	/**
	 * Returns the parser output for all slots, including inherited slots.
	 *
	 * @return ParserOutput[]
	 */
