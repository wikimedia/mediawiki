...
class OutputPage extends ContextSource {
	 ...
	 * page loads.
	 *
	 * @param Mixed $modules module name (string) or array of module names
	 */
	 ...
	 *
	 * @param Boolean $only whether to output only the body of the article
	 */
	 ...
	 * @see addFeedLink()
	 *
	 * @param Boolean $show true: add default feeds, false: remove all feeds
	 */
	 ...
	 *
	 * @param integer|null $revid an positive integer, or null
	 ...
	 *
	 * @param String $text
	 * @param Boolean $linestart is this the start of a line?
	 * @param Boolean $interface is this text in the user interface language?
	 */
	 ...
	 * @param Title $title Title object
	 * @param Boolean $linestart is this the start of a line?
	 * @param Boolean $tidy whether to use tidy
	 * @param Boolean $interface whether it is an interface message
	 ...
	 * @param String $text
	 * @param Boolean $linestart is this the start of a line?
	 * @param Boolean $interface use interface language ($wgLang instead of
	 ...
	 *
	 * @param Integer $maxage maximum cache time on the Squid, in seconds.
	 */
	 ...
	 * @param Boolean $protected is this a permissions error?
...
" );
	 ...
	 * @param Boolean $includeStyle unused
