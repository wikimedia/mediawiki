...
class OutputPage extends ContextSource {
	...
	/**
	 * Add an array of indicators, with their identifiers as array keys and contents as values.
	 *
	 ...
	 * @since 1.25
	 */
	public function addIndicators( array $indicators ) {
	 ...
	 *
	 * @return array Keys: identifiers, values: contents
	 * @since 1.25
	 */
	...
	public function addParserOutputMetadata( $parserOutput ) {
		...
		$this->addIndicators( $parserOutput->getIndicators() );
