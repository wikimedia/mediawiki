...
class OutputPage extends ContextSource {
	 ...
	 *
	 * Ideally we'd explicitly construct ResourceLoaderClientHtml early on and forward addModules()
	 * calls We can't because disallowUserJs() will affect filters retroactively. And the skin and
	 * extension hooks keep adding modules until very late in the request lifecycle.
	 *
	...
	private function getRlClient() {
		if ( !$this->rlClient ) {
			$rlClient = new ResourceLoaderClientHtml( $this->getRlClientContext() );
