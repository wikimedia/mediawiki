...
TXT;
	 ...
	 * exception that can be used to augement a log message sent to a PSR-3
	 * logger.
	 *
	 * @param Exception $e
	 * @return array
	...
	public static function getLogContext( Exception $e ) {
		return array(
			'exception' => self::getStructuredExceptionData( $e ),
		);
	}

	/**
	 * Get a structured represenation of an Exception.
	 *
