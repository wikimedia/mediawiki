...
class PermissionsError extends ErrorPageError {
	 ...
	 * Special:UserLogin when he is not logged in. See PermissionsError::shouldRedirectLogin.
	 */
	const redirectToLoginPermissions  = [
		'read',
		'edit',
		'createpage',
		'createtalk',
	 ...
	 * redirect the user to Special:UserLogin with a warning message, why he has to login to
