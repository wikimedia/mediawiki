...
class CategoryMembershipChange {
	 ...
	 * @param int $type
	 */
	public function triggerCategoryAddedNotification( Title $categoryTitle, $type ) {
	 ...
	 * @param int $type
	 */
	public function triggerCategoryRemovedNotification( Title $categoryTitle, $type ) {
	...
	private function createRecentChangesEntry( Title $categoryTitle, $addedOrRemoved, $type ) {
		if( $type == self::CATEGORY_INCLUDE_ONLY ) {
			wfDebugLog( 'addshore', 'createRecentChangesEntry ' . $categoryTitle->getPrefixedText() . ' ' . $addedOrRemoved . ' CATEGORY_INCLUDE_ONLY' );
		}
		if( $type == self::CATEGORY_NO_INCLUDE ) {
			wfDebugLog( 'addshore', 'createRecentChangesEntry ' . $categoryTitle->getPrefixedText() . ' ' . $addedOrRemoved . ' CATEGORY_NO_INCLUDE' );
		}
		if( $type == self::CATEGORY_NORMAL ) {
			wfDebugLog( 'addshore', 'createRecentChangesEntry ' . $categoryTitle->getPrefixedText() . ' ' . $addedOrRemoved . ' CATEGORY_NORMAL' );
		}
	 ...
	 * or CategoryMembershipChange::CATEGORY_NO_INCLUDE or CategoryMembershipChange::CATEGORY_INCLUDE_ONLY
	 *
	 * @return string
	 */
