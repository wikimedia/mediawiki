...
class EnhancedChangesList extends ChangesList {
	...
	protected function getLineData( array $block, RCCacheEntry $rcObj, array $queryParams = [] ) {
		...
		$lineParams['attribs'] = Xml::expandAttributes( $attribs );
	...
	protected function recentChangesBlockLine( $rcObj ) {
		...
		$data['attribs'] = array_merge( [ 'class' => $classes ], $this->getDataAttributes( $rcObj ) );
		...
		$line = Html::openElement( 'table', $data['attribs'] ) . Html::openElement( 'tr' );
