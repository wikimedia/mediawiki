...
abstract class ReverseChronologicalPager extends IndexPager {
	 ...
	 * @param int $year Year up to which we want revisions. If not set or invalid, current year is used.
	 * @param int $month Month up to which we want revisions. If not set or invalid, end of year is used.
	 * @param int $day Day up to which we want revisions. If not set or invalid, end of month is used.
