...
class PageProps {
	 ...
	 *
	 * @param int $pageId page ID of page being queried
	 * @param array $properties mapping property name to property value
	 * @param ParserOutput $parserOutput reference to parser output for
	...
	public static function setProperties( $pageId, $properties,
		...
		foreach ( $properties as $propertyName => $propertyValue ) {
			...
			$parserOutput->setProperty( $propertyName, $propertyValue );
		}
	...
	public static function setProperty( $pageId, $propertyName,
		...
		self::setProperties( $pageId, $properties, $parserOutput );
