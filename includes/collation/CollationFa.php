...
/**
 * Workaround for incorrect collation of Persian language ('fa') in ICU (bug T139110).
 *
 * 'ا' and 'و' should not be considered the same letter for the purposes of collation in Persian. We work around this by replacing 'W' and 'w' with 'ᴡ' U+1D21 'LATIN LETTER SMALL
 * CAPITAL W' for sortkey generation, which is collated like 'W' and is not tailored to have the
 * same primary weight as 'ء' in Persian.
 *
 * @since 1.28
 */
