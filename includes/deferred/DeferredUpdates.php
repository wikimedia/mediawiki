...
class DeferredUpdates {
	 ...
	 * @param integer $mode DeferredUpdates constant (PRESEND or POSTSEND) (since 1.27)
	 */
	public static function addUpdate( DeferrableUpdate $update, $mode = self::POSTSEND ) {
	 ...
	 * @param integer $mode DeferredUpdates constant (PRESEND or POSTSEND) (since 1.27)
	 */
	public static function addCallableUpdate( $callable, $mode = self::POSTSEND ) {
		self::addUpdate( new MWCallableUpdate( $callable ), $mode );
	}
