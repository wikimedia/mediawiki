...
class LinksUpdate extends SqlDataUpdate {
	...
	/** @var Revision Revision ID for which this update has been triggered */
	public $mRevision;
	...
	protected function doIncrementalUpdate() {
		...
		if ( $wgRCWatchCategoryMembership && $this->mRevision && !$this->mTriggeredRecursive &&
				( $categoryInserts || $categoryDeletes ) ) {
			try {
