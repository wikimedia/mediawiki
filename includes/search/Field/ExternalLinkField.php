...
/**
 * Search index field for external links
 *
 ...
 * @since 1.28
 */
class ExternalLinkField implements ParserOutputDataSearchField {
	...
	public function getData( ParserOutput $parserOutput ) {
		return array_fieldNames( $parserOutput->getExternalLinks() );
	}
