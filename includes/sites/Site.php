...
interface Site extends \IORMRow {
	 ...
	 */
	const GROUP_NONE = -1;
	const GROUP_WIKIPEDIA = 0;
	const GROUP_WIKTIONARY = 1;
	const GROUP_WIKIBOOKS = 2;
	const GROUP_WIKIQUOTE = 3;
	const GROUP_WIKISOURCE = 4;
	const GROUP_WIKIVERSITY = 5;
	const GROUP_WIKINEWS = 6;
	...
	/**
	 * Returns the type of the site (ie Site::TYPE_MEDIAWIKI).
	 *
	 * @since 1.20
	 *
	 * @return integer
	...
	/**
	 * Returns the type of the site (ie Site::GROUP_WIKIPEDIA).
	 *
	 * @since 1.20
	 *
	 * @return integer
