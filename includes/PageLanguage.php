...
class PageLanguage {
	 ...
	 * @param string/null $langNew Language code for the language to be set as page language(null for default wiki
	 *   language)
	 * @param User $user object User making the change
	 * @param string/null $defLang Default language for the wiki
	 *
	 * @return Status object
	 */
	public static function changeLanguage( Title $title, $langNew, $user, $defLang ) {
