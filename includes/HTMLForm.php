...
class HTMLForm extends ContextSource {
	 ...
	 */
	function trySubmit() {
		if ( $this->mThrottle !== null && $this->mThrottle->increment() ) {
			$lang = $this->getLanguage();
			$ts = $this->mThrottle->getCurrentExpiry()->getTimestamp();
			return array( 'actionthrottledtext-expiry', $lang->userTimeAndDate( $ts, $this->getUser() ) );
		}
	 ...
	 * @return HTMLForm $this for chaining calls
	 */
	public function setThrottle( Throttle $throttle, $resetOnSuccess ) {
