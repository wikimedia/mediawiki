...
abstract class File {
	...
	*/
	...
	/**
	 * Get the path of the transcodes directory, or a particular file if $suffix is specified
	 *
	 * @param $suffix bool|string if not false, the name of a media file
	 *
	 * @return string
	 */
	function getTranscodesPath( $suffix = false ) {
		return $this->getZonePath( 'transcodes', $suffix );
	}
	...
	/**
	 * Get the URL of the transcodes directory, or a particular file if $suffix is specified
	 *
	 * @param $suffix bool|string if not false, the name of a media file
	 *
	 * @return string path
	 */
	function getTranscodesUrl( $suffix = false ) {
		return $this->getZoneUrl( 'transcodes', $suffix );
	}
