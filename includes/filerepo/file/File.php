...
abstract class File {
	...
	*/
	...
	/**
	 * Get the path of the transcode directory, or a particular file if $suffix is specified
	 *
	 * @param $suffix bool|string if not false, the name of a media file
	 *
	 * @return string
	 */
	function gettranscodePath( $suffix = false ) {
		return $this->getZonePath( 'transcode', $suffix );
	}
	...
	/**
	 * Get the URL of the transcode directory, or a particular file if $suffix is specified
	 *
	 * @param $suffix bool|string if not false, the name of a media file
	 *
	 * @return string path
	 */
	function gettranscodeUrl( $suffix = false ) {
		return $this->getZoneUrl( 'transcode', $suffix );
	}
