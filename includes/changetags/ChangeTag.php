...
class ChangeTag {
	...
	/**
	 * @var bool Whether to check existence of the tag
	 */
	 ...
	 * @since 1.28
	 */
	public function __construct( $tag, ChangeTagsContext $context, $checkExistence = true ) {
		$this->name = $tag;
	...
	public function canActivate( User $user = null ) {
		...
		if ( $this->checkExistence && !$this->exists() ) {
