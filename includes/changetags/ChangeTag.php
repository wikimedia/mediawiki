...
class ChangeTag {
	 ...
	 * @since 1.28
	 */
	public function __construct( $tag, IChangeTagsContextSource $context ) {
		$this->name = $tag;
	 ...
	 * you don't care (e.g. permissions already checked, or maintenance scripts)
	 * @param bool $checkExistence Set to false if tag is already known to exist
	 * @return Status
	 * @since 1.28
	 */
	public function canActivate( User $user = null, $checkExistence = true ) {
	 ...
	 * @since 1.28
	 */
	public function canDeactivate( User $user = null, $checkExistence = true ) {
	 ...
	 * @since 1.28
	 */
	public function canDelete( User $user = null, $checkExistence = true ) {
