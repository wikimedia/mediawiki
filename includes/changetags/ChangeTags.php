...
class ChangeTags {
	 ...
	 * @since 1.28
	 */
	public static function logTagUpdateAction( $tagsAdded, $tagsRemoved, $initialTags,
		$rev_id, $log_id, $reason, User $user ) {
	 ...
	 * @since 1.25
	 */
	public static function logTagManagementAction( $action, $tag, $reason,
	...
	/**
	 * @deprecated since 1.28, use ChangeTagsContext::canAddTagsAccompanyingChange
	 * @since 1.25
	 */
	public static function canAddTagsAccompanyingChange( array $tags,
		...
		return $changeTagsContext->canAddTagsAccompanyingChange( $tags, $user, $lang );
	}
