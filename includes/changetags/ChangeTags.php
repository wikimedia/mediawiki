...
class ChangeTags {
	...
	/**
	 * Gets accurate hitcount for a given tag
	 * Does not account for replica lag
	 *
	 * @param string $tag
	 * @since 1.29
	 */
	public static function getAccurateHitcount( $tag ) {
	...
	/**
	 * Gets estimated hitcount for a given tag
	 *
	 * @param string $tag
	 * @since 1.29
	 */
	public static function getEstimatedHitcount( $tag ) {
		$fname = __METHOD__;
		...
		return ChangeTagsCache::getHitcountFromCache( $tag, $callBack );
	}
