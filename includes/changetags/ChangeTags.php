...
class ChangeTags {
	 ...
	 * an example.
	 *
	 * Extensions should not use this function. Call ChangeTags::updateTags()
	 * instead, unless directly handling a user request to add or remove tags
	 * from an existing revision or log entry.
	 *
