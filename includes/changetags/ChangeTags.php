...
class ChangeTags {
	 ...
	 * @todo Move this to ChangeTagsUpdate
	 */
	public static function addTags( $tags, $rc_id = null, $rev_id = null,
		$log_id = null, $params = null
	) {
		$result = ChangeTagsUpdater::updateTags( $tags, null, $rc_id, $rev_id, $log_id, $params );
	...
	public static function canAddTagsAccompanyingChange( array $tags,
		...
		$manager = new ChangeTagsUpdater( $changeTagsContext, $lang );
		if ( $user !== null ) {
			$manager->setPerformer( $user );
		}
