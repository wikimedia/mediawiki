...
class ComplexNamespaceInputWidget extends \OOUI\Widget {
	 ...
	 * @param array $config['invert'] Configuration for the "invert selection" CheckboxInputWidget. If
	 *     null, the checkbox will not be generated.
	 * @param array $config['associated'] Configuration for the "include associated namespace"
	...
	public function __construct( array $config = array() ) {
		...
		$this->namespace = new \MediaWiki\Widget\NamespaceInputWidget( $config['namespace'] );
