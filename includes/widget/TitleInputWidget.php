...
class TitleInputWidget extends \OOUI\TextInputWidget {
	 ...
	 * @param bool|null $config['highlightFirst'] Automatically highlight the first result (default: true)
	 * @param bool|null $config['flagEmpty'] Flag empty value (default: true)
	 */
	public function __construct( array $config = array() ) {
		...
		if ( isset( $config['flagEmpty'] ) ) {
			$this->flagEmpty = $config['flagEmpty'];
		}
