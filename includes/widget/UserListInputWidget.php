...
class UserListInputWidget extends \OOUI\Widget {
	...
	public function __construct( array $config = array() ) {
		...
		if ( $config['groupinput'] !== null ) {
			...
			$this->groupinputLabel = $userinputWidgetItems[] = new \OOUI\FieldLayout(
				$this->groupinput,
		...
		if ( $userinputWidgetItems ) {
			$this->userinputWidget = new \OOUI\HorizontalLayout( array(
				'items' => array(
					$this->userinputLabel,
					$this->groupinputLabel,
				),
			) );
		}
