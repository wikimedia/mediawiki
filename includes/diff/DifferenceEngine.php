...
class DifferenceEngine extends ContextSource {
	 ...
	 * @param int|string $new Revision id or string 'next' or string 'prev', e.g. from URL parameter
	 *     'diff'
	 * @return array Array of two revision ids, older first, later second.
	 *     Zero signifies invalid argument passed.
	 *     false signifies that there is no previous/next revision ($old is the oldest/newest one).
	 */
	public static function mapDiffPrevNext( $old, $new ) {
		if ( $new === 'prev' ) {
	...
	private function loadRevisionIds() {
		...
		list( $this->mNewid, $this->mOldid ) = self::mapDiffPrevNext( $old, $new );
