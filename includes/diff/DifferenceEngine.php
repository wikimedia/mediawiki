...
class DifferenceEngine extends ContextSource {
	...
	public function showDiffPage( $diffOnly = false ) {
		...
		if ( $this->mOldRev === false ) {
			...
			// Allow extensions to change the $oldHeader variable
			Hooks::run( 'DifferenceEngineOldHeader', [ $this, &$oldHeader, $prevlink, $oldminor, $diffOnly, $ldel, $this->unhide ] );
		...
		Hooks::run( 'DifferenceEngineNewHeader', [ $this, &$newHeader, $formattedRevisionTools, $nextlink, $rollback, $newminor, $diffOnly, $rdel, $this->unhide ] );
	...
	protected function markPatrolledLink() {
		if ( $this->mMarkPatrolledLink === null ) {
			...
			if ( !$linkInfo ) {
				...
				Hooks::run( 'DifferenceEngineMarkPatrolledLink', [ $this, &$this->mMarkPatrolledLink, $linkInfo['rcid'], $linkInfo['token'] ] );
			}
		}
