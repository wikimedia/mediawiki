...
class DifferenceEngine extends ContextSource {
	...
	protected function markPatrolledLink() {
		global $wgUseRCPatrol, $wgUseTagPatrol, $wgIgnoredTagsList, $wgEnableAPI, $wgEnableWriteAPI;
		$user = $this->getUser();
		...
		if ( $this->mMarkPatrolledLink === null ) {
			...
			if (
				...
				( $wgUseRCPatrol || ( $wgUseTagPatrol && array_diff( $this->mNewTags, $wgIgnoredTagsList ) ) &&
