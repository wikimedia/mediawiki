...
class DifferenceEngine extends ContextSource {
	 ...
	 *
	 * FIXME: Omitting the default module shouldn't be possible (implemented to
	 * allow MobileFrontend to use it's own spinner without loading a second library
	 * (jquery.spinner) to achieve the same thing).
	 *
