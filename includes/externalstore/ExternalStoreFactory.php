...
class ExternalStoreFactory implements LoggerAwareInterface {
	...
	public function getStoreObject( $proto, array $params = [] ) {
		...
		$params['writableLocations'] = []; // locations still receiving writes
	 ...
	 * @return array
	 */
	private static function splitStoreUrl( $storeUrl ) {
		return explode( '://', $storeUrl, 2 );
	}
}
