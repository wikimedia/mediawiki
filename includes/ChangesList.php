...
class EnhancedChangesList extends ChangesList {
	...
	public function beginRecentChangesList() {
		...
		$this->lastdate = '';
		$this->rclistOpen = false;
		$this->getOutput()->addModuleStyles( 'mediawiki.special.changeslist', 'mediawiki.special.changeslist.enhanced' );
		$this->getOutput()->addModules( 'mediawiki.special.changeslist.enhanced' );
		return '';
	}
	/**
