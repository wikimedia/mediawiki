...
class Status {
	 ...
	 *
	 * @param bool|string $shortContext a short enclosing context message name, to
	 *        be used when there is a single error
	 * @param bool|string $longContext a long enclosing context message name, for a list
	 * @return String
	 */
