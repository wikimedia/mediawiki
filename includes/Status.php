...
class Status {
	...
	public static function newGood( $value = null ) {
		return new self( new StatusValue( $value ) );
	}
	...
	public function getErrorsArray() {
		return $this->sv->getStatusArray( "error" );
	}
	...
	public function getWarningsArray() {
		return $this->sv->getStatusArray( "warning" );
	}
	...
	function __get( $name ) {
		return $this->sv->$name; // b/c
	}

	function __set( $name, $value ) {
		$this->sv->$name = $value; // b/c
	}
