...
class TextContentHandler extends ContentHandler {
	...
	protected function fillParserOutput(
		...
		$this->collectMetadata(
			$content, $cpoParams, $output, $textModelsToParse, $parserFactory,
	...
	protected function collectMetadata(
		...
		if ( in_array( $content->getModel(), $textModelsToParse ) ) {
			// Parse just to get links etc into the database, no HTML is added;
			// HTML is generated by the caller.
			$parserFactory->getInstance()->parse(
				$content->getText(),
				$cpoParams->getPage(),
				$parserOptions,
				true,
