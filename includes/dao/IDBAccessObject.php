 ...
 * data is either (a) on a slave an up-to-date or (b) no yet there, but on the master/quorum.
 * Because the data is append-only, it never be stale on a slave if present.
 *
