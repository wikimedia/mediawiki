 ...
 *
 * @todo: more info on shard key, what it is, why we still keep it, ...
 *
 * This class can be easily extended (as DataModelSample.php does) for a
 * specific implementation, like DataModelSample.
 *
...
*/ );
	 ...
	 * @return DataModel
	 */
	public function toObject( ResultWrapper $row ) {
	 ...
	 * @return DataModel
	 */
	public static function loadFromRow( ResultWrapper $row ) {
		$entry = new static;
