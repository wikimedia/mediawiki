 ...
 *
 * This requires the AzureSDK extension in order to work. Information on how to
 * install and set up this extension are all located at
 * http://www.mediawiki.org/wiki/Extension:AzureSDK.
 *
 * @ingroup FileBackend
 * @since 1.21
 */
class AzureFileBackend extends FileBackendStore {
	...
	protected function doCreateInternal( array $params ) {
		...
		try {
			...
			$this->_blobProxy->createBlockBlob( $dstCont, $dstRel, (string)$params['content'], $options );
		} catch ( ServiceException $e ) {
			switch ( $e->getCode() ) {
				case 404:
