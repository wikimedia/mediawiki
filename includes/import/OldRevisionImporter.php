...
/**
 * @access private DO NOT construct these directly.
 * Get a WikiRevisionOldRevisionImporter instance from MediaWikiService instead.
 */
class OldRevisionImporter implements WikiRevisionOldRevisionImporter {
	...
	public function import( WikiRevisionOldRevision $wikiRevision, $doUpdates = true ) {
