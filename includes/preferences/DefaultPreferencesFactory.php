 ...
 *
 * Note that the public visibility of most of the methods in this class is only temporary while
 * the old Preferences class is being removed, and will change to 'protected' after that happens.
 */
class DefaultPreferencesFactory implements PreferencesFactory {
	...
	public function profilePreferences(
		...
		if ( $this->config->get( 'SecureLogin' )
			&& wfCanIPUseHTTPS( $context->getRequest()->getIP() )
		) {
	 ...
	 * @param array &$defaultPreferences
	 */
	public function renderingPreferences( MessageLocalizer $l10n, &$defaultPreferences ) {
		# # Diffs ####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function editingPreferences( User $user, MessageLocalizer $l10n, &$defaultPreferences ) {
		# # Editing #####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function rcPreferences( User $user, MessageLocalizer $l10n, &$defaultPreferences ) {
	 ...
	 * @param array &$defaultPreferences
	 */
	public function searchPreferences( &$defaultPreferences ) {
	 ...
	 */
	public function generateSkinOptions( User $user, IContextSource $context ) {
		$ret = [];
	 ...
	 * @return array
	 */
	public function getImageSizes( MessageLocalizer $l10n ) {
		$ret = [];
	 ...
	 * @return array
	 */
	public function getThumbSizes( MessageLocalizer $l10n ) {
		$ret = [];
		$pixels = $l10n->msg( 'unit-pixel' )->text();
