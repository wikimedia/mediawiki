...
class DefaultPreferencesFactory implements PreferencesFactory {
	 ...
	 * @return array|string
	 */
	public function getOptionFromUser( $name, $info, User $user ) {
	 ...
	 * @return void
	 */
	public function skinPreferences( User $user, IContextSource $context, &$defaultPreferences ) {
		# # Skin #####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function filesPreferences( IContextSource $context, &$defaultPreferences ) {
		# # Files #####################################
