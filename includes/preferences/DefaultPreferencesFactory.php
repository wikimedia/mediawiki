...
class DefaultPreferencesFactory implements PreferencesFactory {
	...
	public function __construct(
		Language $contLang, AuthManager $authManager, LinkRenderer $linkRenderer
	) {
	...
	protected function getSaveFilters() {
		return [
			...
			'rclimit' => [ $this, 'filterIntval' ],
			'wllimit' => [ $this, 'filterIntval' ],
			'searchlimit' => [ $this, 'filterIntval' ],
		];
	}
	...
	public function getFormDescriptor( User $user, IContextSource $context ) {
		...
		$this->filesPreferences( $user, $context, $preferences );
		...
		$this->searchPreferences( $user, $context, $preferences );
		$this->miscPreferences( $user, $context, $preferences );
	 ...
	 * @return array|null
	 */
	public function loadPreferenceValues(
	 ...
	 * @return array|string
	 */
	public function getOptionFromUser( $name, $info, $user ) {
	...
	public function profilePreferences(
		...
		$defaultPreferences['nickname'] = [
			...
			'validation-callback' => [ $this, 'validateSignature' ],
			'section' => 'personal/signature',
			'filter-callback' => [ $this, 'cleanSignature' ],
		];
	 ...
	 * @return void
	 */
	public function skinPreferences( $user, IContextSource $context, &$defaultPreferences ) {
		# # Skin #####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function filesPreferences( $user, IContextSource $context, &$defaultPreferences ) {
		# # Files #####################################
	 ...
	 * @return void
	 */
	public function datetimePreferences( $user, IContextSource $context, &$defaultPreferences ) {
		# # Date and time #####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function renderingPreferences( $user, IContextSource $context, &$defaultPreferences ) {
		# # Diffs ####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function editingPreferences( $user, IContextSource $context, &$defaultPreferences ) {
		# # Editing #####################################
	 ...
	 * @param array &$defaultPreferences
	 */
	public function rcPreferences( $user, IContextSource $context, &$defaultPreferences ) {
		$config = $context->getConfig();
	 ...
	 * @param array &$defaultPreferences
	 */
	public function watchlistPreferences(
	 ...
	 * @param array &$defaultPreferences
	 */
	public function searchPreferences( $user, IContextSource $context, &$defaultPreferences ) {
	 ...
	 * @param array &$defaultPreferences
	 */
	public function miscPreferences( $user, IContextSource $context, &$defaultPreferences ) {
	}
	 ...
	 */
	public function generateSkinOptions( $user, IContextSource $context ) {
		$ret = [];
	 ...
	 * @return array
	 */
	public function getDateOptions( IContextSource $context ) {
		$lang = $context->getLanguage();
	 ...
	 * @return array
	 */
	public function getImageSizes( IContextSource $context ) {
		$ret = [];
	 ...
	 * @return array
	 */
	public function getThumbSizes( IContextSource $context ) {
		$ret = [];
		$pixels = $context->msg( 'unit-pixel' )->text();
	 ...
	 * @return bool|string
	 */
	public function validateSignature( $signature, $alldata, $form ) {
		global $wgParser;
	 ...
	 * @return string
	 */
	public function cleanSignature( $signature, $alldata, $form ) {
	 ...
	 * @return array
	 */
	public function getTimezoneOptions( IContextSource $context ) {
		$opt = [];
	 ...
	 */
	public function saveFormData( $formData, $form ) {
	 ...
	 * @return Status
	 */
	public function submitForm( $formData, $form ) {
	 ...
	 * @since 1.26
	 */
	public function getTimeZoneList( Language $language ) {
