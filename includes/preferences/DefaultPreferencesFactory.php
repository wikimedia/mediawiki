...
class DefaultPreferencesFactory implements PreferencesFactory {
	...
	protected function getSaveFilters() {
		return [
			'timecorrection' => function ( $tz, $alldata  ) {
					$this->filterTimezoneInput( $tz, $alldata );
				} ,
			'rclimit' => 'intval',
			'wllimit' => 'intval',
			'searchlimit' => 'intval',
	...
	protected function profilePreferences(
		...
		$defaultPreferences['nickname'] = [
			...
			'validation-callback' => function ( $signature, array $alldata, HTMLForm $form ) {
	 ...
	 * @return bool|string
	 */
	protected function validateSignature( $signature, array $alldata, HTMLForm $form ) {
