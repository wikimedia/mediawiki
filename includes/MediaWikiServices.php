...
class MediaWikiServices {
	 ...
	 *        This has to contain at least the information needed to set up the 'CoreConfig' service.
	 */
	 ...
	 * and other information that may be needed before the CoreConfig object
	 * can be instantiated.
	 *
	 * @note This should only be used during bootstrapping, in particular
	 * when creating the CoreConfig service. Application logic should
	 * use getCoreConfig() to get a Config instances.
	 *
	 * @return Config
	 */
	 ...
	 * This may or may not be the same object that is returned by getCoreConfig().
	 *
	 * @return Config
	 */
	public function getCoreConfig() {
		return $this->getService( 'CoreConfig' );
	}
