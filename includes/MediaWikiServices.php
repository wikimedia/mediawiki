...
use Config;
use Language;
use MediaWikiPageLinkRenderer;
use MediaWikiTitleCodec;
use PageLinkRenderer;
use SiteLookup;
use SiteStore;
use DBSiteStore;
...
class MediaWikiServices {
	...
	public function getTitleFormatter() {
		// XXX: we will probably want to manage this per language,
		//      or at least content language vs user language.
		$reset = $this->checkConfigForTitleCodecChanged() ? 'reset' : '';
		return $this->getService( 'TitleCodec', $reset );
	}
