...
class MediaWikiServices extends ServiceContainer {
	...
	/**
	 * Initializes and enables the global service locator. Before initialize() has been called,
	 * global service instances are not available, and any call to getInstance() will fail.
	 * The idea is that calling this method signifies the point during bootstrapping when
	 * configuration and registration of extensions is complete, and after which services
	 * can be constructed.
	 *
	 * @note This should be called exactly once for every web request or CLI invocation.
	 * @note This should be called after settings have been loaded and extensions have been
	 * registered.
	 */
	public static function initialize() {
		if ( self::$instance === null ) {
			...
			// log this, since it might indicate an inconsistency in the initialization process
			wfDebugLog( __CLASS__, 'Redundant call to initialize()' );
		}
	}
	 ...
	 *
	 * @note This method will fail with an exception if called before initialize().
	 *
	...
	public static function getInstance() {
		if ( self::$instance === null ) {
			throw new RuntimeException( 'Global service locator was not yet initialized.' );
		}
	...
	public static function resetGlobalInstance( Config $bootstrapConfig = null ) {
		...
		Assert::postcondition(
			self::$instance instanceof MediaWikiServices,
			'self::$instance should now contain a MediaWikiServices instance'
		);
	}
	 ...
	 * @throws MWException
	 */
	private static function newInstance( Config $bootstrapConfig = null ) {
		if ( $bootstrapConfig === null ) {
