...
class User implements IDBAccessObject {
	 ...
	 *
	 * @deprecated since 1.26, use PasswordFactory::generateRandomPasswordString()
	 ...
	 *
	 * @deprecated since 1.26, create a PasswordFactory directly instead
