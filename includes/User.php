...
class User {
	...
	public function getOptionKinds( IContextSource $context, $options = null ) {
		...
		$prefs = Preferences::getPreferences( $user, $context );
		$mapping = array();
	 ...
	 * array( 'registered', 'registered-api', 'registered-multiselect', 'unused' ) for back-compat.
	 */
	public function resetOptions(
		...
		$optionKinds = $this->getOptionKinds;
