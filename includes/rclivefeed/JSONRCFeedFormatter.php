...
class JSONRCFeedFormatter implements RCFeedFormatter {
	...
	public function getLine( array $feed, RecentChange $rc, $actionComment ) {
		...
		$packet = array(
			...
			'type' => RecentChange::typeToString( $attrib['rc_type'] ),
			...
			'title' => $rc->getTitle()->getDBkey(),
			'full_title' => $rc->getTitle()->getPrefixedText(),

			'comment' => $attrib['rc_comment'],
			'timestamp' => wfTimestamp( TS_ISO_8601, $attrib['rc_timestamp'] ),
