...
class TitleSecurity {
	 ...
	 * @return array List of errors
	 */
	protected static function resultToError( Title $title, $errors, $result ) {
	 ...
	 */
	protected function loadRestrictionsFromResultWrapper( Title $title, $res, $oldFashionedRestrictions = null ) {
		$rows = array();
	 ...
	 */
	public static function purgeExpiredRestrictions( Title $title ) {
		if ( wfReadOnly() ) {
			return;
		}
