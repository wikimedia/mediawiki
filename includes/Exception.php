...
class MWExceptionHandler {
	...
	protected static function getLogMessage( Exception $e ) {
		...
		// MWException have fixed IDs on them so that one can match the ID
		// output to the user through HTML to the entry in the debug log.
		$id = $e instanceof MWException ? $e->getId() : self::getLogId();
		$file = $e->getFile();
		$line = $e->getLine();
