...
class TextConflictHelper {
	...
	public function showEditFormTextAfterFooters() {
		...
		// Treat it all as wikitext
		$yourContent = new WikitextContent( $this->yourtext );
		$storedContent = new WikitextContent( $this->storedversion );
		$handler = ContentHandler::getForModelID( CONTENT_FORMAT_WIKITEXT );
