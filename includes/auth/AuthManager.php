...
final class AuthManager implements LoggerAwareInterface {
	...
	/**
	 * After a successful authentication that could not result in a successful login because
	 * no local account existed or could be created, stash the result so that the remote account
	 * can be linked to the local account once the user creates one or logs into one via another
	 * method.
	 ...
	 * @param User $user
	 * @return StatusValue|null One or more UI messages if some accounts have been linked,
	 *   (These are set as warnings as StatusValue has no option for "good" messages.)
	 */
