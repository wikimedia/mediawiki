...
final class AuthManager implements LoggerAwareInterface {
	 ...
	 *
	 * The stashed data will be used in ConfirmAutolinkingSecondaryAuthenticationProvider.
	 *
	 * @param AuthenticationResponse $res
	 */
	protected function stashRemoteLogin( $res ) {
		$session = $this->request->getSession();
		$maybeLink = $session->get( 'AuthManager::maybeLink', array() );
		$maybeLink[$res->linkRequest->getUniqueId()] = $res->linkRequest;
