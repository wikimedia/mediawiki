	...
	extends AbstractPasswordPrimaryAuthenticationProvider
{
	...
	public function __construct( \AuthPlugin $auth, $requestType = null ) {
		...
		if ( $requestType === null ) {
			$requestType = PasswordAuthenticationRequest::class;
		} else {
			$need = PasswordAuthenticationRequest::class;
	...
	public function getAuthenticationRequests( $action, array $options ) {
		...
		switch ( $action ) {
			...
			case AuthManager::ACTION_CHANGE:
				return $this->auth->allowPasswordChange() ? [ new $class( 'change' ) ] : [];

			case AuthManager::ACTION_REMOVE:
				return $this->auth->allowPasswordChange() ? [ new $class( 'login' ) ] : [];
	...
	public function providerAllowsAuthenticationDataChange(
		...
		if ( !$req instanceof $this->requestType ) {
