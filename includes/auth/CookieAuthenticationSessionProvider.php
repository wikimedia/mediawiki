<?php
/**
 * Authentication session provider for cookie-based sessions
 *
 ...
 * @since 1.26
 */
class CookieAuthenticationSessionProvider extends AbstractAuthenticationSessionProvider {
	...
	public function provideAuthenticationSession( WebRequest $request, $empty = false ) {
		return new CookieAuthenticationSession(
