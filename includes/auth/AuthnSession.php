...
abstract class AuthnSession implements LoggerAwareInterface {
	 ...
	 *
	 * If $this->canSetSessionUserInfo() returns true, return the $id, $name,
	 * and $token that were passed to $this->setSessionUserInfo().
	 *
	 * If $this->canSetSessionUserInfo() returns false, return either
	 * array( $id, null, null ) or array( 0, $name, null ).
	 *
