...
class ResetPasswordAuthenticationRequest extends PasswordAuthenticationRequest {
	...
	/**
	 * Tells whether this request is for a hard reset or a soft reset.
	 *
	 * Soft reset is optional and can be bypassed; hard reset prevents authentication until performed.
	 *
	 * @return bool
	 */
	...
	public function loadFromSubmission( array $data ) {
		...
		// the user must either press the skip button or provide a new password
