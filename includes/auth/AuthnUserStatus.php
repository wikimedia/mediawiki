...
class AuthnUserStatus {
	...
	public static function newDefaultStatus() {
		if ( $this->defaultAuthnUserStatus === null ) {
			$this->defaultAuthnUserStatus = new self();
		}
		return $this->defaultAuthnUserStatus;
	}
	...
	public static function newExistsStatus() {
		if ( $this->existsAuthnUserStatus === null ) {
			$this->existsAuthnUserStatus = new self( array( 'exists' => true ) );
		}
		return $this->existsAuthnUserStatus;
	}
