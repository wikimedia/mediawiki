...
class AuthenticationResponse {
	...
	/**
	 * @var StatusValue|null One or more UI messages if some accounts have been linked, (These are
	 * set as warnings as StatusValue has no option for "good" messages.)
	 */
