<?php
/**
 * Authentication session provider interface
 *
...
/**
 * An AuthenticationSessionProvider, as its name implies, provides an AuthenticationSession
 *
 * @ingroup Auth
 * @since 1.26
 */
interface AuthenticationSessionProvider extends LoggerAwareInterface {
	 ...
	 * AuthenticationSession with a priority and optional key and return it; AuthManager
	 * will handle setting the store and logger if necessary.
	 *
	 * If multiple AuthenticationSessionProviders provide sessions, the one with highest
	 * priority wins. In case of a tie, an exception is thrown.
	 * AuthenticationSessionProviders are encouraged to make priorities
	 ...
	 */
	public function provideAuthenticationSession( WebRequest $request, $empty = false );
