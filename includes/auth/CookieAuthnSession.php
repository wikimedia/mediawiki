...
class CookieAuthnSession extends AuthnSession {
	 ...
	 *  - priority: Priority of the returned sessions
	 *  - emptyPriority: Priority if the session isn't for a logged-in user
	 ...
	 *  - sessionName: Session cookie name. Doesn't honor 'prefix'.
	 *  - empty: Force creation of a non-logged-in session
	 */
