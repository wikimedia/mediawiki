...
interface SecondaryAuthenticationProvider extends AuthenticationProvider {
	 ...
	 */
	public function beginSecondaryAuthentication( AuthManager $manager, array $reqs );
	 ...
	 * @return AuthenticationResponse
	 */
	public function continueSecondaryAuthentication( AuthManager $manager, array $reqs );
	 ...
	 * @return AuthenticationResponse
	 */
	public function beginSecondaryAccountCreation( AuthManager $manager, array $reqs );
	 ...
	 * @return AuthenticationResponse
	 */
	public function continueSecondaryAccountCreation( AuthManager $manager, array $reqs );
