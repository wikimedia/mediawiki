...
interface AuthenticationProvider extends LoggerAwareInterface {
	 ...
	 *
	 * AuthenticationRequests returned for ACTION_REMOVE must be able to be
	 * successfully passed to the implementing class's
	 * PrimaryAuthenticationProvider::providerChangeAuthenticationData() or
	 * SecondaryAuthenticationProvider::providerChangeAuthenticationData()
	 * without first calling providerAllowsAuthenticationDataChange().
	 *
