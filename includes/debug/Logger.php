 ...
 * the MWLogger::getInstance() static method which in turn deligates to the
...
class MWLogger implements \Psr\Log\LoggerInterface {
	 ...
	 *
	 * @var \Psr\Log\LoggerInterface $deligate
	 */
	protected $deligate;
	...
	public function log( $level, $message, array $context = array() ) {
		$this->deligate->log( $level, $message, $context );
	}
