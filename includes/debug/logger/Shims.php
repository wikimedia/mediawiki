 ...
 * the MediaWiki\Logger namespace.
 *
 * @deprecated since 1.25 Use \MediaWiki\Logger\Monolog\Handler
 * @todo This class should be removed before the 1.25 final release.
 */
class MWLoggerMonologHandler extends \MediaWiki\Logger\Monolog\Handler {
}
 ...
 * the MediaWiki\Logger namespace.
 *
 * @deprecated since 1.25 Use \MediaWiki\Logger\Monolog\Processor
 * @todo This class should be removed before the 1.25 final release.
 */
class MWLoggerMonologProcessor extends \MediaWiki\Logger\Monolog\Processor {
}
