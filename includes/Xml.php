...
class Xml {
	 ...
	 * @param string $include 'mw', 'mwfile' or 'all' (see Language::fetchLanguageNames())
	 ...
	 */
	public static function languageSelector( $selected, $include = 'mw', $inLanguage = null, $overrideAttrs = array(), $msg = 'yourlanguage' ) {
		global $wgLanguageCode;

		$include = $include === true ? 'mwfile' : $include; # backwards compatibility
