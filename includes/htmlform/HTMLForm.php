...
class HTMLForm extends ContextSource {
	...
	public function prepareForm() {
		...
		if (
			...
			$this->mFormIdentifier === $this->getRequest()->getVal( 'wpFormIdentifier' )
		) {
			$this->loadData();
		} else {
			$this->mFieldData = [];
	...
	public function tryAuthorizedSubmit() {
		...
		$identOkay = false;
		if ( !$this->mFormIdentifier ) {
			$identOkay = true;
		} else {
			$identOkay = $this->mFormIdentifier === $this->getRequest()->getVal( 'wpFormIdentifier' );
		}
