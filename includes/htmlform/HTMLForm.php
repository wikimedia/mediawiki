...
class HTMLForm extends ContextSource {
	 ...
	 *
	 * @param string|array|Status $elements The set of errors/warnings to process. This is meant
	 * 	for Status objects, all other valid types are always considered as erros.
