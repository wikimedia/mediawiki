...
interface WatchedItemQueryServiceExtension {
	 ...
	 */
	public function watchedItemsWithRCInfoQuery( User $user, array $options, IDatabase $db,
	 ...
	 */
	public function watchedItemsWithRCInfo( User $user, array $options, IDatabase $db,
