...
abstract class Collation {
	 ...
	 * @return Array
	 */
	static function getInstanceByContext( $name, $title = null, $context = null ) {
		global $wgCategoryCollations;

		if ( is_array( $name ) ) {
			if ( isset( $name['collation'] )
				&& in_array( $name['collation'], $wgCategoryCollations ) ) {
				$name = $name['collation'];
			} else if ( in_array( $context->getUser()->getOption( 'collation' ),
				$wgCategoryCollations ) ) {
