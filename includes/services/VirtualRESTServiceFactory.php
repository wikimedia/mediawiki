...
class VirtualRESTServiceFactory {
	 ...
	 * ...)
	 * @param $params array The parameters for the service to create.
	 * @return \VirtualRESTService
	 */
	public function makeService( $module, $params ) {
		$config = $this->config->get( 'VirtualRestConfig' );
		if ( !isset( $this->moduleClassMap[$module] ) ) {
			throw new NoSuchServiceException( 'The module ' . $module .
				' does not have a VirtualRESTService associated.' );
		}
