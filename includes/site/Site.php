...
interface Site {
	...
	const ID_EQUIVALENT = 'equivalent'; // TODO: phase this out, it's confusing.
	...
	/**
	 * Returns the source of the site data (e.g. 'local', 'wikidata', 'my-magical-repo').
	 *
	 * @since 1.21
	 *
	 * @return string
	 ...
	 *
	 * The returned path shall contain the placeholder $1, where a url-encoded page
