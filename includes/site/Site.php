...
/**
 * Value object representing a website.
 *
...
interface Site {
	...
	const PATH_MW_API = 'mw-api';
	const PATH_RESTBASE = 'restbase';
	const PATH_LINKED_DATA = 'linked-data';
	const PATH_SPARQL = 'sparql';

	/**
	 * @deprecated since 1.28 use ID_INTERWIKI instead
	 */
	const ID_EQUIVALENT = self::ID_INTERWIKI;

	/**
	 * @deprecated since 1.28 use PATH_PAGE instead
	 */
	const PATH_LINK = self::PATH_PAGE;
	 ...
	 *
	 * Implementations may derive this value from a value returned by getPath().
	 *
	 * @since 1.21
	 *
	 * @return string|null
	...
	/**
	 * Shall be implemented to be equivalen to expandPath( PATH_PAGE, $pageName ).
	 *
	...
	/**
	 * Returns the IDs as associative array.
	 * The keys are ID scopes, the values are lists of IDs.
	 *
	 * @since 1.28
	 *
	 * @return string[]
