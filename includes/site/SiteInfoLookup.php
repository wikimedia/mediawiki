...
interface SiteInfoLookup {
	 ...
	 * @param mixed $default The value to assume when $field is not set.
	 *
	...
	/**
	 * Returns the global site ID of the site identified by the given local ID.
	 *
	 * @param string $localId The ID to resolve in the given scopes.
	 * @param string[]... Additional parameters define the scopes to try to resolve $localId in.
	 *        If no scopes are given, all scopes will be tried.
	 *
