...
class MediaWikiSite extends Site {
	...
	/**
	 * @var MediaWikiPageNameNormalizer|null
	 */
	private $mediaWikiPageNameNormalizer = null;
	...
	public function normalizePageName( $pageName ) {
		if ( defined( 'MW_PHPUNIT_TEST' ) ) {
			...
			if ( $this->mediaWikiPageNameNormalizer === null ) {
				$this->mediaWikiPageNameNormalizer = new MediaWikiPageNameNormalizer(
					$this->getFileUrl( 'api.php' )
				);
			}

			return $this->mediaWikiPageNameNormalizer->normalizePageName( $pageName );
		}
	}
