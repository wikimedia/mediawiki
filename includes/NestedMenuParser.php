...
class NestedMenuParser {
	 ...
	 * @return Array
	 */
	public function parseMessage( $messageName, array $maxChildrenAtLevel = array(),
		$duration, $forContent = false ) {
	 ...
	 * @return Array
	 */
	protected function parseLines( array $lines, array $maxChildrenAtLevel = array() ) {
		wfProfileIn( __METHOD__ );
