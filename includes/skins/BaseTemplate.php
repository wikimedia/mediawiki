...
abstract class BaseTemplate extends QuickTemplate {
	...
	function getToolbox() {
		...
		if ( isset( $this->data['nav_urls']['print'] ) && $this->data['nav_urls']['print'] ) {
			...
			$toolbox['print']['links']['printableversion']['class'] = 'client-nojs';
			$toolbox['print']['links']['print'] = $this->data['nav_urls']['print'];
			$toolbox['print']['links']['print']['single-id'] = 't-print';
			$toolbox['print']['links']['print']['rel'] = 'alternate';
			...
			$toolbox['print']['links']['print']['class'] = 'client-js';
			$toolbox['print']['links']['print']['tooltiponly'] = true;
		}
