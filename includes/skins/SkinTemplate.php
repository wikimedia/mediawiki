...
class SkinTemplate extends Skin {
	 ...
	 * @since 1.26
	 */
	protected function getPersonalContribsLink( $msg ) {
		$request = $this->getRequest();
	...
	protected function buildPersonalUrls() {
		...
		if ( $this->loggedin ) {
			...
			$personal_urls['mycontris'] = $this->getPersonalContribsLink( 'mycontris' );
			...
			if ( User::groupHasPermission( '*', 'edit' ) ) {
				...
				$personal_urls['anoncontribs'] = $this->getPersonalContribsLink( 'anoncontribs' );
			}
