 ...
 * @since 1.25
 */
abstract class WANObjectStashCassandra extends WANObjectStash {
	...
	protected function handleException( Exception $e ) {
		if ( $e instanceof evseevnn\Cassandra\ConnectionException ) {
			$this->lastError = self::ERR_UNREACHABLE;
		} elseif ( $e instanceof evseevnn\Cassandra\QueryException ) {
			$this->lastError = self::ERR_NO_RESPONSE;
		} elseif ( $e instanceof evseevnn\Cassandra\CassandraException ) {
