...
abstract class Action {
	...
	final public static function factory( $action, Page $page, IContextSource $context = null ) {
		...
		if ( is_callable( $classOrCallable ) ) {
			$instance = call_user_func_array( $classOrCallable, array( $page, $context ) );

			if ( !( $instance instanceof Action ) ) {
				throw new MWException( 'Callbacks registered for actions should return an Action instance' );
			}
