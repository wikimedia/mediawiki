...
class Interwiki {
	...
	public static function resetLocalCache() {
		// NOTE: Will fail for implementations that do not provide a resetLocalCache() method.
		// However, once we have alternative implementations, the "old behavior" tests in
		// InterwikiTest can be removed, and this method will no longer be needed.
		return MediaWikiServices::getInstance()->getInterwikiLookup()->resetLocalCache();
	}
