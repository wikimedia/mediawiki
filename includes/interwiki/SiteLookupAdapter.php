...
/**
 * SiteLookup adapter on top of InterwikiLookup to make it possible to lookup for sites without
 * needing to query from sites table. It's better to use this class as a service.
 *
