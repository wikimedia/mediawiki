...
class RevisionDeleteUser {
	...
	private static function setUsernameBitfields( $name, $userId, $op, $dbw ) {
		...
		# Hide contents from live user pages
		...
		# Hide contents from deleted user pages
	...
	private static function fetchLiveUserPages( $name ) {
		...
		return $res = $dbr->select(
				...
				[ 'rev_id' ],
				[ 
					$dbr->makeList(['page_namespace' => '2', 'page_namespace' => '3'], LIST_OR),
					'page_title' => $name
				],
				__METHOD__,
				[],
	...
	private static function fetchDeletedUserPages( $name ) {
		...
		return $res = $dbr->select(
				...
				[ 'ar_id' ],
				[
					$dbr->makeList(['ar_namespace' => '2', 'ar_namespace' => '3'], LIST_OR),
					'ar_title' => $name
				],
				__METHOD__,
				[]
