 ...
 * Use the hook name "ParserOptionsDefaults" to register handlers implementing this interface.
 *
 * @stable to implement
 * @ingroup Hooks
 */
interface ParserOptionsDefaultsHook {
	/**
	 ...
	 * @param array &$postprocOpts To indicate that an option is a post-processing option, add its name
	 *   to this array.
	 * @return bool|void True or no return value to continue or false to abort
	 */
	public function onParserOptionsDefaults( &$defaults, &$inCacheKey, &$lazyLoad, array &$postprocOpts );
}
