...
<div class="mw-ui-container">
	<?php
	// XXX (spage 2013-04-12) Move html('header') up here also, as in UserloginVform.php?
	...
	<?php } ?>
		...
		<?php if( $this->data['createemail'] ) { ?>
			<label class="mw-ui-checkbox-label">
				<input name="wpCreateaccountMail" type="checkbox" value="1" id="wpCreateaccountMailwpRemember" tabindex="2"
		...
		<?php if( $this->data['canremember'] ) { ?>
			<div>
				<label class="mw-ui-checkbox-label">
					...
					>
					<?php echo $this->getMsg( 'remembermypassword' )->numParams( $expirationDays )->escaped(); ?>
				</label>
			</div>
		<?php }
...
<?php
		...
		// JS attempts to move the image CAPTCHA to this part of the form.
?>
		<div class="mw-submit">
			<input type='submit' class="mw-ui-button mw-ui-big mw-ui-block mw-ui-primary" name="wpCreateaccount" id="wpCreateaccount"
				tabindex="<?php echo ++$tabIndex; // skip one index for moved CAPTCHA ?>"
...
<div class="createacct-benefits-container hidden-phone visible-desktop visible-tablet">
	...
	<div class="createacct-benefits-list">
		<div>
