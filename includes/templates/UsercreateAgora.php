...
<form name="userlogin2" id="userlogin2" method="post" action="<?php $this->text('action') ?>">
	<h2><?php $this->msg('createaccount-join') ?> UsercreateAgora.php!!</h2>
...
<?php } ?>
		<li>
			<label class="acux-label" for='wpName2'><?php $this->msg('yourname') ?></label>
			<?php
		...
		<!-- what did tr class="mw-row-password" do? -->
			<label class="acux-label" for='wpPassword2'><?php $this->msg('yourpassword') ?></label>
<?php
	...
	<?php } ?>
		<!-- what did tr class="mw-row-password" do? -->
			<label class="acux-label" for='wpRetype'><?php $this->msg('yourpasswordagain') ?></label>
			<?php
		...
		<li>
			<?php if( $this->data['useemail'] ) { ?>
				<label class="acux-label" for='wpEmail'><?php $this->msg('youremail') ?></label>
				<?php
		echo Html::input( 'wpEmail', $this->data['email'], 'email', array(
			...
			<?php if( $this->data['usereason'] ) { ?>
				<label class="acux-label" for='wpReason'><?php $this->msg('createaccountreason') ?></label>
...
?>
		<li>
			<div class="mw-submit">
				<input type='submit' class="mw-ui-button primary" name="wpCreateaccount" id="wpCreateaccount"
					tabindex="<?php echo $tabIndex++; ?>"
