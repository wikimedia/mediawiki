 ...
 * @ingroup Templates
 */
class UsercreateTemplateAgora extends QuickTemplate {
...
<form name="userlogin2" id="userlogin2" method="post" action="<?php $this->text('action') ?>">
	<h2 class="createaccount-join"><?php $this->msg('createaccount-join') ?></h2>
...
<?php } ?>
		<li>
			<label class="acux-label" for='wpName2'><?php $this->msg('userlogin-yourname') ?></label>
			<?php
		...
		<li class="mw-row-password">
			<label class="acux-label" for='wpPassword2'><?php $this->msg('userlogin-yourpassword') ?></label>
			<?php
	...
	?>
		<li>
			...
			<div class="acux-label"><?php $this->msg( 'yourdomainname' ) ?></span>
			<div class="mw-input">
	...
	<?php } ?>
		<li class="mw-row-password">
			<label class="acux-label" for='wpRetype'><?php $this->msg('usercreate-yourpasswordagain') ?></label>
			<?php
			...
			'size' => '20',
			'required',
			'placeholder' => wfMessage( 'usercreate-yourpasswordagain-help' )->text()
		) + User::passwordChangeInputAttribs() ); ?>
		</li>
		<li>
			<?php if( $this->data['useemail'] ) { ?>
				<label class="acux-label" for='wpEmail'><?php $this->msg('usercreate-email') ?></label>
				<?php
		echo Html::input( 'wpEmail', $this->data['email'], 'email', array(
			...
			'tabindex' => '6',
			'size' => '20',
			'placeholder' => $this->data['emailrequired']
				? wfMessage( 'usercreate-emailrequired-help' )->text()
				: wfMessage( 'usercreate-email-help' )->text()
			...
			<?php if( $this->data['userealname'] ) { ?>
				<label class="acux-label" for='wpRealName'><?php $this->msg('yourrealname') ?></label>
			...
			<?php if( $this->data['usereason'] ) { ?>
				<label class="acux-label" for='wpReason'><?php $this->msg('usercreate-reason') ?></label>
		...
		<li>
			<?php
				if ( !empty( $inputItem['msg'] ) && $inputItem['type'] != 'checkbox' ) {
					?><label class="acux-label" for="<?php
...
?>
		<li>
			<div class="mw-submit">
				<input type='submit' class="mw-ui-button primary login-button" name="wpCreateaccount" id="wpCreateaccount"
					tabindex="<?php echo $tabIndex++; ?>"
