...
?>
	...
	<?php } ?>
		<li>
			<label for='wpName2'>
				...
				<span class="mw-ui-flush-right"><?php echo wfMessage( 'usercreate-helpusername-link' )->parse() ?></span>
			</label>
	...
	<?php } ?>
		<li class="mw-row-password">
			<label for='wpRetype'><?php $this->msg('usercreate-yourpasswordagain') ?></label>
			<?php
		...
		<?php if( $this->data['useemail'] ) { ?>
			<label for='wpEmail'><?php $this->msg('usercreate-email') ?></label>
			<?php
		...
		<?php if( $this->data['usereason'] ) { ?>
			<li>
				<label for='wpReason'><?php $this->msg('usercreate-reason') ?></label>
