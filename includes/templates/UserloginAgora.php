	...
	if( $this->haveData( 'extrafields' ) ) {
		...
		<li>
			<?php if( $this->data['canremember'] ) {
				...
				/* 
				 * This outputs an input checkbox followed by nbsp followed by label.
				 * echo Xml::checkLabel(
					...
					array( 'tabindex' => '8' )
				 * );
				 * Agora needs label _containing_ input checkbox.
				 */
