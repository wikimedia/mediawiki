				...
				<?php if ( $this->haveData( 'createOrLoginHref' ) ) {
					if ( $this->data['loggedin'] ) { ?>
						<span id="mw-createaccount-another">
							<a href="<?php $this->text( 'createOrLoginHref' ); ?>" id="mw-createaccount-join" tabindex="7"  class="mw-ui-button mw-ui-quiet mw-ui-progressive"><?php $this->msg( 'userlogin-createanother' ); ?></a>
						</span>
					<?php } else { ?>
						<a href="<?php $this->text( 'createOrLoginHref' ); ?>" id="mw-createaccount-join" tabindex="7"  class="mw-ui-button mw-ui-quiet mw-ui-progressive"><?php $this->msg( 'userlogin-joinproject' ); ?></a>
					<?php }
				} ?>
				<?php
