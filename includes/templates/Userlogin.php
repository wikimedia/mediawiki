...
<p>
	^BAD Can't hardcode this button, wiki may not allow creating account!<br>
	old dynamic userloginlink link text: <p id="userloginlink"><?php $this->html('link') ?>
</p>
</div>
