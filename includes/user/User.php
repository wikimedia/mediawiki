		...
		if ( $user->isLoggedIn() ) {
			...
			if ( $config->get( 'CookieSetOnAutoblock' ) === true ) {
				...
				if ( $setCookies ) {
					...
					$block->setCookie( $this->getRequest()->response(), false );
				}
			}
