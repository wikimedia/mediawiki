...
class BatchLinkExistenceLookup {
	...
	const HANDLE_ONLY = LinkTargetExistenceLookup::HANDLE_ONLY;
	const HANDLE = LinkTargetExistenceLookup::HANDLE;
	const SKIP = LinkTargetExistenceLookup::SKIP;
	const EXISTS = LinkTargetExistenceLookup::EXISTS;
	const BROKEN = LinkTargetExistenceLookup::BROKEN;
	...
	/**
	 * Add a LinkTarget to be queued for lookup
	 *
	 * This function could return self::EXISTS or self:BROKEN,
	 * in which case the caller should short-circuit and use that
	 *
	...
	/**
	 * Do the batch lookup for all the queued titles
	 */
	...
	/**
	 * Check whether a link exists after doing the
	 * batch lookup. True means it exists, false
	 * means it doesn't.
	 *
	 * @param LinkTarget $linkTarget
	 * @return bool
