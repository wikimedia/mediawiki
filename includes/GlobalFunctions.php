...
function wfBaseConvert( $input, $sourceBase, $destBase, $pad = 1, $lowercase = true,
	...
	if ( extension_loaded( 'gmp' ) && ( $engine == 'auto' || $engine == 'gmp' ) ) {
		...
		// @todo FIXME: Avoid function calls in a FOR loop test part
 ...
 *
 * @param $maxLag int|bool (deprecated)
 * @param $wiki mixed Wiki identifier accepted by wfGetLB
 * @param $cluster string|bool cluster name accepted by LBFactory. Default: false.
 */
