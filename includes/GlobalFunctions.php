 ...
 *
 * @param string ... strings to escape and glue together,
...
function wfEscapeShellArg( /*...*/ ) {
	...
	return call_user_func_array( 'MediaWiki\\Shell::escape', $args );
}
 ...
 * @deprecated since 1.30 use class MediaWiki\Shell
 */
