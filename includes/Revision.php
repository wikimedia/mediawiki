...
class Revision implements IDBAccessObject {
	...
	/** @var int */
	protected $mQueryFlags = 0; // FIXME: keep this? is it still useful?
	...
	public static function loadFromId( $db, $id ) {
		wfDeprecated( __METHOD__, '1.30' ); // no known callers
	 ...
	 * to that page, will return null.
	 *
	 * @deprecated since 1.30, use RevisionStore::getRevisionByTitle() instead.
	 *
	 * @param IDatabase $db
	 * @param Title $title
	 * @param int $id
	 ...
	 *
	 * @deprecated since 1.30, use RevisionStore::loadRevisionFromTimestamp() instead.
	 *
	 * @param IDatabase $db
	 * @param Title $title
	...
	public static function loadFromTimestamp( $db, $title, $timestamp ) {
		// FIXME: replace loadRevisionFromTimestamp by getRevisionByTimestamp
	 ...
	 * @deprecated Since 1.28, no callers in core nor in known extensions. No-op since 1.30.
	 */
	...
	public function insertOn( $dbw ) {
		...
		$rec = self::getRevisionStore()->insertRevisionOn( $this->mRecord, $dbw, $this->mQueryFlags );
