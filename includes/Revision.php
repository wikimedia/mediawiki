...
class Revision implements IDBAccessObject {
	...
	protected function getContentInternal() {
		if ( !isset( $this->mSlotContent['main'] ) ) {
			$store = $this->getRevisionContentLookup();
			$this->mSlotContent['main'] = $store->getRevisionContent( $this->getId(), 'main' );
		}

		// NOTE: copy() will return $this for immutable content objects
		return isset( $this->mSlotContent['main'] )? $this->mSlotContent['main']->copy() : null;
	}
	...
	public function insertOn( $dbw ) {
		...
		$contentStore->storeRevisionContent( $this->mTitle, $rev_id, $this->mSlotContent, $this->mTimestamp, )
