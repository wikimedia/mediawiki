...
class Revision implements IDBAccessObject {
	 ...
	 *
	 * This method allows for the use of caching in the retrieval of page revisions.
	 * However, for a cached Revision, using any accessors that normally requires permission
	 * checks (aside from the text) will trigger a small one-time DB lookup. In addition,
	 * the title will also be lazy loaded in getTitle(); callers can use setTitle()
	 * to immediately preload it instead, provided a Title object is at hand.
	 *
	 * @param IDatabase $db
