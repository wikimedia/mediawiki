...
class LinkSearchPage extends QueryPage {
	...
	private function initServices() {
		...
		if ( !$this->titleFormatter ) {
			$this->titleFormatter = new WikitextTitleFormatter( $lang, GenderCache::singleton(), false );
		}

		if ( !$this->linkRenderer ) {
			$this->linkRenderer = new HtmlPageLinkRenderer( new UrlTitleFormatter( $this->titleFormatter ) );
		}
	}
	...
	function formatResult( $skin, $result ) {
		...
		$pageLink = $this->linkRenderer->renderLink( $title, $text );
