...
class ContribsPager extends ReverseChronologicalPager {
	...
	function reallyDoQuery( $offset, $limit, $descending ) {
		...
		/*
		 * Fetch the user id from the already-built core query - this is not expensive and will most
		 * likely come in handy for extensions building upon this
		 */
		$userId = $parameters[2]['rev_user'];
		 ...
		 * $userId: the userId to fetch contributions for
		 * $offset: see phpdoc above
		 * $limit: see phpdoc above
		 * $descending: see phpdoc above
		 */
		$queries[] = $parameters;
		wfRunHooks( 'ContribsPager::reallyDoQuery', array( &$queries, $userId, $offset, $limit, $descending ) );
