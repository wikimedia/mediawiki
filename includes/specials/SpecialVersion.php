...
class SpecialVersion extends SpecialPage {
	 ...
	 *
	 * @param string|null $version Value of wgVersion or null
	 * @return string
	 */
	public static function softwareInformation( $version = null ) {
		if ( !$version ) {
			$version = ConfigFactory::getDefaultInstance()->makeConfig( 'main' )->get( 'Version' );
		}
	 ...
	 *
	 * @todo FIXME: Pass wgVersion when all dependencies can easily access
	 *  Config object (e.g. Parser, WikiStatsOutputs)
	 * @param string $flags
	 * @return mixed
	 */
	 ...
	 * @return mixed
	 */
	public static function getVersionLinked( $version = null ) {
		wfProfileIn( __METHOD__ );
	...
	/**
	 * @param string $mwVersion Value of wgVersion
	...
	/**
	 * @param string $version Value of wgVersion
	 * @return string
	 */
