...
class SpecialTags extends SpecialPage {
	...
	/**
	 * @var array $storedTags Array of tags stored in valid_tag table,
	 * mapped to their params
	 */
	protected $storedTags = null;

	/**
	 * @var array $registeredTags Array of tags registered by extensions,
	 * mapped to their params
	 */
	...
	function showTagList() {
		...
		// Retrieving defined tags by source for use in #doTagRow()
	...
	function doTagRow( $tag, $hitcount, $showActions, $showEditLinks ) {
		...
		// retrieve extension name as provided in hook
		if ( $changeTag->extensionDefined && isset( $this->params['extName'] ) ) {
