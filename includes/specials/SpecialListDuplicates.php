<?php
/**
 * Implements Special:ListDuplicateFiles
 *
...
/**
 * Special:ListDuplicateFiles Lists all files where the current version is
 *   a duplicate of the current version of some other file.
 * @ingroup SpecialPage
 */
class ListDuplicatesPage extends QueryPage {
