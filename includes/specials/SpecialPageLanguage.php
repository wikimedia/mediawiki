...
class SpecialPageLanguage extends FormSpecialPage {
	...
	public function onSubmit( array $data ) {
		...
		// Wrong for one case where old language was null and new language is also null
		if ( $langNew === $langOld ) {
			return false;
		}
		...
		// For logging null means wiki language
		if ( $langNew === null ) {
		...
		$logParams = array(
			'4::oldlanguage' => $langOld,
			'5::newlanguage' => $langNew
		);
