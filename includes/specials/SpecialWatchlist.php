...
class SpecialWatchlist extends ChangesListSpecialPage {
	...
	function execute( $subpage ) {
		...
		if ( $this->isStructuredFilterUiEnabled() ) {
			...
			$output->addJsConfigVars( 'wgSavedQueriesPreferenceName', 'rcfilters-wl-saved-queries' );
			$output->addJsConfigVars( 'wgEnableLimit', !$opts['extended'] );
		}
	}

	protected function isStructuredFilterUiEnabled() {
		return parent::isStructuredFilterUiEnabled()
			&& ( $this->getConfig()->get( 'RcfiltersOnWatchlist' )
	...
	protected function showHideCheck( $options, $message, $name, $value, $inStructuredUi ) {
		...
		$attribs = [ 'class' => 'clshowhideoption cloption' ];
		if ( $inStructuredUi ) {
