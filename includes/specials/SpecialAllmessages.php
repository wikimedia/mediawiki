		...
		switch ( $field ) {
			case 'am_title' :
				...
				$translation = Linker::makeExternalLink(
					'https://translatewiki.net/w/i.php?title=Special:SearchTranslations&group=mediawiki&grouppath=mediawiki&query='
						. wfUrlencode ( $this->msg ( $value )->inLanguage ( 'en' )->plain() ),
