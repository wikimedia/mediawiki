...
class UserrightsPage extends SpecialPage {
	...
	/**
	 * Returns true if this user rights form should provide an interface to set and
	 * change user group expiries. Subclasses may wish to override this to return
	 * false.
	 *
	 * @return bool
	 */
