...
class UserrightsPage extends SpecialPage {
	...
	public function execute( $par ) {
		...
		if (
			...
			/** @var UserGroupManager $targetUser */
	 ...
	 * @param UserGroupManager $user Target user object.
	 * @return null
	 */
	function saveUserGroups( $username, $reason, UserGroupManager $user ) {
	 ...
	 */
	function doSaveUserGroups( UserGroupManager $user, $add, $remove, $reason = '' ) {
		global $wgAuth;
	 ...
	 * @param array $reason
	 */
	function addLogEntry( UserGroupManager $user, $oldGroups, $newGroups, $reason ) {
