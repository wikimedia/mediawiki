	...
	public function execute( $par = '' ) {
		...
		if ( $params['async'] ) {
			...
			DeferredUpdates::addCallableUpdate( function () use ( $params ) {
				// HACK: JobRunner needs outer scope, manually clear the transaction
				// started by DeferredUpdates::runUpdate.
				// FIXME: Is there a better way to clear or avoid this transaction?
				$lbFactory = MediaWikiServices::getInstance()->getDBLoadBalancerFactory();
				$lbFactory->commitMasterChanges( 'MWCallableUpdate::doUpdate' );
