...
class TemplateSelector extends HTMLFormField {
	...
	/**
	 * The inputs are configurable by i18n message which are parsed by this class.
	 * This is a simple convenience method to figure out those lines without having to instantiate
	 * the class (well, that's what it'll do behind the screens anyway...)
	 *
	 * @param string|null $message
	 * @return array
	 */
	public static function getLinesFromMessage( $message = null ) {
		$params = [];
		if ( $message ) {
