...
class LoginForm extends SpecialPage {
	 ...
	 * @since 1.25
	 */
	public function validateUsername( $username, $password, $email ) {
		...
		if ( !Hooks::run( 'AbortNewAccount', array( $u, &$abortError, &$abortStatus ) ) ) {
			...
			wfDebug( "LoginForm::validateUsername: a hook blocked creation\n" );
			if ( $abortStatus === null ) {
	...
	public function addNewAccountInternal() {
		...
		$usernameValidated = $this->validateUsername( $this->mUsername, $this->mPassword, $this->mEmail );
