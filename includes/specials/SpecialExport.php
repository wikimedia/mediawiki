...
class SpecialExport extends SpecialPage {
	...
	public function execute( $par ) {
		global $wgSitename;
		global $wgExportAllowListContributors, $wgExportFromNamespaces, $wgExportFromPrefix;
		...
		} elseif ( $request->getCheck( 'addprefix' ) && $wgExportFromPrefix ) {
			$page = $request->getText( 'pages' );
