...
class ImageListPager extends TablePager {
	 ...
	 *
	 * @note $descending is poorly named, but keeping consistent with IndexPager base class.
	 */
	function reallyDoQuery( $offset, $limit, $descending ) {
		...
		return $this->combineResult( $imageRes, $oldimageRes, $limit, $descending );
	}
	 ...
	 * @param $limit int
	 * @param $ascending boolean This variable is named descending in the IndexPager base class...
	...
	function getForm() {
		...
		$inputForm['listfiles-show-all'] = HTML::input( 'ilshowall', 1, 'checkbox', array( 'checked' => $this->mShowAll ) );
