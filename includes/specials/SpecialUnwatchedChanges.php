...
class SpecialUnwatchedChanges extends SpecialRecentChanges {
	...
	function __construct( $name = 'UnwatchedChanges', $restriction = 'unwatchedpages' ) {
	...
	public function doMainQuery( $conds, $opts ) {
		...
		if ( !wfRunHooks( 'SpecialRecentChangesQuery', array( &$conds, &$tables, &$joinConds, $opts, &$queryOptions, &$select ) ) ) {
			return false;
		}
