...
class SpecialSearch extends SpecialPage {
	...
	public function showResults( $term ) {
		...
		$sidebarResultWidget = $search->getFeatureData( 'enable-new-crossproject-page' ) === true
			? new InterwikiSearchResultWidget( $this, $linkRenderer )
			: new SimpleSearchResultWidget( $this, $linkRenderer );
