...
class SpecialSearch extends SpecialPage {
	...
	public function showResults( $term ) {
		...
		if ( $num === 0 && !$hasErrors ) {
			...
			$widget = new MediaWiki\Widget\BasicSearchResultSetWidget(
				$this,
				// Single search results in the main view
				new MediaWiki\Widget\Search\FullSearchResultWidget( $this ),
				// Sidebar of interwiki results
				new MediaWiki\Widget\Search\InterwikiSearchResultSetWiget(
					$this,
					new MediaWiki\Widget\Search\SimpleSearchResultWiget( $this )
				)
			);
