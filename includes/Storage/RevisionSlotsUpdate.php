...
class RevisionSlotsUpdate {
	 ...
	 *
	 * Will return true for the role names returned by getModifiedRoles().
	 * Will return false for the role names returned by getRemovedRoles().
	 *
	 * @param string $role The role name of the desired slot
	 *
	 * @return bool
	 ...
	 *
	 * Will return false for the role names returned by getModifiedRoles().
	 * Will return true for the role names returned by getRemovedRoles().
	 *
	 * @param string $role The role name of the desired slot
	 *
	 * @return bool
