...
class PageUpdater {
	 ...
	 * It acts as a check-and-set (CAS) token in that it is guaranteed that doEdit() will fail
	 ...
	 * It acts as a check-and-set (CAS) token in that it is guaranteed that doEdit() will fail
	 * with the edit-conflict status if the current revision of the page changes after
	 * grabParentRevision() was called and before doEdit() could insert a new revision.
	 *
