...
class PageUpdater implements IDBAccessObject {
	...
	private function getContentHandler( $role ) {
		// NOTE: eventually, we won't get a WikiPage passed into the constructor any more
		// FIXME: WikiPage::getContentHandler doesn't take a $role!
		return $this->wikiPage->getContentHandler( $role );
	}
	...
	public function prepareContentForEdit(
		...
		// FIXME: parser options for each slot, or combined for all slots? Including inherited?
		...
		// FIXME: inherit slots from base revision!
