...
class PageMetaDataUpdater implements IDBAccessObject {
	...
	public function canUseFor(
		...
		// TODO: check $this->stopSlots if needed
	...
	public function getTouchedSlotRoles() {
		...
		if ( $this->stopSlots ) {
			// XXX: if prepareEdit wasn't called, we don't know which slots were stopped.
