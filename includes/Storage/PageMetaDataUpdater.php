...
class PageMetaDataUpdater implements IDBAccessObject {
	 ...
	 * grabCurrentRevision, or by the first call to prepareUpdate. If pageState was not
	...
	public function prepareUpdate( RevisionRecord $revision, array $options = [] ) {
		...
		if ( !$this->pageState ) {
			...
			// This is a null-edit, so the state of the page table before the edit is the
			// same as the state of the table after the edit!
