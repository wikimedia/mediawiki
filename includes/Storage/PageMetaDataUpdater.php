...
class PageMetaDataUpdater implements IDBAccessObject {
	 ...
	 *
	 * @param UserIdentity $user|null The user creating the revision in question
	 ...
	 */
	public function prepareEdit( User $user, RevisionSlots $newContentSlots, $stopSlots = [], $useStash = true ) {
		if ( $this->newContentSlots ) {
