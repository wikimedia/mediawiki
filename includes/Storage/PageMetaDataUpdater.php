...
class PageMetaDataUpdater implements IDBAccessObject {
	 ...
	 *
	 * @param User $user
	 * @param RevisionRecord|null $revision New revision (after save)
	 * @param RevisionSlots|null $content New content (before PST)
	 * @param string[] $stopSlots
