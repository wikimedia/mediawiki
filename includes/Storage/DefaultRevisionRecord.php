...
class DefaultRevisionRecord implements RevisionRecord, TransientDataAccess {
	 ...
	 * @throws MWException
	 */
	function __construct( $row, RevisionSlots $slots, $wikiId = false ) {
		...
		// TODO: move crazy dual constructor logic to separate methods in RevisionStore
		if ( is_object( $row ) ) {
	...
	public function getTransientData( $key, $default = null ) {
		return array_key_exists( $this->transientData, $key )
