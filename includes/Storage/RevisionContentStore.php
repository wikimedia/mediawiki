 ...
 *
 * @todo: explore a stateful builder/interactor variant of this interface, for modeling a
...
interface RevisionContentStore {
	 ...
	 *        instead of getting a revision id from the caller. As defined now, the
	 *        caller has to create an incomplete entry in the revision table first,
	 *        and then call this method. See also the idea about a transaction context
