...
abstract class RevisionRecord {
	 ...
	 *
	 * @param ImmutablePageIdentity $pageIdentity The title of the page this Revision is associated with.
	 ...
	 * @throws MWException
	 */
	function __construct( ImmutablePageIdentity $pageIdentity, RevisionSlots $slots, $wikiId = false ) {
		...
		$this->mPageId = $pageIdentity->getArticleID();
	}
