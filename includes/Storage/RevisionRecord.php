...
interface RevisionRecord {
	 ...
	 *
	 * @todo replace this with a method that returns a narrow view on the relevant page table fields.
	 * We could also use Title::newFromID( $revision->getPageId() ) instead.
	 *
	 * @return Title
	 */
