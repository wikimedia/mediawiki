...
abstract class RevisionRecord implements TransientDataAccess {
	...
	public function getSize() {
		...
		if ( $this->mSize === null  ) { // FIXME: move this to MutableRevisionRecord
	...
	public function getSha1() {
		...
		if ( $this->mSha1 === null  ) { // FIXME: move this to MutableRevisionRecord
	...
	public function getTimestamp() {
		return $this->mTimestamp === null ? null : wfTimestamp( TS_MW, $this->mTimestamp );
	}
