...
abstract class RevisionRecord {
	...
	public function getTitle() {
		// TODO: Rename! getLinkTarget is not very descriptive, though. getTitleLinkTarget?
		//       getPageAsLinkTarget? Or use a PageRecord instead?
		return $this->mTitle;
	}
	...
	public function getUserId( $audience = self::FOR_PUBLIC, User $user = null ) {
		// TODO: replace with getUserIdentity()
