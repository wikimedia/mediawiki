...
class MutableRevisionRecord extends RevisionRecord {
	...
	public static function newFromArray_1_29( Title $title, array $array, RevisionSlots $slots, $wikiId = false ) {
		...
		if ( isset( $row['size'] ) ) $record->setSha1( intval( $row['size'] ) );
	...
	// FIXME: TODO: newFromRevisionRecord()
	...
	function __construct( Title $title, $wikiId = false ) {
		// FIXME: init mutable RevisionSlots
	 ...
	 * @param RevisionSlots $slots
	 */
	public function setSlots( RevisionSlots $slots ) {
		$this->mSlots = $slots; // FIXME: set individual slots?! remove slots? inherit slots?
	}
	 ...
	 * FIXME
	 */
	public function guaranteeContent() {
		// FIXME!
	}
