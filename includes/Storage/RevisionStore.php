...
class RevisionStore implements IDBAccessObject {
	...
	public function newKnownCurrent( IDatabase $db, $pageId, $revId ) {
		// FIXME: LazyRevisionRecords may or may not be serializable - they may
		// drag in service objects through callbacks.
		// Do we want to fully load them, and then cache them? Or should we rather
		// avoid caching fully loaded revisions?
