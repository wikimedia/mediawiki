...
class RevisionStore implements IDBAccessObject, RevisionFactory, RevisionLookup {
	...
	public function userJoinCond() {
		return $this->getQueryInfo( ['user'], false )['joins']['user'];
	}
	...
	public function pageJoinCond() {
		return $this->getQueryInfo( ['page'], false )['joins']['page'];
	}
	...
	public function selectTextFields() {
		return $this->getQueryInfo( ['text'], false )['fields'];
	}
	...
	public function selectPageFields() {
		return $this->getQueryInfo( ['page'], false )['fields'];
	}
	...
	public function selectUserFields() {
		return $this->getQueryInfo( ['user'], false )['fields'];
	}
	 ...
	 * @param bool $includeRevisionQueryInfo Whether to include the necessary fields
	 *        and tables for the revision table itself.
	 *
	 ...
	 */
	public function getQueryInfo( $options = [], $includeRevisionQueryInfo = true ) {
		$ret = [
			'tables' => [],
			'fields' => [],
			'joins'  => [],
		...
		if ( $includeRevisionQueryInfo || in_array( 'revision', $options, true ) ) {
			$ret['tables'][] = 'revision';
