...
interface RevisionFactory {
	 ...
	 *
	 * @param SlotRecord[]|callable $slots An array of SlotRecords with slot role names as its keys,
	 *        or a callable that returns such an array, when called with a RevisionRecord as the
	 *        only parameter.
	 *
	 * @return RevisionRecord
	 */
