...
class RevisionContentStore {
	 ...
	 * @param NameInterner $roleInternalizer
	 * @param NameInterner $modelInternalizer
	 * @param NameInterner $formatlInternalizer
	 */
	public function __construct(
		LoadBalancer $dbLoadBalancer,
		NameInterner $roleInternalizer,
		NameInterner $modelInternalizer,
		NameInterner $formatlInternalizer
	) {
