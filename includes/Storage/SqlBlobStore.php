...
class SqlBlobStore implements IDBAccessObject, BlobStore {
	...
	/**
	 * @param bool $compressRevisions whether blobs should be compressed for storage
	 */
	...
	public function compressRevisionData( &$blob ) {
		...
		// Revisions not marked as UTF-8 will have legacy decoding applied.
		// TODO: if $this->legacyEncoding is not set, we could perhaps skip this.
		$blobFlags[] = 'utf-8';
	 ...
	 * This method should become private after migration to the MCR storage schema.
	 *
	 ...
	 */
	public static function getTextIdFromAddress( $address ) {
