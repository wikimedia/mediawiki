 ...
 */
class LazyRevisionRecord implements RevisionRecord, TransientDataAccess {
	...
	public function getSize() {
		...
		if ( $this->mSize === null  ) {
			...
			$this->mSize = array_reduce( $slots, function ( $accu, SlotRecord $slot ) {
	...
	public function getSha1() {
		...
		if ( $this->mSha1 === null  ) {
			...
			// FIXME: centralize this algorithm! Move to SlotRecord? Or RevisionContent?
			$this->mSha1 = array_reduce( $slots, function ( $accu, SlotRecord $slot ) {
				return $accu === null
					?  $slot->getSha1()
					: ContentStore::base36Sha1( $accu . $slot->getSha1() );
			}, null );
		}
