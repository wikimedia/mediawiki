 ...
 */
class ContentStore implements IDBAccessObject, BlobLookup, SlotContentLookup {
	 ...
	 * @return boolean
	 */
	public function isCompressRevisions() {
	 ...
	 *
	 * @note direct use is deprecated, use getBlob() or getSlotContent() instead.
			...
			if ( $cacheKey ) {
				...
				return $this->cache->getWithSetCallback(
					...
					function () use ( $url, $flags ) {
						// No negative caching per ContentStore::getBlob()
