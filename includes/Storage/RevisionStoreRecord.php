...
class RevisionStoreRecord extends RevisionRecord {
	 ...
	 *
	 * @param ImmutablePageIdentity $pageIdentity The identity of the page this Revision is associated with.
	...
	function __construct(
		ImmutablePageIdentity $pageIdentity,
		UserIdentity $user,
		...
		// sanity check
		if (
			$this->mPageId && $this->mPageIdentity->exists()
			&& $this->mPageId !== $this->mPageIdentity->getId()
		) {
