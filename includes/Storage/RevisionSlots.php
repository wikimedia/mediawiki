...
class RevisionSlots {
	 ...
	 *
	 * @throw RevisionAccessException if the slot does not exist or slot data
	...
	/**
	 * Returns an array of SlotRecord that represents the content meta-data of a revision.
	 *
