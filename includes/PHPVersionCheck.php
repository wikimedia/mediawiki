 ...
 */
function wfGenericError( $type, $title, $shortText, $longText, $longHtml ) {
	$mwVersion = '1.26';
...
HTML;
	wfGenericError( $type, 'Supported PHP versions', $shortText, $longText, $longHtml );
}
...
HTML;
	...
	wfGenericError( $type, 'External dependencies', $shortText, $longText, $longHtml );
}
