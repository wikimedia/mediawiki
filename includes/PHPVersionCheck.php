...
function wfEntryPointCheck( $entryPoint ) {
	...
	if ( !function_exists( 'version_compare' )
		...
		$phpORhhvmText = HHVM;
		wfPHPMVersionError(
			$entryPoint, $mwVersion, $minimumVersionHHVM, $hhvmVersion, $phpORhhvmText,
			$php = false, $hhvm = true
		);
	}
	...
	if ( !function_exists( 'version_compare' )
		...
		$phpORhhvmText = PHP;
		wfPHPVersionError(
			$entryPoint, $mwVersion, $minimumVersionPHP, $phpVersion, $phpORhhvmText,
			$php = true, $hhvm = false
		);
	}
...
function wfPHPVersionError(
	$type, $mwVersion, $minimumVersionPHPorHHVM, $phpORhhvmVersion, $phpORhhvmText, $php, $hhvm
) {
	...
	$longText = "Error: You might be using on older $phpORhhvmText version. \n"
