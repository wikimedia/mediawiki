...
function wfEntryPointCheck( $entryPoint ) {
	...
	if ( !function_exists( 'version_compare' )
		...
		$phpImpl = false;
		wfPHPVersionError(
			$entryPoint, $mwVersion, $minimumVersionHHVM, $minimumVersionHHVMa, 'HHVM', $phpImpl
		);
	}
	...
	if ( !function_exists( 'version_compare' )
		...
		$phpImpl = true;
		wfPHPVersionError(
			$entryPoint, $mwVersion, $minimumVersionPHP, $phpVersion, 'PHP', $phpImpl
		);
	}
 ...
 * @param string $phpImpl true if it detects wrong php version
 */
function wfPHPVersionError(
	$type, $mwVersion, $minimumVersionPHPorHHVM, $phpOrhhvmVersion, $phpOrhhvmText, $phpImpl
) {
