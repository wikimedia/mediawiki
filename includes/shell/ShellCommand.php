...
class ShellCommand {
	...
	public function __destruct() {
		if ( $this->exitCode === null && $this->output === null ) {
	 ...
	 * - If execute() hasn't been called yet, will return null.
	 *
	 * @return int|null
	 */
	 ...
	 * - If includeStderr( true ) was called, it will also include stderr
