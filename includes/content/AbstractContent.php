...
abstract class AbstractContent implements Content {
	 ...
	 * Subclasses that want to control the parser output may override this, but
	 * they must override fillParserOutput(). If they override this, they should
	 * take care to call the ContentGetParserOutput hook.
	 *
