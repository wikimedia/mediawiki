...
abstract class CodeContent extends TextContent {
	 ...
	 * @param string|null $data if given, will be used instead of self::getNativeData()
	 * @return string code wrapped in a <pre> tag with the specified css class
	 */
	protected function codeToPreElement( $cssClass, $data = null ) {
		$html = "<pre class='mw-code $cssClass' dir='ltr'>\n";
		$html .= htmlspecialchars( $data !== null ? $data : $this->getNativeData() );
		$html .= "\n</pre>\n";
