...
abstract class CodeContent extends TextContent {
	...
	/** If set, will apply Parser::preSaveTransform() transformation in the preSaveTransform() override */
	const ApplyPST = 0x01;

	/** @var int bit fields defining the behaviour of the instance */
	protected $flags;

	/**
	 * @param string $text
	 * @param string $model_id
	 * @param int $flags Bit flags that define behavior of this class. For now, only supports ApplyPST
	 * @throws MWException
	 */
	public function __construct( $text, $model_id = CONTENT_MODEL_TEXT, $flags = 0 ) {
