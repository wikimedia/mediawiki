...
class JsonContent extends TextContent {
	...
	public function isEmpty() {
		// NOTE: casting to array turns an empty object (stdClass) or null into an empty array,
		// but will turn other values (e.g. empty string, 0, or false) into a non-empty array.
		// This matches the intended semantics of Content::isEmpty for JSON.
