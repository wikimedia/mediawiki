...
abstract class ContentHandler {
	 ...
	 */
	private function getChangeType( Content $oldContent = null, Content $newContent = null,
		$flags ) {
		/**
		 * @var $ot Title
		 * @var $rt Title
		...
		if ( $oldContent && $oldContent->getModel() !== $newContent->getModel() ) {
	 ...
	 */
	public function getChangeTag( Content $oldContent = null, Content $newContent = null,
		$flags ) {
		$changeType = $this->getChangeType( $oldContent, $newContent, $flags );
	...
	public function getAutosummaryAndChangeTag( Content $oldContent = null,
		...
		return [
			'summary' => $this->getAutosummary( $oldContent, $newContent, $flags ),
			'tag' => $this->getChangeTag( $oldContent, $newContent, $flags )
		];
	}
