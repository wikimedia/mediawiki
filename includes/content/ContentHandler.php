...
abstract class ContentHandler {
	 ...
	 *
	 * @return string|null The textual form of $content, if available
	 * @throws MWException If the ccontent is not an instance of TextContent and
	 ...
	 * @throws MWException If model ID or format is not supported or if text can
	 *    not be unserialized using the format.
	 */
	 ...
	 * @param Title $title
	 *
	 * @return string|null Default model name for the page given by $title
	 */
