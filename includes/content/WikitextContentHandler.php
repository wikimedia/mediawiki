...
class WikitextContentHandler extends TextContentHandler {
	...
	public function getFieldsForSearchIndex() {
		...
		$this->addSearchField( $fields, 'coordinates', SearchIndexFieldDefinition::INDEX_TYPE_GEOPOINT );
		$this->addSearchField( $fields, 'external_link', SearchIndexFieldDefinition::INDEX_TYPE_KEYWORD );
		...
		$this->addSearchField( $fields, 'incoming_links', SearchIndexFieldDefinition::INDEX_TYPE_INTEGER );
		$this->addSearchField( $fields, 'auxiliary_text', SearchIndexFieldDefinition::INDEX_TYPE_TEXT );
		$this->addSearchField( $fields, 'opening_text', SearchIndexFieldDefinition::INDEX_TYPE_TEXT );
		$fields['opening_text']->setFlag( SearchIndexFieldDefinition::FLAG_SECONDARY );
		$this->addSearchField( $fields, 'outgoing_link', SearchIndexFieldDefinition::INDEX_TYPE_KEYWORD );
		$this->addSearchField( $fields, 'popularity_score', SearchIndexFieldDefinition::INDEX_TYPE_NUMBER );
		$this->addSearchField( $fields, 'template', SearchIndexFieldDefinition::INDEX_TYPE_KEYWORD );
		$fields['template']->setFlag( SearchIndexFieldDefinition::FLAG_CASEFOLD );
		$this->addSearchField( $fields, 'wikibase_item', SearchIndexFieldDefinition::INDEX_TYPE_KEYWORD );
		...
		$this->addSearchField( $fields, 'local_sites_with_dupe', SearchIndexFieldDefinition::INDEX_TYPE_KEYWORD );
