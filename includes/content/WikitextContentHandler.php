...
class WikitextContentHandler extends TextContentHandler {
	...
	private function getParserOutputSearchFields( SearchEngine $engine ) {
		...
		$fields = [
			'category' => $parserOutputFieldFactory->getCategoryField(),
			'external_link' => $parserOutputFieldFactory->getExternalLinkField(),
			'outgoing_link' => $parserOutputFieldFactory->getOutgoingLinkField(),
			'template' => $parserOutputFieldFactory->getTemplateField()
		];
