...
class WikitextContentHandler extends TextContentHandler {
	...
	public function getDataForSearchIndex(
		...
		$fieldData['category'] = $parserOutputSearchDataExtractor->getCategories( $parserOutput );
		$fieldData['external_link'] = $parserOutputSearchDataExtractor->getExternalLinks( $parserOutput );
		$fieldData['outgoing_link'] = $parserOutputSearchDataExtractor->getOutgoingLinks( $parserOutput );
		$fieldData['template'] = $parserOutputSearchDataExtractor->getTemplates( $parserOutput );
