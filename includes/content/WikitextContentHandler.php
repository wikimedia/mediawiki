...
class WikitextContentHandler extends TextContentHandler {
	...
	public function getFieldsForSearchIndex( SearchEngine $engine ) {
		$fields = $this->getParserOutputSearchFields( $engine );
	 ...
	 */
	private function getParserOutputSearchFields( SearchEngine $engine ) {
		$parserOutputFieldFactory = new ParserOutputSearchIndexFieldFactory( $engine );

		$fields = [
			'category' => $parserOutputFieldFactory->newCategoryField(),
			'external_link' => $parserOutputFieldFactory->newExternalLinkField(),
			'outgoing_link' => $parserOutputFieldFactory->newOutgoingLinkField(),
			'template' => $parserOutputFieldFactory->newTemplateField()
		];
