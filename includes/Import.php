...
class WikiRevision {
	...
	function importOldRevision() {
		...
		if ( !$page->exists() ) {
			...
			$created = true;
			$oldcountable = null;
			wfDebug( __METHOD__ . ': nonexistent page "' . $this->title . '", created=true' );
		} else {
			$pageId = $page->getId();
			$created = false;
			...
			wfDebug( __METHOD__ . ': existing page "' . $this->title . '", oldcountable=' . $oldcountable );
		}
		...
		wfDebug( __METHOD__ . ': after updateIfNewerOn, changed=' . $changed );
