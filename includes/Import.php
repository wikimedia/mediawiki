...
class WikiImporter {
	...
	private function processRevision( $pageInfo, $revisionInfo ) {
		...
		/* Make sure revisions imported with ImportDump.php wont violate $wgMaxArticleSize which may lead to errors in database and instability
		Testing for revisions with only listed models (or if there is none)
		because other content models might use serialization formats which aren't checked against $wgMaxArticleSize */
