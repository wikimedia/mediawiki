...
class WikiImporter {
	...
	private function openSource( ImportStreamSource $source ) {
		...
		if ( !$result ) {
			throw new MWException( 'Could not open the provided source file.' );
		}
	...
	private function checkRegisteredStreams() {
		...
		if ( !in_array( 'uploadsource', stream_get_wrappers() ) ) {
			$result = stream_wrapper_register( 'uploadsource', 'UploadSourceAdapter' );
		}

		if ( !$result ) {
			throw new MWException( 'Could not register upload source as a valid stream.' );
		}
