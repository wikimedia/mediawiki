 ...
 *
 * Use the hook name "OutputTransformFirstStage" to register handlers
 * implementing this interface.
 *
 * @stable to implement
 * @ingroup Hooks
 */
interface OutputTransformFirstStageHook {
	/**
	 * This hook is called from the post-processing output transform pipeline
	 * at the very start of processing to do post-cache transformations.
	 *
