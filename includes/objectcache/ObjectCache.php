...
class ObjectCache {
	...
	static function newWANCacheFromId( $id ) {
		...
		$class = $wgWANObjectCaches['pubSubConfig']['class'];
		$params['publisher'] = new $class( $wgWANObjectCaches['pubSubConfig'] );
		$params['cache'] = self::newFromId( $wgWANObjectCaches[$id]['cacheId'] );
