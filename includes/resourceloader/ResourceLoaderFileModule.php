...
class ResourceLoaderFileModule extends ResourceLoaderModule {
	 ...
	 * @param Less_Parser $compiler Compiler to use, if not default
	 * @param ResourceLoaderContext $context Context in which to generate script
	 * @return string CSS source
	 */
	protected function compileLessFile( $fileName, $compiler = null, ResourceLoaderContext $context ) {
		static $cache;
		...
		if ( !$compiler ) {
			return ResourceLoader::getLessCompiler( $this->getConfig(), $vars );
		}
