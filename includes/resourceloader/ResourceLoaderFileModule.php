...
class ResourceLoaderFileModule extends ResourceLoaderModule {
	...
	protected function compileLESSFile( $fileName ) {
		...
		try {
			...
			// ResourceLoader::makeModuleResponse requires we abstract the lower level
			// exceptions from LESS in a MWException
			throw new MWException( 'LESS error: ' . $e->getMessage() );
		}
