...
class ResourceLoader {
	 ...
	 *
	 * @param mixed $id Source ID (string), or array( id1 => loadUrl, id2 => loadUrl, ... )
	 * @param array|string|null $loadUrl load.php url, may be an array for backwards-compatability
	 * @throws MWException
	 */
