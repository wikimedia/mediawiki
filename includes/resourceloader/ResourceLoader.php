					...
					default:
						...
						if ( is_string( $scripts ) ) {
							if ( $name === 'site' || $name === 'user' ) {
								// Legacy scripts that run in the global scope without closure.
								// Transport as string instructs mw.loader.implement to use globalEval.
								// Minify manually here, because general response minification is not
								// effective due it being a string literal, not a function. (T107377)
