...
trait ResourceLoaderOOUIModule {
	...
	protected static $builtinThemePaths = [
		'MediaWiki' => [
			'scripts' => 'resources/lib/oojs-ui/oojs-ui-mediawiki.js',
			'styles' => 'resources/lib/oojs-ui/oojs-ui-{module}-mediawiki.css',
			'images' => 'resources/lib/oojs-ui/themes/mediawiki/{module}.json',
		],
		'Apex' => [
	...
	/**
	 * Return a path to load given module of given theme from, or `null` if given theme doesn't have
	 * the given module.
	 *
	 * @param string $theme OOUI theme name, for example 'MediaWiki' or 'Apex'
	 ...
	 * @return null|string|ResourceLoaderFilePath
	 */
