...
abstract class ResourceLoaderModule {
	 ...
	 * function, when provided, will be passed along to the module registry on the client.
	 * When this module is loaded (either directly or as dependency of another module), then
	 * this function is executed first. If the function returns true, the module will
