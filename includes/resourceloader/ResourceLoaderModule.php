...
abstract class ResourceLoaderModule {
	...
	public function getDefinitionMtime( ResourceLoaderContext $context ) {
		...
		if ( is_int( $data ) && $data > 0 ) {
			// We've seen this hash before, re-use the timestamp of when we first it.
			return $data;
		}

		wfDebugLog( 'resourceloader', __METHOD__ . ": Definition for {$this->getName()} (context: \"{$context->getHash()}\") changed." );
