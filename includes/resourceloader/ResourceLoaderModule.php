...
abstract class ResourceLoaderModule {
	 ...
	 *
	 * A number of utility methods are available to help you gathering data. These are
	 * not called by default and must be included by the subclass' getDefinitionSummary().
	 *
	 * - getMsgBlobMtime()
	 *
	 * @since 1.23
