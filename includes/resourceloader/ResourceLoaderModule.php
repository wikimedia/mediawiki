...
abstract class ResourceLoaderModule implements LoggerAwareInterface {
	 ...
	 *
	 * It is not supported to send headers through this method that
	 * are required to be unique or otherwise send once in an HTTP response
	 * because a clients may make a batch request for multiple modules (and
	 * this is the default for ResourceLoader clients).
	 *
	 ...
	 *
	 * Behaviour of rel=preload links are specified at <https://www.w3.org/TR/preload/>.
	 *
