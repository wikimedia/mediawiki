...
abstract class ResourceLoaderModule {
	 ...
	 * @return array
	 */
	protected function getContents( $context ) {
		...
		if ( !array_key_exists( $contextHash, $this->versionHash ) ) {
			$this->versionHash[ $contextHash ] = $this->buildContent( $context );
		}
	...
	final protected function buildContent( $context ) {
		...
		// Messages
		$modules = array();
		$modules[$this->getName()] = $this;
		$blobs = $this->blobStore->get( $rl, $modules, $context->getLanguage() );
