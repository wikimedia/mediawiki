...
abstract class ResourceLoaderModule {
	...
	public function getVersionHash( ResourceLoaderContext $context ) {
		// Cache this somewhat expensive operation. Especially because some classes (e.g. startup
		// module) iterate over all modules and retrieve version hashes more than once.
		$contextHash = $context->getHash();
		echo "\n" . __METHOD__ . " " . $context->getHash() . " " . $this->getName();
		if ( isset( $this->versionHash[ $contextHash ] ) ) {
			return $this->versionHash[ $contextHash ];
		}

		$str = json_encode( $this->getDefinitionSummary( $context ) );
		...
		$this->versionHash[ $contextHash ] = $str;
		return $str;
	}
	...
	public function getDefinitionSummary( ResourceLoaderContext $context ) {
		return array(
			...
			'cacheEpoch' => $this->getConfig()->get( 'CacheEpoch' ),
		);
	}
