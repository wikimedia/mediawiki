...
class ResourceLoaderSkinModule extends ResourceLoaderFileModule {
	...
	public function getStyles( ResourceLoaderContext $context ) {
		...
		$logo1 = CSSMin::buildUrlValue( OutputPage::transformResourcePath( $logo ) );
		$logo15 = CSSMin::buildUrlValue( OutputPage::transformResourcePath( $logoHD['1.5x'] ) );
		$logo2 = CSSMin::buildUrlValue( OutputPage::transformResourcePath( $logoHD['2x'] ) );
