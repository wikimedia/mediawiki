...
class ResourceLoaderWikiModule extends ResourceLoaderModule {
	 ...
	 * @return null|string
	 * @since 1.30 added the $context parameter
	 */
	protected function getContent( $titleText, ResourceLoaderContext $context = null ) {
		if ( $context === null ) {
			wfDeprecated( __METHOD__ . ' without a ResourceLoader context', '1.30' );
		}
	 ...
	 * @return Content|null
	 * @since 1.30 added the $context and $maxRedirects parameter
	 */
