...
class EditPage {
	...
	function getSummaryInput( $summary = "", $labelText = null,
		...
		$input = Html::rawElement( 'div', array( 'class' => 'mw-summary-wrap' ) ) .
			Html::rawElement( 'div', array( 'class' => 'mw-summary-div' ), $input ) .
			Html::rawElement( 'div', array( 'class' => 'mw-summary-clear' ) );
