...
HTML
	...
	/**
	 * Turns section name wikitext into anchors for use in HTTP redirects. Since various
	 * versions of Microsoft browsers interpret Location: headers as something other
	 * than UTF-8, redirect them to legacy (.C0.DE) section IDs, if possible. All the other
	 * browsers get HTML5 if the wiki is configured for it, to spread the new style links
	 * more efficiently.
	 *
	 * @param string $text
	 * @return string
