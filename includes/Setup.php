...
// These lines should eventually be generated by the installer and placed in DefaultSettings.php,
// along with a require_once for each skin file (instead of loading them via AutoLoader like now).
