...
ExtensionRegistry::getInstance()->loadFromQueue( $wgVersion, $wgConfigRegistry );
...
// no longer needed (were used only in bootstrap config)
unset( $wgConfigRegistry, $wgServiceWiringFiles );
