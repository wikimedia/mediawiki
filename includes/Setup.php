...
# We always output html5, override any change made by local settings
$wgHtml5 = true;

# Setting wgXhtmlDefaultNamespace is no longer supported.
# However define it here for extensions that depend on it's value.
