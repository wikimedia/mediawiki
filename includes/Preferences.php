...
class Preferences {
	 ...
	 * @return array A list of all time zones, the value is an array which contains localized name,
	 *  the timecorrection value used for preferences and the region
	 * @since 1.26
	 */
	public static function getTimeZoneList( Language $language ) {
		...
		$tzRegions = array();
		$tzRegions['Africa'] = wfMessage( 'timezoneregion-africa' )->inLanguage( $language )->text();
		$tzRegions['America'] = wfMessage( 'timezoneregion-america' )->inLanguage( $language )->text();
		$tzRegions['Antarctica'] = wfMessage( 'timezoneregion-antarctica' )->inLanguage( $language )->text();
		$tzRegions['Arctic'] = wfMessage( 'timezoneregion-arctic' )->inLanguage( $language )->text();
		$tzRegions['Asia'] = wfMessage( 'timezoneregion-asia' )->inLanguage( $language )->text();
		$tzRegions['Atlantic'] = wfMessage( 'timezoneregion-atlantic' )->inLanguage( $language )->text();
		$tzRegions['Australia'] = wfMessage( 'timezoneregion-australia' )->inLanguage( $language )->text();
		$tzRegions['Europe'] = wfMessage( 'timezoneregion-europe' )->inLanguage( $language )->text();
		$tzRegions['Indian'] = wfMessage( 'timezoneregion-indian' )->inLanguage( $language )->text();
		$tzRegions['Pacific'] = wfMessage( 'timezoneregion-pacific' )->inLanguage( $language )->text();
		asort( $tzRegions );
