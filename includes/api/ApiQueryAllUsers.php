...
class ApiQueryAllUsers extends ApiQueryBase {
	...
	public function execute() {
		...
		if ( $params['activeusers'] ) {
			...
			$timestamp = $db->timestamp( wfTimestamp( TS_UNIX ) - $this->getConfig()->get( 'wgActiveUserDays' ) * 24 * 3600 );
	...
	public function getParamDescription() {
		return array(
			...
			'activeusers' => "Only list users active in the last {$this->getConfig()->get( 'wgActiveUserDays' )} days(s)"
		);
	}
