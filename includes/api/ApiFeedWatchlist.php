...
class ApiFeedWatchlist extends ApiBase {
	...
	public function execute() {
		...
		try {
			...
			if ( $params['wlshow'] !== null ) {
				$fauxReqArr['show'] = join( '|', $params['wlshow'] );
			}
	...
	public function getAllowedParams( $flags = 0 ) {
		...
		if ( $flags ) {
			$wlparams = $this->getMain()->getModuleManager()->getModule( 'query' )->getModuleManager()->getModule( 'watchlist' )->getAllowedParams( $flags );
	...
	public function getParamDescription() {
		return array(
			...
			'wlshow'     => "Only show revisions that meet wlshow (=ApiQueryWatchlist's 'show') criteria",
