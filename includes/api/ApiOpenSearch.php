...
class ApiOpenSearch extends ApiBase {
	...
	public function execute() {
		...
		if ( $suggest && !$this->getConfig()->get( 'wgEnableOpenSearchSuggest' ) ) {
			$searches = array();
		} else {
			// Open search results may be stored for a very long time
			$this->getMain()->setCacheMaxAge( $this->getConfig()->get( 'wgSearchSuggestCacheExpiry' ) );
	...
	public function getAllowedParams() {
		return array(
			'search' => null,
			'limit' => array(
				ApiBase::PARAM_DFLT => $this->getConfig()->get( 'wgOpenSearchDefaultLimit' ),
