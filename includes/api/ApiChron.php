...
/**
 * This is a simple class to handle action=chron and is only used internally
 *
 * @note: this does not requre "write mode" nor tokens due to the signature check
 *
 * @ingroup API
 */
class ApiChron extends ApiBase {
	...
	public function getExamples() {
		return array(
			'api.php?action=chron&tasks=jobs&maxjobs=1' => 'Run up to 3 jobs from the queue',
		);
	}
}
