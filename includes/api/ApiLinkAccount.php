...
class ApiLinkAccount extends ApiBase {
	...
	public function getFinalDescription() {
		...
		$msgs[] = ApiBase::makeMessage( 'api-help-authmanager-general-usage', $this->getContext(), array(
	...
	public function dynamicParameterDocumentation() {
		return array( 'api-help-authmanagerhelper-additional-params', AuthManager::ACTION_LINK );
	}
