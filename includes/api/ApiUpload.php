...
class ApiUpload extends ApiBase {
	...
	public function execute() {
		...
		$this->mParams['async'] = ( $this->mParams['async'] && $this->getConfig()->get( 'wgEnableAsyncUploads' ) );
		...
		switch ( $verification['status'] ) {
			...
			case UploadBase::FILETYPE_BADTYPE:
				$extradata = array(
					...
					'allowed' => array_values( array_unique( $this->getConfig()->get( 'wgFileExtensions' ) ) )
				);
	...
	protected function checkAsyncDownloadEnabled() {
		if ( !$this->getConfig()->get( 'wgAllowAsyncCopyUploads' ) ) {
