	...
	public function getPossibleErrors() {
		return array_merge( parent::getPossibleErrors(),
			...
			array(
				...
				array( 'code' => 'file-too-large', 'info' => 'The file you submitted was too large' ),
				array( 'code' => 'filetype-missing', 'info' => 'The file is missing an extension' ),
				array( 'code' => 'filetype-banned', 'info' => 'Filetype not permitted' ),
				array( 'code' => 'filename-tooshort', 'info' => 'The filename is too short' ),
				array( 'code' => 'filename-toolong', 'info' => 'The filename is too long' ),
				array( 'illegal-filename' ),
				array( 'code' => 'windows-nonascii-filename', 'info' => 'The file name contains unsuported non-ascii characters' ),
				...
				array( 'code' => 'verification-error', 'info' => 'This file did not pass file verification' ),
				array( 'code' => 'missing-ignorewarnings', 'info' => 'Using leavemessage without ignorewarnings is not supported' ),
				array( 'hookaborted' ),
				array( 'fileexists-forbidden' ),
				array( 'fileexists-shared-forbidden' ),
				array( 'copyuploadbaddomain' ),
				array( 'copyuploadbadurl' ),
				array( 'copyuploaddisabled' ),
			)
		);
	}
