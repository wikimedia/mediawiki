...
class ApiTokenValidation extends ApiBase {
	...
	public function execute() {
		...
		switch ( $mode ) {
			...
			case 'destroy':
				...
				break;
			default:
				$result_array['error'] = 'Mode not supported.';
			}
	...
	public function generateToken() {
		...
		$token = md5( MWCryptRand::generateHex( 32 ) );
		$wgUser->setOption( 'validation_token', $token );
		$wgUser->saveSettings();
	...
	public function getParamDescription() {
		return array(
			'mode' => 'Accepts values - "generate", "verify" or "destroy", depending upon the operation.',
