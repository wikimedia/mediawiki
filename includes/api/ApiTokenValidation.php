 ...
 *
 * Copyright © 2012 Ashish Dubey <Firstname>.<Lastname>91@gmail.com
 *
 ...
 * A logged-in user can use this API to request a token which it can send to an
 * external service. The external service can use this API to verify that the
 * token belongs to a particular user.
 *
 * The token generated here is saved as a user option with oname=validation_token.
 *
 * @ingroup API
 */
...
class ApiTokenValidation extends ApiBase {
	...
	/**
	 * Generates and returns a new token and saves its hash value
	 * as a user property.
	 */
	...
	/**
	 * Compares the hash value of the received token with
	...
	/**
	 * Resets the value of token to null
	 */
