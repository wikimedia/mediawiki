...
class ApiDelete extends ApiBase {
	 ...
	 * @param UserIdentity $deleter user doing the action
	 * @param string|null &$reason Reason for the deletion. Autogenerated if null
	 * @param string[] $tags Tags to tag the deletion with
	 * @return Status
	 */
	private static function delete( WikiPage $page, UserIdentity $deleter, &$reason = null, $tags = [] ) {
		$title = $page->getTitle();
	...
	private function deleteFile( WikiPage $page, UserIdentity $deleter, $oldimage,
		...
		if ( !self::canDeleteFile( $file ) ) {
			return self::delete( $page, $deleter, $reason, $tags );
		}
		...
		return FileDeleteForm::doDelete( $title, $file, $oldimage, $reason, $suppress, $deleter, $tags );
	}
