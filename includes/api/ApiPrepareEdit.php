...
class ApiPrepareEdit extends ApiBase {
	public function execute() {
		...
		// @TODO: make this work for new pages
		...
		if ( !ContentHandler::getForModelID( $params['model'] )
			->isSupportedFormat( $params['format'] )
		) {
			$this->dieUsage( "Unsupported content model/format pair", 'badmodelformat' );
		}
