...
class ApiManageTags extends ApiBase {
	...
	protected function getExamplesMessages() {
		return [
			'formatversion=2&action=managetags&operation=create&tag=spam'
				. '&reason=For+use+in+edit+patrolling&token=123ABC'
				=> 'apihelp-managetags-example-create',
			'formatversion=2&action=managetags&operation=delete&tag=vandlaism'
				. '&reason=Misspelt&token=123ABC'
				=> 'apihelp-managetags-example-delete',
			'formatversion=2&action=managetags&operation=activate&tag=spam'
				. '&reason=For+use+in+edit+patrolling&token=123ABC'
				=> 'apihelp-managetags-example-activate',
			'formatversion=2&action=managetags&operation=deactivate&tag=spam'
				. '&reason=No+longer+required&token=123ABC'
