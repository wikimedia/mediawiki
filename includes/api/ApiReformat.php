...
class ApiReformat extends ApiBase {
	...
	protected function getExamplesMessages() {
		return [
			'action=reformat&text={"a":"b","c":"d"}&contentmodel=structured&inputformat=application/json&outputformat=text/x-yaml' => 'apihelp-reformat-example-structured',
			'action=reformat&text=foobar&contentmodel=wikitext&inputformat=text/x-wiki&outputformat=text/x-wiki' => 'apihelp-reformat-example-wikitext'
		];
	}
