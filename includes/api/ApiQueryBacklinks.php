...
class ApiQueryBacklinks extends ApiQueryGeneratorBase {
	...
	protected function getExamplesMessages() {
		static $examples = [
			...
			'imageusage' => [
				'formatversion=2&action=query&list=imageusage'
					. '&iutitle=File:Albert%20Einstein%20Head.jpg'
					=> 'apihelp-query+imageusage-example-simple',
				'formatversion=2&action=query&generator=imageusage'
					. '&giutitle=File:Albert%20Einstein%20Head.jpg&prop=info'
