...
class ApiQueryContributors extends ApiQueryBase {
	...
	public function execute() {
		...
		foreach ( $res as $row ) {
			...
			if ( !$fit ) {
				...
				$this->setContinueEnumParameter( 'continue', '0|0' );
				return;
			}
		}
	...
	public function getParamDescription() {
		return array(
			...
			'rights' => 'Limit users to those having given right(s)' .
				'(does not include rights granted by implicit or auto-promoted groups like *, user, or autoconfirmed)',
			'excluderights' => 'Limit users to those not having given right(s)' .
				'(does not include rights granted by implicit or auto-promoted groups like *, user, or autoconfirmed)',
			'excluderights' => 'Limit users to given right(s) (does not include rights granted by implicit or auto-promoted groups like *, user, or autoconfirmed)',
	...
	public function getDescription() {
		return 'Get the list of logged-in contributors and the count of anonymous contributors to a page';
	}
	...
	public function getHelpUrls() {
		return 'https://www.mediawiki.org/wiki/API:Properties#contributors_.2F_co';
	}
}
