...
class ApiOptions extends ApiBase {
	...
	public function execute() {
		...
		if ( $params['reset'] ) {
			// FIXME: Ugly workaround to have $user->mOptionsLoaded flag set to true
			// Waiting for werdna's response about resetOptions()
			$user->getOptions();
			$user->resetOptions();
			$changes++;
		}
		...
		if ( isset( $params['optionname'] ) ) {
			$user->setOption( $params['optionname'], $params['optionvalue'] );
			$changes++;
		}
