...
class ApiCreateAccount extends ApiBase {
	...
	public function __construct( $main, $action ) {
		parent::__construct( $main, $action, 'ca' );
	}
	...
	public function getExamples() {
		return array(
			'api.php?action=createaccount&caname=testuser&capassword=test123',
			'api.php?action=createaccount&caname=testmailuser&camailpassword=true&careason=MyReason',
		);
	}
