...
class ApiCreateAccount extends ApiBase {
	public function execute() {
		...
		if ( $status->isGood() ) {
			...
			} elseif ( $this->getConfig()->get( 'wgEmailAuthentication' ) && Sanitizer::validateEmail( $user->getEmail() ) ) {
	...
	public function getAllowedParams() {
		return array(
			...
			'email' => array(
				...
				ApiBase::PARAM_REQUIRED => $this->getConfig()->get( 'wgEmailConfirmToEdit' ),
			),
			'realname' => null,
			'mailpassword' => array(
	...
	public function getPossibleErrors() {
		...
		$errors[] = array(
			...
			'info' => wfMessage( 'passwordtooshort', $this->getConfig()->get( 'wgMinimalPasswordLength' ) )
