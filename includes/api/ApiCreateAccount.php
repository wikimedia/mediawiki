...
class ApiCreateAccount extends ApiBase {
	...
	public function getPossibleErrors() {
		// Note the following arrows aren't possible and don't need to be listed:
		...
		$errors[] = array( 'code' => 'permdenied-createaccount', 'info' => 'You do not have the right to create a new account' );
		$errors[] = array( 'code' => 'blocked', 'info' => 'You cannot create a new account because you are blocked' );
		$errors[] = array( 'code' => 'aborted', 'info' => 'Account creation aborted by hook (info may vary)' );
