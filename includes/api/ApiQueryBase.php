...
abstract class ApiQueryBase extends ApiBase {
	...
	public function titlePartToKey( $titlePart, $defaultNamespace = NS_MAIN ) {
		...
		if ( $defaultNamespace != $t->getNamespace() ) {
			// This happens if you call titlePartToKey with a title part that looks like a 
			// namespace, but with $defaultNamespace = NS_MAIN. It would be very difficult to 
			// handle such a case, and such pages cannot exist. Therefore, the easiest thing to do
