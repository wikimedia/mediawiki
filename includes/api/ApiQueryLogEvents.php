...
class ApiQueryLogEvents extends ApiQueryBase {
	...
	public function execute() {
		...
		if ( !is_null( $prefix ) ) {
			if ( $this->getConfig()->get( 'wgMiserMode' ) ) {
	...
	public function getAllowedParams() {
		...
		return array(
			...
			'type' => array(
				ApiBase::PARAM_TYPE => $config->get( 'wgLogTypes' )
			),
			'action' => array(
				ApiBase::PARAM_TYPE => array_keys(
					array_merge(
						$config->get( 'wgLogActions' ),
						$config->get( 'wgLogActionsHandlers' )
					)
				)
			),
			'start' => array(
	...
	public function getResultProperties() {
		return array(
			...
			'type' => array(
				'type' => array(
					ApiBase::PROP_TYPE => $this->getConfig()->get( 'wgLogTypes' )
				),
				'action' => 'string'
			),
			'details' => array(
