...
class ApiClearHasMsg extends ApiBase {
	...
	public function getDescription() {
		return array( 'Flags all new messages as read.',
			'This is useful for tools that are reading new messages using api or' .
			' some unusual way and need to flag them as read.'
		);
	}

	public function getExamples() {
		return array(
			'api.php?action=clearhasmsg' => 'Mark all messages for user who is ' .
			'currently logged in as read',
		);
	}
