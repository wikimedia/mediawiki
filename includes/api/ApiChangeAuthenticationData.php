...
class ApiChangeAuthenticationData extends ApiBase {
	...
	public function execute() {
		...
		// Fetch the request
		$reqs = $helper->loadAuthenticationRequests( AuthManager::ACTION_CHANGE );
		if ( count( $reqs ) !== 1 ) {
		...
		$this->getResult()->addValue( null, 'changeauthenticationdata', array( 'status' => 'success' ) );
	}
	...
	public function dynamicParameterDocumentation() {
		return array( 'api-help-authmanagerhelper-additional-params', AuthManager::ACTION_CHANGE );
	}
