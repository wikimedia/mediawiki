...
abstract class ApiFormatBase extends ApiBase {
	...
	public function closePrinter() {
		...
		if ( $this->getIsHtml() && $mime !== null ) {
			...
			$context->setSkin( SkinFactory::getDefaultInstance()->makeSkin( 'bare' ) );
			...
			if ( wfRunHooks( 'ApiFormatHighlight', array( $result, $out, $mime, $format ) ) ) {
				$out->addHTML(
	 ...
	 * @deprecated since 1.24, output is always buffered
	 * @param bool $value
	 */
