...
class ApiQueryAuthManagerInfo extends ApiQueryBase {
	...
	protected function getExamplesMessages() {
		return [
			'formatversion=2&action=query&meta=authmanagerinfo&amirequestsfor='
				. urlencode( AuthManager::ACTION_LOGIN )
				=> 'apihelp-query+authmanagerinfo-example-login',
			'formatversion=2&action=query&meta=authmanagerinfo&amirequestsfor='
				. urlencode( AuthManager::ACTION_LOGIN ) . '&amimergerequestfields=1'
				=> 'apihelp-query+authmanagerinfo-example-login-merged',
			'formatversion=2&action=query&meta=authmanagerinfo&amisecuritysensitiveoperation=foo'
