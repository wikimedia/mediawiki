 ...
 * @ingroup API
 */
class ApiFlagNewMessagesAsRead extends ApiBase {
	/**
	...
	public function getExamples() {
		return array(
			'api.php?action=flagnewmessagesasread' => 'Mark all messages for user who is currently logged in as read',
		);
	}

	public function getHelpUrls() {
		return 'https://www.mediawiki.org/wiki/API:FlagNewMessagesAsRead';
	}
}
