...
class ApiQuery extends ApiBase {
	 ...
	 * @deprecated since 1.21, use getModuleMgr()'s methods instead
	 * @return array array(modulename => classname)
	 */
	public function getModules() {
		return $this->getModuleMgr()->getNamesWithClasses();
	}
	 ...
	 * @deprecated since 1.21, use getModuleMgr()->getModuleGroup()
	 * @param $moduleName string Name of the module to find type for
	 * @return mixed string or null
	 */
	function getModuleType( $moduleName ) {
		return $this->getModuleMgr()->getModuleGroup( $moduleName );
	}
