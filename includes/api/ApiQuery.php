...
class ApiQuery extends ApiBase {
	...
	public function __construct( $main, $action ) {
		...
		$this->mModuleMgr->addModules( $config->get( 'wgAPIPropModules' ), 'prop' );
		$this->mModuleMgr->addModules( self::$QueryListModules, 'list' );
		$this->mModuleMgr->addModules( $config->get( 'wgAPIListModules' ), 'list' );
		$this->mModuleMgr->addModules( self::$QueryMetaModules, 'meta' );
		$this->mModuleMgr->addModules( $config->get( 'wgAPIMetaModules' ), 'meta' );
