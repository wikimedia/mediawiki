...
class ApiChangePassword extends ApiBase {
	...
	public function execute() {
		...
		if ( $params['token'] === null ) {
			...
			if ( $params['retypepassword'] === null ) {
				$params['retypepassword'] = $params['newpassword'];
			}

			$manager = new UserManager( $user, $this );
			$status = $manager->changePassword(
				$params['oldpassword'], $params['newpassword'], $params['retypepassword']
			);
