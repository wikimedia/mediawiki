...
class ApiMain extends ApiBase {
	...
	protected function sendCacheHeaders() {
		...
		// The logic should be:
		// $this->mCacheMode['max-age'] is set?
		//    Use it, the module knows better than our guess.
		// !$this->mModule || $this->mModule->isWriteMode()?
		...
		$maxage = 0;
		if ( isset( $this->mCacheMode['max-age'] ) ) {
			$maxage = $this->mCacheMode['max-age'];
		} elsif ( $this->mModule && !$this->mModule->isWriteMode() ) {
