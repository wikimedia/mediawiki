...
class ApiMain extends ApiBase {
	...
	public function modifyHelp( array &$help, array $options, array &$tocData ) {
		...
		if ( empty( $options['nolead'] ) ) {
			...
			$id = Sanitizer::escapeIdForHtml( 'main/datatypes', Sanitizer::ID_PRIMARY );
			$idFallback = Sanitizer::escapeIdForHtml( 'main/datatypes', Sanitizer::ID_FALLBACK );
			...
			$id = Sanitizer::escapeIdForHtml( 'main/credits', Sanitizer::ID_PRIMARY );
			$idFallback = Sanitizer::escapeIdForHtml( 'main/credits', Sanitizer::ID_FALLBACK );
