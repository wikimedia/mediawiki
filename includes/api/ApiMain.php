...
class ApiMain extends ApiBase {
	...
	public function __construct( $context = null, $enableWrite = false ) {
		...
		$this->mModuleMgr->addModules( $config->get( 'wgAPIModules' ), 'action' );
		$this->mModuleMgr->addModules( self::$Formats, 'format' );
		$this->mModuleMgr->addModules( $config->get( 'wgAPIFormatModules' ), 'format' );
	...
	protected function handleCORS() {
		...
		$matchOrigin = self::matchOrigin(
			$originParam,
			$config->get( 'wgCrossSiteAJAXdomains' ),
			$config->get( 'wgCrossSiteAJAXdomainExceptions' )
		);
