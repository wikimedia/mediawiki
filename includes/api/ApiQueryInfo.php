...
class ApiQueryInfo extends ApiQueryBase {
	...
	public function requestExtraData( $pageSet ) {
		...
		if ( !$config->get( 'wgDisableCounters' ) ) {
			$pageSet->requestField( 'page_counter' );
		}
		$pageSet->requestField( 'page_touched' );
		$pageSet->requestField( 'page_latest' );
		$pageSet->requestField( 'page_len' );
		if ( $config->get( 'wgContentHandlerUseDB' ) ) {
	...
	private function extractPageInfo( $pageid, $title ) {
		...
		if ( $titleExists ) {
			...
			$pageInfo['counter'] = $this->getConfig()->get( 'wgDisableCounters' )
				? ''
	...
	private function getWatcherInfo() {
		...
		$unwatchedPageThreshold = $this->getConfig()->get( 'wgUnwatchedPageThreshold' );
