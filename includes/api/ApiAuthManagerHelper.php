...
class ApiAuthManagerHelper {
	...
	/** @var ApiBase $module API module, for context and parameters */
	private $module;
	...
	public function loadAuthenticationRequests( $action ) {
		...
		if ( isset( $params['requests'] ) ) {
			...
			$wantedRequests = array( $params['request'] => true );
		}
	 ...
	 * @return array
	 */
	public static function getStandardParams( $param /* ... */ ) {
		static $params = array(
			'requests' => array(
				ApiBase::PARAM_TYPE => 'string',
				ApiBase::PARAM_ISMULTI => true,
				ApiBase::PARAM_HELP_MSG => 'api-help-authmanagerhelper-requests',
			),
			'request' => array(
				ApiBase::PARAM_TYPE => 'string',
				ApiBase::PARAM_REQUIRED => true,
				ApiBase::PARAM_HELP_MSG => 'api-help-authmanagerhelper-request',
			),
			'messageformat' => array(
