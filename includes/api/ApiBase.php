...
abstract class ApiBase extends ContextSource {
	 ...
	 * - tags: If not PARAM_ISMULTI, a string containing one existing, explicitly defined tag.
	 *   Otherwise, an array of existing, explicitly defined tags.
