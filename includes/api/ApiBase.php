...
abstract class ApiBase extends ContextSource {
	...
	/**
	 * Return the additional help text message.
	 *
	...
	protected function getHelpTopTextMessage() {
		return "apihelp-{$this->getModulePath()}-toptext";
	}
	...
	public function getFinalDescription() {
		...
		$toptext = ApiBase::makeMessage( $this->getHelpTopTextMessage(), $this->getContext(), [
			$this->getModulePrefix(),
			$this->getModuleName(),
			$this->getModulePath(),
		] );
