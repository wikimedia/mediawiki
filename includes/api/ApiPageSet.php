...
class ApiPageSet extends ApiBase {
	...
	/**
	 * Populate the generator data all titles in the result
	 *
	 * Data for pages not in $result will be ignored.
	 *
	 * @param ApiResult|array &$result
	 * @param array $path Must point to an array in the result indexed by the
	 *   pageid codes returned by this pageset.
