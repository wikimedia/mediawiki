 ...
 * BatchRowWriter for access to the correct table. The components will
...
class BatchRowUpdate {
	/**
	 * @var BatchRowIterator $reader Iterator that returns an array of database rows
	 */
	protected $reader;
	...
	/**
	 * @param BatchRowIterator   $reader    Iterator that returns an array of database rows
