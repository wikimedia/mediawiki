...
class ServiceContainer {
	...
	/**
	 * Provides an argument array for an instantiator function.
	 *
	 * @param mixed $arg1... Any required arguments for the instantiator.
	 *
	 ...
	 */
	private function getInstantiatorArgs() {
		$args = func_get_args();
	...
	public function defineService( $name, $instantiator ) {
		...
		Assert::parameterType( 'callable', $instantiator, '$instantiator' );
