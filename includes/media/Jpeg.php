...
//	}
	...
	function makeParamString( $params ) {
		// Add "-qNNN" at the end of the string. This has to match parseParamString() below
	...
	function parseParamString( $str ) {
		$res = false;
		$m = false;
		// $str contains "200px-q30" or "200px" strings because thumb.php would strip the filename
		// first - check if the string ends with "-qNNN", and if so, treat it as quality.
		// Pass the first portion, or the whole string if "-qNNN" not found, to the parent
