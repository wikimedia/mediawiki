...
class BacklinkJobUtils {
	 ...
	 *
	 * The job provided ($job) must have the 'table' parameter set. The job title will be
	 * used as the title to find backlinks for. Any 'range' parameter must follow the same
	 * format as mentioned above. This should be managed by recursive calls to this method.
	 *
