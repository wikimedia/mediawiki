...
class LogEventsList extends ContextSource {
	 ...
	 * - fullLogParams array|bool Additional url parameters for "full log" link (if it is shown)
	...
	public static function showLogExtract(
		...
		$wrap = $param['wrap'];
		$flags = $param['flags'];
		$fullLogParams = $param['fullLogParams'];
		...
		if ( $numRows > $pager->mLimit ) { # Show "Full log" link
			...
			if ( $fullLogParams !== false ) {
				$urlParam = array_merge( $urlParam, $fullLogParams );
			}
