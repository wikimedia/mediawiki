...
class LogEventsList extends ContextSource {
	...
	/**
	 * @var array of action strings mapped to message keys
	 */
	protected $allowedSubTypes = null;
	...
	private function getActionSelector( $types, $action ) {
		if ( $this->allowedSubTypes === null || !count( $this->allowedSubTypes ) ) {
			return '';
		}
		$html = '';
		...
		foreach ( $this->allowedSubTypes as $value => $msgKey ) {
