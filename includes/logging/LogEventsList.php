...
class LogEventsList extends ContextSource {
	...
	private function getUserInputDesc( $user ) {
		return [
			...
			// TODO Isn't there a better way to do this label?
			'label' => $this->msg( 'specialloguserlabel' )->text(),
			'name' => 'user',
		];
	}
	...
	private function getTitlePatternDesc( $pattern ) {
		return [
			...
			'name' => 'pattern',
			// TODO Where is the value coming from?
		];
	}
	...
	private function getActionSelectorDesc( $types, $action ) {
			...
			return [
				...
				'default' => $action, // TODO Does this work?
