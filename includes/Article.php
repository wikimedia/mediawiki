...
class Article implements Page {
	...
	public function showPatrolFooter() {
		...
		if ( $wgUseRCPatrol && !$request->getBool( 'patrolpage' ) ) {
			...
			if ( $cache->get( wfMemcKey( 'NotPatrollableRevId', $this->getRevIdFetched() ) ) === true ) {
				wfProfileOut( __METHOD__ );
				return;
			}
			...
			// Check for cached results
			if ( $cache->get( wfMemcKey( 'NotPatrollablePage', $this->getTitle()->getArticleID() ) ) === true ) {
				wfProfileOut( __METHOD__ );
				return;
			}
