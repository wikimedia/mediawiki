...
abstract class SessionProvider implements SessionProviderInterface, LoggerAwareInterface {
	 ...
	 */
	protected $priority = SessionInfo::MIN_PRIORITY + 10;
	 ...
	 *
	 * If self::canChangeUser() returns true, return false here.
	 *
	 * Otherwise, return true if it is possible that some request could
	 * currently result in a SessionInfo for the specified user, e.g. are there
	 * any credentials that map to this user's name or ID.
	 *
