...
interface IMessagePoster {
	 ...
	 *
	 * @param LinkTarget $linkTarget Title of talk page
	 ...
	 *   (0).
	 *
	 * @return Status A status on success, possibly with warnings or non-fatal errors.
	 *   Note that you must also handle exceptions.
