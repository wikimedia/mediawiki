...
class ArchiveTableRevisionSlot extends TextTableRevisionSlot {
	 ...
	 */
	public function __construct( Title $title, $archiveRow, $queryFlags = 0, $textFieldPrefix = 'ar_', $slotName = 'main' ) {
		!!!//FIXME: $archiveRow uses ar_ prefix
		parent::__construct( $title, $archiveRow, $archiveRow, $queryFlags, $textFieldPrefix, $slotName );
	}
