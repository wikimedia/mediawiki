...
class SimpleRevisionSlot implements RevisionSlot {
	 ...
	 * @param string[]|null $restrictions a list of permissions that grant read access to the
	 *        slot's content. Null means no permissions are required. Empty means no permission
	 *        is sufficient.
	 */
