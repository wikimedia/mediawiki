...
class WebRequest {
	...
	public function getSession() {
		if ( $this->sessionId !== null ) {
			return MWSessionManager::singleton()->getSessionById( $this->sessionId, $this );
		}

		$session = MWSessionManager::singleton()->getSessionForRequest( $this );
...
class FauxRequest extends WebRequest {
	...
	public function __construct( $data = array(), $wasPosted = false,
		...
		if ( $session instanceof MWSession ) {
			...
			$mwsession = MWSessionManager::singleton()->getEmptySession( $this );
			$this->sessionId = $mwsession->getId();
