...
class WebRequest {
	...
	public function __construct() {
		...
		// On HHVM, use `register_postsend_function`, as recommended in
...
HTML;
	 ...
	 *
	 * @param callable|null $callback Function to call after shutdown.
	 *  Optional.
	 * @since 1.26
	 */
	public function shutdown( $callback = null ) {
		...
		// Under FastCGI, client disconnects prevent shutdown functions from
		// running, unless PHP is explicitly instructed to ignore user aborts.
		// See http://php.net/manual/en/function.register-shutdown-function.php#112746
		ignore_user_abort( true );

		// PHP-FPM. See http://php.net/manual/en/function.fastcgi-finish-request.php
		if ( function_exists( 'fastcgi_finish_request' ) ) {
			fastcgi_finish_request();
		}

		// Call exit() to ensure shutdown functions get called.
		// See https://www.drupal.org/node/2157053#comment-8448197
		exit;
	}
}
