...
HTML;
	 ...
	 *
	 * Safe methods are verbs (GET/HEAD/OPTIONS) used for obtaining content. Such requests are
	 * not expected to mutate content, especially in ways attributable to the client. Verbs like
	 * POST and PUT and typical of non-safe requests, which often change content.
	 *
	 * @return bool
