...
class Linker {
	 ...
	 *
	 * If the option brackets is set the rollback link will be enclosed in []
	 *
	 * @param $rev Revision object
	 ...
	 * @return string
	 */
	public static function generateRollback( $rev, IContextSource $context = null, $options = array( 'verify', 'brackets' ) ) {
		if ( $context === null ) {
