...
class Linker {
	...
	public static function link(
		...
		if ( in_array( 'known', $options, true ) ) {
			return $htmlPageLinkRenderer->makeKnownLink( $target, $html, $customAttribs, $query );
		} elseif ( in_array( 'broken', $options, true ) ) {
			return $htmlPageLinkRenderer->makeBrokenLink( $target, $html, $customAttribs, $query );
		} else {
			return $htmlPageLinkRenderer->makeLink( $target, $html, $customAttribs, $query );
		}
	}
